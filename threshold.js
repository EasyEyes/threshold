...
var consentFormName = "consentform.pdf";
var debriefFormName = "consentform.md";
...
const experiment = (blockCount) => {
  ...
  async function experimentInit() {
    ...
    debrief_form_content = new visual.TextStim({
      win: psychoJS.window,
      name: "debrief_form_content",
      text: "I agree to participate in this study (indicate by clicking one option).",
      font: "Open Sans",
      units: undefined,
      pos: [0, -0.35],

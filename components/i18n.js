...
export const phrases = {
  ...
  "🕑RC_distanceTrackingGuide": {
    ...
    de: "Ihre Augen sind 111 cm vom Bildschirm entfernt, aber das Experiment benötigt ungefähr 222 cm. Das Experiment wird wieder aufgenommen, wenn Sie den richtigen Abstand erreichen.",
    fr: "Vos yeux sont à 111 cm de l'écran, mais l'expérience a besoin d'environ 222 cm. L'expérience reprendra lorsque vous atteignez la distance correcte.",
    ...
    pt: "Seus olhos estão 111 cm da tela, mas o experimento precisa de aproximadamente 222 cm. O experimento será retomado quando você atingir a distância correta.",
    it: "I tuoi occhi sono 111 cm dallo schermo, ma l'esperimento ha bisogno di circa 222 cm. L'esperimento riprenderà quando raggiungi la distanza corretta.",
    ro: "Ochii tăi sunt la 111 cm de ecran, dar experimentul are nevoie de aproximativ 222 cm. Experimentul se va relua când ajungeți la distanța corectă.",
    pl: "Twoje oczy są 111 cm od ekranu, ale eksperyment wymaga około 222 cm. Eksperyment zostanie wznowiony po osiągnięciu prawidłowej odległości.",
    ru: "Ваши глаза находятся в 111 см от экрана, но эксперимент нуждается в приблизительно 222 см. Эксперимент возобновится, когда вы достигнете правильного расстояния.",
    hy: "Ձեր աչքերը էկրանից 111 սմ են, բայց փորձը պետք է մոտավորապես 222 սմ: Փորձը կվերսկսվի ճիշտ հեռավորության վրա:",
    fi: "Silmäsi ovat 111 cm näytöltä, mutta koe tarvitsee noin 222 cm. Koe jatkuu, kun saavutat oikean etäisyyden.",
    ka: "თქვენი თვალები ეკრანიდან 111 სმ -ია, მაგრამ ექსპერიმენტს დაახლოებით 222 სმ სჭირდება. ექსპერიმენტი განახლდება, როდესაც მიაღწევთ სწორ მანძილს.",
    he: 'העיניים שלך הן 111 ס"מ מהמסך, אך הניסוי זקוק לכ- 222 ס"מ. הניסוי יחודש כשתגיע למרחק הנכון.',
    ar: "عيناك 111 سم من الشاشة ، لكن التجربة تحتاج إلى حوالي 222 سم. ستستأنف التجربة عند الوصول إلى المسافة الصحيحة.",
    ur: "آپ کی آنکھیں اسکرین سے 111 سینٹی میٹر ہیں ، لیکن اس تجربے کی تقریبا 222 سینٹی میٹر کی ضرورت ہے۔ جب آپ صحیح فاصلے پر پہنچیں گے تو تجربہ دوبارہ شروع ہوگا۔",
    hi: "आपकी आँखें स्क्रीन से 111 सेमी हैं, लेकिन प्रयोग को लगभग 222 सेमी की आवश्यकता है। जब आप सही दूरी तक पहुंचेंगे तो प्रयोग फिर से शुरू हो जाएगा।",
    ...
    ml: "സ്ക്രീനിൽ നിന്ന് 111 സെന്റിമീറ്റർ നിങ്ങളുടെ കണ്ണുകൾ ഉണ്ട്, പക്ഷേ പരീക്ഷണത്തിന് ഏകദേശം 222 സെന്റിമീറ്റർ ആവശ്യമാണ്. നിങ്ങൾ ശരിയായ ദൂരത്തിലെത്തുമ്പോൾ പരീക്ഷണം പുനരാരംഭിക്കും.",
    te: "మీ కళ్ళు స్క్రీన్ నుండి 111 సెం.మీ., కానీ ప్రయోగానికి సుమారు 222 సెం.మీ. మీరు సరైన దూరానికి చేరుకున్నప్పుడు ప్రయోగం తిరిగి ప్రారంభమవుతుంది.",
    kn: "ನಿಮ್ಮ ಕಣ್ಣುಗಳು ಪರದೆಯಿಂದ 111 ಸೆಂ.ಮೀ., ಆದರೆ ಪ್ರಯೋಗಕ್ಕೆ ಸುಮಾರು 222 ಸೆಂ.ಮೀ. ನೀವು ಸರಿಯಾದ ದೂರವನ್ನು ತಲುಪಿದಾಗ ಪ್ರಯೋಗವು ಪುನರಾರಂಭಗೊಳ್ಳುತ್ತದೆ.",
    bn: "আপনার চোখ পর্দা থেকে 111 সেন্টিমিটার, তবে পরীক্ষায় প্রায় 222 সেমি প্রয়োজন। আপনি যখন সঠিক দূরত্বে পৌঁছেছেন তখন পরীক্ষাটি আবার শুরু হবে।",
    id: "Mata Anda 111 cm dari layar, tetapi percobaan membutuhkan sekitar 222 cm. Eksperimen akan dilanjutkan saat Anda mencapai jarak yang benar.",
    "zh-CN":
    ...
    ko: "눈은 화면에서 111cm이지만 실험은 약 222cm가 필요합니다. 올바른 거리에 도달하면 실험이 재개됩니다.",
  },
  RC_distanceTrackingGuide: {
    "en-US":
  ...
  T_continueClickProceedOrHitReturnOrKeypad: {
    ...
    de: "Um fortzufahren, klicken Sie auf fortfahren oder drücken Sie die Rückgabe in der Tastatur/der Tastatur.",
    fr: "Pour continuer, cliquez sur Procéder ou appuyez sur Retour dans le clavier / clavier.",
    es: "Para continuar, haga clic en continuar o presione la devolución en el teclado/teclado.",
    pt: "Para continuar, clique em prosseguir ou pressionar o retorno no teclado/teclado.",
    it: "Per continuare, fare clic su Procedere o premere Restituzione nella tastiera/tastiera.",
    ro: "Pentru a continua, faceți clic pe continuați sau apăsați returnarea în tastatură/tastatură.",
    pl: "Aby kontynuować, kliknij, kontynuuj lub naciśnij Wróć do klawiatury/klawiatury.",
    ru: "Чтобы продолжить, нажмите «Продолжить» или нажмите «Возврат» на клавиатуре/клавиатуре.",
    hy: "Շարունակելու համար կտտացրեք «Շարունակել» կամ հարվածել ստեղնաշարի / ստեղնաշարի մեջ:",
    fi: "Jatka jatka napsauttamalla tai napsauttamalla näppäimistöä/näppäimistöä.",
    ka: "გასაგრძელებლად, დააჭირეთ ღილაკს გაგრძელება ან დააჭირეთ კლავიატურაზე/კლავიატურაში.",
    he: "להמשך, לחץ על המשך או לחץ על החזרה במקלדת/לוח המקשים.",
    ar: "للمتابعة ، انقر فوق متابعة أو ضرب الإرجاع في لوحة المفاتيح/لوحة المفاتيح.",
    ur: "جاری رکھنے کے لئے ، کی بورڈ/کیپیڈ میں آگے بڑھیں یا واپسی پر کلک کریں۔",
    hi: "जारी रखने के लिए, कीबोर्ड/कीपैड में आगे बढ़ने या हिट रिटर्न पर क्लिक करें।",
    ta: "தொடர, விசைப்பலகை/விசைப்பலகையில் திரும்பவும் அல்லது அழுத்தவும் என்பதைக் கிளிக் செய்க.",
    ml: "തുടരുന്നതിന്, കീബോർഡ് / കീപാഡിൽ മുന്നോട്ട് മടങ്ങുക ക്ലിക്കുചെയ്യുക അല്ലെങ്കിൽ അമർത്തുക.",
    te: "కొనసాగించడానికి, కీబోర్డ్/కీప్యాడ్‌లో కొనసాగండి లేదా రిటర్న్ నొక్కండి.",
    kn: "ಮುಂದುವರಿಸಲು, ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಮುಂದುವರಿಯಿರಿ ಅಥವಾ ರಿಟರ್ನ್ ಹಿಟ್ ಕ್ಲಿಕ್ ಮಾಡಿ.",
    bn: "চালিয়ে যাওয়ার জন্য, কীবোর্ড/কীপ্যাডে এগিয়ে যাওয়া বা হিট হিট ক্লিক করুন।",
    id: "Untuk melanjutkan, klik lanjutkan atau tekan kembali di keyboard/keypad.",
    "zh-CN": "要继续，请单击“继续或点击键盘/键盘中的返回。",
    "zh-HK": "要繼續，請單擊“繼續或點擊鍵盤/鍵盤中的返回。",
    ja: "続行するには、キーボード/キーパッドの[再度]をクリックするか、[戻り]をクリックします。",
    ko: "계속하려면 키보드/키패드에서 진행 또는 반환을 클릭하십시오.",
  },
  ...
  "🕑T_counterBlock": {
    ...
    ro: "Blocul 111 din 222.",
    pl: "Blok 111 z 222.",
    ru: "Блок 111 из 222.",
    hy: "222-ից 111-ը:",
    fi: "Lohko 111/222.",
    ka: "222 -ე ბლოკი 111.",
    he: "חסום 111 מתוך 222.",
    ar: "كتلة 111 من 222.",
    ur: "222 کے 111 کو بلاک کریں۔",
    hi: "222 का ब्लॉक 111।",
    ta: "222 இன் தொகுதி 111.",
    ml: "222 ൽ 111 ബ്ലോക്ക് ചെയ്യുക.",
    te: "బ్లాక్ 111 లో 222.",
    kn: "222 ರಲ್ಲಿ 111 ಅನ್ನು ನಿರ್ಬಂಧಿಸಿ.",
    bn: "222 এর 111 ব্লক।",
    id: "Blok 111 dari 222.",
    "zh-CN": "第111块，共222块。",
    "zh-HK": "第111塊，共222塊。",
    ja: "222のブロック111。",
    ko: "블록 111 of 222.",
  ...
  "🕑T_counterReadingPageBlock": {
    ...
    ro: "Pagina 111 din 222. Blocul 333 din 444.",
    pl: "Strona 111 z 222. Blok 333 z 444.",
    ru: "Страница 111 из 222. Блок 333 из 444.",
    hy: "Էջ 111-ը 222. 444-ի արգելափակում 333:",
    fi: "Sivu 111/222. Lohko 333/444.",
    ka: "გვერდი 111 of 222. ბლოკი 333 of 444.",
    he: "עמוד 111 מתוך 222. בלוק 333 מתוך 444.",
    ar: "صفحة 111 من 222. كتلة 333 من 444.",
    ur: "صفحہ 111 کا 222. بلاک 333 آف 444۔",
    hi: "पृष्ठ 111 का 222. 444 का ब्लॉक 333।",
    ta: "222 இன் பக்கம் 111. 444 இன் தொகுதி 333.",
    ml: "222 ന്റെ പേജ് 111 എണ്ണം 444 ലെ ബ്ലോക്ക് 333.",
    te: "పేజీ 111 యొక్క 222. బ్లాక్ 333 ఆఫ్ 444.",
    kn: "ಪುಟ 111 ಆಫ್ 222. 444 ರ ಬ್ಲಾಕ್ 333.",
    bn: "222 এর পৃষ্ঠা 1112. 444 এর 333 ব্লক করুন।",
    id: "Halaman 111 dari 222. Blok 333 dari 444.",
    "zh-CN": "第111页，共222页。第333块，共444页。",
    "zh-HK": "第111頁，共222頁。第333塊，共444頁。",
    ja: "ページ111/222。444のブロック333。",
    ko: "222 페이지. 블록 333 of 444.",
  },
  "🕑T_counterTrialBlock": {
    ...
    fi: "Koe 111/222. Lohko 333/444.",
    ka: "222 წლის 111 სასამართლო პროცესი. 444 -ე ბლოკი 333.",
    ...
    ta: "சோதனை 111 of 222. 444 இன் தொகுதி 333.",
    ml: "വിചാരണ 111 ൽ 111 എണ്ണം 444 ലെ ബ്ലോക്ക് 333.",
    te: "ట్రయల్ 111 లో 222. బ్లాక్ 333 లో 444.",
    kn: "222 ರಲ್ಲಿ ಪ್ರಯೋಗ 111. 444 ರಲ್ಲಿ 333 ಬ್ಲಾಕ್.",
    bn: "222 এর 111 ট্রায়াল 2. 444 এর 333 ব্লক।",
  ...
  T_guessingGame: {
    ...
    ur: "خط کی جسامت اور خالی جگہ چھوٹے اور سخت سے زیادہ مختلف اور آسان ہوتی ہے۔ آپ کو دو تہائی سے زیادہ نہیں مل سکتے ہیں ، لہذا آرام کریں۔ اس کو تخمینہ کھیل کے طور پر سوچیں ، اور زیادہ سے زیادہ حاصل کریں۔ جب بھی آپ ٹھیک کہتے ہیں ، آپ کو بیپ سنی جائے گی۔",
  ...
  T_identifyLetterPressItOrClickIt: {
    ...
    pl: "Zidentyfikuj list, klikając ją poniżej lub naciskając na klawiaturę/klawiaturę.",
    ...
    kn: "ಅಕ್ಷರವನ್ನು ಕೆಳಗೆ ಕ್ಲಿಕ್ ಮಾಡುವುದರ ಮೂಲಕ ಅಥವಾ ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ ದಯವಿಟ್ಟು ಗುರುತಿಸಿ.",
  ...
  T_typeOrClickLetter: {
    ...
    ta: "காட்டப்பட்ட கடிதங்களின் பட்டியலில் அதைக் கிளிக் செய்வதன் மூலம் அல்லது விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம்.",
  ...
  T_keypadLetterOrClickingLetterOrPressingKey: {
    ...
    ka: "დააჭირეთ მას ასოების ნაჩვენები ჩამონათვალში, დააჭირეთ მას კლავიატურაზე, ან დააჭირეთ მას კლავიატურაზე.",
  ...
  T_typeRepeatedLetters: {
    ...
    ar: "بالضغط عليها على لوحة المفاتيح/لوحة المفاتيح.",
  ...
  T_readyTrackCrosshair: {
    ...
    fr: "Prêt? Utilisez le curseur pour suivre le centre de la transformation jusqu'à ce que la cible apparaisse.",
  ...
  T_thresholdVenierBeginBlock: {
    ...
    it: "Stai per iniziare un blocco di prove xxx. Ogni prova presenterà una nuova coppia di linee. Si prega di segnalare se la linea superiore è spostata a sinistra o a destra (L o R),",
    ...
    ru: "Вы собираетесь начать блок xxx испытаний. Каждое испытание представит новую пару линий. Пожалуйста, сообщите, смещается ли верхняя линия влево или вправо (L или R),",

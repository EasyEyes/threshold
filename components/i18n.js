...
export const phrases = {
  ...
  T_rsvpReadingTask: {
    ...
    ar: "أنت على وشك بدء كتلة من تجارب xxx. ستكون قراءات قصة ، بضع كلمات في وقت واحد. ستظهر لك كل تجربة بسرعة حول قيمة الكلمات ، واحدة تلو الأخرى ، ثم تطلب منك أن تتذكر الكلمات التي تقرأها.",

...
export const phrases = {
  ...
  EE_ID: {
    ...
    "zh-CN":
      "需要独特的ID来链接跨会话的数据。这台计算机以前参加了有关easyeyes id“ ** sss **”的** ddd **的会话。如果是你，请按确定。否则，如果您有EasyEyes ID文件，请按下面的文件选择按钮打开它。 （该文件名以“ EasyEyes”开头，以“ .txt”结尾，通常在您的下载文件夹中。）如果您没有文件，但是知道您的EasyEyes ID，请输入。否则，只需构成自己的ID，即至少有5个字符的字符串长。如果您愿意，可以是您的名字。我们会在这台计算机上为您记住它，但是如果您转到另一台计算机，请获取您的EasyEyes ID文件（您的下载文件夹中的最新文件），或者至少写下您的EasyEyes ID。每次使用它将您的数据从会话链接到会话。",
    "zh-HK":
  ...
  RC_distanceTrackingCloseL: {
    ...
    pt: "1. Feche o olho esquerdo. (Este é o lado esquerdo da tela.)\n2. Use ▶ Chave de seta para deslizar o ponto de tremeling. (Ou simplesmente arraste -o, se não estiver respondendo à tecla de seta.) Enquanto olha os cabelos cruzados, monitore o ponto de tremeling no canto do olho e deslize -o para a esquerda e para a direita até desaparecer no seu ponto cego.\n3. Bata o retorno.\nNota: Fique de olho nos cabelos cruzados. O ponto piscador não desaparecerá enquanto seu olho o segue.",
  ...
  RC_gazeTrackingNudge: {
    ...
    pt: "Pegue a cruz! Nós precisamos da sua ajuda. O rastreador ocular precisa de mais treinamento. Como mostrado pela seta, quando você clicou, o rastreador achou que seu olhar estava longe dos cabelos cruzados. Clique nos cabelos cruzados em cada nova posição. É um jogo. Pegue a cruz!",
  ...
  RC_privacyCamera: {
    ...
    "zh-CN":
      "保证相机隐私。没有录制照片或视频。每个网络摄像头框架仅在这台计算机内使用，仅用于估计眼睛和凝视位置，然后在10秒内删除。只保留了眼睛和凝视位置。",
    "zh-HK":
  ...
  RC_screenSizeCredit: {
    ...
    te: 'క్రెడిట్ కార్డ్ లి మరియు ఇతరులు సూచించింది. (2020) "వర్చువల్ చిన్‌రెస్ట్" కాగితం.',
  ...
  RC_viewingBlindSpotRejected: {
    ...
    "zh-HK":
      "抱歉，最新的左和右測量值不一致。我們可以再試一次嗎？閉上眼睛。專注於十字頭髮，並從眼角監視閃爍的點。向左和向右滑動點，直到它消失在盲點中，然後擊中返回。測試雙眼時，保持觀看距離。",
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    "zh-CN":
      "解释。对于此步骤，如有必要，靠近，因此您的宽度不超过两倍。每只眼睛都有一个盲点。我们会找到您的，以发现您的眼睛离屏幕有多远。您会被要求闭上或遮住一只眼睛以隔离另一只眼睛。当您专注于十字头头发时，请观察眼角闪烁的点，并在盲点消失时击中返回。根据查看距离和屏幕尺寸，闪烁的点通常会在盲点到达屏幕中间之前到达盲点。您将用每只眼睛交替进行此操作，直到最后两个测量一致。测试双眼时，请保持观看距离。笔记。如果点永远不会消失，则意味着您的眼睛正在跟随点，而不是呆在十字头发上。该测试需要您在监视眼角的闪烁点时密切关注叉头发。一开始很难，但是练习变得更加容易。",
    "zh-HK":
  ...
  T_guessingGame: {
    ...
    fi: "Kirjeen koko ja etäisyys vaihtelevat suuresta ja helposta alas pieneen ja kovaan tai mahdottomaan. Et voi saada paljon enemmän kuin kaksi kolmasosaa oikein, joten rentoudu. Ajattele sitä arvauspelinä ja hanki vain niin monta kuin pystyt. Kuulet piippauksen aina kun olet oikeassa.",
  ...
  T_middleLetterBrief: {
    ...
    te: "ఇది R. ఈ ప్రదర్శన స్థిరంగా ఉంది, కాబట్టి మీ కళ్ళను లేఖకు తరలించి గుర్తించడం సులభం. కానీ, నిజమైన విచారణలో, అక్షరాలు వెలిగిపోతాయి, కాబట్టి మీ కళ్ళను కదిలించడానికి సమయం లేదు. మీరు ట్రయల్ ప్రారంభించినప్పుడు క్రాస్ హెయిర్స్ చూడటం చాలా ముఖ్యం. అక్షరాలు వెంటనే ఫ్లాష్ అవుతాయి. ఫ్లాష్ తర్వాత మీ కళ్ళు ఎక్కడికి వెళతాయో అది పట్టింపు లేదు. పరీక్ష యొక్క మొదటి బ్లాక్ మేము ఆసక్తిగా ప్రారంభించడానికి ముందు, కొన్ని ప్రయత్నాలు సాధన.",
    kn: "ಇದು ಆರ್. ಈ ಪ್ರದರ್ಶನವು ಸ್ಥಿರವಾಗಿದೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಪತ್ರಕ್ಕೆ ಸರಿಸಿ ಅದನ್ನು ಗುರುತಿಸುವುದು ಸುಲಭ. ಆದರೆ, ನಿಜವಾದ ಪ್ರಯೋಗದಲ್ಲಿ, ಅಕ್ಷರಗಳು ಮಿನುಗುತ್ತವೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಸರಿಸಲು ಸಮಯವಿಲ್ಲ. ನೀವು ಪ್ರಯೋಗವನ್ನು ಪ್ರಾರಂಭಿಸಿದಾಗ ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವುದು ಮುಖ್ಯ. ಅಕ್ಷರಗಳು ತಕ್ಷಣ ಮಿಂಚುತ್ತವೆ. ನಿಮ್ಮ ಕಣ್ಣುಗಳು ಫ್ಲ್ಯಾಷ್ ನಂತರ ಎಲ್ಲಿಗೆ ಹೋಗುತ್ತವೆ ಎಂಬುದು ಮುಖ್ಯವಲ್ಲ. ನಾವು ಶ್ರದ್ಧೆಯಿಂದ ಪ್ರಾರಂಭಿಸುವ ಮೊದಲು ಪರೀಕ್ಷೆಯ ಮೊದಲ ಬ್ಲಾಕ್ ಅಭ್ಯಾಸದ ಕೆಲವು ಪ್ರಯೋಗಗಳು.",
  ...
  T_letterBrief: {
    ...
    te: "ఇది R. ఈ ప్రదర్శన స్థిరంగా ఉంది, కాబట్టి మీ కళ్ళను లేఖకు తరలించి గుర్తించడం సులభం. కానీ, నిజమైన విచారణలో, లేఖ వెలిగింది, కాబట్టి మీ కళ్ళను కదిలించడానికి సమయం లేదు. మీరు ట్రయల్ ప్రారంభించినప్పుడు క్రాస్ హెయిర్స్ చూడటం చాలా ముఖ్యం. లేఖ వెంటనే ఫ్లాష్ అవుతుంది. ఫ్లాష్ తర్వాత మీ కళ్ళు ఎక్కడికి వెళతాయో అది పట్టింపు లేదు. పరీక్ష యొక్క మొదటి బ్లాక్ మేము ఆసక్తిగా ప్రారంభించడానికి ముందు, కొన్ని ప్రయత్నాలు సాధన.",
    kn: "ಇದು ಆರ್. ಈ ಪ್ರದರ್ಶನವು ಸ್ಥಿರವಾಗಿದೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಪತ್ರಕ್ಕೆ ಸರಿಸಿ ಅದನ್ನು ಗುರುತಿಸುವುದು ಸುಲಭ. ಆದರೆ, ನಿಜವಾದ ಪ್ರಯೋಗದಲ್ಲಿ, ಪತ್ರವು ಹರಿಯುತ್ತದೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಸರಿಸಲು ಸಮಯವಿಲ್ಲ. ನೀವು ಪ್ರಯೋಗವನ್ನು ಪ್ರಾರಂಭಿಸಿದಾಗ ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವುದು ಮುಖ್ಯ. ಪತ್ರವು ತಕ್ಷಣವೇ ಮಿಂಚಾಗುತ್ತದೆ. ನಿಮ್ಮ ಕಣ್ಣುಗಳು ಫ್ಲ್ಯಾಷ್ ನಂತರ ಎಲ್ಲಿಗೆ ಹೋಗುತ್ತವೆ ಎಂಬುದು ಮುಖ್ಯವಲ್ಲ. ನಾವು ಶ್ರದ್ಧೆಯಿಂದ ಪ್ರಾರಂಭಿಸುವ ಮೊದಲು ಪರೀಕ್ಷೆಯ ಮೊದಲ ಬ್ಲಾಕ್ ಅಭ್ಯಾಸದ ಕೆಲವು ಪ್ರಯೋಗಗಳು.",
  ...
  T_rsvpReadingTask: {
    ...
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu starten. Sie werden eine Geschichte lesen, ein paar Worte gleichzeitig. Jeder Versuch zeigt Ihnen schnell über ein Satz von Wörtern nacheinander und bittet Sie dann, sich daran zu erinnern, welche Wörter Sie lesen.",
  ...
  T_sentenceIdentifyClick: {
    ...
    ar: "تُظهر القوائم أدناه جميع إمكانيات كل كلمة في الجملة. أبلغ عن الجملة ، أو أفضل تخمين ، من خلال النقر على الكلمات التي سمعتها.",
  ...
  T_soundPhraseBlock: {
    ...
    ko: "각 시험에서 문장을 듣고 두 단어를 기억하도록 요청받을 것입니다. 소리가 왜곡되어 인식하기 어려울 수 있으므로 올바르게 얻을 수는 없습니다. 괜찮아요. 게임으로 대우하고 최선을 다하십시오. 행운을 빌어요. 반품을 누르거나 계속 진행하려면 진행하십시오.\n\n진행 버튼은 즉시 사라지고 사운드가로드되면 실험이 시작되며 인터넷 연결 속도에 따라 40 초 이상이 걸립니다. 우리는 향후 릴리스 에서이 지연을 단축하기 위해 노력하고 있습니다.\n\n소리로드 ...",
  },

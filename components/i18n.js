...
export const phrases = {
  ...
  RC_citeSoundCompressionModel: {
    ...
    ro: 'Bazat pe Eq. 4 din Giannoulis și colab. (2012). <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicRangecompression-jaes2012.pdf"> Digital Dynamic Range Design Compresor. </a> J. Audio Eng. Soc. 6 (6): 399-408.',
  ...
  RC_turnMeToReadBelow: {
    ...
    fr: "Mettez ce téléphone sur le chiffon plié. Faites-moi tourner pour lire les instructions ci-dessous.",
    ...
    id: "Letakkan ponsel ini di atas kain yang dilipat. Putar saya untuk membaca instruksi di bawah ini.",
  ...
  RC_placeSmartphoneMicrophone: {
    ...
    ro: "Arătați acest capăt al telefonului ⇧ la computer și împingeți capătul dincolo de pânza pliată. Apăsați.",
    ...
    fi: "Osoita tämä puhelimen pää ⇧ tietokoneellasi ja työnnä pää taitetun kankaan ulkopuolelle. Paina jatka.",
    ...
    ar: "أشر إلى هذه الطرف من الهاتف ⇧ على جهاز الكمبيوتر الخاص بك ، وادفع النهاية إلى ما وراء القماش المطوي. اضغط على متابعة.",
    ur: "فون کے اس سرے کی نشاندہی کریں ⇧ اپنے کمپیوٹر پر ، اور جوڑ والے کپڑے سے آگے کو دھکیلیں۔ آگے بڑھیں۔",
    hi: "फोन के इस छोर को अपने कंप्यूटर पर इंगित करें, और मुड़े हुए कपड़े से परे अंत को धक्का दें। दबाएं।",
  ...
  T_keypadScanQRCodeSubtitle: {
    ...
    "zh-CN":
      "这将使您可以使用手机作为键盘进行响应，从而使您可以坐在计算机键盘上。",
    "zh-HK":
      "這將使您可以使用手機作為鍵盤進行響應，從而使您可以坐在計算機鍵盤上。",

...
export const phrases = {
  ...
  RC_viewingDistanceIntro: {
    ...
    ar: "توضيح. لهذه الخطوة ، اقترب أكثر ، إذا لزم الأمر ، لذلك أنت لست أكثر من ضعف عرض الشاشة. كل عين لديها مجموعة أعمى. سنجد لك لاكتشاف مدى انتباهك عن الشاشة. يُطلب منك إغلاق أو تغطية عين واحدة لعزل الآخر. ستستخدم مفاتيح سهم لوحة المفاتيح ← → لنقل النقطة الخفية إلى اليسار واليمين حتى تختفي في لعبة BlindSpot. ستقوم بذلك مع كل عين ، بالتناوب ، حتى يتسق القياسين الأخيرين. يرجى الحفاظ على مسافة المشاهدة الخاصة بك أثناء اختبار كلتا العينين. ملحوظة. إذا لم تختفي النقطة أبدًا ، فهذا يعني أن عينيك تتبع النقطة ، بدلاً من البقاء على الشعر المتقاطع. يتطلب هذا الاختبار أن تراقب عن الشعر المتقاطع أثناء مراقبة النقطة الوهمية في زاوية عينيك. هذا صعب في البداية ، لكنه يصبح أسهل مع الممارسة.",
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    "zh-CN":
      "解释。对于此步骤，如有必要，靠近，因此您的屏幕宽度不超过两倍。每只眼睛都有一个盲点。我们会发现您的眼睛离屏幕有多远。您会被要求闭上或遮住一只眼睛以隔离另一只眼睛。当您专注于十字头发时，请观察眼角闪烁的点，并在盲点消失时击中回报。根据观看距离和屏幕尺寸，闪烁的点通常会在盲点到达屏幕中间之前到达盲点。您将用每只眼睛交替进行此操作，直到最后两个测量一致。测试双眼时，请保持观看距离。笔记。如果点永远不会消失，则意味着您的眼睛正在跟随点，而不是留在十字头发上。该测试要求您在监视眼角的闪烁点时密切注意十字头发。一开始很难，但是练习变得更加容易。",
    "zh-HK":

...
export const phrases = {
  ...
  T_keypadScanQRCode: {
    "en-US":
      "To allow a long viewing distance, please recruit your smartphone to provide a remote keypage. Point your smartphone camera at this QR code and use your finger to click the link that appears.",
    de: "Um eine lange Betrachtungsentfernung zu ermöglichen, rekrutieren Sie bitte Ihr Smartphone, um eine Remote -Tastatur bereitzustellen. Zeigen Sie Ihre Smartphone -Kamera auf diesen QR -Code und klicken Sie mit Ihrem Finger auf den angezeigten Link.",
    fr: "Pour permettre une longue distance de visualisation, veuillez recruter votre smartphone pour fournir une clé à distance. Pointez votre appareil photo pour smartphone sur ce code QR et utilisez votre doigt pour cliquer sur le lien qui apparaît.",
    es: "Para permitir una larga distancia de visualización, reclute su teléfono inteligente para proporcionar un teclado remoto. Apunte la cámara de su teléfono inteligente en este código QR y use su dedo para hacer clic en el enlace que aparece.",
    pt: "Para permitir uma distância de visualização longa, recrute seu smartphone para fornecer um teclado remoto. Aponte a câmera do seu smartphone para este código QR e use o dedo para clicar no link que aparece.",
    it: "Per consentire una lunga distanza di visualizzazione, si prega di reclutare lo smartphone per fornire una tastiera remota. Punta la fotocamera per smartphone su questo codice QR e usa il dito per fare clic sul collegamento che appare.",
    ro: "Pentru a permite o distanță lungă de vizualizare, vă rugăm să recrutați smartphone -ul pentru a oferi o tastatură la distanță. Indicați camera de smartphone la acest cod QR și folosiți degetul pentru a face clic pe linkul care apare.",
    pl: "Aby umożliwić długą odległość oglądania, rekrutuj smartfon, aby zapewnić zdalną klawiaturę. Wskaż aparat smartfona na ten kod QR i użyj palca, aby kliknąć wyświetlony link.",
    ru: "Чтобы разрешить длительное расстояние просмотра, пожалуйста, наберите свой смартфон, чтобы обеспечить удаленное клавиатуру. Укажите камеру смартфона на этом QR -коде и используйте свой палец, чтобы нажать на появление ссылки.",
    hy: "Երկար դիտման հեռավորություն թույլ տալու համար խնդրում ենք հավաքագրել ձեր սմարթֆոնը `հեռավոր ջերմաստիճան ապահովելու համար: Նշեք ձեր սմարթֆոնների տեսախցիկը այս QR կոդով եւ օգտագործեք ձեր մատը `կտտացնելով այն հղումը, որը հայտնվում է:",
    fi: "Rekrytoi älypuhelimesi kauko -avaimen sallimiseksi pitkän katseluetäisyyden. Osoita älypuhelinkamera tässä QR -koodissa ja napsauta sormesi napsauttamalla näkyvää linkkiä.",
    ka: "გრძელი სანახავი მანძილის დასაშვებად, გთხოვთ, შეაგროვოთ თქვენი სმარტფონი, რომ უზრუნველყოთ დისტანციური კლავიატურა. მიუთითეთ თქვენი სმარტფონის კამერა ამ QR კოდზე და გამოიყენეთ თქვენი თითი, რომ დააჭირეთ ბმულს, რომელიც გამოჩნდება.",
    he: "כדי לאפשר מרחק צפייה ארוך, אנא גייס את הטלפון החכם שלך כדי לספק לוח מקשים מרוחק. כוון את מצלמת הסמארטפון שלך בקוד QR זה והשתמש באצבע שלך כדי ללחוץ על הקישור שמופיע.",
    ar: "للسماح بمسافة عرض طويلة ، يرجى توظيف هاتفك الذكي لتوفير مفاتيح عن بُعد. قم بإشارة كاميرا الهاتف الذكي إلى رمز الاستجابة السريعة هذا واستخدم إصبعك للنقر على الرابط الذي يظهر.",
    ur: "دیکھنے کے طویل فاصلے کی اجازت دینے کے لئے ، براہ کرم ریموٹ کیپج فراہم کرنے کے لئے اپنے اسمارٹ فون کو بھرتی کریں۔ اپنے اسمارٹ فون کیمرہ کو اس کیو آر کوڈ پر اشارہ کریں اور اپنی انگلی کا استعمال لنک پر کلک کرنے کے لئے کریں جو ظاہر ہوتا ہے۔",
    hi: "एक लंबी देखने की दूरी की अनुमति देने के लिए, कृपया अपने स्मार्टफोन को रिमोट कीपेज प्रदान करने के लिए भर्ती करें। इस QR कोड पर अपना स्मार्टफोन कैमरा इंगित करें और दिखाई देने वाले लिंक पर क्लिक करने के लिए अपनी उंगली का उपयोग करें।",
    ta: "நீண்ட பார்வை தூரத்தை அனுமதிக்க, தொலைதூர விசைப்பலகையை வழங்க உங்கள் ஸ்மார்ட்போனை நியமிக்கவும். இந்த QR குறியீட்டில் உங்கள் ஸ்மார்ட்போன் கேமராவை சுட்டிக்காட்டி, தோன்றும் இணைப்பைக் கிளிக் செய்ய உங்கள் விரலைப் பயன்படுத்தவும்.",
    ml: "ഒരു വിദൂര കീപേജ് നൽകാൻ നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ ദയവായി റിക്രൂട്ട് ചെയ്യുക. നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ ക്യാമറ ഈ സ്മാർട്ട്ഫോൺ ക്യാമറ പോയിൻറ് ദൃശ്യമാകുന്ന ലിങ്കിൽ ക്ലിക്കുചെയ്യാൻ നിങ്ങളുടെ വിരൽ ഉപയോഗിക്കുക.",
    te: "సుదీర్ఘ వీక్షణ దూరాన్ని అనుమతించడానికి, దయచేసి రిమోట్ కీపేజీని అందించడానికి మీ స్మార్ట్‌ఫోన్‌ను నియమించుకోండి. ఈ QR కోడ్ వద్ద మీ స్మార్ట్‌ఫోన్ కెమెరాను సూచించండి మరియు కనిపించే లింక్‌ను క్లిక్ చేయడానికి మీ వేలిని ఉపయోగించండి.",
    kn: "ದೀರ್ಘ ವೀಕ್ಷಣೆ ದೂರವನ್ನು ಅನುಮತಿಸಲು, ದೂರಸ್ಥ ಕೀಪೇಜ್ ಒದಗಿಸಲು ದಯವಿಟ್ಟು ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಅನ್ನು ನೇಮಿಸಿ. ಈ ಕ್ಯೂಆರ್ ಕೋಡ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಕ್ಯಾಮೆರಾವನ್ನು ಸೂಚಿಸಿ ಮತ್ತು ಗೋಚರಿಸುವ ಲಿಂಕ್ ಅನ್ನು ಕ್ಲಿಕ್ ಮಾಡಲು ನಿಮ್ಮ ಬೆರಳನ್ನು ಬಳಸಿ.",
    bn: "দীর্ঘ দেখার দূরত্বের অনুমতি দেওয়ার জন্য, দয়া করে আপনার স্মার্টফোনটিকে একটি রিমোট কীপেজ সরবরাহ করতে নিয়োগ করুন। এই কিউআর কোডটিতে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করুন এবং প্রদর্শিত লিঙ্কটিতে ক্লিক করতে আপনার আঙুলটি ব্যবহার করুন।",
    id: "Untuk mengizinkan jarak menonton yang panjang, silakan rekrut ponsel cerdas Anda untuk menyediakan keypage jarak jauh. Arahkan kamera ponsel cerdas Anda ke kode QR ini dan gunakan jari Anda untuk mengklik tautan yang muncul.",
    "zh-CN":
      "为了允许长时间的观看距离，请招募您的智能手机提供远程关键。将您的智能手机相机指向此QR码，并用手指单击出现的链接。",
    "zh-HK":
      "為了允許長時間的觀看距離，請招募您的智能手機以提供遠程關鍵。將您的智能手機相機指向此QR碼，並用手指單擊出現的鏈接。",
    ja: "視聴距離が長くなるようにするには、スマートフォンをリクルートしてリモートキーパージを提供してください。このQRコードでスマートフォンカメラをポイントし、指を使用して表示されるリンクをクリックします。",
    ko: "시청 거리가 길어 지려면 스마트 폰을 모집하여 원격 키패를 제공하십시오. 이 QR 코드에서 스마트 폰 카메라를 가리키고 손가락을 사용하여 나타나는 링크를 클릭하십시오.",
  },

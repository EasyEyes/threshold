...
export const phrases = {
  ...
  RC_FindModelAndroid: {
    ...
    es: 'Dado que se trata de un Android, vaya al menú Configuración o opciones, desplácese hasta la parte inferior de la lista y verifique "sobre el teléfono", "sobre el dispositivo" o similar. Copie el nombre y el número del modelo a los campos correspondientes a continuación.',
  ...
  RC_citeSoundCompressionModel: {
    ...
    ko: 'Eq. Giannoulis et al. (2012). <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicrangecompression-jaes2012.pdf"> 디지털 동적 범위 컴프레서 디자인. </a> Audio Eng. 사회 6 (6) : 399-408.',
  },

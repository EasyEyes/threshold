...
export const phrases = {
  ...
  RC_distanceTrackingCloseL: {
    ...
    hi: "1. अपनी बाईं आंख बंद करें। (यह स्क्रीन का बायाँ हिस्सा है।)\n2. टिमटिमाती डॉट को स्लाइड करने के लिए ▶ तीर कुंजी का उपयोग करें। (या बस इसे खींचें, यदि यह तीर की कुंजी का जवाब नहीं दे रहा है।) क्रॉस हेयर को देखते समय, अपनी आंख के कोने में टिमटिमाते हुए डॉट की निगरानी करें, और इसे बाएं और दाएं स्लाइड करें जब तक कि यह आपके ब्लाइंडस्पॉट में गायब न हो जाए।\n3. हिट रिटर्न।\nनोट: अपनी नजर क्रॉस हेयर पर रखें। झिलमिलाहट डॉट गायब नहीं होगा जबकि आपकी आंख इसका अनुसरण करती है।",

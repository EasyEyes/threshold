...
export const phrases = {
  ...
  EE_compatibleOSDeviceCores: {
    ...
    "zh-CN": "如其描述中所述，这项研究仅在具有至少222个CPU内核的OOO DDD上运行",
  ...
  EE_ID_invalidFile: {
    ...
    hi: "क्षमा मांगना। एक easyeyes आईडी फ़ाइल के लिए गलत प्रारूप। एक और फ़ाइल का प्रयास करें, या कुछ टाइप करें।",
  ...
  RC_distanceTrackingCloseL: {
    ...
    fr: "1. Fermez votre œil gauche. (C'est le côté gauche de l'écran.)\n2. Utilisez ▶ Clé flèche pour faire glisser le point scintillant. (Ou faites-le simplement glisser, s'il ne répond pas à la clé de flèche.) En regardant les poils, surveillez le point vacillant dans le coin de votre œil et faites-le glisser à gauche et à droite jusqu'à ce qu'il disparaisse dans votre point mort.\n3. Appuyez sur Retour.\nRemarque: Gardez l'œil sur les poils. Le point vacillant ne disparaîtra pas pendant que votre œil le suit.",
    ...
    ro: "1. Închideți ochiul stâng. (Aceasta este partea stângă a ecranului.)\n2. Utilizați ▶ Tasta săgeată pentru a glisa punctul pâlpâit. (Sau pur și simplu trageți -l, dacă nu răspunde la cheia săgeată.) În timp ce priviți părul încrucișat, monitorizați punctul pâlpâitor din colțul ochiului și glisați -l la stânga și la dreapta până când va dispărea în blabspot.\n3. Apăsați revenirea.\nNotă: Fii cu ochii pe firele de păr. Punctul pâlpâit nu va dispărea în timp ce ochiul tău îl urmărește.",
    ...
    ar: "1. أغلق عينيك اليسرى. (هذا هو الجانب الأيسر من الشاشة.)\n2. استخدم ▶ مفتاح السهم لتزويد النقطة الخفقان. (أو فقط اسحبه ، إذا لم يستجب لمفتاح السهم.) أثناء النظر إلى الشعر المتقاطع ، راقب النقطة الوهمية في زاوية عينيك ، وحركها إلى اليسار واليمين حتى تختفي في النقطة العمياء.\n3. ضرب العودة.\nملاحظة: راقب الشعر عبر الشعر. لن تختفي النقطة الخفقان بينما تتبعها عينك.",
    ur: "1. اپنی بائیں آنکھ کو بند کریں۔ (یہ اسکرین کا بائیں طرف ہے۔)\n2. ٹمٹماہٹ ڈاٹ سلائیڈ کرنے کے لئے ▶ یرو کلید کا استعمال کریں۔ (یا صرف اسے گھسیٹیں ، اگر یہ تیر کی چابی کا جواب نہیں دے رہا ہے۔) کراس بالوں کو دیکھتے وقت ، اپنی آنکھ کے کونے میں ٹمٹماہٹ ڈاٹ کی نگرانی کریں ، اور اسے بائیں اور دائیں سلائیڈ کریں جب تک کہ یہ آپ کے اندھے مقام میں غائب نہ ہوجائے۔\n3. واپسی کو ہٹ.\nنوٹ: کراس بالوں پر نگاہ رکھیں۔ جب آپ کی آنکھ اس کی پیروی کرتی ہے تو چمکتا ہوا ڈاٹ غائب نہیں ہوگا۔",
    hi: "1. अपनी बाईं आंख बंद करें। (यह स्क्रीन का बायाँ हिस्सा है।)\n2. टिमटिमाती डॉट को स्लाइड करने के लिए ▶ तीर कुंजी का उपयोग करें। (या बस इसे खींचें, अगर यह तीर कुंजी का जवाब नहीं दे रहा है।) क्रॉस हेयर को देखते समय, अपनी आंख के कोने में टिमटिमाती डॉट की निगरानी करें, और इसे बाएं और दाएं स्लाइड करें जब तक कि यह आपके अंधा में गायब नहीं हो जाता।\n3. हिट रिटर्न।\nनोट: अपनी नजर क्रॉस हेयर पर रखें। झिलमिलाहट डॉट गायब नहीं होगा जबकि आपकी आंख इसका अनुसरण करती है।",
  ...
  RC_distanceTrackingCloseR: {
    ...
    ar: "1. أغلق عينك اليمنى. (هذا هو الجانب الأيمن من الشاشة.)\n2. استخدم ◀ مفتاح السهم لتزويد النقطة الخفقان. أثناء النظر إلى الشعر المتقاطع ، راقب النقطة الوهمية في زاوية عينيك ، وحركها إلى اليسار واليمين حتى تختفي في لعبة Blindspot.\n3. ضرب العودة.\nملاحظة: راقب الشعر عبر الشعر. لن تختفي النقطة الخفقان بينما تتبعها عينك.",
    ur: "1. اپنی دائیں آنکھ کو بند کریں۔ (یہ اسکرین کا دائیں طرف ہے۔)\n2. ٹمٹماہٹ ڈاٹ سلائیڈ کرنے کے لئے ◀ یرو کلید کا استعمال کریں۔ کراس بالوں کو دیکھتے ہوئے ، اپنی آنکھ کے کونے میں ٹمٹماہٹ ڈاٹ کی نگرانی کریں ، اور اسے بائیں اور دائیں سلائیڈ کریں جب تک کہ یہ آپ کے اندھے مقام میں غائب نہ ہوجائے۔\n3. واپسی کو ہٹ.\nنوٹ: کراس بالوں پر نگاہ رکھیں۔ جب آپ کی آنکھ اس کی پیروی کرتی ہے تو چمکتا ہوا ڈاٹ غائب نہیں ہوگا۔",
    hi: "1. अपनी दाहिनी आंख बंद करें। (यह स्क्रीन का दाहिना हिस्सा है।)\n2. टिमटिमाते हुए डॉट को स्लाइड करने के लिए to तीर कुंजी का उपयोग करें। क्रॉस हेयर को देखते हुए, अपनी आंख के कोने में टिमटिमाते हुए डॉट की निगरानी करें, और इसे बाएं और दाएं स्लाइड करें जब तक कि यह आपके अंधा में गायब न हो जाए।\n3. हिट रिटर्न।\nनोट: अपनी नजर क्रॉस हेयर पर रखें। झिलमिलाहट डॉट गायब नहीं होगा जबकि आपकी आंख इसका अनुसरण करती है।",
    ...
    "zh-HK":
      "1.閉上右眼。 （這是屏幕的右側。）\n2.使用◀箭頭鍵滑動閃爍的點。在看著十字頭髮的同時，監視眼角的閃爍點，然後向左和向右滑動，直到它消失在盲點中。\n3.命中返回。\n注意：請密切關註十字頭髮。當您的眼睛跟隨它時，閃爍的點不會消失。",
  ...
  RC_gazeTrackingIntro: {
    ...
    ar: 'العب "اصطاد الصليب!" الآن سنقوم بإعداد تتبع النظرة ، لمراقبة وضع العين. حافظ على وجهك في تغذية الفيديو (انظر أدناه). انقر على مركز الشعر المتقاطع ، أينما كان. تأكد من أن عينيك على ذلك عند النقر فوقه. عند النقر فوقه ، سينتقل الشعر المتقاطع إلى موقع جديد. انقر فوقه في كل موقع جديد ، حتى يتم المعايرة. انها لعبة. اصطاد الصليب!',
    ...
    kn: '"ಶಿಲುಬೆಯನ್ನು ಹಿಡಿಯಿರಿ!" ಕಣ್ಣಿನ ಸ್ಥಾನವನ್ನು ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡಲು ನಾವು ಈಗ ನೋಟದ ಟ್ರ್ಯಾಕಿಂಗ್ ಅನ್ನು ಹೊಂದಿಸುತ್ತೇವೆ. ನಿಮ್ಮ ಮುಖವನ್ನು ವೀಡಿಯೊ ಫೀಡ್‌ನಲ್ಲಿ ಇರಿಸಿ (ಕೆಳಗೆ ನೋಡಿ). ಅದು ಎಲ್ಲಿದ್ದರೂ ಅಡ್ಡ ಕೂದಲಿನ ಮಧ್ಯಭಾಗದಲ್ಲಿ ಕ್ಲಿಕ್ ಮಾಡಿ. ನೀವು ಅದನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿದಾಗ ನಿಮ್ಮ ಕಣ್ಣುಗಳು ಅದರ ಮೇಲೆ ಇದ್ದವು ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ. ನೀವು ಅದನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿದಾಗ, ಅಡ್ಡ ಕೂದಲುಗಳು ಹೊಸ ಸ್ಥಳಕ್ಕೆ ಚಲಿಸುತ್ತವೆ. ಮಾಪನಾಂಕ ನಿರ್ಣಯವನ್ನು ಮಾಡುವವರೆಗೆ ಪ್ರತಿ ಹೊಸ ಸ್ಥಳದಲ್ಲಿ ಅದನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ. ಇದು ಒಂದು ಆಟ. ಶಿಲುಬೆಯನ್ನು ಹಿಡಿಯಿರಿ!',
  ...
  RC_gazeTrackingNudge: {
    ...
    pl: "Złap krzyż! Potrzebujemy Twojej pomocy. Śledzenie wzroku wymaga więcej treningu. Jak pokazuje strzałka, po kliknięciu, tracker pomyślał, że twoje spojrzenie jest dalekie od włosów krzyżowych. Kliknij włosy krzyżowe w każdej nowej pozycji. To jest gra. Złap krzyż!",
    ...
    ar: "اصطاد الصليب! نحن نحتاج مساعدتك. يحتاج متتبع العين إلى مزيد من التدريب. كما هو موضح في السهم ، عندما نقرت ، اعتقد المتتبع أن نظرتك كانت بعيدة عن الشعر المتقاطع. يرجى النقر على الشعر المتقاطع في كل موقف جديد. انها لعبة. اصطاد الصليب!",
    ...
    hi: "क्रॉस को पकड़ो! हमे आपकी मदद की जरूरत है। आई ट्रैकर को अधिक प्रशिक्षण की आवश्यकता है। जैसा कि तीर द्वारा दिखाया गया है, जब आपने क्लिक किया, तो ट्रैकर ने सोचा कि आपका टकटकी क्रॉस हेयर से दूर है। कृपया प्रत्येक नई स्थिति में क्रॉस हेयर पर क्लिक करें। यह एक खेल है। क्रॉस को पकड़ो!",
    ...
    bn: "ক্রস ধরুন! আমাদের আপনার সাহায্য দরকার. চোখের ট্র্যাকারটির আরও প্রশিক্ষণ প্রয়োজন। তীর দ্বারা দেখানো হিসাবে, আপনি যখন ক্লিক করেছেন, ট্র্যাকারটি ভেবেছিল আপনার দৃষ্টিশক্তি ক্রস কেশ থেকে অনেক দূরে। প্রতিটি নতুন পজিশনে ক্রস চুল ক্লিক করুন। এটি একটি খেলা. ক্রস ধরুন!",
  ...
  RC_viewingBlindSpotRejected: {
    ...
    it: "Mi dispiace, le misurazioni più recenti di sinistra e destra erano incoerenti. Possiamo riprovare? Tieni un occhio chiuso. Concentrati sui peli incrociati e monitora il punto lampeggiante dall'angolo dell'occhio. Fai scorrere il punto a sinistra e a destra finché non scompare nel tuo cieco, quindi premi ritorno. Mantieni la distanza di visione mentre si verificano entrambi gli occhi.",
    ...
    ur: "معذرت ، حالیہ بائیں اور دائیں پیمائش متضاد تھیں۔ کیا ہم دوبارہ کوشش کر سکتے ہیں؟ ایک آنکھ بند رکھیں۔ کراس بالوں پر توجہ دیں اور اپنی آنکھ کے کونے سے باہر چمکتے ڈاٹ کی نگرانی کریں۔ ڈاٹ کو بائیں اور دائیں سلائڈ کریں جب تک کہ یہ آپ کے اندھے مقام میں غائب نہ ہوجائے ، اور پھر واپسی کو ماریں۔ جب آپ دونوں آنکھوں کی جانچ کرتے ہو تو اپنے دیکھنے کا فاصلہ برقرار رکھیں۔",
    ...
    ja: "申し訳ありませんが、最新の左右の測定値は一貫していませんでした。もう一度やり直してもいいですか？片目を閉じてください。交差毛に焦点を合わせ、目の隅から点滅するドットを監視します。ブラインドスポットに消えてしまうまで、ドットを左右にスライドさせてから、戻ってきます。両目をテストするときに、視聴距離を維持します。",
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    de: "ERLÄUTERUNG. Kommen Sie für diesen Schritt bei Bedarf näher, damit Sie nicht weiter als doppelt so hoch wie die Bildschirmbreite sind. Jedes Auge hat einen Blindspot. Wir werden Ihre finden, um herauszufinden, wie weit Ihr Auge vom Bildschirm vom Bildschirm entfernt ist. Sie werden gebeten, ein Auge zu schließen oder abzudecken, um das andere zu isolieren. Während Sie sich auf die Kreuzhaare konzentrieren, beobachten Sie den flackernden Punkt aus dem Augenwinkel und treffen Sie die Rückkehr, wenn er in Ihrem Blindspot verschwindet. Abhängig von der Betrachtung der Entfernung und der Bildschirmgröße erreicht der flackernde Punkt normalerweise Ihren Blindspot, bevor er in die Mitte des Bildschirms gelangt. Sie werden dies mit jedem Auge wechseln, bis die letzten beiden Messungen konsistent sind. Bitte behalten Sie Ihren Betrachtungsabstand bei, während Sie beide Augen testen. HINWEIS. Wenn der Punkt nie verschwindet, bedeutet dies, dass Ihr Auge dem Punkt folgt, anstatt auf den Kreuzhaaren zu bleiben. Dieser Test erfordert, dass Sie die Kreuzhaare im Auge behalten, während Sie den flackernden Punkt in Ihrem Augenwinkel überwachen. Das ist zunächst schwierig, wird aber beim Üben einfacher.",
    ...
    he: "הֶסבֵּר. לשלב זה, התקרב, במידת הצורך, כך שאתה לא רחוק יותר מרוחב המסך. לכל עין יש כתב עיוור. נמצא את שלך כדי לגלות כמה רחוק העין שלך מהמסך. תתבקש לסגור או לכסות עין אחת כדי לבודד את השני. בזמן שאתה מתמקד בשערות הצלב, צפה בנקודה המהבהבת מזווית העין שלך, ופגע בחזרה כשהוא נעלם לתוך העיוור שלך. תלוי במרחק הצפייה ובגודל המסך, הנקודה המהבהבת בדרך כלל תגיע לספוט העיוור שלך לפני שהוא יגיע לאמצע המסך. תעשה זאת עם כל עין, לסירוגין, עד ששתי המדידות האחרונות יהיו עקביות. אנא שמור על מרחק הצפייה שלך כשאתה בודק את שתי העיניים. הערה. אם הנקודה לעולם לא נעלמת, פירוש הדבר שהעין שלך עוקבת אחר הנקודה, במקום להישאר על שערות הצלב. מבחן זה מחייב שתפקח עין על שערות הצלב תוך כדי פיקוח על הנקודה המהבהבת בפינת העין שלך. זה קשה בהתחלה, אבל הופך להיות קל יותר עם תרגול.",
    ar: "توضيح. لهذه الخطوة ، اقترب أكثر ، إذا لزم الأمر ، لذلك أنت لست أكثر من ضعف عرض الشاشة. كل عين لديها مجموعة أعمى. سنجد لك لاكتشاف مدى انتباهك عن الشاشة. يُطلب منك إغلاق أو تغطية عين واحدة لعزل الآخر. أثناء التركيز على الشعر المتقاطع ، شاهد النقطة الخفقان من زاوية عينيك ، واضغط على العودة عندما تختفي في لعبة BlindSpot. اعتمادًا على عرض المسافة وحجم الشاشة ، ستصل النقطة الوهمية عادةً إلى النقطة العمياء قبل وصولها إلى منتصف الشاشة. ستقوم بذلك مع كل عين ، بالتناوب ، حتى يتسق القياسين الأخيرين. يرجى الحفاظ على مسافة المشاهدة الخاصة بك أثناء اختبار كلتا العينين. ملحوظة. إذا لم تختفي النقطة أبدًا ، فهذا يعني أن عينيك تتبع النقطة ، بدلاً من البقاء على الشعر المتقاطع. يتطلب هذا الاختبار أن تراقب عن الشعر المتقاطع أثناء مراقبة النقطة الوهمية في زاوية عينيك. هذا صعب في البداية ، لكنه يصبح أسهل مع الممارسة.",
    ...
    hi: "व्याख्या। इस कदम के लिए, यदि आवश्यक हो, तो करीब आएं, इसलिए आप स्क्रीन की चौड़ाई से दोगुने से दूर नहीं हैं। हर आंख में एक अंधा होता है। हम आपको यह पता लगाने के लिए पाएंगे कि आपकी आंख स्क्रीन से कितनी दूर है। आपको दूसरे को अलग करने के लिए एक आंख को बंद करने या कवर करने के लिए कहा जाएगा। जब आप क्रॉस हेयर पर ध्यान केंद्रित करते हैं, तो अपनी आंख के कोने से टिमटिमाते हुए डॉट को देखें, और जब यह आपके ब्लाइंडस्पॉट में गायब हो जाता है तो रिटर्न हिट करें। दूरी और स्क्रीन के आकार को देखने के आधार पर, फ़्लिकरिंग डॉट आमतौर पर स्क्रीन के बीच में आने से पहले आपके ब्लाइंडस्पॉट तक पहुंच जाएगा। आप प्रत्येक आंख के साथ ऐसा करेंगे, बारी -बारी से, जब तक कि अंतिम दो माप सुसंगत न हों। कृपया अपनी देखने की दूरी बनाए रखें क्योंकि आप दोनों आंखों का परीक्षण करते हैं। टिप्पणी। यदि डॉट कभी गायब नहीं होता है, तो इसका मतलब है कि आपकी आंख क्रॉस हेयर पर रहने के बजाय डॉट का अनुसरण कर रही है। इस परीक्षण के लिए आवश्यक है कि आप अपनी आंख के कोने में टिमटिमाती डॉट की निगरानी करते हुए क्रॉस हेयर पर अपनी नज़र रखें। यह पहली बार में कठिन है, लेकिन अभ्यास के साथ आसान हो जाता है।",
    ...
    "zh-CN":
      "解释。对于此步骤，如有必要，靠近，因此您的屏幕宽度不超过两倍。每只眼睛都有一个盲点。我们会发现您的眼睛离屏幕有多远。您会被要求闭上或遮住一只眼睛以隔离另一只眼睛。当您专注于十字头发时，请观察眼睛角落的闪烁点，并在盲点消失时击中回报。根据观看距离和屏幕尺寸，闪烁的点通常会在盲点到达屏幕中间之前到达盲点。您将用每只眼睛交替进行此操作，直到最后两个测量一致。测试双眼时，请保持观看距离。笔记。如果点永远不会消失，则意味着您的眼睛正在跟随点，而不是留在十字头发上。该测试要求您在监视眼角的闪烁点时密切注意十字头发。一开始很难，但是练习变得更加容易。",
    "zh-HK":
      "解釋。對於此步驟，如有必要，靠近，因此您的屏幕寬度不超過兩倍。每隻眼睛都有一個盲點。我們會發現您的眼睛離屏幕有多遠。您會被要求閉上或遮住一隻眼睛以隔離另一隻眼睛。當您專注於十字頭髮時，請觀察眼睛角落的閃爍點，並在盲點消失時擊中回報。根據觀看距離和屏幕尺寸，閃爍的點通常會在盲點到達屏幕中間之前到達盲點。您將用每隻眼睛交替進行此操作，直到最後兩個測量一致。測試雙眼時，請保持觀看距離。筆記。如果點永遠不會消失，則意味著您的眼睛正在跟隨點，而不是留在十字頭髮上。該測試要求您在監視眼角的閃爍點時密切注意十字頭髮。一開始很難，但是練習變得更加容易。",
  ...
  T_middleLetterBrief: {
    ...
    ro: "Este un R. Acest ecran este static, așa că ar fi ușor să vă mutați ochii spre scrisoare și să îl identificați. Dar, într -un test real, literele sunt arătate, așa că nu există timp să vă mișcați ochii. Este important să ne uităm la părul Cruz în timp ce faceți clic. Literele vor clipi imediat. Nu contează unde îți dau ochii după flash. Primul bloc de testare este doar câteva teste de practică, înainte de a începe serios.",
    ...
    ur: "یہ ایک آر ہے۔ یہ کارکردگی مستحکم ہے ، لہذا آپ کی آنکھوں کو خط میں منتقل کرنا اور اس کی شناخت کرنا آسان ہوگا۔ لیکن ، ایک حقیقی امتحان میں ، خطوط چمکتے ہیں ، لہذا آپ کی آنکھیں منتقل کرنے کا وقت نہیں ہے۔ جیسا کہ آپ اس پر کلک کرتے ہیں ، کراس بال دیکھنا ضروری ہے۔ خطوط فوری طور پر فلیش ہوجائیں گے۔ اس سے کوئی فرق نہیں پڑتا ہے کہ آپ کی آنکھیں فلیش کے بعد کہاں جاتی ہیں۔ بیانا میں شروع ہونے سے پہلے ، ٹیسٹ کے پہلے بلاک میں مشق کے کچھ ٹیسٹوں کے کچھ ٹیسٹ ہوتے ہیں۔",
    hi: "यह एक आर है। यह प्रदर्शन स्थिर है, इसलिए आपकी आंखों को पत्र में ले जाना और इसे पहचानना आसान होगा। लेकिन, एक वास्तविक परीक्षण में, पत्र चमकते हैं, इसलिए आपकी आँखों को स्थानांतरित करने का समय नहीं है। जैसा कि आप इसे क्लिक करते हैं, क्रॉस हेयर को देखना महत्वपूर्ण है। पत्र तुरंत फ्लैश हो जाएंगे। इससे कोई फर्क नहीं पड़ता कि आपकी आँखें फ्लैश के बाद कहां जाती हैं। परीक्षण का पहला ब्लॉक अभ्यास के कुछ परीक्षणों के कुछ परीक्षण हैं, इससे पहले कि हम बयाना में शुरू करें।",
    ...
    kn: "ಇದು ಆರ್. ಈ ಪ್ರದರ್ಶನವು ಸ್ಥಿರವಾಗಿದೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಪತ್ರಕ್ಕೆ ಸರಿಸಿ ಅದನ್ನು ಗುರುತಿಸುವುದು ಸುಲಭ. ಆದರೆ, ನಿಜವಾದ ಪ್ರಯೋಗದಲ್ಲಿ, ಅಕ್ಷರಗಳು ಹರಿಯುತ್ತವೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಸರಿಸಲು ಸಮಯವಿಲ್ಲ. ನೀವು ಕ್ಲಿಕ್ ಮಾಡುವಾಗ ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವುದು ಮುಖ್ಯ. ಅಕ್ಷರಗಳು ತಕ್ಷಣ ಮಿಂಚುತ್ತವೆ. ಫ್ಲ್ಯಾಷ್ ನಂತರ ನಿಮ್ಮ ಕಣ್ಣುಗಳು ಎಲ್ಲಿಗೆ ಹೋಗುತ್ತವೆ ಎಂಬುದು ಮುಖ್ಯವಲ್ಲ. ನಾವು ಶ್ರದ್ಧೆಯಿಂದ ಪ್ರಾರಂಭಿಸುವ ಮೊದಲು ಪರೀಕ್ಷೆಯ ಮೊದಲ ಬ್ಲಾಕ್ ಅಭ್ಯಾಸದ ಕೆಲವು ಪ್ರಯೋಗಗಳು.",
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو جاننے کے ل first ، پہلے اسے مستحکم کارکردگی کے ساتھ آزمائیں۔ جب آپ نیچے کراس بال کو دیکھیں تو ، آنکھیں ہلائے بغیر ، درمیانی خط کی شناخت کرنے کی کوشش کریں۔",
  ...
  T_readyClickCrosshairRepeatedLetters: {
    ...
    ar: "هل أنت مستعد لتحديد الحروف؟ انقر فوق وسط الشعر الصليب.",
  ...
  T_readyClickCrosshairRsvpReading: {
    ...
    ar: "هل أنت مستعد لقراءة بعض الكلمات؟ انقر فوق وسط الشعر الصليب.",
  ...
  T_readyPressSpaceOrClickCrosshairRepeatedLetters: {
    ...
    ar: "هل أنت مستعد لتحديد الحروف؟ أثناء النظر مباشرة إلى مركز الشعر المتقاطع ، يرجى النقر فوقه أو الضغط على شريط الفضاء.",

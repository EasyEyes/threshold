...
export const phrases = {
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    he: "הֶסבֵּר. לשלב זה, התקרב, במידת הצורך, כך שאתה לא רחוק יותר מרוחב המסך. לכל עין יש כתב עיוור. נמצא את שלך כדי לגלות כמה רחוק העין שלך מהמסך. תתבקש לסגור או לכסות עין אחת כדי לבודד את השנייה. בזמן שאתה מתמקד בשערות הצלב, צפה בנקודה המהבהבת מזווית העין שלך, ופגע בחזרה כשהוא נעלם לתוך העיוור שלך. תלוי במרחק הצפייה ובגודל המסך, הנקודה המהבהבת בדרך כלל תגיע לספוט העיוור שלך לפני שהוא יגיע לאמצע המסך. תעשה זאת עם כל עין, לסירוגין, עד ששתי המדידות האחרונות יהיו עקביות. אנא שמור על מרחק הצפייה שלך כשאתה בודק את שתי העיניים. הערה. אם הנקודה לעולם אינה נעלמת, פירוש הדבר שהעין שלך עוקבת אחר הנקודה, במקום להישאר על שערות הצלב. מבחן זה צריך שתפקח עין על שערות הצלב תוך ניטור הנקודה המהבהבת בפינת העין שלך. זה קשה בהתחלה, אבל הופך להיות קל יותר עם תרגול.",
  ...
  T_letterDemo: {
    ...
    hi: "प्रत्येक परीक्षण पर, एक यादृच्छिक पत्र आपकी आंख के कोने में चमक जाएगा। बस एक झलक। कार्य को जानने के लिए, इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आँखों को हिलाने के बिना, नीचे, नीचे के बालों को देखते हुए, पत्र को पहचानने का प्रयास करें।",

...
export const phrases = {
  ...
  EE_incompatibleReturnToProlific: {
    ...
    he: "מחקר זה אינו תואם את המחשב או הדפדפן שלך, אז אנא החזיר אותו ל- prolific.co. הגשת תשלום תידחה (מה שפוגע במוניטין שלך), אז אנא החזיר אותו.",
  ...
  RC_angleDistanceIntro: {
    ...
    de: "Drehen Sie sich einfach um und wir werden Ihre Betrachtungsabstand finden! Wenn Sie gefragt werden, gewähren Sie bitte Zugriff auf Ihre Kamera.",
    ...
    ro: "Pur și simplu întoarceți -vă și vă vom găsi distanța de vizionare! Când ați fost întrebat, vă rugăm să acordați acces la camera dvs.",
  ...
  RC_gazeTrackingIntro: {
    ...
    "zh-CN":
      "播放“赶十字架！”现在，我们将建立凝视跟踪，以监视眼睛位置。在视频提要中保持脸部（见下文）。无论何处，单击十字头发的中心。单击它时，请确保您的眼睛在上面。当您单击它时，十字头发将移至新位置。在每个新位置单击它，直到完成校准。游戏而已。抓住十字架！",
    "zh-HK":
  ...
  RC_privacyIphoneMicrophone: {
    ...
    ta: 'மைக்ரோஃபோன் தனியுரிமையின் உறுதி. உங்கள் டெஸ்க்டாப்பின் உள்ளமைக்கப்பட்ட மைக்ரோஃபோனைக் காட்டிலும் ஈஸிஇஸ் உங்கள் ஐபோன்/ஐபாட் மைக்ரோஃபோனைப் பயன்படுத்துகிறது, ஏனெனில் ஐபோன்/ஐபாட் மைக்ரோஃபோன் உற்பத்தியாளர்-அளவீடு செய்யப்படுகிறது. மைக்ரோஃபோன் பதிவுசெய்கிறது, டெஸ்க்டாப் கம்ப்யூட்டர் ஒலிபெருக்கி மூலம் உரத்த ஒலி இயங்குகிறது, மேலும் டெஸ்க்டாப் கணினி இரண்டும் முக்கியமாக "அமைதியாக தயவுசெய்து! இப்போது பதிவுசெய்கின்றன" என்று காட்டுகிறது. ஒலிபெருக்கி பண்புகளை மதிப்பிடுவதற்கு மட்டுமே பதிவு பயன்படுத்தப்படுகிறது, பின்னர் 30 வினாடிகளுக்குள் அழிக்கப்படுகிறது. ஒலிபெருக்கி பண்புகள் மட்டுமே தக்கவைக்கப்படுகின்றன.',
    ...
    ko: '마이크 프라이버시의 보증. EasyEyes는 iPhone/iPad 마이크가 제조업체 계산되기 때문에 Desktop의 내장 마이크 대신 iPhone/iPad 마이크를 사용합니다. 마이크는 데스크탑 컴퓨터 라우드 스피커를 통해 큰 소리가 재생되는 동안에 만 기록되며, 데스크탑 컴퓨터는 "조용히 해주세요! 지금 녹음"을 표시합니다. 기록은 라우드 스피커 특성을 추정하는 데만 사용 된 다음 30 초 이내에 지워집니다. 라우드 스피커 특성 만 유지됩니다.',
  },
  RC_requestCamera: {
  ...
  RC_soundCalibrationDone: {
    ...
    de: "Danke. Die Kalibrierung erfolgt und Sie können das iPhone/iPad weglegen. WICHTIG: Berühren Sie die Volumenkontrolle erst, wenn das Experiment durchgeführt wird. Durch das Ändern des Volumens wird die Kalibrierung ruiniert und alle Ergebnisse ungültig.",
    fr: "Merci. L'étalonnage est fait et vous pouvez ranger l'iPhone / iPad. IMPORTANT: Ne touchez pas le contrôle du volume avant la fin de l'expérience. La modification du volume ruinera l'étalonnage et invalidera tous les résultats.",
    es: "Gracias. La calibración está lista y puede guardar el iPhone/iPad. IMPORTANTE: No toque el control de volumen hasta que se realice el experimento. Cambiar el volumen arruinará la calibración e invalidará todos los resultados.",
    pt: "Obrigado. A calibração está concluída e você pode guardar o iPhone/iPad. IMPORTANTE: Não toque no controle de volume até que o experimento seja feito. Alterar o volume arruinará a calibração e invalidará todos os resultados.",
    ...
    ro: "Mulțumiri. Calibrarea se face și puteți elimina iPhone/iPad. IMPORTANT: Nu atingeți controlul volumului până la finalizarea experimentului. Modificarea volumului va strica calibrarea și va invalida toate rezultatele.",
    ...
    ru: "Спасибо. Калибровка сделана, и вы можете убрать iPhone/iPad. Важно: не касайтесь регулятора громкости, пока эксперимент не будет проведен. Изменение тома разрушит калибровку и аннулирует все результаты.",
    ...
    fi: "Kiitos. Kalibrointi on tehty, ja voit laittaa iPhonen/iPadin pois. Tärkeää: Älä kosketa äänenvoimakkuuden säätöä ennen kuin koe on tehty. Tängomentin muuttaminen pilaa kalibroinnin ja mitätöidä kaikki tulokset.",
    ...
    he: "תודה. הכיול נעשה, ותוכלו להרחיק את ה- iPhone/iPad. חשוב: אל תיגע בבקרת עוצמת הקול עד לסיום הניסוי. שינוי הנפח יהרוס את הכיול ויבטל את כל התוצאות.",
    ar: "شكرًا. تتم المعايرة ، ويمكنك وضع iPhone/iPad بعيدًا. هام: لا تلمس التحكم في مستوى الصوت حتى تتم التجربة. سيؤدي تغيير مستوى الصوت إلى تدمير المعايرة وإبطال جميع النتائج.",
    ur: "شکریہ. انشانکن ہوچکا ہے ، اور آپ آئی فون/آئی پیڈ کو دور کرسکتے ہیں۔ اہم: جب تک تجربہ نہ ہو اس وقت تک حجم کے کنٹرول کو مت لگائیں۔ حجم کو تبدیل کرنے سے انشانکن خراب ہوجائے گا اور تمام نتائج کو باطل کردیں گے۔",
    ...
    ta: "நன்றி. அளவுத்திருத்தம் செய்யப்படுகிறது, மேலும் நீங்கள் ஐபோன்/ஐபாட் ஒதுக்கி வைக்கலாம். முக்கியமானது: சோதனை செய்யப்படும் வரை தொகுதி கட்டுப்பாட்டைத் தொட வேண்டாம். அளவை மாற்றுவது அளவுத்திருத்தத்தை அழித்து அனைத்து முடிவுகளையும் செல்லாது.",
    ml: "നന്ദി. കാലിബ്രേഷൻ ചെയ്തു, നിങ്ങൾക്ക് ഐഫോൺ / ഐപാഡ് മാറ്റിസ്ഥാപിക്കാം. പ്രധാനം: പരീക്ഷണം നടക്കുന്നതുവരെ വോളിയം നിയന്ത്രണത്തിൽ തൊടരുത്. വോളിയം മാറ്റുന്നത് കാലിബ്രേഷനെ നശിപ്പിക്കുകയും എല്ലാ ഫലങ്ങളും അസാധുവാക്കുകയും ചെയ്യും.",
    te: "ధన్యవాదాలు. క్రమాంకనం పూర్తయింది మరియు మీరు ఐఫోన్/ఐప్యాడ్‌ను దూరంగా ఉంచవచ్చు. ముఖ్యమైనది: ప్రయోగం పూర్తయ్యే వరకు వాల్యూమ్ నియంత్రణను తాకవద్దు. వాల్యూమ్‌ను మార్చడం క్రమాంకనాన్ని నాశనం చేస్తుంది మరియు అన్ని ఫలితాలను చెల్లదు.",
    ...
    "zh-CN":
      "谢谢。校准已经完成，您可以收起iPhone/iPad。重要的是：在实验完成之前，请勿触摸音量控制。更改音量会破坏校准并使所有结果无效。",
    "zh-HK":
  ...
  RC_viewingBlindSpotCredit: {
    ...
    ja: "Li et alの盲点マッピングを強化しました。 （2020）フリッカーと手動制御を追加することにより。",
  ...
  RC_viewingBlindSpotRejected: {
    ...
    "zh-CN":
      "抱歉，最新的左和右测量值不一致。我们可以再试一次吗？闭上眼睛。专注于十字头发，并从眼角监视闪烁的点。向左和向右滑动点，直到它消失在盲点中​​，然后击中返回。测试双眼时，保持观看距离。",
    "zh-HK":
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    "zh-CN":
      "解释。对于此步骤，如有必要，靠近，因此您的宽度不超过屏幕宽度的两倍。每只眼睛都有一个盲点。我们会找到您的，以发现您的眼睛离屏幕有多远。您会被要求闭上或遮住一只眼睛以隔离另一只眼睛。当您专注于十字头头发时，请观察眼角闪烁的点，并在盲点消失时击中返回。根据查看距离和屏幕尺寸，闪烁的点通常会在盲点到达屏幕中间之前到达盲点。您将用每只眼睛交替进行此操作，直到最后两个测量一致。测试双眼时，请保持观看距离。笔记。如果点永远不会消失，则意味着您的眼睛正在跟随点，而不是呆在十字头发上。该测试需要您在监视眼角的闪烁点时密切关注叉头发。一开始很难，但是练习变得更加容易。",
    "zh-HK":
  ...
  T_middleLetterBrief: {
    ...
    ka: "ეს არის R. ეს ეკრანი სტატიკურია, ამიტომ ადვილი იქნება თქვენი თვალების გადატანა წერილზე და იდენტიფიცირება. მაგრამ, რეალურ განსაცდელში, წერილები ააფეთქეს, ასე რომ, თვალების გადაადგილების დრო არ არის. მნიშვნელოვანია, რომ გადახედოთ ჯვრის თმას, როდესაც დაიწყებთ სასამართლო პროცესს. ასოები დაუყოვნებლივ გაისვრის. არ აქვს მნიშვნელობა სად მიდის თვალები flash- ის შემდეგ. ტესტირების პირველი ბლოკი მხოლოდ რამდენიმე პრაქტიკის გამოცდაა, სანამ სერიოზულად დავიწყებთ.",
    he: "זה R. תצוגה זו היא סטטית, כך שיהיה קל להעביר את העיניים למכתב ולזהות אותו. אבל, במשפט אמיתי, המכתבים הבזיקו, כך שאין זמן להזיז את העיניים. חשוב להסתכל על שערות הצלב כשאתה יוזם את המשפט. האותיות יבהבו מייד. לא משנה לאן העיניים שלך הולכות אחרי ההבזק. גוש הבדיקה הראשון הוא רק כמה ניסויים של תרגול, לפני שנתחיל ברצינות.",
  ...
  T_middleLetterDemo: {
    ...
    fi: "Jokaisessa kokeessa, kun tarkastellaan ristikarvoja, kolmen satunnaisen kirjaimen kolmoinen vilkkuu silmäsi nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun tarkastellaan ristikarvoja, yritä tunnistaa keskimmäistä kirjainta liikuttamatta silmiäsi.",
    ...
    te: "ప్రతి ట్రయల్‌లో, మీరు క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, మూడు యాదృచ్ఛిక అక్షరాల త్రిపాది మీ కంటి మూలలో మెరుస్తుంది. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో ప్రయత్నిద్దాం. కళ్ళు కదిలించకుండా, క్రింద, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, మధ్య అక్షరాన్ని గుర్తించడానికి ప్రయత్నించండి.",
  ...
  T_letterBrief: {
    ...
    ka: "ეს არის R. ეს ეკრანი სტატიკურია, ამიტომ ადვილი იქნება თქვენი თვალების გადატანა წერილზე და იდენტიფიცირება. მაგრამ, რეალურ განსაცდელში, წერილი ააფეთქეს, ასე რომ, თვალების გადაადგილების დრო აღარ არის. მნიშვნელოვანია, რომ გადახედოთ ჯვრის თმას, როდესაც დაიწყებთ სასამართლო პროცესს. წერილი დაუყოვნებლივ შეირყება. არ აქვს მნიშვნელობა სად მიდის თვალები flash- ის შემდეგ. ტესტირების პირველი ბლოკი მხოლოდ რამდენიმე პრაქტიკის გამოცდაა, სანამ სერიოზულად დავიწყებთ.",
    ...
    id: "Ini adalah R. Tampilan ini statis, jadi akan mudah untuk memindahkan mata Anda ke surat dan mengidentifikasinya. Tapi, dalam persidangan nyata, surat itu terbebas, jadi tidak ada waktu untuk menggerakkan mata Anda. Penting untuk melihat rambut silang saat Anda memulai persidangan. Surat itu akan segera muncul. Tidak masalah ke mana mata Anda mengejar kilat. Blok pengujian pertama hanyalah beberapa percobaan latihan, sebelum kita mulai dengan sungguh -sungguh.",
    "zh-CN":
  ...
  T_letterDemo: {
    ...
    hi: "प्रत्येक परीक्षण पर, एक यादृच्छिक पत्र आपकी आंख के कोने में चमक जाएगा। बस एक झलक। कार्य को सीखने के लिए, आइए इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आँखों को हिलाने के बिना, नीचे, नीचे के बालों को देखते हुए, पत्र को पहचानने का प्रयास करें।",
    ...
    te: "ప్రతి విచారణలో, యాదృచ్ఛిక అక్షరం మీ కంటి మూలలో మెరుస్తుంది. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో ప్రయత్నిద్దాం. కళ్ళు కదిలించకుండా, క్రింద, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, లేఖను గుర్తించడానికి ప్రయత్నించండి.",
    ...
    id: "Pada setiap percobaan, surat acak akan berkedip di sudut mata Anda. Hanya sekejap. Untuk mempelajari tugas ini, mari kita coba terlebih dahulu dengan tampilan statis. Sambil melihat rambut salib, di bawah, tanpa menggerakkan mata Anda, cobalah untuk mengidentifikasi surat itu.",
    "zh-CN":
  ...
  T_rsvpReadingTask: {
    ...
    ja: "xxxトライアルのブロックを開始しようとしています。あなたは一度にいくつかの言葉を読むでしょう。各トライアルは、次々と文の文章についてすぐに表示され、読んだ言葉を覚えておくように頼みます。",
  ...
  T_readingTask: {
    ...
    ro: "Timpul pentru o poveste! Veți citi 111 pagini dintr -o carte. După ce începeți, vă rugăm să citiți în tăcere toate paginile cât de repede puteți, menținând în același timp o înțelegere completă, până când ajungeți la sfârșit. Apoi vă vom pune câteva întrebări despre poveste. Pe fiecare pagină, apăsați bara spațială pentru pagina următoare. Când sunteți gata, apăsați spațiu.",
  ...
  T_readyTrackCrosshair: {
    "en-US":
      "Ready to identify a letter? Track the center of the cross hairs until the letter(s) appear.",
    de: "Bereit, einen Brief zu identifizieren? Verfolgen Sie die Mitte der Kreuzhaare, bis die Buchstaben angezeigt werden.",
    fr: "Prêt à identifier une lettre? Suivez le centre des poils jusqu'à ce que la ou les lettres apparaissent.",
    es: "Listo para identificar una carta? Rastree el centro de la cruz hasta que aparezcan las letras.",
    pt: "Pronto para identificar uma carta? Rastreie o centro dos cabelos cruzados até que as cartas apareçam.",
    it: "Pronto a identificare una lettera? Traccia il centro dei peli incrociati fino a quando non compaiono le lettere.",
    ro: "Sunteți gata să identificați o scrisoare? Urmăriți centrul părului încrucișat până când apar literele (literele).",
    pl: "Gotowy do zidentyfikowania listu? Śledź środek włosów krzyżowych, aż pojawią się litera.",
    ru: "Готовы идентифицировать письмо? Отслеживайте центр кросс -волосков, пока не появятся буквы (ы).",
    hy: "Պատրաստ եք նամակը ճանաչելու համար: Հետեւեք խաչի մազերի կենտրոնին, մինչեւ որ հայտնվի տառը (ներ) ը:",
    fi: "Oletko valmis tunnistamaan kirjeen? Seuraa ristikarvojen keskustaa, kunnes kirjaimet ilmestyvät.",
    ka: "მზად ხართ წერილის იდენტიფიცირებისთვის? თვალყური ადევნეთ ჯვრის თმას ცენტრს, სანამ ასო (ებ) ის გამოჩნდება.",
    he: "מוכנים לזהות מכתב? עקוב אחר מרכז שערות הצלב עד להופעת המכתב (ים).",
    ar: "هل أنت مستعد لتحديد رسالة؟ تتبع مركز الشعر الصليب حتى تظهر الرسالة (الحرف).",
    ur: "ایک خط کی شناخت کے لئے تیار ہیں؟ خط (زبانیں) ظاہر ہونے تک کراس بالوں کے مرکز کو ٹریک کریں۔",
    hi: "एक पत्र की पहचान करने के लिए तैयार हैं? जब तक अक्षर (ओं) दिखाई देते हैं, तब तक क्रॉस हेयर के केंद्र को ट्रैक करें।",
    ta: "ஒரு கடிதத்தை அடையாளம் காண தயாரா? கடிதம் (கள்) தோன்றும் வரை குறுக்கு முடிகளின் மையத்தைக் கண்காணிக்கவும்.",
    ml: "ഒരു കത്ത് തിരിച്ചറിയാൻ തയ്യാറാണോ? കത്ത് (കൾ) ദൃശ്യമാകുന്നതുവരെ ക്രോസ് ഹെറികളുടെ കേന്ദ്രം ട്രാക്കുചെയ്യുക.",
    te: "ఒక లేఖను గుర్తించడానికి సిద్ధంగా ఉన్నారా? అక్షరం (లు) కనిపించే వరకు క్రాస్ హెయిర్స్ మధ్యలో ట్రాక్ చేయండి.",
    kn: "ಪತ್ರವನ್ನು ಗುರುತಿಸಲು ಸಿದ್ಧರಿದ್ದೀರಾ? ಅಕ್ಷರ (ಗಳು) ಕಾಣಿಸಿಕೊಳ್ಳುವವರೆಗೆ ಅಡ್ಡ ಕೂದಲಿನ ಮಧ್ಯಭಾಗವನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡಿ.",
    bn: "একটি চিঠি সনাক্ত করতে প্রস্তুত? চিঠিটি (গুলি) উপস্থিত না হওয়া পর্যন্ত ক্রস হেয়ারগুলির কেন্দ্রটি ট্র্যাক করুন।",
    id: "Siap mengidentifikasi surat? Lacak tengah rambut silang sampai huruf muncul.",
    "zh-CN": "准备识别一封信了吗？跟踪十字头发的中心，直到字母出现为止。",
    "zh-HK": "準備識別一封信了嗎？跟踪十字頭髮的中心，直到字母出現為止。",
    ja: "手紙を識別する準備はできましたか？文字が表示されるまで、交差毛の中心を追跡します。",
    ko: "편지를 식별 할 준비가 되셨습니까? 문자가 나타날 때까지 십자 머리카락의 중심을 추적하십시오.",
  },
  ...
  T_sentenceProcedure: {
    ...
    pt: "Em cada tentativa, você ouvirá uma frase, geralmente em ruído. Em seguida, você verá uma lista de todas as possibilidades para cada palavra na frase. Relate a frase, ou seu melhor palpite, clicando nas palavras que você ouviu.",
    ...
    "zh-CN":
      "在每个审判中，通常会听到一句话，通常是在噪音中。然后，您将看到句子中每个单词的所有可能性列表。通过单击您听到的单词来报告句子或最好的猜测。",
    "zh-HK":
  ...
  T_soundPhraseResponse: {
    ...
    ja: "あなたはちょうどこの文を聞いた。 2つのメニューから単語を選択して、不足している単語を入力してください。",
  ...
  T_thresholdLetterBeginBlock: {
    ...
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. წერილები გამოჩნდება თითოეულ სასამართლო პროცესზე. გთხოვთ, შეატყობინოთ მას,",
  ...
  T_thresholdSoundResponse: {
    ...
    he: "האם צליל היעד היה נוכח? לחץ על y או n.",

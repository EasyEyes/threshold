...
export const phrases = {
  ...
  EE_compatibleBrowserDeviceCores: {
    ...
    hi: "जैसा कि इसके विवरण में कहा गया है, यह अध्ययन केवल बीबीबी ब्राउज़र के साथ कम से कम 222 सीपीयू कोर के साथ एक डीडीडी पर चल रहा है",
  ...
  RC_privacyIphoneMicrophone: {
    ...
    pl: "Zapewnienie prywatności mikrofonu. Easyeyes używa mikrofonu iPhone'a/iPada, a nie wbudowanego mikrofonu komputera stacjonarnego, ponieważ mikrofon iPhone/iPad jest kalibrowany producentem. Mikrofon rejestruje tylko podczas głośnego dźwięku przez głośnik komputerowy komputerowy, a oba komputer stacjonarny wyświetla „Cicho proszę! Teraz nagrywanie”. Nagrywanie jest używane wyłącznie do oszacowania właściwości głośnika, a następnie usunięte, w ciągu 30 sekund. Zatrzymywane są tylko charakterystyka głośnika.",
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    "zh-CN":
      "解释。对于此步骤，如有必要，靠近，因此您的屏幕宽度不超过两倍。每只眼睛都有一个盲点。我们会发现您的眼睛离屏幕有多远。您会被要求闭上或遮住一只眼睛以隔离另一只眼睛。当您专注于十字头发时，请观察眼角闪烁的点，并在盲点消失时击中回报。根据观看距离和屏幕尺寸，闪烁的点通常会在盲点到达屏幕中间之前到达盲点。您将用每只眼睛交替进行此操作，直到最后两个测量一致。测试双眼时，请保持观看距离。笔记。如果点永远不会消失，则意味着您的眼睛正在跟随点，而不是留在十字头发上。该测试需要您在监视眼角的闪烁点时密切注意十字头发。一开始很难，但是练习变得更加容易。",
    "zh-HK":
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں گے تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو جاننے کے ل first ، پہلے اسے مستحکم کارکردگی کے ساتھ آزمائیں۔ جب آپ کراس کے بالوں کو دیکھیں تو ، آنکھیں ہلائے بغیر ، درمیانی خط کی شناخت کرنے کی کوشش کریں۔",
  ...
  T_pressingKey: {
    ...
    kn: "ಕೀಬೋರ್ಡ್‌ನಲ್ಲಿ ಅದನ್ನು ಒತ್ತುವ ಮೂಲಕ.",
  ...
  T_readyPressSpaceOrClickCrosshair: {
    ...
    it: "Pronto? Guardando direttamente il mirino, fare clic sul mirino.",
    ro: "Gata? În timp ce priviți direct la centrul crucii, faceți clic pe centru sau apăsați spațiul.",

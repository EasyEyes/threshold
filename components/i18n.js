...
export const phrases = {
  ...
  RC_getUSBMicrophoneReady: {
    ...
    pl: "2. Ustaw mikrofon na statywie i kliknij OK lub naciśnij powrót.",
    ...
    hi: "2. माइक्रोफोन को उसके तिपाई पर सेट करें, और ओके या हिट रिटर्न पर क्लिक करें।",
    ...
    "zh-CN": "2.在其三脚架上设置麦克风，然后单击“确定”或单击“返回”。",
    "zh-HK": "2.在其三腳架上設置麥克風，然後單擊“確定”或單擊“返回”。",
  ...
  RC_identifyMicrophone: {
    "en-US":
      "2. In the box below, type the make and model of the smartphone or USB microphone, e.g. iPhone 12 Pro.\n",
    de: "2. Geben Sie im folgenden Feld das Make und das Modell des Smartphones oder des USB -Mikrofons ein, z. iPhone 12 Pro.\n",
    fr: "2. Dans la case ci-dessous, tapez la marque et le modèle du smartphone ou du microphone USB, par ex. iPhone 12 Pro.\n",
    es: "2. En el cuadro a continuación, escriba la marca y el modelo del teléfono inteligente o el micrófono USB, p. iPhone 12 Pro.\n",
    pt: "2. Na caixa abaixo, digite a marca e o modelo do smartphone ou microfone USB, p. iPhone 12 Pro.\n",
    it: "2. Nella casella sottostante, digitare la marca e il modello dello smartphone o del microfono USB, ad es. iPhone 12 Pro.\n",
    ro: "2. În caseta de mai jos, tastați marca și modelul smartphone -ului sau microfonului USB, de ex. iPhone 12 Pro.\n",
    pl: "2. W poniższym polu wpisz markę i model smartfona lub mikrofonu USB, np. iPhone 12 Pro.\n",
    ru: "2. В приведенной ниже поле введите Make and Model смартфона или USB -микрофона, например, iPhone 12 Pro.\n",
    hy: "2. Ստորեւ նշված վանդակում մուտքագրեք սմարթֆոնի կամ USB միկրոֆոնի պատրաստումը եւ մոդելը, օրինակ: iPhone 12 Pro.\n",
    fi: "2. Kirjoita alla olevaan laatikossa älypuhelimen tai USB -mikrofonin malli ja malli, esim. iPhone 12 Pro.\n",
    ka: "2. ქვემოთ მოცემულ ყუთში ჩაწერეთ სმარტფონის ან USB მიკროფონის მაკიაჟი და მოდელი, მაგ. iPhone 12 Pro.\n",
    he: "2. בתיבה למטה, הקלד את הייצור והדגם של הטלפון החכם או מיקרופון USB, למשל. Pro iPhone 12.\n",
    ar: "2. في المربع أدناه ، اكتب صنع وطراز الهاتف الذكي أو ميكروفون USB ، على سبيل المثال iPhone 12 Pro.\n",
    ur: "2. نیچے والے خانے میں ، اسمارٹ فون یا USB مائکروفون کے میک اور ماڈل کو ٹائپ کریں ، جیسے۔ آئی فون 12 پرو۔\n",
    hi: "2. नीचे दिए गए बॉक्स में, स्मार्टफोन या यूएसबी माइक्रोफोन का मेक और मॉडल टाइप करें, उदा। iPhone 12 प्रो।\n",
    ta: "2. கீழே உள்ள பெட்டியில், ஸ்மார்ட்போன் அல்லது யூ.எஸ்.பி மைக்ரோஃபோனின் மேக் மற்றும் மாடலை தட்டச்சு செய்க, எ.கா. ஐபோன் 12 புரோ.\n",
    ml: "2. ചുവടെയുള്ള ബോക്സിൽ, സ്മാർട്ട്ഫോണിന്റെ അല്ലെങ്കിൽ യുഎസ്ബി മൈക്രോഫോൺ, ഉദാ. ഐഫോൺ 12 പ്രോ.\n",
    te: "2. దిగువ పెట్టెలో, స్మార్ట్‌ఫోన్ లేదా యుఎస్‌బి మైక్రోఫోన్ యొక్క మేక్ మరియు మోడల్‌ను టైప్ చేయండి, ఉదా. ఐఫోన్ 12 ప్రో.\n",
    kn: "2. ಕೆಳಗಿನ ಪೆಟ್ಟಿಗೆಯಲ್ಲಿ, ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಅಥವಾ ಯುಎಸ್‌ಬಿ ಮೈಕ್ರೊಫೋನ್‌ನ ತಯಾರಿಕೆ ಮತ್ತು ಮಾದರಿಯನ್ನು ಟೈಪ್ ಮಾಡಿ, ಉದಾ. ಐಫೋನ್ 12 ಪ್ರೊ.\n",
    bn: "২. নীচের বাক্সে, স্মার্টফোন বা ইউএসবি মাইক্রোফোনের মেক এবং মডেলটি টাইপ করুন, উদাঃ আইফোন 12 প্রো।\n",
    id: "2. Dalam kotak di bawah ini, ketik Make dan Model Mikrofon Smartphone atau USB, mis. iPhone 12 Pro.\n",
    "zh-CN":
      "2.在下面的框中，键入智能手机或USB麦克风的制造和型号，例如iPhone 12 Pro。\n",
    "zh-HK":
      "2.在下面的框中，鍵入智能手機或USB麥克風的製造和型號，例如iPhone 12 Pro。\n",
    ja: "2.下のボックスに、スマートフォンまたはUSBマイクのメーカーとモデルを入力します。 iPhone 12 Pro。\n",
    ko: "2. 아래 상자에 스마트 폰 또는 USB 마이크의 제조업체 및 모델을 입력하십시오 (예 : iPhone 12 Pro.\n",
    __EMPTY: "",
    __EMPTY_1: "",
  },
  ...
  T_identifyClickItSentence: {
    ...
    ur: "تمام ممکنہ جملے دکھائے جاتے ہیں۔ جس کو آپ نے سنا ہے یا آپ کا بہترین اندازہ لگائیں۔",
  ...
  T_sentenceProcedure: {
    ...
    "zh-HK":
      "在每個審判中，通常會聽到一句話，通常是在噪音中。然後，您將看到句子中每個單詞的所有可能性列表。通過單擊您聽到的單詞來報告句子或最好的猜測。",

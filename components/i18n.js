...
export const phrases = {
  ...
  RC_gazeTrackingIntro: {
    ...
    fi: 'Pelaa "Catch the Risti!" Nyt asetamme katseen seurannan tarkkailemaan silmien sijaintia. Pidä kasvosi videosyötteessä (katso alla). Napsauta ristikästen keskustaa missä tahansa. Varmista, että silmäsi ovat siinä, kun napsautat sitä. Kun napsautat sitä, ristikarvat siirtyvät uuteen sijaintiin. Napsauta sitä jokaisessa uudessa paikassa, kunnes kalibrointi on tehty. Se on peli. Pudota risti!',

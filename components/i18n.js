...
export const phrases = {
  ...
  RC_findModelAndroid: {
    ...
    de: 'Gehen Sie zum Menü oder Optionen für die Einstellungen oder Optionen, scrollen Sie nach unten in der Liste und überprüfen Sie "Über Telefon", "Über Gerät" oder ähnlich. Kopieren Sie den Modellnamen und die Nummer in die entsprechenden Felder unten.',
  ...
  RC_findModelMacOs: {
    ...
    kn: "ಆಯ್ಕೆ ಕೀಲಿಯನ್ನು ಒತ್ತುವಾಗ, ಆಪಲ್ ಮೆನು 🍏> ಸಿಸ್ಟಮ್ ಮಾಹಿತಿಗೆ ಹೋಗಿ. ಹಾರ್ಡ್‌ವೇರ್ ಅವಲೋಕನದಿಂದ, ಮಾದರಿ ಹೆಸರು ಮತ್ತು ಮಾದರಿ ಗುರುತಿಸುವಿಕೆಯನ್ನು ಕೆಳಗಿನ ಅನುಗುಣವಾದ ಕ್ಷೇತ್ರಗಳಿಗೆ ನಕಲಿಸಿ.",
  ...
  RC_needModelNumberAndName: {
    ...
    ta: "இந்த xxx YYY இன் மாதிரி எண் மற்றும் பெயர் எங்களுக்கு தேவை.",
  ...
  RC_howLongToCalibrate: {
    ...
    ar: "يستغرق المعايرة حوالي 111 دقيقة (S).",
  ...
  RC_screenSizeIntro: {
    ...
    fi: "Mittaamme tämän näytön koon. Valitse jotain kätevää. Voit käyttää mitä tahansa yleistä USB -liitintä (mukaan lukien tietokoneellesi virran) tai luottokortti (tai mitä tahansa samankokoista korttia). Aseta objekti näytölle ja siirrä liukusäädintä kuvan säätämiseksi objektin kokoa. Kun ne vastaavat, jatka paina (tai napsauta OK).",
  ...
  RC_usingSmartPhoneMicrophone: {
    ...
    he: "❌ rc_usingsmartphonemicrophone מיושן.",
    ar: "❌ rc_usingsmartphonemorrophone عفا عليها الزمن.",
  ...
  T_guessingGameVernier: {
    ...
    ta: "வரி மாற்றமானது பெரிய மற்றும் எளிதான முதல் சிறிய மற்றும் கடினமான வரை மாறுபடும். மூன்றில் இரண்டு பங்கிற்கு மேல் நீங்கள் பெற முடியாது, எனவே ஓய்வெடுங்கள். இதை ஒரு யூகிக்கும் விளையாட்டாக நினைத்துப் பாருங்கள், உங்களால் முடிந்தவரை பலவற்றைப் பெறுங்கள். நீங்கள் சரியாக இருக்கும் போதெல்லாம் ஒரு பீப் கேட்பீர்கள்.",
    ...
    "zh-CN":
      "线路的偏移从大小易于往下到微小而艰难。您不能获得超过三分之二的正确，所以放松。将其视为一个猜测游戏，只需获得尽可能多的游戏。每当您正确时，您都会听到蜂鸣声。",
    "zh-HK":
  ...
  "❌T_identifyPressIt": {
    ...
    fi: "Vaihda T_IdentifyPressit → T_IdentifyMiddLeletTerPressit",
  ...
  "❌T_identifyPressItOrClickIt": {
    ...
    kn: "T_IDENTIFYPRESSITOTERCLICKIT → T_IDEDIFYMIDLELETELETTERTERSPERCLICKIT ಅನ್ನು ಬದಲಾಯಿಸಿ",
  ...
  T_VernierDemo: {
    ...
    ro: "La fiecare încercare, în timp ce te uiți la părul încrucișat, o pereche de linii se va clipi undeva. Poate unde te uiți; Poate în colțul ochiului tău. Doar un bliț. Pentru a învăța sarcina, să o încercăm mai întâi cu un afișaj static. În timp ce te uiți la părul încrucișat, mai jos, fără a -ți mișca ochii: linia superioară este deplasată la stânga sau la dreapta, în raport cu linia inferioară?",
    pl: "Podczas każdej próby, patrząc na włosy krzyżowe, para linii gdzieś błysnę. Może gdzie szukasz; Może w rogu oka. Tylko błysk. Aby nauczyć się tego zadania, spróbujmy najpierw z wyświetlaczem statycznym. Patrząc na krzyżowe włosy poniżej, bez poruszania oczu: czy górna linia jest przesunięta w lewo lub w prawo, w stosunku do dolnej linii?",
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو جاننے کے ل first ، پہلے اسے مستحکم کارکردگی کے ساتھ آزمائیں۔ آنکھیں ہلاتے ہوئے ، نیچے کے بالوں کو دیکھتے ہوئے: درمیانی کاغذ کیا ہے؟",
  ...
  T_keypadLetter: {
    ...
    bn: "এটি আপনার ফোনে কীপ্যাডে টিপুন।",
  ...
  T_thresholdMiddleLetterBeginBlock: {
    ...
    ja: "xxxトライアルのブロックを開始しようとしています。各試験では、3文字の三重項、例えば次のようになります。Z R N.中央の文字のみを報告してください、",
  ...
  T_thresholdVenierBeginBlock: {
    ...
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण लाइनों की एक नई जोड़ी पेश करेगा। कृपया रिपोर्ट करें कि ऊपरी रेखा को बाएं या दाएं (एल या आर) को स्थानांतरित कर दिया गया है,",
  ...
  T_thresholdLetterBeginBlock: {
    ...
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. თითოეულ სასამართლო პროცესს წარუდგენს წერილს. გთხოვთ, შეატყობინოთ მას,",

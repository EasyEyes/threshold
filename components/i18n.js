...
export const phrases = {
  ...
  EE_ID_noLocalStorage: {
    ...
    fi: "Tutkija pyysi sinua toimittamaan Easyeyes -tunnusesi edellisestä istunnosta, kirjoita se tähän tai ladata tiedosto, joka on ladattu, kun viimeinen istunto päättyy.",
  ...
  RC_privacyCamera: {
    ...
    kn: "ಕ್ಯಾಮೆರಾ ಗೌಪ್ಯತೆಯ ಭರವಸೆ. ಯಾವುದೇ ಫೋಟೋಗಳು ಅಥವಾ ವೀಡಿಯೊವನ್ನು ದಾಖಲಿಸಲಾಗಿಲ್ಲ. ಪ್ರತಿ ವೆಬ್‌ಕ್ಯಾಮ್ ಫ್ರೇಮ್ ಅನ್ನು ಈ ಕಂಪ್ಯೂಟರ್ ಒಳಗೆ ಮಾತ್ರ ಬಳಸಲಾಗುತ್ತದೆ, ಕೇವಲ ಕಣ್ಣು ಮತ್ತು ನೋಟದ ಸ್ಥಾನಗಳನ್ನು ಅಂದಾಜು ಮಾಡಲು, ಮತ್ತು ನಂತರ 10 ಸೆಕೆಂಡುಗಳಲ್ಲಿ ಅಳಿಸಿಹಾಕಲಾಗುತ್ತದೆ. ಕಣ್ಣು ಮತ್ತು ನೋಟದ ಸ್ಥಾನಗಳನ್ನು ಮಾತ್ರ ಉಳಿಸಿಕೊಳ್ಳಲಾಗುತ್ತದೆ.",

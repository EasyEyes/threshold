...
export const phrases = {
  ...
  RC_modelNumber: {
    ...
    de: "❌ rc_modelnumber ist veraltet. Verwenden Sie die osspezifische Version.",
    fr: "❌ RC_ModelNumber est obsolète. Utilisez la version spécifique au système d'exploitation.",
    es: "❌ rc_modelnumber es obsoleta. Use la versión específica del sistema operativo.",
    pt: "❌ rc_modelNumber é obsolere. Use a versão específica do OS.",
    it: "❌ rc_modelnumber è obsolere. Utilizzare la versione specifica del sistema operativo.",
    ro: "❌ rc_modelnumber este învechit. Utilizați versiunea specifică sistemului de operare.",
    pl: "❌ RC_ModelNumber jest Obsolere. Użyj wersji specyficznej dla systemu operacyjnego.",
    ru: "❌ rc_modelnumber является устаревшим. Используйте ОС-специфическую версию.",
    hy: "❌ rc_modelnumber- ը հնացած է: Օգտագործեք OS- ի հատուկ տարբերակը:",
    fi: "❌ RC_MOLLNUMBER on OFFOLERE. Käytä käyttöjärjestelmäkohtaista versiota.",
    ka: "❌ rc_modelnumber არის მოძველებული. გამოიყენეთ OS სპეციფიკური ვერსია.",
    he: "❌ RC_MODELNUMBER הוא OBSOLERE. השתמש בגרסה הספציפית למערכת ההפעלה.",
    ar: "❌ RC_MODELNumber عبر. استخدم النسخة الخاصة بنظام التشغيل.",
    ur: "❌ rc_modelnumber متروک ہے۔ OS مخصوص ورژن استعمال کریں۔",
    hi: "❌ RC_MODELNUMBER OBOLERER है। ओएस-विशिष्ट संस्करण का उपयोग करें।",
    ta: "❌ rc_modelnumber என்பது ஒதுக்கப்படுகிறது. OS- குறிப்பிட்ட பதிப்பைப் பயன்படுத்தவும்.",
    ml: "❌ Rc_Modelnumber കാലഹരണപ്പെടുന്നു. OS-നിർദ്ദിഷ്ട പതിപ്പ് ഉപയോഗിക്കുക.",
    te: "❌ RC_MODELNumber వాడుకలో ఉంది. OS- నిర్దిష్ట సంస్కరణను ఉపయోగించండి.",
    kn: "❌ rc_modelNumber ಬಳಕೆಗಳಿಂದ ಕೂಡಿದೆ. ಓಎಸ್-ನಿರ್ದಿಷ್ಟ ಆವೃತ್ತಿಯನ್ನು ಬಳಸಿ.",
    bn: "❌ rc_modelnumber অপ্রচলিত। ওএস-নির্দিষ্ট সংস্করণ ব্যবহার করুন।",
    id: "❌ RC_ModelNumber sudah usang. Gunakan versi spesifik OS.",
    "zh-CN": "❌rc_modelnumber是过时的。使用特定于OS的版本。",
    "zh-HK": "❌rc_modelnumber是過時的。使用特定於OS的版本。",
    ja: "rc_modelnumberはobsolereです。 OS固有のバージョンを使用します。",
    ko: "RC_MODELNUMBER는 더 이상 사용되지 않습니다. OS- 특이 적 버전을 사용하십시오.",
  },
  RC_modelName: {
    "en-US": "Model name",
    de: "Modellname",
  ...
  RC_allowMicrophoneUse: {
    "en-US":
      'If a pop up appears, asking for permission to use the microphone, click "Allow".',
    ...
    hi: 'यदि कोई पॉप अप दिखाई देता है, तो माइक्रोफोन का उपयोग करने की अनुमति मांगता है, "अनुमति" पर क्लिक करें।',
  ...
  RC_distanceTrackingBeyond50Cm: {
    ...
    fi: "50 cm: n yli on vaikeampaa tavoittaa tietokoneen näppäimistö, joten voit käyttää sen sijaan näppäimistöä älypuhelimessa.",
    ...
    ar: "إلى ما بعد 50 سم ، من الصعب الوصول إلى لوحة مفاتيح جهاز الكمبيوتر الخاص بك ، لذلك لا تتردد في استخدام لوحة المفاتيح على هاتفك الذكي بدلاً من ذلك.",
    ur: "50 سینٹی میٹر سے آگے ، اپنے کمپیوٹر کے کی بورڈ تک پہنچنا مشکل ہے ، لہذا اس کے بجائے اپنے اسمارٹ فون پر کیپیڈ کو بلا جھجھک استعمال کریں۔",
    ...
    ko: "50cm를 넘어서 컴퓨터의 키보드에 도달하기가 더 어렵 기 때문에 대신 스마트 폰에서 키패드를 사용하십시오.",
  },
  ...
  RC_needPortraitOrientation: {
    ...
    ru: "Поверните этот телефон на портретную ориентацию.",
  ...
  RC_panelIntro: {
    ...
    pt: "",
    it: "",
    ro: "❌ RC_panelIntro is obsolete.",
    pl: "❌ RC_panelIntro is obsolete.",
    ru: "❌ RC_panelIntro is obsolete.",
    hy: "❌ RC_panelIntro is obsolete.",
    fi: "❌ RC_panelIntro is obsolete.",
    ka: "❌ RC_panelIntro is obsolete.",
    he: "❌ RC_panelIntro is obsolete.",
    ar: "❌ RC_panelIntro is obsolete.",
    ur: "❌ RC_panelIntro is obsolete.",
    hi: "❌ RC_panelIntro is obsolete.",
    ta: "❌ RC_panelIntro is obsolete.",
    ml: "❌ RC_panelIntro is obsolete.",
    te: "❌ RC_panelIntro is obsolete.",
    kn: "❌ RC_panelIntro is obsolete.",
    bn: "❌ RC_panelIntro is obsolete.",
    id: "❌ RC_panelIntro is obsolete.",
    "zh-CN": "❌ RC_panelIntro is obsolete.",
    "zh-HK": "❌ RC_panelIntro is obsolete.",
    ja: "❌ RC_panelIntro is obsolete.",
    ko: "❌ RC_panelIntro is obsolete.",
  },
  RC_panelIntroNext: {
  ...
  RC_privacyIphoneMicrophone: {
    ...
    de: "❌ rc_privacyiphonemicrophon ist veraltet. Verwenden Sie stattdessen RC_PRIVACYMICROPHONECALIBRATION.",
    fr: "❌ RC_Privacyiphonémicrophone est obsolète. Utilisez RC_PRIVACYMICROPHONECALIBRATION à la place.",
    es: "❌ rc_privacyiphonemicrófono es obsoleto. Use RC_PrivacyMicroPhonecalibration en su lugar.",
    pt: "❌ rc_privacyiphonemicrophone é obsoleto. Use rc_privacymicrophonecalibration.",
    it: "❌ RC_PrivacifonemicRophone è obsoleto. Usa invece RC_Privacimicrofonecalibration.",
    ro: "❌ rc_privacyifonemicrofon este învechit. Utilizați în schimb rc_privacymicrofonecalibration.",
    pl: "❌ rc_privacyiphonemikrofon jest przestarzały. Zamiast tego użyj RC_PrivacyMicrofoneCalibration.",
    ru: "❌ rc_privacyiphonemicrophone устарел. Вместо этого используйте RC_PRIVATACYCROPHONECALIBRATION.",
    hy: "❌ rc_privacyiphonicrophone- ը հնացած է: Փոխարենը օգտագործեք rc_privacymicrophonecalibration փոխարենը:",
    fi: "❌ RC_Privacyiphonemicrofone on vanhentunut. Käytä sen sijaan rc_privacymikrofonekalibrointia.",
    ka: "❌ rc_privacyiphonemicrophone არის მოძველებული. ამის ნაცვლად გამოიყენეთ RC_PRIVACYMICROPHONECALIBRATION.",
    he: "❌ RC_PRIVACYIPHONEMICYROPHONE מיושן. השתמש במקום זאת RC_PRIVACYMICROPHONECALIBRATION.",
    ar: "❌ rc_privacyiphonemicrophone عفا عليها الزمن. استخدم RC_PRIVACYMICROPHONECILIBRATION بدلاً من ذلك.",
    ur: "❌ rc_privacyiphonemicrophone متروک ہے۔ اس کے بجائے rc_privacymicrophonecalibration استعمال کریں۔",
    hi: "❌ rc_privacyiphonemicrophone अप्रचलित है। इसके बजाय RC_PRIVACYMICROPHONECALIBRATION का उपयोग करें।",
    ta: "❌ rc_privacyiphonemicropone வழக்கற்றுப் போய்விட்டது. அதற்கு பதிலாக RC_PRIVACYMICROPHONECALIBRATION ஐப் பயன்படுத்தவும்.",
    ml: "❌ Rc_privashiphonekraphone കാലഹരണപ്പെട്ടു. പകരം rc_privasemicconrophonation ഉപയോഗിക്കുക.",
    te: "❌ RC_PRIVACYIPHONEMICHROPONE వాడుకలో లేదు. బదులుగా RC_PRIVACYMICROPENECALIBRATION ఉపయోగించండి.",
    kn: "❌ rc_privacyiphonemicrophone ಬಳಕೆಯಲ್ಲಿಲ್ಲ. ಬದಲಾಗಿ rc_privacymicrophonecalibration ಬಳಸಿ.",
    bn: "❌ আরসি_প্রাইভেসিফোনমিক্রোফোন অপ্রচলিত। পরিবর্তে rc_privacymicrophonecalibration ব্যবহার করুন।",
    id: "❌ rc_privacyiphonemicrophone sudah usang. Gunakan rc_privacymicrophonecalibration sebagai gantinya.",
    "zh-CN":
      "RC_PRIVACYIPHONEMECROPHONE已过时。改用RC_PrivacyMicrophoneCalibration。",
    "zh-HK":
      "RC_PRIVACYIPHONEMECROPHONE已過時。改用RC_PrivacyMicrophoneCalibration。",
    ja: "❌rc_privacyiphonemicrophoneは時代遅れです。代わりにrc_privacymicrophonecalibrationを使用します。",
    ko: "RC_PRIVACYIPHONEMICROPHONE은 더 이상 사용되지 않습니다. 대신 rc_privacymicrophonecalibration을 사용하십시오.",
  },
  ...
  RC_soundAllHzDetails: {
    ...
    ar: "تمت معايرة استجابة التردد مع 111 تكرار (بعد 222 الاحماء) من انفجار 333 ثانية ، تم أخذ عينات منه في 444 هرتز.",
    ur: "تعدد ردعمل 111 دہرائے (222 وارم اپ کے بعد) 333 سیکنڈ پھٹ کے ساتھ کیلیبریٹ کیا گیا ، جس کا نمونہ 444 ہرٹج میں کیا گیا۔",
  ...
  RC_noSounds: {
    ...
    fr: "L'expérience n'a pas fourni de coffre-tobsoundfolder, il n'y a donc pas de sons à jouer.",
    ...
    id: "Eksperimen ini tidak memberikan target -oundfolder, jadi tidak ada suara untuk dimainkan.",
  ...
  RC_usingSmartPhoneMicrophone: {
    ...
    de: "❌ rc_usingsmartphonemicrophon ist veraltet.",
    fr: "❌ RC_USINGSMARTPHONEMICROPHONE est obsolète.",
    es: "❌ rc_usingsmartphonemicrófono es obsoleto.",
    pt: "❌ rc_usingsmartphonemicrophone é obsoleto.",
    it: "❌ RC_USINGSMARTPHONEMICROPHONE è obsoleto.",
    ro: "❌ rc_usingsmartfonemicrofon este învechit.",
    pl: "❌ RC_USingsmartphonemikrofon jest przestarzały.",
    ru: "❌ rc_usingsmartphonemicrophone устарел.",
    hy: "❌ rc_usingsmartphonicrophone- ը հնացած է:",
    fi: "❌ RC_USINGSMARTPHONEMICROPHONE on vanhentunut.",
    ka: "❌ rc_usingsmartphonemicrophone არის მოძველებული.",
    he: "❌ RC_USINGSMARTPHONEMICYROPHON מיושן.",
    ar: "❌ rc_usingsmartphonemorphone عفا عليها الزمن.",
    ur: "❌ rc_usingsmartphonemicrophone متروک ہے۔",
    hi: "❌ rc_usingsmartphonemicrophone अप्रचलित है।",
    ta: "❌ rc_ussingsmartphonemicropone வழக்கற்றுப் போய்விட்டது.",
    ml: "❌ rc_usinesmarthhhhophone കാലഹരണപ്പെട്ടു.",
    te: "❌ RC_USINGSMARTPHONEMICYROPONE వాడుకలో లేదు.",
    kn: "❌ rc_usingsMartphonemicrofoone ಬಳಕೆಯಲ್ಲಿಲ್ಲ.",
    bn: "R",
    id: "❌ rc_usingsmartphonemicrophone sudah usang.",
    "zh-CN": "RC_USINGSMARTPHONEMETROPHONE已过时。",
    "zh-HK": "RC_USINGSMARTPHONEMETROPHONE已過時。",
    ja: "rc_usingsmartphonemicrophoneは時代遅れです。",
    ko: "RC_USINGSMARTPHONEMICROPHONE은 더 이상 사용되지 않습니다.",
  },
  ...
  RC_soundCalibrationNeedsIPhone: {
    ...
    de: "❌ RC_SoundCalibrationNeedsiphone ist veraltet. Verwenden Sie stattdessen RC_SoundCalibrationNeedsMicrophon.",
    fr: "❌ RC_SOUNDCALIBRATIONNEDSIPHONE est obsolète. Utilisez RC_SOUNDCALIBRATIONNEDEDSMICROPHON à la place.",
    es: "❌ rc_soundcalibrationNeedSiphone es obsoleto. Use RC_SOUNDCALIBRATIONEnedSmicrophone en su lugar.",
    pt: "❌ RC_SOUNDCalibrationNeedSiphone é obsoleto. Use RC_SoundCalibrationNeedSmicrophone.",
    it: "❌ rc_soundcalibrationneedsiphone è obsoleto. Utilizzare invece RC_SoundCalibrationneedsmicrofono.",
    ro: "❌ rc_soundcalibrationneedsiphone este învechit. Utilizați în schimb rc_soundcalibrationneedsmicrofon.",
    pl: "❌ RC_SoundCalibationneedsiphone jest przestarzały. Zamiast tego użyj RC_SoundcalibrationNeedsmikrofon.",
    ru: "❌ rc_soundcalibrationneedsiphone устарел. Вместо этого используйте RC_SoundCalitibrationneedsmicrophone.",
    hy: "❌ rc_soundcalibrationneedsiphone- ը հնացած է: Փոխարենը օգտագործեք rc_soundcalibrationneeedsMicrophone- ը:",
    fi: "❌ RC_SOONDCALIBRATIONNEEDSIPHONE on vanhentunut. Käytä sen sijaan RC_SOONDCALIBRATIONNEEDSMICROPHONE.",
    ka: "❌ rc_soundcalibrationneedsiphone არის მოძველებული. გამოიყენეთ rc_soundcalibrationneedsmicrophone ამის ნაცვლად.",
    he: "❌ RC_SOUNDCALIBRATIONNEEDSIPHONE מיושן. השתמש במקום זאת rc_soundcalibrationneedsmicrophone.",
    ar: "❌ rc_soundcalibrationneedsiphone عفا عليها الزمن. استخدم rc_soundcalibrationneedsmicrophone بدلاً من ذلك.",
    ur: "❌ rc_soundcalibrationneedsiphone متروک ہے۔ اس کے بجائے rc_soundcalibrationneedsmicropone استعمال کریں۔",
    hi: "❌ RC_SoundCalibrationNeedSiphone अप्रचलित है। इसके बजाय rc_soundcalibrationneedsmicrophone का उपयोग करें।",
    ta: "❌ rc_soundcalibrationneedsiphone வழக்கற்றுப் போய்விட்டது. அதற்கு பதிலாக rc_soundcalibrationneedsmicrobone ஐப் பயன்படுத்தவும்.",
    ml: "❌ rc_soundcalibrationneediphone കാലഹരണപ്പെട്ടു. പകരം rc_soundcalibruationnedsneedtsmicon ഉപയോഗിക്കുക.",
    te: "❌ RC_SOUNDCALIBRATIONNEEDSIPHONE వాడుకలో లేదు. బదులుగా RC_SOUNDCALIBRATIONNEEDSMICROPHONE ఉపయోగించండి.",
    kn: "❌ RC_SOUNDCALIBARATIONNEEDSIPHONE ಬಳಕೆಯಲ್ಲಿಲ್ಲ. ಬದಲಾಗಿ RC_SOUNDCALIBARATIONNEEDSMICROPHONE ಬಳಸಿ.",
    bn: "R পরিবর্তে rc_soundcalibrationneedsmicrophone ব্যবহার করুন।",
    id: "❌ rc_soundCalibrationNeedSiphone sudah usang. Gunakan rc_soundCalibrationNeedSmicrophone sebagai gantinya.",
    "zh-CN":
      "RC_SOUNDCALIBRATIONNEEDSIPHONE已过时。改用RC_SOUNDCALIBRATIONNEEDSMICROPHONE。",
    "zh-HK":
      "RC_SOUNDCALIBRATIONNEEDSIPHONE已過時。改用RC_SOUNDCALIBRATIONNEEDSMICROPHONE。",
    ja: "rc_SoundCalibrationNeedSiphoneは時代遅れです。代わりにRC_SoundCalibrationNeedSmicrofoneを使用します。",
    ko: "rc_soundcalibrationneedsiphone은 더 이상 사용되지 않습니다. 대신 rc_soundcalibrationneedsmicrophone을 사용하십시오.",
  },
  ...
  RC_soundCalibrationTitle: {
    ...
    de: "❌ RC_SoundCalibrationTitle ist veraltet. Verwenden Sie RC_SoundCalibrationTitle1000Hz\nund RC_SoundCalibrationTitleallhz stattdessen.",
    fr: "❌ RC_SOUNDCALIBRATIONTITLE est obsolète. Utilisez rc_soundcalibrationtitle1000hz\net rc_soundcalibrationtitleallhz à la place.",
    es: "❌ rc_soundcalibrationtitle es obsoleto. Use rc_soundcalibrationtitle1000Hz\ny rc_soundcalibrationtitleallhz en su lugar.",
    pt: "❌ rc_soundCalibrationTitle é obsoleto. Use RC_SoundCalibrationTitle1000Hz\ne RC_SOUNDCALIBRATIONTITLEALLHZ.",
    it: "❌ rc_soundcalibrationTitle è obsoleto. Usa rc_soundcalibrationtitle1000Hz\ne rc_soundcalibrationtitleallhz.",
    ro: "❌ rc_soundcalibrationTitle este învechit. Utilizați RC_SoundCalibrationTitle1000Hz\nși rc_soundcalibrationTitleAllHz.",
    pl: "❌ RC_SoundCalibrationTitle jest przestarzałe. Użyj RC_SoundCalibrationTitle1000Hz\ni zamiast tego RC_SoundCalibationTitleallHz.",
    ru: "❌ rc_soundCalibrationTitle устарел. Используйте rc_soundcalibrationtitle1000hz\nи rc_soundcalibrationtitleallhz вместо этого.",
    hy: "❌ rc_soundcalibrationtitle- ը հնացած է: Օգտագործեք rc_soundcalibrationtitle1000hz\nփոխարենը rc_soundcalibrationtitleallhz փոխարենը:",
    fi: "❌ RC_SOONDCALIBRATIONTITLE on vanhentunut. Käytä rc_soundcalibrotionTitle1000Hz\nja rc_soundcalibrotionTitleallhz.",
    ka: "❌ rc_soundcalibrationTitle მოძველებულია. გამოიყენეთ rc_soundcalibrationtitle1000hz\nდა RC_SOUNDCALIBRATIONTITLEALLHZ.",
    he: "❌ RC_SoundCalibrationTitle מיושן. השתמש ב- RC_SoundCalibrationTitle1000Hz\nו- RC_SoundCalibrationTitLealLHz במקום.",
    ar: "❌ rc_soundcalibrationTitle عفا عليها الزمن. استخدم RC_SOUNDCALIBRITIONTITLE1000Hz\nو rc_soundCalibrationTitleallhz بدلاً من ذلك.",
    ur: "❌ rc_soundcalibrationTitle متروک ہے۔ rc_soundcalibrationTitle1000Hz استعمال کریں\nاور اس کے بجائے rc_soundcalibrationtittleallhz.",
    hi: "❌ RC_SoundCalibrationTitle अप्रचलित है। RC_SoundCalibrationTitle1000Hz का उपयोग करें\nऔर इसके बजाय rc_soundcalibrationtitleallhz।",
    ta: "❌ rc_soundcalibrationtitle வழக்கற்றுப் போய்விட்டது. RC_SOUNDCALIBRATIONTITLE1000Hz ஐப் பயன்படுத்தவும்\nமற்றும் rc_soundcalibrationtitleallhz அதற்கு பதிலாக.",
    ml: "❌ rc_soundcalibrationtile കാലഹരണപ്പെട്ടു. Rc_soundcalibrationtiittle1000hz ഉപയോഗിക്കുക\nഒപ്പം rc_soundcalibrationTiitllhzz.",
    te: "❌ RC_SOUNDCALIBRATIONTITLE వాడుకలో లేదు. Rc_soundcalibrationTitle1000Hz ఉపయోగించండి\nమరియు బదులుగా rc_soundcalibrationtitleallhz.",
    kn: "❌ rc_soundCalibrationTitle ಬಳಕೆಯಲ್ಲಿಲ್ಲ. RC_SOUNDCALIBARATIONTETLE1000HZ ಬಳಸಿ\nಮತ್ತು rc_soundCalibrationTitleallhz ಬದಲಿಗೆ.",
    bn: "❌ rc_soundcalibrationtitle অপ্রচলিত। RC_SoundCalibrationTitle1000Hz ব্যবহার করুন\nএবং পরিবর্তে rc_soundcalibrationtitleallhz।",
    id: "❌ rc_soundCalibrationTitle sudah usang. Gunakan rc_soundCalibrationTitle1000Hz\ndan rc_soundCalibrationTitleallhz sebagai gantinya.",
    "zh-CN":
      "RC_SOUNDCALIBRATIONTITLE已过时。使用RC_SOUNDCALIBRATIONTITLE1000Hz\n和rc_soundCalibrationTitleallHz。",
    "zh-HK":
      "RC_SOUNDCALIBRATIONTITLE已過時。使用RC_SOUNDCALIBRATIONTITLE1000Hz\n和rc_soundCalibrationTitleallHz。",
    ja: "❌rc_soundcalibrationTitleは時代遅れです。 RC_SoundCalibrationTitle1000Hzを使用します\n代わりにrc_soundcalibrationtitleallhz。",
    ko: "rc_soundcalibrationtitle은 더 이상 사용되지 않습니다. rc_soundcalibrationtitle1000Hz를 사용하십시오\n및 대신 rc_soundcalibrationtitleallhz.",
  },
  ...
  T_continueClickProceedOrKeypad: {
    ...
    ka: "გასაგრძელებლად, დააჭირეთ ღილაკს გაგრძელება ან დააჭირეთ დაბრუნებას კლავიატურაზე/კლავიატურაზე",
  ...
  T_continueClickProceedOrHitReturnOrKeypad: {
    ...
    he: "להמשך, לחץ על המשך או לחץ על החזר במקלדת או בלוח המקשים שלך.",
    ar: "للمتابعة ، انقر فوق متابعة أو ضرب العودة على لوحة المفاتيح أو لوحة مفاتيح الهاتف.",
  ...
  T_identifyMiddleLetterPressIt: {
    ...
    ro: "Vă rugăm să identificați litera de mijloc apăsând -o în tastatură/tastatură.",
    pl: "Zidentyfikuj środkową literę, naciskając ją w klawiaturze/klawiaturze.",
    ru: "Пожалуйста, определите среднюю букву, нажав ее на клавиатуре/клавиатуре.",
  ...
  T_identifyLetterPressItOrClickIt: {
    ...
    ja: "下をクリックするか、キーボード/キーパッドで押して文字を識別してください。",
  ...
  "❌T_identifyPressIt": {
    ...
    fi: "Vaihda T_IdentifyPressit → T_IdentifyMiddlotterPressit",
    ka: "შეცვალეთ t_identifypressit → t_identifymiddleletterpressit",
    ...
    ta: "T_identifirepressit ஐ மாற்றவும் → T_identifymiddleletterpressit",
    ml: "T_INDEPSPITE → t_indipildllletterpresspitt മാറ്റുക",
    te: "T_IDENTIFYPRESSIT → T_IDENTIFIMIDDLELETERPRESSIT ని మార్చండి",
    kn: "T_IDENTIFYPRESSIT → T_IDENTIFYMIDLELETELTERSPERIT ಅನ್ನು ಬದಲಾಯಿಸಿ",
    bn: "T_INDIFIFEREPREST → T_INDIFIFIDEMIDLETERPREPRESTIT পরিবর্তন করুন",
    id: "Ubah T_IdentifyPressit → T_IdentifyMidDleletterpressit",
    "zh-CN": "请按下键盘上的对应按键来报告您认出的中间字母。",
    "zh-HK": "請按下鍵盤上的對應按鍵來報告您認出的中間字母。",
    ja: "キーボードで対応するキーを押して、認識した真ん中の文字を報告してください。",
    ko: "t_identifypressit → t_identifymiddleletterpressit를 변경하십시오",
  },
  ...
  "❌T_identifyPressItOrClickIt": {
    ...
    fr: "Modifier T_IdentifypressitorClickit → T_IdentifymiddleletterPressitorClickit",
    es: "Identifica la letra del medio presionándola en el teclado o haciendo clic en ella abajo.",
    pt: "Alterar T_IdentifyPressitorClickit → T_IdentifyMidDleLeTterPressitorClickit",
    ...
    fi: "Vaihda T_IdentifyPressitorClickit → T_IdentifyMiddlotEtterPressItorClickit",
    ka: "შეცვალეთ t_identifypressitorClickit → t_identifymiddLeletterpressitorClickit",
    ...
    ta: "T_identifiefrositorclickit ஐ மாற்றவும் → T_identifymiddleletterpressitorclickit",
    ml: "T_IDIDESPIRICIRCICIT മാറ്റുക → t_indifieddllerterpercercepreceriterchit",
    te: "T_identifyPressitorclickit → t_identifimiddlelettressitorclickit ని మార్చండి",
    kn: "T_IDENTIFYPRESSITOTERCLICKIT → T_IDEDIFYMIDLELETELETTERTERPRESPRCLICKIT ಅನ್ನು ಬದಲಾಯಿಸಿ",
    bn: "T_INDIFIFERPERPERCCLICKIT → T_INDIFIDEMIDLELTERPREPREPREPREPRESTIORCLICKIT পরিবর্তন করুন",
    id: "Ubah t_IdentifyPressitorClickit → T_IdentifyMidDleletterpressitorClickit",
    ...
    ko: "t_identifypressitorclickit → t_identifymiddleletterpressitorclickit을 변경하십시오",
  },
  ...
  T_keypadLetter: {
    ...
    ru: "Нажав его на клавиатуре на своем телефоне.",
  ...
  T_thresholdBeginBlock: {
    ...
    ka: "შეცვალეთ t_thresholdbeginblock → t_thresholdmiddleletterbeginblock",
    ...
    ta: "T_thresholdbeginblock → t_thresholdmiddleletterbeginblock ஐ மாற்றவும்",
    ml: "T_THROSHOLDBEGINBLOCK മാറ്റുക → T_THRESHOLDMIDDLELTERBEBINBLOCK",
    te: "T_thresholdbeginblock → t_thresholdmiddletterbegiginblock ని మార్చండి",
    kn: "T_THRESHOLDBEGINBLOCK → T_THRESHOLDMIDLELETELETTERBEGINBLOCK ಅನ್ನು ಬದಲಾಯಿಸಿ",
    bn: "T_ThresholdbeginBlock পরিবর্তন করুন → T_THRESHOLDMIDLELTERBEGINBLOCK",
    id: "Ubah t_thresholdbeginblock → t_thresholdMidDleletterbeginblock",
    "zh-CN":
    ...
    ko: "t_thresholdbeginblock → t_thresholdmiddleletterbeginBlock을 변경하십시오",
  },
  ...
  T_whyClick: {
    ...
    ta: "இந்தத் தொகுதியில் நாங்கள் விசைப்பலகைக்கு பதிலாக கிளிக்குகளைப் பயன்படுத்துவோம், ஏனென்றால் கிளிக் செய்வது சரியான நேரத்தில் சரியான இடத்திற்கு உங்கள் கண்ணைப் பெறுகிறது.",

...
export const phrases = {
  ...
  T_middleLetterBrief: {
    ...
    te: "ఇది R. ఈ ప్రదర్శన స్థిరంగా ఉంది, కాబట్టి మీ కళ్ళను లేఖకు తరలించి గుర్తించడం సులభం. కానీ, నిజమైన విచారణలో, అక్షరాలు వెలిగిపోతాయి, కాబట్టి మీ కళ్ళను కదిలించడానికి సమయం లేదు. మీరు క్లిక్ చేస్తున్నప్పుడు క్రాస్ వెంట్రుకలను చూడటం ముఖ్యం. అక్షరాలు వెంటనే ఫ్లాష్ అవుతాయి. ఫ్లాష్ తర్వాత మీ కళ్ళు ఎక్కడికి వెళ్తాడనేది పట్టింపు లేదు. పరీక్ష యొక్క మొదటి బ్లాక్ మేము ఆసక్తిగా ప్రారంభించడానికి ముందు, కొన్ని ప్రయత్నాలు సాధన.",
  ...
  T_thresholdBeginBlock: {
    ...
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკის დაწყებას. სამი ასოების ტრიპლეტი გამოჩნდება თითოეულ სასამართლო პროცესზე, მაგალითად: Z R N. გთხოვთ, შეატყობინოთ მხოლოდ შუა წერილს,",

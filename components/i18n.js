...
export const phrases = {
  ...
  RC_findModelAndroid: {
    ...
    ko: "설정 또는 옵션 메뉴로 이동하여 목록 하단으로 스크롤하여‘전화 정보’,‘장치 정보’또는 이와 유사한 것을 확인하십시오. 모델 이름과 번호를 아래의 해당 필드에 복사하십시오.",
  },
  RC_findModelGoogle: {
    "en-US":
  ...
  RC_findModelSamsung: {
    ...
    pt: '❌ Verifique a parte de trás do aparelho. A Samsung inclui o número do modelo na parte inferior do dispositivo - abaixo, onde diz "Projetado e projetado pela Samsung". Copie o número do modelo e o nome para os campos correspondentes abaixo. Ou vá para o seu aplicativo de configurações e depois para o telefone. Aqui, você deve encontrar o número e o nome do modelo.',
    ...
    ro: "❌ Verificați partea din spate a receptorului. Samsung include numărul modelului chiar în partea de jos a dispozitivului - dedesubt unde se citește „Proiectat și proiectat de Samsung”. Copiați numărul și numele modelului în câmpurile corespunzătoare de mai jos. Sau accesați aplicația de setări și apoi la telefon. Aici, ar trebui să puteți găsi numărul și numele modelului.",
    ...
    kn: 'The ಹ್ಯಾಂಡ್‌ಸೆಟ್‌ನ ಹಿಂಭಾಗವನ್ನು ಪರಿಶೀಲಿಸಿ. ಸ್ಯಾಮ್‌ಸಂಗ್ ಸಾಧನದ ಅತ್ಯಂತ ಕೆಳಭಾಗದಲ್ಲಿರುವ ಮಾದರಿ ಸಂಖ್ಯೆಯನ್ನು ಒಳಗೊಂಡಿದೆ - ಅದು "ಸ್ಯಾಮ್‌ಸಂಗ್ ವಿನ್ಯಾಸಗೊಳಿಸಿದ ಮತ್ತು ವಿನ್ಯಾಸಗೊಳಿಸಿದ" ಎಂದು ಓದುತ್ತದೆ. ಮಾದರಿ ಸಂಖ್ಯೆ ಮತ್ತು ಹೆಸರನ್ನು ಕೆಳಗಿನ ಅನುಗುಣವಾದ ಕ್ಷೇತ್ರಗಳಿಗೆ ನಕಲಿಸಿ. ಅಥವಾ ನಿಮ್ಮ ಸೆಟ್ಟಿಂಗ್‌ಗಳ ಅಪ್ಲಿಕೇಶನ್‌ಗೆ ಮತ್ತು ನಂತರ ಫೋನ್‌ಗೆ ಹೋಗಿ. ಇಲ್ಲಿ, ನೀವು ಮಾದರಿ ಸಂಖ್ಯೆ ಮತ್ತು ಹೆಸರನ್ನು ಕಂಡುಹಿಡಿಯಲು ಸಾಧ್ಯವಾಗುತ್ತದೆ.',
  ...
  RC_placeSmartphoneMicrophone: {
    ...
    bn: "ভাঁজ কাপড়ের উপর আপনার ফোনটি বিশ্রামে, আপনার কম্পিউটারে এই ফোন প্রান্তটি নির্দেশ করুন, ভাঁজ করা কাপড়ের প্রান্তটি কিছুটা দূরে ঠেলে দিন। প্রেস এগিয়ে।",

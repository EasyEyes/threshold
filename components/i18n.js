...
export const phrases = {
  ...
  RC_privacyIphoneMicrophone: {
    ...
    fi: "❌ Mikrofoni yksityisyyden varmuus. Vanhentunut versio. Päivitys RC_Privacyiphonemicrofonista RC_Privacymikrofonekalibrointiin",
  ...
  RC_placeSmartphoneMicrophone: {
    "en-US":
      "Point this end of the phone ⇧ at your computer, and push the end beyond the folded cloth. Press Proceed.",
    de: "Zeigen Sie dieses Ende des Telefons auf Ihren Computer und schieben Sie das Ende über das gefaltete Tuch hinaus. Presse gehen weiter.",
    fr: "Pointez cette extrémité du téléphone ⇧ sur votre ordinateur et poussez l'extrémité au-delà du tissu plié. La presse continue.",
    es: "Apunte este extremo del teléfono ⇧ en su computadora y presiona el extremo más allá de la tela doblada. Presione proceder.",
    pt: "Aponte esta extremidade do telefone ⇧ no seu computador e empurre a ponta além do pano dobrado. Pressione prosseguir.",
    it: "Punta questa estremità del telefono ⇧ sul tuo computer e spingi l'estremità oltre il panno piegato. Processo stampa.",
    ro: "Puneți acest capăt al telefonului ⇧ la computer și împingeți capătul dincolo de pânza pliată. Apăsați.",
    pl: "Wskaż ten koniec telefonu ⇧ na komputer i naciśnij koniec poza złożoną szmatkę. Naciśnij postęp.",
    ru: "Укажите этот конец телефона ⇧ на вашем компьютере и нажмите конец за пределами сложенной ткани. Пресса продолжается.",
    hy: "Հեռախոսի այս վերջը նշեք ձեր համակարգչում եւ վերջը մղեք ծալովի կտորից այն կողմ: Մամուլի շարունակությունը:",
    fi: "Osoita tämä puhelimen pää ⇧ tietokoneellesi ja työnnä pää taitetun kankaan ulkopuolelle. Paina jatka.",
    ka: "მიუთითეთ ტელეფონის ეს დასასრული ⇧ თქვენს კომპიუტერში და დასასრულს დასაკეცი ქსოვილის მიღმა. დააჭირეთ ღილაკს.",
    he: "הצבע את הקצה הזה של הטלפון ⇧ במחשב שלך, ודחף את הקצה מעבר לבד המקופל. לחץ על המשך.",
    ar: "أشر إلى هذه النهاية من الهاتف ⇧ على جهاز الكمبيوتر الخاص بك ، وادفع النهاية إلى ما وراء القماش المطوي. اضغط على متابعة.",
    ur: "فون کے اس سرے کی نشاندہی کریں ⇧ اپنے کمپیوٹر پر ، اور جوڑ والے کپڑے سے آگے کو دھکیلیں۔ آگے بڑھیں۔",
    hi: "अपने कंप्यूटर पर फोन के इस छोर को इंगित करें, और मुड़े हुए कपड़े से परे अंत को धक्का दें। दबाएं।",
    ta: "தொலைபேசியின் இந்த முடிவை உங்கள் கணினியில் சுட்டிக்காட்டி, மடிந்த துணிக்கு அப்பால் முடிவைத் தள்ளுங்கள். தொடரவும்.",
    ml: "നിങ്ങളുടെ കമ്പ്യൂട്ടറിൽ ഫോണിന്റെ ഈ അവസാനം പോയിന്റ്, മടക്കിക്കളയുന്ന തുണിക്കപ്പുറത്തേക്ക് അവസാനം തള്ളുക. തുടരുക അമർത്തുക.",
    te: "ఫోన్ యొక్క ఈ చివరను మీ కంప్యూటర్ వద్ద సూచించండి మరియు మడతపెట్టిన వస్త్రానికి మించి ముగింపును నెట్టండి. నొక్కండి.",
    kn: "ಫೋನ್‌ನ ಈ ತುದಿಯನ್ನು ನಿಮ್ಮ ಕಂಪ್ಯೂಟರ್‌ನಲ್ಲಿ ಸೂಚಿಸಿ, ಮತ್ತು ಮಡಿಸಿದ ಬಟ್ಟೆಯನ್ನು ಮೀರಿ ಅಂತ್ಯವನ್ನು ತಳ್ಳಿರಿ. ಮುಂದುವರಿಯಿರಿ.",
    bn: "আপনার কম্পিউটারে ফোনের এই প্রান্তটি নির্দেশ করুন এবং ভাঁজ করা কাপড়ের বাইরে প্রান্তটি চাপুন। প্রেস প্রেস।",
    id: "Arahkan ujung telepon ini ⇧ di komputer Anda, dan dorong ujungnya melampaui kain yang dilipat. Tekan lanjutkan.",
    "zh-CN": "将手机的末端指向您的计算机，然后将末端推到折叠布上。按继续。",
    "zh-HK": "將手機的末端指向您的計算機，然後將末端推到折疊布上。按繼續。",
    ja: "電話のこの端をコンピューターに向けて、折り畳まれた布を越えて端を押します。押し続けます。",
    ko: "컴퓨터에서 전화의 끝을 가리키고 접힌 천을 넘어 끝을 밀어 넣으십시오. 프레스 진행.",
  },
  RC_usingSmartphoneMicrophone: {
    "en-US": "Using smartphone microphone",
    de: "Mit Smartphone -Mikrofon",

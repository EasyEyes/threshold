...
export const phrases = {
  ...
  RC_distanceTrackingCloseL: {
    ...
    ar: "1. أغلق عينيك اليسرى. (هذا هو الجانب الأيسر من الشاشة.)\n2. استخدم ▶ مفتاح السهم لتزويد النقطة الخفقان. (أو فقط اسحبه ، إذا لم يكن يستجيب لمفتاح السهم.) أثناء النظر إلى الشعر المتقاطع ، راقب النقطة الوهمية في زاوية عينيك ، وحركها إلى اليسار واليمين حتى تختفي في النقطة العمياء.\n3. ضرب العودة.\nملاحظة: راقب الشعر المتقاطع. لن تختفي النقطة الخفقان بينما تتبعها عينك.",
  ...
  RC_nearPointIntro: {
    ...
    "zh-CN":
      "我们将测量您的眼睛之间的距离。使用视频图像观看您的眼睛。在眼前，水平握住笔在您的脸上。将您的左右拇指指甲与左右学生的中心对齐。然后将笔带到屏幕上的统治者，以测量拇指之间的分离。用零左右拇指，并注意右拇指在哪里。放下笔，然后单击标尺。最后，单击确定继续。",
    "zh-HK":
  ...
  RC_privacyCamera: {
    ...
    ko: "카메라 프라이버시 보증. 사진이나 비디오가 녹음되지 않습니다. 각 웹캠 프레임은이 컴퓨터 내부에서만 사용되며 눈과 시선 위치를 추정 한 다음 10 초 이내에 지워집니다. 눈과 시선 위치 만 유지됩니다.",
  },
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس بالوں کو دیکھیں گے تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب خطوط کا ایک ٹرپل چمکتا ہے۔ صرف ایک جھلک کام کو جاننے کے ل first ، پہلے اسے مستحکم کارکردگی کے ساتھ آزمائیں۔ نیچے کے بالوں کو دیکھتے ہوئے آنکھیں ہلائے بغیر درمیانی خط کی شناخت کرنے کی کوشش کریں۔",
  ...
  T_rsvpReadingTask: {
    ...
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. మీరు ఒక కథను, ఒకేసారి కొన్ని పదాలు రీడింగులు చేస్తారు. ప్రతి ట్రయల్ పదాల వాక్య-విలువ గురించి, ఒకదాని తరువాత ఒకటి, ఆపై మీరు ఏ పదాలు చదివారో గుర్తుంచుకోవాలని మిమ్మల్ని అడుగుతుంది.",
  ...
  T_readyClickCrosshair: {
    ...
    hy: "Պատրաստ? Նայելով ճիշտ խաչմերուկին, կտտացրեք նրան:",
  ...
  T_readyPressSpaceOrClickCrosshair: {
    ...
    hy: "Պատրաստ? Նայելով ուղղակիորեն խաչմերուկին, կտտացրեք բացը կամ կտտացրեք խաչմերուկին:",
  ...
  T_thresholdLetterBeginBlock: {
    ...
    pl: "Niedługo rozpoczniecie blok prób xxx. W każdej próbie pojawią się litery. Zgłoś to,",

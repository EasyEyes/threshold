...
export const phrases = {
  ...
  EE_languageChoose: {
    ...
    id: "Pilih bahasa untuk studi ini",
    "zh-CN": "为这项研究选择一种语言",
    "zh-HK": "為這項研究選擇一種語言",
    ja: "この調査の言語を選択してください",
  ...
  EE_compatibleNotBrowserDeviceCores: {
    ...
    "zh-HK":
      "如其描述中所述，這項研究與BBB瀏覽器不相容，並且需要至少具有222個CPU核心的DDD",
  ...
  RC_findModelAndroid: {
    "en-US":
      "Go to the Settings or Options menu, scroll to the bottom of the list, and check ‘About phone’, ‘About device’ or similar. Copy the Model Name and Number to the corresponding fields below.",
    de: 'Gehen Sie zum Menü- oder Optionsmenü, scrollen Sie nach unten in der Liste und überprüfen Sie "Über Telefon", "Über Gerät" oder ähnlich. Kopieren Sie den Modellnamen und die Nummer in die entsprechenden Felder unten.',
    fr: "Accédez au menu Paramètres ou Options, faites défiler vers le bas de la liste et vérifiez «sur le téléphone», «sur l'appareil» ou similaire. Copiez le nom et le numéro du modèle dans les champs correspondants ci-dessous.",
    es: 'Vaya al menú Configuración o opciones, desplácese hasta la parte inferior de la lista y verifique "Acerca del teléfono", "Acerca del dispositivo" o similar. Copie el nombre y el número del modelo a los campos correspondientes a continuación.',
    pt: "Vá para o menu de configurações ou opções, role até a parte inferior da lista e verifique 'Sobre o telefone', 'Sobre o dispositivo' ou similar. Copie o nome e o número do modelo para os campos correspondentes abaixo.",
    it: 'Vai al menu Impostazioni o opzioni, scorrere fino in fondo all\'elenco e controllare "About Phone", "About Device" o simile. Copia il nome e il numero del modello nei campi corrispondenti di seguito.',
    ro: "Accesați meniul Setări sau opțiuni, derulați în partea de jos a listei și verificați „Despre telefon”, „Despre dispozitiv” sau similar. Copiați numele și numărul modelului în câmpurile corespunzătoare de mai jos.",
    pl: "Przejdź do menu Ustawienia lub opcji, przewiń do dołu listy i sprawdź „About Telefon”, „About Device” lub podobne. Skopiuj nazwę modelu i numer do odpowiednich pól poniżej.",
    ru: "Перейдите в меню «Параметры» или «Параметры», прокрутите в нижней части списка и проверьте «о телефоне», «о устройстве» или аналогичном. Скопируйте имя и номер модели в соответствующие поля ниже.",
    hy: "Գնացեք պարամետրերի կամ ընտրանքների ընտրացանկ, ոլորեք ցուցակի ներքեւի մասում եւ ստուգեք «Հեռախոսի մասին», «սարքի մասին» կամ նման: Պատճենեք մոդելի անունը եւ համարը `ստորեւ նշված համապատասխան ոլորտներին:",
    fi: "Siirry Asetukset- tai Asetukset -valikkoon, vieritä luettelon alaosaan ja tarkista 'About About Phone', 'About Laite' tai vastaava. Kopioi mallin nimi ja numero alla oleviin vastaaviin kenttiin.",
    ka: 'გადადით პარამეტრების ან პარამეტრების მენიუში, გადადით სიის ბოლოში და შეამოწმეთ "ტელეფონის შესახებ", "მოწყობილობის შესახებ" ან მსგავსი. დააკოპირეთ მოდელის სახელი და ნომერი ქვემოთ მოცემულ შესაბამის ველებში.',
    he: "עבור לתפריט ההגדרות או האפשרויות, גלול לתחתית הרשימה ובדוק 'אודות טלפון', 'אודות מכשיר' או דומה. העתק את שם הדגם ומספר השדות המתאימים למטה.",
    ar: 'انتقل إلى قائمة الإعدادات أو الخيارات ، ثم قم بالتمرير إلى أسفل القائمة ، وتحقق من "حول الهاتف" ، أو "حول الجهاز" أو ما شابه. انسخ اسم النموذج والرقم إلى الحقول المقابلة أدناه.',
    ur: "ترتیبات یا اختیارات کے مینو پر جائیں ، فہرست کے نیچے سکرول کریں ، اور 'فون کے بارے میں' ، 'آلہ کے بارے میں' یا اسی طرح کی جانچ کریں۔ ماڈل کے نام اور نمبر کو ذیل میں متعلقہ فیلڈز میں کاپی کریں۔",
    hi: "सेटिंग्स या विकल्प मेनू पर जाएं, सूची के नीचे स्क्रॉल करें, और 'फोन के बारे में', 'डिवाइस के बारे में' या इसी तरह की जांच करें। मॉडल नाम और संख्या को नीचे दिए गए संबंधित फ़ील्ड में कॉपी करें।",
    ta: "அமைப்புகள் அல்லது விருப்பங்கள் மெனுவுக்குச் சென்று, பட்டியலின் கீழே உருட்டவும், ‘தொலைபேசியைப் பற்றி’, ‘சாதனம் பற்றி’ அல்லது அதற்கு ஒத்ததாக சரிபார்க்கவும். மாதிரி பெயர் மற்றும் எண்ணை கீழே உள்ள தொடர்புடைய புலங்களுக்கு நகலெடுக்கவும்.",
    ml: "ക്രമീകരണങ്ങൾ അല്ലെങ്കിൽ ഓപ്ഷനുകൾ മെനുവിലേക്ക് പോയി, ലിസ്റ്റിന്റെ ചുവടെ സ്ക്രോൾ ചെയ്യുക, 'ഫോണിനെക്കുറിച്ച്' ',' ഉപകരണത്തെക്കുറിച്ച് 'അല്ലെങ്കിൽ സമാനമായത്' പരിശോധിക്കുക. ചുവടെയുള്ള അനുബന്ധ ഫീൽഡുകൾക്ക് മോഡൽ പേരും നമ്പറും പകർത്തുക.",
    te: "సెట్టింగులు లేదా ఎంపికల మెనుకి వెళ్లి, జాబితా దిగువకు స్క్రోల్ చేయండి మరియు ‘ఫోన్ గురించి’, ‘పరికరం గురించి’ లేదా ఇలాంటివి తనిఖీ చేయండి. మోడల్ పేరు మరియు సంఖ్యను దిగువ సంబంధిత ఫీల్డ్‌లకు కాపీ చేయండి.",
    kn: "ಸೆಟ್ಟಿಂಗ್‌ಗಳು ಅಥವಾ ಆಯ್ಕೆಗಳ ಮೆನುಗೆ ಹೋಗಿ, ಪಟ್ಟಿಯ ಕೆಳಭಾಗಕ್ಕೆ ಸ್ಕ್ರಾಲ್ ಮಾಡಿ ಮತ್ತು ‘ಫೋನ್ ಬಗ್ಗೆ’, ‘ಸಾಧನದ ಬಗ್ಗೆ’ ಅಥವಾ ಅಂತಹುದೇ ಪರಿಶೀಲಿಸಿ. ಮಾದರಿ ಹೆಸರು ಮತ್ತು ಸಂಖ್ಯೆಯನ್ನು ಕೆಳಗಿನ ಅನುಗುಣವಾದ ಕ್ಷೇತ್ರಗಳಿಗೆ ನಕಲಿಸಿ.",
    bn: "সেটিংস বা অপশন মেনুতে যান, তালিকার নীচে স্ক্রোল করুন এবং ‘ফোন সম্পর্কে’, ‘ডিভাইস সম্পর্কে’ বা অনুরূপ পরীক্ষা করুন। নীচের সংশ্লিষ্ট ক্ষেত্রগুলিতে মডেলের নাম এবং নম্বরটি অনুলিপি করুন।",
    id: "Buka menu Pengaturan atau Opsi, gulir ke bagian bawah daftar, dan periksa ‘Tentang Telepon’, ‘Tentang Perangkat’ atau serupa. Salin nama model dan nomor ke bidang yang sesuai di bawah ini.",
    "zh-CN":
      "转到“设置或选项”菜单，滚动到列表的底部，然后检查“关于电话”，“关于设备”或类似方式。将型号和数字复制到下面的相应字段。",
    "zh-HK":
      "轉到“設置或選項”菜單，滾動到列表的底部，然後檢查“關於電話”，“關於設備”或類似方式。將型號和數字複製到下面的相應字段。",
    ja: "[設定]またはオプションメニューに移動し、リストの下部までスクロールし、「電話について」、「デバイスについて」などを確認します。モデル名と番号を以下の対応するフィールドにコピーします。",
    ko: "설정 또는 옵션 메뉴로 이동하여 목록 하단으로 스크롤하여‘전화 정보’,‘장치 정보’또는 이와 유사한 것을 확인하십시오. 모델 이름과 숫자를 아래의 해당 필드에 복사하십시오.",
  },
  RC_findModelIOs: {
    "en-US":
      "Go to Settings > General > About. To the right of “Model Number,” you'll find the part number. To find the model number (an “A” followed by a number), tap the part number. Copy the Model Name and Number to the corresponding fields below.",
    de: 'Gehen Sie zu Einstellungen> allgemein> über. Rechts von der „Modellnummer“ finden Sie die Teilenummer. Tippen Sie auf die Teilenummer, um die Modellnummer (ein "A" gefolgt von einer Zahl) zu finden. Kopieren Sie den Modellnamen und die Nummer in die entsprechenden Felder unten.',
    fr: "Accédez à Paramètres> Général> À propos. À droite du «numéro de modèle», vous trouverez le numéro de pièce. Pour trouver le numéro de modèle (un «A» suivi d'un nombre), appuyez sur le numéro de pièce. Copiez le nom et le numéro du modèle dans les champs correspondants ci-dessous.",
    es: 'Vaya a Configuración> General> Acerca de. A la derecha del "número de modelo", encontrará el número de pieza. Para encontrar el número de modelo (una "A" seguida de un número), toque el número de pieza. Copie el nombre y el número del modelo a los campos correspondientes a continuación.',
    pt: 'Vá para Configurações> Geral> Sobre. À direita do "número do modelo", você encontrará o número da peça. Para encontrar o número do modelo (um "A" seguido por um número), toque no número da peça. Copie o nome e o número do modelo para os campos correspondentes abaixo.',
    it: 'Vai a Impostazioni> Generale> Informazioni. A destra di "numero di modello", troverai il numero di parte. Per trovare il numero di modello (una "A" seguita da un numero), tocca il numero di parte. Copia il nome e il numero del modello nei campi corrispondenti di seguito.',
    ro: "Accesați Setări> General> despre. În dreapta „Numărului modelului”, veți găsi numărul piesei. Pentru a găsi numărul modelului (un „A” urmat de un număr), atingeți numărul piesei. Copiați numele și numărul modelului în câmpurile corespunzătoare de mai jos.",
    pl: "Przejdź do Ustawienia> Ogólne> O. Po prawej stronie „Numer modelu” znajdziesz numer części. Aby znaleźć numer modelu („A”, a następnie numer), dotknij numeru części. Skopiuj nazwę modelu i numer do odpowiednich pól poniżej.",
    ru: "Перейдите к настройкам> General> О. Справа от «номера модели» вы найдете номер детали. Чтобы найти номер модели («А», за которым следует число), нажмите номер детали. Скопируйте имя и номер модели в соответствующие поля ниже.",
    hy: "Գնալ պարամետրեր> Ընդհանուր> մասին. «Մոդելի համարի» աջ կողմում կգտնեք մասի համարը: Մոդելի համարը գտնելու համար («ա» -ին, որին հաջորդում է համարը), թակել մասի համարը: Պատճենեք մոդելի անունը եւ համարը `ստորեւ նշված համապատասխան ոլորտներին:",
    fi: "Siirry kohtaan Asetukset> Yleinen> Tietoja. ”Mallinumero” oikealla puolella löydät osanumeron. Löydä mallinumero (A: n, jota seuraa numero) napauttamalla osanumeroa. Kopioi mallin nimi ja numero alla oleviin vastaaviin kenttiin.",
    ka: 'გადადით პარამეტრებში> ზოგადი> შესახებ. "მოდელის ნომრის" მარჯვნივ, თქვენ ნახავთ ნაწილის ნომერს. მოდელის ნომრის მოსაძებნად ("A", რომელსაც მოჰყვება ნომერი), შეეხეთ ნაწილის ნომერს. დააკოპირეთ მოდელის სახელი და ნომერი ქვემოთ მოცემულ შესაბამის ველებში.',
    he: 'עבור אל הגדרות> כללי> אודות. מימין ל"מספר הדגם ", תמצא את מספר החלק. כדי למצוא את מספר הדגם (A "A" ואחריו מספר), הקש על מספר החלק. העתק את שם הדגם ומספר השדות המתאימים למטה.',
    ar: 'انتقل إلى الإعدادات> عام> حول. على يمين "رقم الطراز" ، ستجد رقم الجزء. للعثور على رقم الطراز ("A" متبوعًا برقم) ، اضغط على رقم الجزء. انسخ اسم النموذج والرقم إلى الحقول المقابلة أدناه.',
    ur: 'ترتیبات> عمومی> کے بارے میں جائیں۔ "ماڈل نمبر" کے دائیں طرف ، آپ کو حصہ نمبر مل جائے گا۔ ماڈل نمبر (ایک "A" کے بعد ایک نمبر کے بعد) تلاش کرنے کے لئے ، حصہ نمبر پر ٹیپ کریں۔ ماڈل کے نام اور نمبر کو ذیل میں متعلقہ فیلڈز میں کاپی کریں۔',
    hi: 'सेटिंग्स पर जाएं> सामान्य> के बारे में। "मॉडल नंबर" के दाईं ओर, आपको भाग संख्या मिलेगी। मॉडल नंबर (एक संख्या के बाद "ए") को खोजने के लिए, भाग संख्या पर टैप करें। मॉडल नाम और संख्या को नीचे दिए गए संबंधित फ़ील्ड में कॉपी करें।',
    ta: "அமைப்புகள்> பொது> பற்றிச் செல்லவும். “மாதிரி எண்” என்ற வலதுபுறத்தில், நீங்கள் பகுதி எண்ணைக் காண்பீர்கள். மாதிரி எண்ணைக் கண்டுபிடிக்க (“ஏ” தொடர்ந்து ஒரு எண்), பகுதி எண்ணைத் தட்டவும். மாதிரி பெயர் மற்றும் எண்ணை கீழே உள்ள தொடர்புடைய புலங்களுக்கு நகலெடுக்கவும்.",
    ml: 'ക്രമീകരണങ്ങൾ> പൊതുവായ> ഇതിലേക്ക് പോകുക. "മോഡൽ നമ്പർ" എന്നതിന്റെ വലതുവശത്ത് നിങ്ങൾ പാർട്ട് നമ്പർ കണ്ടെത്തും. മോഡൽ നമ്പർ കണ്ടെത്താൻ (ഒരു "ഒരു" ഒരു നമ്പർ), പാർട്ട് നമ്പർ ടാപ്പുചെയ്യുക. ചുവടെയുള്ള അനുബന്ധ ഫീൽഡുകൾക്ക് മോഡൽ പേരും നമ്പറും പകർത്തുക.',
    te: "సెట్టింగులు> జనరల్> గురించి వెళ్ళండి. “మోడల్ నంబర్” యొక్క కుడి వైపున, మీరు పార్ట్ నంబర్‌ను కనుగొంటారు. మోడల్ సంఖ్యను కనుగొనడానికి (సంఖ్య తరువాత “A”), పార్ట్ నంబర్‌ను నొక్కండి. మోడల్ పేరు మరియు సంఖ్యను దిగువ సంబంధిత ఫీల్డ్‌లకు కాపీ చేయండి.",
    kn: "ಸೆಟ್ಟಿಂಗ್‌ಗಳು> ಸಾಮಾನ್ಯ> ಬಗ್ಗೆ ಹೋಗಿ. “ಮಾದರಿ ಸಂಖ್ಯೆ” ನ ಬಲಭಾಗದಲ್ಲಿ, ನೀವು ಭಾಗ ಸಂಖ್ಯೆಯನ್ನು ಕಾಣುತ್ತೀರಿ. ಮಾದರಿ ಸಂಖ್ಯೆಯನ್ನು ಕಂಡುಹಿಡಿಯಲು (ಒಂದು ಸಂಖ್ಯೆಯ ನಂತರ “ಎ”), ಭಾಗ ಸಂಖ್ಯೆಯನ್ನು ಟ್ಯಾಪ್ ಮಾಡಿ. ಮಾದರಿ ಹೆಸರು ಮತ್ತು ಸಂಖ್ಯೆಯನ್ನು ಕೆಳಗಿನ ಅನುಗುಣವಾದ ಕ್ಷೇತ್ರಗಳಿಗೆ ನಕಲಿಸಿ.",
    bn: 'সেটিংস> সাধারণ> সম্পর্কে যান। "মডেল নম্বর" এর ডানদিকে আপনি অংশ নম্বরটি পাবেন। মডেল নম্বরটি (একটি "এ" এর পরে একটি নম্বর) সন্ধান করতে, অংশ নম্বরটি আলতো চাপুন। নীচের সংশ্লিষ্ট ক্ষেত্রগুলিতে মডেলের নাম এবং নম্বরটি অনুলিপি করুন।',
    id: 'Pergi ke Pengaturan> Umum> Tentang. Di sebelah kanan "nomor model," Anda akan menemukan nomor bagian. Untuk menemukan nomor model ("A" diikuti oleh nomor), ketuk nomor bagian. Salin nama model dan nomor ke bidang yang sesuai di bawah ini.',
    "zh-CN":
      "转到设置>一般>关于。在“型号”的右侧，您会找到零件号。要查找型号（“ A”，然后是一个数字），请点击零件号。将型号和数字复制到下面的相应字段。",
    "zh-HK":
      "轉到設置>一般>關於。在“型號”的右側，您會找到零件號。要查找型號（“ A”，然後是一個數字），請點擊零件號。將型號和數字複製到下面的相應字段。",
    ja: "[設定]> [一般>]に移動します。 「モデル番号」の右側には、部品番号が見つかります。モデル番号（「A」に続く番号）を見つけるには、部品番号をタップします。モデル名と番号を以下の対応するフィールドにコピーします。",
    ko: '설정> 일반>에 대해 이동하십시오. "모델 번호"의 오른쪽에는 부품 번호가 있습니다. 모델 번호 ( "A"다음 숫자가 이어지면)를 찾으려면 부품 번호를 누릅니다. 모델 이름과 숫자를 아래의 해당 필드에 복사하십시오.',
  },
  RC_findModelLinux: {
    "en-US":
    ...
    ko: "이 모델은 다른 Linux 시스템에서 다른 방식으로 발견됩니다. 하나는 파일을 보는 것입니다\n/SYS/장치/가상/DMI/ID/Product_Name\n모델 이름과 숫자를 아래의 해당 필드에 복사하십시오.",
  },
  RC_findModelMacOs: {
    "en-US":
      "While pressing the Option key, go to the Apple menu 🍏>System Information.  From the Hardware Overview, copy the Model Name and Model Identifier to the corresponding fields below.",
    de: "Gehen Sie beim Drücken der Optionstaste zum Apple -Menü 🍏> Systeminformationen. Kopieren Sie den Modellnamen und die Modellkennung in den entsprechenden Feldern unten aus der Hardware -Übersicht.",
    fr: "En appuyant sur la touche d'option, accédez au menu Apple 🍏> Informations système. À partir de la vue d'ensemble du matériel, copiez le nom du modèle et l'identifiant du modèle aux champs correspondants ci-dessous.",
    es: "Mientras presiona la tecla Opción, vaya al menú Apple 🍏> Información del sistema. Desde la descripción general del hardware, copie el nombre del modelo y el identificador del modelo a los campos correspondientes a continuación.",
    pt: "Ao pressionar a tecla Opção, vá para o menu Apple 🍏> Informações do sistema. A partir da visão geral do hardware, copie o nome do modelo e o identificador do modelo para os campos correspondentes abaixo.",
    it: "Durante la pressione del tasto Opzione, vai al menu Apple 🍏> Informazioni di sistema. Dalla panoramica dell'hardware, copiare il nome del modello e l'identificatore del modello nei campi corrispondenti di seguito.",
    ro: "În timp ce apăsați tasta de opțiune, accesați meniul Apple 🍏> Informații despre sistem. Din prezentarea generală a hardware -ului, copiați numele modelului și identificatorul modelului pe câmpurile corespunzătoare de mai jos.",
    pl: "Podczas nacisku klawisza opcji przejdź do menu Apple 🍏> Informacje o systemie. Z przeglądu sprzętu skopiuj nazwę modelu i identyfikator modelu do odpowiednich pól poniżej.",
    ru: "Нажав клавишу опции, перейдите в меню Apple 🍏> Информация о системе. Из обзора оборудования скопируйте имя модели и идентификатор модели в соответствующие поля ниже.",
    hy: "Ընտրանքների ստեղնը սեղմելիս գնացեք Apple Menu 🍏> Համակարգի տեղեկատվություն: Ապարատային ակնարկից պատճենեք մոդելի անունը եւ մոդելի նույնականիչը ստորեւ նշված համապատասխան դաշտերի:",
    fi: "Kun painat vaihtoehto -näppäintä, siirry Apple -valikkoon 🍏> Järjestelmätiedot. Kopioi laitteistokatsauksesta mallin nimi ja mallin tunniste vastaaviin kenttiin alla oleviin kenttiin.",
    ka: "ვარიანტის ღილაკზე დაჭერისას გადადით Apple მენიუში 🍏> სისტემის ინფორმაცია. ტექნიკის მიმოხილვიდან დააკოპირეთ მოდელის სახელი და მოდელის იდენტიფიკატორი ქვემოთ მოცემულ შესაბამის ველებზე.",
    he: "תוך כדי לחיצה על מקש האפשרות, עבור לתפריט Apple 🍏> מידע על מערכת. מתוך סקירה כללית של החומרה, העתק את שם הדגם ואת מזהה הדגם לשדות המתאימים להלן.",
    ar: "أثناء الضغط على مفتاح الخيار ، انتقل إلى قائمة معلومات Apple 🍏>. من نظرة عامة على الأجهزة ، انسخ اسم النموذج ومعرف الطراز إلى الحقول المقابلة أدناه.",
    ur: "آپشن کلید کو دبانے کے دوران ، ایپل مینو 🍏> سسٹم کی معلومات پر جائیں۔ ہارڈ ویئر کے جائزہ سے ، ماڈل نام اور ماڈل شناخت کنندہ کو نیچے دیئے گئے فیلڈز میں کاپی کریں۔",
    hi: "विकल्प कुंजी दबाते समय, Apple मेनू 🍏> सिस्टम जानकारी पर जाएं। हार्डवेयर अवलोकन से, मॉडल नाम और मॉडल पहचानकर्ता को नीचे दिए गए संबंधित फ़ील्ड में कॉपी करें।",
    ta: "விருப்ப விசையை அழுத்தும்போது, ​​ஆப்பிள் மெனு 🍏> கணினி தகவலுக்குச் செல்லவும். வன்பொருள் கண்ணோட்டத்தில், மாதிரி பெயர் மற்றும் மாதிரி அடையாளங்காட்டியை கீழே உள்ள தொடர்புடைய புலங்களுக்கு நகலெடுக்கவும்.",
    ml: "ഓപ്ഷൻ കീ അമർത്തുമ്പോൾ, ആപ്പിൾ മെനുവിലേക്ക് പോകുക 🍏> സിസ്റ്റം വിവരങ്ങൾ. ഹാർഡ്വെയർ അവലോകനത്തിൽ നിന്ന്, ചുവടെയുള്ള അനുബന്ധ ഫീൽഡുകളിലേക്ക് മോഡൽ പേരും മോഡൽ ഐഡന്റിഫയർ പകർത്തുക.",
    te: "ఆప్షన్ కీని నొక్కేటప్పుడు, ఆపిల్ మెను 🍏> సిస్టమ్ సమాచారానికి వెళ్లండి. హార్డ్‌వేర్ అవలోకనం నుండి, మోడల్ పేరు మరియు మోడల్ ఐడెంటిఫైయర్‌ను దిగువ సంబంధిత ఫీల్డ్‌లకు కాపీ చేయండి.",
    kn: "ಆಯ್ಕೆಯ ಕೀಲಿಯನ್ನು ಒತ್ತುವಾಗ, ಆಪಲ್ ಮೆನು 🍏> ಸಿಸ್ಟಮ್ ಮಾಹಿತಿಗೆ ಹೋಗಿ. ಹಾರ್ಡ್‌ವೇರ್ ಅವಲೋಕನದಿಂದ, ಮಾದರಿ ಹೆಸರು ಮತ್ತು ಮಾದರಿ ಗುರುತಿಸುವಿಕೆಯನ್ನು ಕೆಳಗಿನ ಅನುಗುಣವಾದ ಕ್ಷೇತ್ರಗಳಿಗೆ ನಕಲಿಸಿ.",
    bn: "বিকল্প কী টিপানোর সময়, অ্যাপল মেনুতে যান 🍏> সিস্টেমের তথ্য। হার্ডওয়্যার ওভারভিউ থেকে, নীচের সংশ্লিষ্ট ক্ষেত্রগুলিতে মডেলের নাম এবং মডেল সনাক্তকারীকে অনুলিপি করুন।",
    id: "Saat menekan tombol opsi, buka Informasi Menu Apple 🍏> Sistem. Dari ikhtisar perangkat keras, salin nama model dan pengidentifikasi model ke bidang yang sesuai di bawah ini.",
    "zh-CN":
      "在按选项键时，请转到Apple菜单🍏>系统信息。从硬件概述中，将模型名称和模型标识符复制到下面的相应字段。",
    "zh-HK":
      "在按選項鍵時，請轉到Apple菜單🍏>系統信息。從硬件概述中，將模型名稱和模型標識符複製到下面的相應字段。",
    ja: "オプションキーを押しながら、Appleメニュー>システム情報に移動します。ハードウェアの概要から、モデル名とモデル識別子を以下の対応するフィールドにコピーします。",
    ko: "옵션 키를 누르면 Apple 메뉴 🍏> 시스템 정보로 이동하십시오. 하드웨어 개요에서 모델 이름과 모델 식별자를 아래의 해당 필드에 복사하십시오.",
  },
  RC_findModelWindows: {
    "en-US":
  ...
  RC_modelNumberMacOS: {
    ...
    ka: "მოდელის იდენტიფიკატორი",
    he: "מזהה מודל",
    ar: "المعرف النموذج",
    ur: "ماڈل شناخت کنندہ",
    hi: "मॉडल पहचानकर्ता",
    ta: "மாதிரி அடையாளங்காட்டி",
    ml: "മോഡൽ ഐഡന്റിഫയർ",
    te: "మోడల్ ఐడెంటిఫైయర్",
    kn: "ಮಾದರಿ ಗುರುತಿಸುವಿಕೆ",
    bn: "মডেল শনাক্তকারী",
    id: "Pengidentifikasi Model",
    "zh-CN": "模型标识符",
    "zh-HK": "模型標識符",
    ja: "モデル識別子",
    ko: "모델 식별자",
  ...
  RC_modelNumber: {
    "en-US": "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    de: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    fr: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    es: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    pt: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    it: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ro: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    pl: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ru: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    hy: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    fi: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ka: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    he: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ar: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ur: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    hi: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ta: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ml: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    te: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    kn: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    bn: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    id: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    "zh-CN": "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    "zh-HK": "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ja: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
    ko: "❌ RC_modelNumber is obsolere. Use the OS-specific version.",
  },
  RC_modelName: {
    "en-US": "Model name",
    de: "Modellname",
  ...
  RC_needModelNumberAndName: {
    ...
    pt: "Precisamos do número do modelo e do nome deste xxx aaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
  ...
  RC_allowMicrophoneUse: {
    ...
    de: 'Wenn ein Pop -up um Erlaubnis zur Verwendung des Mikrofons aufgefordert wird, klicken Sie auf "Zulassung".',
    fr: 'Si une fenêtre contextuelle demande la permission d\'utiliser le microphone, cliquez sur "Autoriser".',
    es: 'Si una ventana emergente solicita permiso para usar el micrófono, haga clic en "Permitir".',
    pt: 'Se um pop -up solicitar permissão para usar o microfone, clique em "Permitir".',
    it: 'Se un pop up chiede il permesso di utilizzare il microfono, fare clic su "Consenti".',
    ro: "Dacă un pop -up solicită permisiunea de a utiliza microfonul, faceți clic pe „Permite”.",
    pl: "Jeśli wyskakowanie poprosi o pozwolenie na użycie mikrofonu, kliknij „Zezwalaj”.",
    ru: "Если всплывающее окно просит разрешение использовать микрофон, нажмите «Разрешить».",
    hy: "Եթե ​​փոփը խնդրում է թույլտվություն օգտագործել խոսափողը, կտտացրեք «Թույլ տվեք»:",
    fi: 'Jos ponnahdusikkuna pyytää lupaa käyttää mikrofonia, napsauta "Salli".',
    ka: 'თუ pop up ითხოვს მიკროფონის გამოყენების ნებართვას, დააჭირეთ ღილაკს "ნება".',
    he: 'אם פופ -אפ מבקש אישור להשתמש במיקרופון, לחץ על "אפשר".',
    ar: 'إذا طلب منبثق عن الإذن لاستخدام الميكروفون ، فانقر فوق "السماح".',
    ur: 'اگر کوئی پاپ اپ مائکروفون کو استعمال کرنے کی اجازت طلب کرتا ہے تو ، "اجازت دیں" پر کلک کریں۔',
    hi: 'यदि एक पॉप अप माइक्रोफोन का उपयोग करने की अनुमति मांगता है, तो "अनुमति" पर क्लिक करें।',
    ta: 'மைக்ரோஃபோனைப் பயன்படுத்த ஒரு பாப் அப் அனுமதி கேட்டால், "அனுமதி" என்பதைக் கிளிக் செய்க.',
    ml: 'ഒരു പോപ്പ് അപ്പ് മൈക്രോഫോൺ ഉപയോഗിക്കാൻ അനുമതി ആവശ്യപ്പെടുകയാണെങ്കിൽ, "അനുവദിക്കുക" ക്ലിക്കുചെയ്യുക.',
    te: 'పాప్ అప్ మైక్రోఫోన్‌ను ఉపయోగించడానికి అనుమతి అడిగితే, "అనుమతించు" క్లిక్ చేయండి.',
    kn: 'ಮೈಕ್ರೊಫೋನ್ ಬಳಸಲು ಪಾಪ್ ಅಪ್ ಅನುಮತಿ ಕೇಳಿದರೆ, "ಅನುಮತಿಸಿ" ಕ್ಲಿಕ್ ಮಾಡಿ.',
    bn: 'যদি কোনও পপ আপ মাইক্রোফোনটি ব্যবহারের অনুমতি চায় তবে "অনুমতি দিন" ক্লিক করুন।',
    id: 'Jika pop up meminta izin untuk menggunakan mikrofon, klik "Izinkan".',
    "zh-CN": "如果弹出窗口要求使用麦克风许可，请单击“允许”。",
    "zh-HK": "如果彈出窗口要求使用麥克風許可，請單擊“允許”。",
    ja: "ポップアップがマイクを使用する許可を求めた場合は、「許可」をクリックします。",
    ko: '팝업이 마이크 사용 권한을 요청하면 "허용"을 클릭하십시오.',
  },
  ...
  RC_distanceTrackingCloseL: {
    ...
    ru: "1. Закройте левый глаз. (Это левая сторона экрана.)\n2. Используйте ▶ Ключ стрелка, чтобы сдвинуть мерцающую точку. (Или просто перетащите его, если он не отвечает на ключ стрелки.), Глядя на кросс -волоски, следите за мерцающей точкой в ​​углу глаза и скользите влево и вправо, пока он не исчезнет в вашем слепой точке.\n3. Нажмите на возврат.\nПримечание: следите за кросс -волосами. Мерцающая точка не исчезнет, ​​пока ваш глаз следует за ней.",
  ...
  RC_distanceTrackingIntroStart: {
    ...
    ka: "❌ RC_distanceTrackingIntroStart is obsolete.",
    ...
    ta: "❌ RC_distanceTrackingIntroStart is obsolete.",
    ml: "❌ RC_distanceTrackingIntroStart is obsolete.",
    te: "❌ RC_distanceTrackingIntroStart is obsolete.",
    kn: "❌ RC_distanceTrackingIntroStart is obsolete.",
    bn: "❌ RC_distanceTrackingIntroStart is obsolete.",
  ...
  RC_distanceTrackingWhenFar: {
    ...
    ro: "Dincolo de 111 cm, este mai greu să ajungi la tastatura computerului, așa că nu ezitați să utilizați tastatura pe smartphone -ul dvs. în schimb.",
    ...
    ka: "111 სმ -ის მიღმა, უფრო რთულია თქვენი კომპიუტერის კლავიატურას მისასვლელად, ასე რომ მოგერიდებათ გამოიყენოთ კლავიატურა თქვენს სმარტფონზე.",
    he: 'מעבר ל -111 ס"מ, קשה יותר להגיע למקלדת של המחשב שלך, אז אל תהסס להשתמש בלוח המקשים בסמארטפון שלך במקום.',
    ar: "بعد 111 سم ، من الصعب الوصول إلى لوحة مفاتيح جهاز الكمبيوتر الخاص بك ، لذلك لا تتردد في استخدام لوحة المفاتيح على هاتفك الذكي بدلاً من ذلك.",
    ...
    ta: "111 செ.மீ தாண்டி, உங்கள் கணினியின் விசைப்பலகையை அடைவது கடினம், எனவே அதற்கு பதிலாக உங்கள் ஸ்மார்ட்போனில் விசைப்பலகையைப் பயன்படுத்தலாம்.",
    ...
    te: "111 సెం.మీ దాటి, మీ కంప్యూటర్ కీబోర్డ్‌ను చేరుకోవడం చాలా కష్టం, కాబట్టి బదులుగా మీ స్మార్ట్‌ఫోన్‌లో కీప్యాడ్‌ను ఉపయోగించడానికి సంకోచించకండి.",
    ...
    bn: "111 সেমি ছাড়িয়ে আপনার কম্পিউটারের কীবোর্ডে পৌঁছানো আরও শক্ত, তাই পরিবর্তে আপনার স্মার্টফোনে কীপ্যাড ব্যবহার করতে নির্দ্বিধায়।",
  ...
  RC_howLongToCalibrate: {
    ...
    fr: "L'étalonnage prend environ 111 minutes (s).",
    es: "La calibración toma aproximadamente 111 minutos.",
    ...
    pl: "Kalibracja zajmuje około 111 minut (-ów).",
    ru: "Калибровка занимает около 111 минуты.",
    ...
    ur: "انشانکن میں تقریبا 111 منٹ (منٹ) لگتے ہیں۔",
    hi: "अंशांकन में लगभग 111 मिनट लगते हैं।",
    ta: "அளவுத்திருத்தத்திற்கு சுமார் 111 நிமிடம் (கள்) ஆகும்.",
    ml: "കാലിബ്രേഷൻ ഏകദേശം 111 മിനിറ്റ് (കൾ) എടുക്കും.",
    te: "అమరిక 111 నిమిషాలు (లు) పడుతుంది.",
    kn: "ಮಾಪನಾಂಕ ನಿರ್ಣಯವು ಸುಮಾರು 111 ನಿಮಿಷ (ಗಳನ್ನು) ತೆಗೆದುಕೊಳ್ಳುತ್ತದೆ.",
  ...
  RC_identifyMicrophone: {
    ...
    "zh-CN":
      "1.在下面的框中，键入智能手机或USB麦克风的制造和型号，例如iPhone 12 Pro。\n",
    "zh-HK":
  ...
  RC_needPortraitOrientation: {
    ...
    fi: "Kierrä tätä puhelinta muotokuvan suuntautumiseen.",
  ...
  RC_panelIntroNext: {
    ...
    de: "❌ RC_panelIntroNext is obsolete.",
    fr: "❌ RC_panelIntroNext is obsolete.",
    es: "❌ RC_panelIntroNext is obsolete.",
    pt: "❌ RC_panelIntroNext is obsolete.",
    it: "❌ RC_panelIntroNext is obsolete.",
    ro: "❌ RC_panelIntroNext is obsolete.",
    pl: "❌ RC_panelIntroNext is obsolete.",
    ru: "❌ RC_panelIntroNext is obsolete.",
    hy: "❌ RC_panelIntroNext is obsolete.",
    fi: "❌ RC_panelIntroNext is obsolete.",
    ka: "❌ RC_panelIntroNext is obsolete.",
    he: "❌ RC_panelIntroNext is obsolete.",
    ar: "❌ RC_panelIntroNext is obsolete.",
    ur: "❌ RC_panelIntroNext is obsolete.",
    hi: "❌ RC_panelIntroNext is obsolete.",
    ta: "❌ RC_panelIntroNext is obsolete.",
    ml: "❌ RC_panelIntroNext is obsolete.",
    te: "❌ RC_panelIntroNext is obsolete.",
    kn: "❌ RC_panelIntroNext is obsolete.",
    bn: "❌ RC_panelIntroNext is obsolete.",
    id: "❌ RC_panelIntroNext is obsolete.",
    "zh-CN": "❌ RC_panelIntroNext is obsolete.",
    "zh-HK": "❌ RC_panelIntroNext is obsolete.",
    ja: "❌ RC_panelIntroNext is obsolete.",
    ko: "❌ RC_panelIntroNext is obsolete.",
  },
  RC_panelTitle: {
  ...
  RC_privacyIphoneMicrophone: {
    "en-US":
      "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    de: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    fr: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    es: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    pt: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    it: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ro: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    pl: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ru: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    hy: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    fi: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ka: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    he: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ar: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ur: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    hi: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ta: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ml: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    te: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    kn: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    bn: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    id: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    "zh-CN":
      "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    "zh-HK":
      "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ja: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
    ko: "❌ RC_privacyIphoneMicrophone is obsolete. Use RC_privacyMicrophoneCalibration instead.",
  },
  ...
  RC_requestCamera: {
    ...
    fi: "Jatkamaan tämä tutkimus tarvitsee luvan kameran käyttöä varten.",
  ...
  RC_sound1000HzRecordingLevels: {
    ...
    fr: "Enregistrement le plus fort de 1000 Hz: 111 dB avec 222 valeurs uniques.",
    es: "Grabación más fuerte de 1000 Hz: 111 dB con 222 valores únicos.",
    pt: "Gravação mais alta de 1000-Hz: 111 dB com 222 valores únicos.",
    it: "Registrazione più forte da 1000 Hz: 111 dB con 222 valori unici.",
    ro: "Cea mai puternică înregistrare de 1000 Hz: 111 dB cu 222 valori unice.",
    pl: "Głośne nagrywanie 1000 Hz: 111 dB z 222 unikalnymi wartościami.",
    ru: "Самая громкая запись 1000 Гц: 111 дБ с 222 уникальными значениями.",
    hy: "Բարձրագույն 1000-Հց ձայնագրում. 111 դԲ 222 եզակի արժեքներով:",
    fi: "Äänekäs 1000 Hz: n tallennus: 111 dB 222 ainutlaatuisella arvolla.",
    ka: "ყველაზე ხმამაღალი 1000-ჰც ჩაწერა: 111 დბ 222 უნიკალური მნიშვნელობით.",
    he: "הקלטה בקול רם של 1000 הרץ: 111 dB עם 222 ערכים ייחודיים.",
    ar: "أعلى تسجيل 1000 هرتز: 111 ديسيبل مع 222 قيم فريدة.",
    ur: "بلند ترین 1000-ہرٹز ریکارڈنگ: 111 ڈی بی 222 منفرد اقدار کے ساتھ۔",
    hi: "सबसे जोर से 1000-हर्ट्ज रिकॉर्डिंग: 222 अद्वितीय मूल्यों के साथ 111 डीबी।",
    ta: "சத்தமாக 1000-ஹெர்ட்ஸ் பதிவு: 222 தனித்துவமான மதிப்புகளுடன் 111 டி.பி.",
    ml: "ഉച്ചത്തിലുള്ള 1000-HZ റെക്കോർഡിംഗ്: 222 സവിശേഷ മൂല്യങ്ങളുള്ള 111 ഡിബി.",
    te: "బిగ్గరగా 1000-Hz రికార్డింగ్: 222 ప్రత్యేక విలువలతో 111 dB.",
    kn: "ಜೋರಾಗಿ 1000-Hz ರೆಕಾರ್ಡಿಂಗ್: 222 ಅನನ್ಯ ಮೌಲ್ಯಗಳೊಂದಿಗೆ 111 ಡಿಬಿ.",
    bn: "জোরে 1000-হার্জ রেকর্ডিং: 222 অনন্য মান সহ 111 ডিবি।",
    id: "Rekaman 1000-Hz paling keras: 111 dB dengan 222 nilai unik.",
    "zh-CN": "最大的1000 Hz记录：111 dB，具有222个唯一值。",
    "zh-HK": "最大的1000 Hz記錄：111 dB，具有222個唯一值。",
    ja: "最も大音量の1000 Hz録音：222の一意の値で111 dB。",
    ko: "가장 큰 1000Hz 녹음 : 222 개의 고유 한 값을 가진 111dB.",
  },
  RC_soundAllHzRecordingLevels: {
    "en-US": "All-Hz recording: 111 dB with 222 unique values.",
    de: "All-Hz-Aufnahme: 111 dB mit 222 eindeutigen Werten.",
    fr: "Enregistrement All-Hz: 111 dB avec 222 valeurs uniques.",
    es: "Grabación All-Hz: 111 dB con 222 valores únicos.",
    pt: "Gravação All-Hz: 111 dB com 222 valores únicos.",
    it: "Registrazione All-Hz: 111 dB con 222 valori unici.",
    ro: "Înregistrare All-HZ: 111 dB cu 222 valori unice.",
    pl: "Nagrywanie All-HZ: 111 dB z 222 unikalnymi wartościami.",
    ru: "All-HZ Запись: 111 дБ с 222 уникальными значениями.",
    hy: "Համընդհանուր ձայնագրում. 111 դԲ 222 եզակի արժեքներով:",
    fi: "All-Hz-tallennus: 111 dB 222 ainutlaatuisella arvolla.",
    ka: "All-HZ ჩაწერა: 111 დბ 222 უნიკალური მნიშვნელობით.",
    he: "הקלטת כל הרץ: 111 dB עם 222 ערכים ייחודיים.",
    ar: "تسجيل All-Hz: 111 ديسيبل مع 222 قيم فريدة.",
    ur: "ALL-HZ ریکارڈنگ: 111 DB 222 منفرد اقدار کے ساتھ۔",
    hi: "ऑल-एचजेड रिकॉर्डिंग: 222 अद्वितीय मूल्यों के साथ 111 डीबी।",
    ta: "ஆல்-ஹெர்ட்ஸ் பதிவு: 222 தனித்துவமான மதிப்புகளுடன் 111 டி.பி.",
    ml: "ഓൾ-ഹെസ് റെക്കോർഡിംഗ്: 222 സവിശേഷ മൂല്യങ്ങളുള്ള 111 ഡി.ബി.",
    te: "ఆల్-హెచ్జెడ్ రికార్డింగ్: 222 ప్రత్యేక విలువలతో 111 డిబి.",
    kn: "ಆಲ್-ಎಚ್‌ Z ಡ್ ರೆಕಾರ್ಡಿಂಗ್: 222 ಅನನ್ಯ ಮೌಲ್ಯಗಳೊಂದಿಗೆ 111 ಡಿಬಿ.",
    bn: "অল-হার্জ রেকর্ডিং: 222 অনন্য মান সহ 111 ডিবি।",
    id: "All-Hz Recording: 111 dB dengan 222 nilai unik.",
    "zh-CN": "全Hz记录：111 dB，具有222个唯一值。",
    "zh-HK": "全Hz記錄：111 dB，具有222個唯一值。",
    ja: "全HZ録音：222の一意の値で111 dB。",
    ko: "All-HZ 녹음 : 222 개의 고유 한 값을 가진 111 dB.",
  },
  RC_soundAllHzDetails: {
    ...
    ka: "სიხშირეზე რეაგირება დაკომპლექტებულია 111 გამეორებით (222 თბილობის შემდეგ) 333 SEC- ის ადიდებული, რომელიც შერჩეულია 444 ჰც -ზე.",
    he: "תגובת תדר מכויל עם 111 חזרות (לאחר 222 חימום) של פרץ של 333 שניות, שנדגמו במהירות 444 הרץ.",
    ...
    ta: "333 நொடி வெடிப்பின் 111 மறுபடியும் (222 வெப்பமயமாதல்களுக்குப் பிறகு) அளவீடு செய்யப்பட்ட அதிர்வெண் பதில், 444 ஹெர்ட்ஸில் மாதிரி எடுக்கப்பட்டது.",
    ...
    te: "ఫ్రీక్వెన్సీ ప్రతిస్పందన 333 సెకన్ల పేలుడు యొక్క 111 రిపీట్స్‌తో (222 వార్మప్‌ల తరువాత) క్రమాంకనం చేయబడింది, ఇది 444 Hz వద్ద నమూనా చేయబడింది.",
    ...
    bn: "ফ্রিকোয়েন্সি প্রতিক্রিয়াটি 333 সেকেন্ড ফেটে 111 পুনরাবৃত্তি (222 ওয়ার্মআপের পরে) দিয়ে ক্যালিব্রেটেড, 444 হার্জেডে নমুনাযুক্ত।",
  ...
  RC_noSounds: {
    ...
    de: "Das Experiment lieferte keinen TargetSoundSoundFolder, so dass es keine Geräusche zu spielen gibt.",
    ...
    ur: "اس تجربے نے ٹارگٹ ساؤنڈ فولڈر فراہم نہیں کیا ، لہذا کھیلنے کی کوئی آواز نہیں ہے۔",
  ...
  RC_citeSoundCompressionModel: {
    ...
    "zh-CN":
      '基于等式。 Giannoulis等人4。 （2012）。 <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicrangecompression-jaes2012.pdf">数字动态动态范围压缩机设计。 Soc。 6（6）：399-408。',
    "zh-HK":
  ...
  RC_usingSmartPhoneMicrophone: {
    "en-US": "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    de: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    fr: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    es: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    pt: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    it: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ro: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    pl: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ru: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    hy: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    fi: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ka: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    he: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ar: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ur: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    hi: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ta: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ml: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    te: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    kn: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    bn: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    id: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    "zh-CN": "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    "zh-HK": "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ja: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
    ko: "❌ RC_usingSmartPhoneMicrophone is obsolete.",
  },
  RC_turnMeToReadBelow: {
    "en-US":
      "Put this phone on the folded cloth. Rotate me to read the instructions below.",
  ...
  RC_placeSmartphoneMicrophone: {
    ...
    fr: "Reposant votre téléphone sur le tissu plié, pointez ce bord de téléphone sur votre ordinateur, le poussant un peu devant le bord du tissu plié. La presse continue.",
    ...
    he: "הנח את הטלפון שלך על הבד המקופל, הצביע על קצה הטלפון הזה במחשב שלך, דוחף אותו מעט מעבר לקצה הבד המקופל. לחץ על המשך.",
    ...
    ta: "உங்கள் தொலைபேசியை மடிந்த துணியில் ஓய்வெடுத்தால், இந்த ⇧ தொலைபேசி விளிம்பை உங்கள் கணினியில் சுட்டிக்காட்டி, மடிந்த துணியின் விளிம்பைக் கடந்து அதைத் தள்ளுங்கள். தொடரவும்.",
    ...
    te: "మడతపెట్టిన వస్త్రంపై మీ ఫోన్‌ను విశ్రాంతి తీసుకొని, మీ కంప్యూటర్ వద్ద ఈ ఫోన్ అంచుని సూచించండి, మడతపెట్టిన వస్త్రం అంచున కొంచెం నెట్టండి. నొక్కండి.",
    kn: "ನಿಮ್ಮ ಫೋನ್ ಅನ್ನು ಮಡಿಸಿದ ಬಟ್ಟೆಯ ಮೇಲೆ ವಿಶ್ರಾಂತಿ ಮಾಡಿ, ಈ ⇧ ಫೋನ್ ಅಂಚನ್ನು ನಿಮ್ಮ ಕಂಪ್ಯೂಟರ್‌ನಲ್ಲಿ ಸೂಚಿಸಿ, ಅದನ್ನು ಮಡಿಸಿದ ಬಟ್ಟೆಯ ಅಂಚಿನ ಹಿಂದೆ ಸ್ವಲ್ಪ ತಳ್ಳುತ್ತದೆ. ಮುಂದುವರಿಯಿರಿ.",
    ...
    "zh-CN":
      "将手机放在折叠的布上，将此⇧手机边缘指向您的计算机，将其推到折叠布的边缘。按继续。",
    "zh-HK":
      "將手機放在折疊的布上，將此⇧手機邊緣指向您的計算機，將其推到折疊布的邊緣。按繼續。",
  ...
  RC_soundCalibrationHoldIPhoneOk: {
    ...
    de: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    fr: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    es: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    pt: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    it: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ro: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    pl: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ru: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    hy: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    fi: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ka: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    he: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ar: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ur: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    hi: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ta: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ml: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    te: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    kn: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    bn: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    id: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    "zh-CN": "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    "zh-HK": "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ja: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
    ko: "❌ RC_soundCalibrationHoldIPhoneOk is obsolete.\n",
  },
  RC_soundCalibrationNeedsMicrophone: {
    ...
    ka: "ზუსტი ხმის შესაქმნელად, ჩვენ უნდა დავასახელოთ დინამიკები. ეს მოითხოვს სმარტფონს, რომელიც დაკავშირებულია ინტერნეტთან (ან USB მიკროფონი). ერთი მოსახერხებელი გაქვს?\n",
  ...
  RC_soundCalibrationNeedsIPhone: {
    "en-US":
      "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    de: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    fr: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    es: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    pt: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    it: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ro: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    pl: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ru: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    hy: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    fi: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ka: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    he: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ar: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ur: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    hi: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ta: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ml: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    te: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    kn: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    bn: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    id: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    "zh-CN":
      "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    "zh-HK":
      "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ja: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
    ko: "❌ RC_soundCalibrationNeedsIPhone is obsolete. Use RC_soundCalibrationNeedsMicrophone instead.",
  },
  ...
  RC_soundCalibrationRedo: {
    ...
    ta: "ஐயோ, 111 டி.பியின் ஆர்.எம்.எஸ் பொருத்துதல் பிழை 222 டிபி சகிப்புத்தன்மையை மீறுகிறது, எனவே ஒலிபெருக்கியை மீண்டும் அளவீடு செய்ய வேண்டும்.",
  ...
  RC_soundCalibrationTitle: {
    "en-US":
      "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    de: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    fr: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    es: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    pt: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    it: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ro: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    pl: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ru: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    hy: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    fi: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ka: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    he: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ar: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ur: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    hi: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ta: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ml: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    te: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    kn: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    bn: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    id: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    "zh-CN":
      "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    "zh-HK":
      "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ja: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
    ko: "❌ RC_soundCalibrationTitle is obsolete. Use  RC_soundCalibrationTitle1000Hz\nand RC_soundCalibrationTitleAllHz instead.",
  },
  ...
  RC_backToExperimentWindow: {
    ...
    de: 'Der Fortschritt wird im Hauptfenster des Hauptversuchs angezeigt. Bitte gehen Sie jetzt dorthin, indem Sie oben auf die Registerkarte "Easyeyes Experiment" (oder links im Bowser) klicken.',
    ...
    es: 'El progreso se muestra en la ventana del experimento principal. Vaya allí ahora, haciendo clic en la pestaña "Experimento EasyEyes" arriba (o a la izquierda en el navegador ARC).',
    pt: 'O progresso é exibido na janela principal do experimento. Por favor, vá para lá agora, clicando na guia "Easyeyes Experiment" acima (ou à esquerda no navegador ARC).',
    it: 'I progressi vengono visualizzati nella finestra dell\'esperimento principale. Vai lì ora, facendo clic sulla scheda "EasyEyes Experiment" sopra (o a sinistra in browser ad arco).',
    ...
    ru: "Прогресс отображается в основном окне эксперимента. Пожалуйста, перейдите туда сейчас, нажав на вкладку «Easyeyes Experime» (или слева в браузере в дуге).",
    hy: "Առաջընթացը ցուցադրվում է հիմնական փորձի պատուհանում: Խնդրում ենք հիմա գնալ այնտեղ, կտտացնելով վերեւում գտնվող «EasyEyes Experiment» ներդիրին (կամ ձախը աղեղի զննարկիչում):",
    fi: 'Edistyminen näkyy pääkoe -ikkunassa. Mene sinne nyt napsauttamalla yllä olevaa "Easyeyes -kokeilu" -välilehteä (tai vasemmalle kaariselaimessa).',
    ka: 'პროგრესი ნაჩვენებია მთავარი ექსპერიმენტის ფანჯარაში. გთხოვთ, ახლავე წახვიდეთ იქ, დააჭირეთ ღილაკს "Easyeyes Experiment" ზემოთ (ან მარცხნივ რკალის ბრაუზერში).',
    ...
    ur: 'مرکزی تجربہ ونڈو میں پیشرفت ظاہر ہوتی ہے۔ براہ کرم اوپر "ایزیئس تجربہ" ٹیب پر کلک کرکے (یا آرک براؤزر میں بائیں طرف) پر ابھی وہاں جائیں۔',
    hi: 'प्रगति मुख्य प्रयोग विंडो में प्रदर्शित होती है। कृपया अब वहां जाएं, ऊपर "Easyeyes प्रयोग" टैब पर क्लिक करके (या ARC ब्राउज़र में बाईं ओर)।',
    ta: 'முக்கிய சோதனை சாளரத்தில் முன்னேற்றம் காட்டப்படும். மேலே உள்ள "எளிதான பரிசோதனை" தாவலைக் கிளிக் செய்வதன் மூலம் தயவுசெய்து இப்போது அங்கு செல்லுங்கள் (அல்லது வில் உலாவியில் இடதுபுறம்).',
    ml: 'പ്രധാന പരീക്ഷണ വിൻഡോയിൽ പുരോഗതി പ്രദർശിപ്പിക്കുന്നു. മുകളിലുള്ള "എളുപ്പത്തിലുള്ള പരീക്ഷണം" ടാബുകളിൽ (അല്ലെങ്കിൽ ARC ബ്രൗസറിൽ ഇടതുവശത്ത്) ക്ലിക്കുചെയ്ത് ഇപ്പോൾ അവിടെ പോകുക).',
    te: 'ప్రధాన ప్రయోగ విండోలో పురోగతి ప్రదర్శించబడుతుంది. పైన ఉన్న "ఈజీయెస్ ప్రయోగం" టాబ్‌ను క్లిక్ చేయడం ద్వారా (లేదా ఆర్క్ బ్రౌజర్‌లో ఎడమ వైపుకు) దయచేసి ఇప్పుడు అక్కడికి వెళ్లండి.',
  ...
  T_clickingWordRsvpReading: {
    ...
    de: "durch Klicken auf sie in einer Liste von Wörtern. Wählen Sie in jeder Spalte ein Wort aus.",
    fr: "en les cliquant dans une liste de mots. Sélectionnez un mot dans chaque colonne.",
    es: "haciendo clic en ellos en una lista de palabras. Seleccione una palabra en cada columna.",
    pt: "clicando neles em uma lista de palavras. Selecione uma palavra em cada coluna.",
    it: "Facendo clic su di loro in un elenco di parole. Seleziona una parola in ogni colonna.",
    ro: "făcând clic pe ele într -o listă de cuvinte. Selectați un cuvânt în fiecare coloană.",
    pl: "klikając je na liście słów. Wybierz jedno słowo w każdej kolumnie.",
    ru: "щелкнув их в списке слов. Выберите одно слово в каждом столбце.",
    hy: "Կտտացնելով դրանք բառերի ցանկում: Յուրաքանչյուր սյունակում ընտրեք մեկ բառ:",
    fi: "napsauttamalla niitä sanaluettelossa. Valitse yksi sana jokaisessa sarakkeessa.",
    ka: "მათი სიტყვების ჩამონათვალში დაჭერით. აირჩიეთ ერთი სიტყვა თითოეულ სვეტში.",
    he: "על ידי לחיצה עליהם ברשימת מילים. בחר מילה אחת בכל עמודה.",
    ar: "من خلال النقر عليها في قائمة الكلمات. حدد كلمة واحدة في كل عمود.",
    ur: "الفاظ کی فہرست میں ان پر کلک کرکے۔ ہر کالم میں ایک لفظ منتخب کریں۔",
    hi: "उन्हें शब्दों की सूची में क्लिक करके। प्रत्येक कॉलम में एक शब्द का चयन करें।",
    ta: "சொற்களின் பட்டியலில் அவற்றைக் கிளிக் செய்வதன் மூலம். ஒவ்வொரு நெடுவரிசையிலும் ஒரு வார்த்தையைத் தேர்ந்தெடுக்கவும்.",
    ml: "അവ വാക്കുകളുടെ പട്ടികയിൽ ക്ലിക്കുചെയ്യുന്നതിലൂടെ. ഓരോ നിരയിലും ഒരു വാക്ക് തിരഞ്ഞെടുക്കുക.",
    te: "వాటిని పదాల జాబితాలో క్లిక్ చేయడం ద్వారా. ప్రతి కాలమ్‌లో ఒక పదాన్ని ఎంచుకోండి.",
    kn: "ಅವುಗಳನ್ನು ಪದಗಳ ಪಟ್ಟಿಯಲ್ಲಿ ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ. ಪ್ರತಿ ಕಾಲಂನಲ್ಲಿ ಒಂದು ಪದವನ್ನು ಆಯ್ಕೆಮಾಡಿ.",
    bn: "শব্দের তালিকায় তাদের ক্লিক করে। প্রতিটি কলামে একটি শব্দ নির্বাচন করুন।",
    id: "dengan mengkliknya dalam daftar kata. Pilih satu kata di setiap kolom.",
    "zh-CN": "通过在单词列表中单击它们。在每列中选择一个单词。",
    "zh-HK": "通過在單詞列表中單擊它們。在每列中選擇一個單詞。",
    ja: "単語のリストでそれらをクリックします。各列で1つの単語を選択します。",
    ko: "단어 목록에서 클릭하여. 각 열에서 하나의 단어를 선택하십시오.",
  },
  ...
  T_continueKeypad: {
    ...
    de: "Um fortzufahren, drücken Sie die Rückkehr auf die Tastatur des Telefons.",
    fr: "Pour continuer, appuyez sur le retour sur le clavier du téléphone.",
    es: "Para continuar, presione el retorno del teclado del teléfono.",
    pt: "Para continuar, pressione o retorno no teclado do telefone.",
    it: "Per continuare, premi ritorno sulla tastiera del telefono.",
    ro: "Pentru a continua, apăsați Returnarea pe tastatura telefonului.",
    pl: "Aby kontynuować, naciśnij Wróć na klawiaturę telefonu.",
    ru: "Чтобы продолжить, нажмите «Возврат на клавиатуре телефона».",
    hy: "Շարունակելու համար հարվածել վերադառնալ հեռախոսի ստեղնաշարի վրա:",
    fi: "Jatkaksesi palautusta puhelinnäppäimistölle.",
    ka: "გასაგრძელებლად, დააჭირეთ დაბრუნებას ტელეფონის კლავიატურაზე.",
    he: "כדי להמשיך, לחץ על החזרה בלוח המקשים של הטלפון.",
    ar: "للمتابعة ، اضغط على العودة على لوحة مفاتيح الهاتف.",
    ur: "جاری رکھنے کے لئے ، فون کیپیڈ پر واپسی کو ہٹائیں۔",
    hi: "जारी रखने के लिए, फोन कीपैड पर हिट रिटर्न।",
    ta: "தொடர, தொலைபேசி விசைப்பலகையில் திரும்பவும்.",
    ml: "തുടരുന്നതിന്, ഫോണിലെ റിട്ടേൺ അമർത്തുക.",
    te: "కొనసాగించడానికి, ఫోన్ కీప్యాడ్‌లో రిటర్న్ నొక్కండి.",
    kn: "ಮುಂದುವರಿಸಲು, ಫೋನ್ ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ರಿಟರ್ನ್ ಒತ್ತಿರಿ.",
    bn: "চালিয়ে যেতে, ফোন কীপ্যাডে রিটার্ন হিট করুন।",
    id: "Untuk melanjutkan, tekan pengembalian ke keypad telepon.",
    "zh-CN": "为了继续，请点击电话键盘。",
    "zh-HK": "為了繼續，請點擊電話鍵盤。",
    ja: "続行するには、電話キーパッドのリターンを押します。",
    ko: "계속하려면 전화 키패드에서 반품을 누르십시오.",
  },
  T_continueHitReturnOrKeypad: {
    "en-US": "To continue, hit RETURN on the keyboard/keypad.",
    de: "Um fortzufahren, drücken Sie die Rückkehr auf die Tastatur/die Tastatur.",
    fr: "Pour continuer, appuyez sur Retour sur le clavier / clavier.",
    es: "Para continuar, presione el regreso en el teclado/teclado.",
    pt: "Para continuar, pressione o retorno no teclado/teclado.",
    it: "Per continuare, premi ritorno sulla tastiera/tastiera.",
    ro: "Pentru a continua, apăsați revenirea pe tastatură/tastatură.",
    pl: "Aby kontynuować, naciśnij powrót na klawiaturze/klawiaturze.",
    ru: "Чтобы продолжить, нажмите возврат на клавиатуре/клавиатуре.",
    hy: "Շարունակելու համար հարվածել ստեղնաշարի / ստեղնաշարի վերադարձը:",
    fi: "Jatka jatkaksesi palautusta näppäimistölle/näppäimistölle.",
    ka: "გასაგრძელებლად, დააჭირეთ დაბრუნებას კლავიატურაზე/კლავიატურაზე.",
    he: "כדי להמשיך, לחץ על החזרה על המקלדת/לוח המקשים.",
    ar: "للمتابعة ، اضغط على العودة على لوحة المفاتيح/لوحة المفاتيح.",
    ur: "جاری رکھنے کے لئے ، کی بورڈ/کیپیڈ پر ریٹرن کو دبائیں۔",
    hi: "जारी रखने के लिए, कीबोर्ड/कीपैड पर हिट रिटर्न।",
    ta: "தொடர, விசைப்பலகை/விசைப்பலகையில் வருவாயைத் தாக்கவும்.",
    ml: "തുടരുന്നതിന്, കീബോർഡ് / കീപാഡിൽ റിട്ടേൺ അമർത്തുക.",
    te: "కొనసాగించడానికి, కీబోర్డ్/కీప్యాడ్‌లో రిటర్న్ నొక్కండి.",
    kn: "ಮುಂದುವರಿಸಲು, ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ರಿಟರ್ನ್ ಒತ್ತಿರಿ.",
    bn: "চালিয়ে যেতে, কীবোর্ড/কীপ্যাডে রিটার্ন হিট করুন।",
    id: "Untuk melanjutkan, tekan kembali pada keyboard/keypad.",
    "zh-CN": "为了继续，请点击键盘/键盘上的返回。",
    "zh-HK": "為了繼續，請點擊鍵盤/鍵盤上的返回。",
    ja: "続行するには、キーボード/キーパッドのリターンを押します。",
    ko: "계속하려면 키보드/키패드에서 반품을 누르십시오.",
  },
  T_continueClickProceedOrKeypad: {
    "en-US": "To continue, click PROCEED or hit RETURN on the keyboard/keypad",
    de: "Um fortzufahren, klicken Sie auf fortfahren oder klicken Sie auf die Tastatur/die Tastatur zurück.",
    fr: "Pour continuer, cliquez sur Procéder ou appuyez sur Retour sur le clavier / clavier",
    es: "Para continuar, haga clic en continuar o presione la devolución en el teclado/teclado",
    pt: "Para continuar, clique em prosseguir ou acertar o retorno no teclado/teclado",
    it: "Per continuare, fare clic su procedi o premi restituzione sulla tastiera/tastiera",
    ro: "Pentru a continua, faceți clic pe continuați sau apăsați returnarea pe tastatură/tastatură",
    pl: "Aby kontynuować, kliknij, kontynuuj lub naciśnij Wróć na klawiaturze/klawiaturze",
    ru: "Чтобы продолжить, нажмите «Продолжить» или нажмите «Возврат» на клавиатуре/клавиатуре",
    hy: "Շարունակելու համար կտտացրեք Շարունակեք կամ հարվածեք ստեղնաշարի վրա / ստեղնաշարի վրա",
    fi: "Jatka jatka napsauttamalla tai napsauttamalla näppäimistöä/näppäimistöä",
    ka: "გასაგრძელებლად, დააჭირეთ ღილაკს გაგრძელება ან დააჭირეთ კლავიატურაზე/კლავიატურას",
    he: "להמשך, לחץ על המשך או לחץ על החזרה על המקלדת/לוח המקשים",
    ar: "للمتابعة ، انقر فوق متابعة أو ضرب الإرجاع على لوحة المفاتيح/لوحة المفاتيح",
    ur: "جاری رکھنے کے لئے ، آگے بڑھنے پر کلک کریں یا کی بورڈ/کیپیڈ پر ریٹرن کو دبائیں",
    hi: "जारी रखने के लिए, कीबोर्ड/कीपैड पर आगे बढ़ने या हिट रिटर्न पर क्लिक करें",
    ta: "தொடர, விசைப்பலகை/விசைப்பலகையில் திரும்புவதைத் தொடரவும் அல்லது அழுத்தவும்",
    ml: "തുടരുന്നതിന്, കീബോർഡ് / കീപാഡിൽ തുടരുക ക്ലിക്കുചെയ്യുക അല്ലെങ്കിൽ അമർത്തുക",
    te: "కొనసాగించడానికి, కీబోర్డ్/కీప్యాడ్‌లో కొనసాగండి లేదా రిటర్న్ నొక్కండి క్లిక్ చేయండి",
    kn: "ಮುಂದುವರಿಸಲು, ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಮುಂದುವರಿಯಿರಿ ಅಥವಾ ಹಿಟ್ ರಿಟರ್ನ್ ಕ್ಲಿಕ್ ಮಾಡಿ",
    bn: "চালিয়ে যেতে, কীবোর্ড/কীপ্যাডে রিটার্নটি এগিয়ে যান বা হিট ক্লিক করুন",
    id: "Untuk melanjutkan, klik lanjutkan atau tekan pengembalian pada keyboard/keypad",
    "zh-CN": "要继续，请单击继续或点击键盘/键盘上的返回",
    "zh-HK": "要繼續，請單擊繼續或點擊鍵盤/鍵盤上的返回",
    ja: "続行するには、クリックするか、キーボード/キーパッドの返品をクリックします",
    ko: "계속하려면 키보드/키패드에서 진행 또는 반환을 클릭하십시오.",
  },
  T_continueClickProceedOrHitReturnOrKeypad: {
    "en-US":
      "To continue, click PROCEED or hit RETURN on your keyboard or phone keypad.",
    de: "Um fortzufahren, klicken Sie auf Fortfahren oder klicken Sie auf Ihre Tastatur- oder Telefon -Tastatur zurück.",
    fr: "Pour continuer, cliquez sur Procéder ou appuyez sur Retour sur votre clavier ou votre clavier de téléphone.",
    es: "Para continuar, haga clic en continuar o presione la devolución en su teclado o teclado de teléfono.",
    pt: "Para continuar, clique em prosseguir ou pressionar o retorno no teclado ou no teclado.",
    it: "Per continuare, fare clic su Procedere o premere Restituisci sulla tastiera o sulla tastiera del telefono.",
    ro: "Pentru a continua, faceți clic pe Continuați sau apăsați returnarea pe tastatura tastaturii sau a telefonului.",
    pl: "Aby kontynuować, kliknij, kontynuuj lub naciśnij Zwróć na klawiaturę lub klawiaturę telefonu.",
    ru: "Чтобы продолжить, нажмите «Продолжить» или нажмите «Возврат» на клавиатуре или клавиатуре телефона.",
    hy: "Շարունակելու համար կտտացրեք Շարունակել կամ հարվածել ձեր ստեղնաշարի կամ հեռախոսի ստեղնաշարի վրա:",
    fi: "Jatka jatka napsauttamalla tai napsauttamalla näppäimistön tai puhelinnäppäimistön palauttamista.",
    ka: "გასაგრძელებლად, დააჭირეთ ღილაკს გაგრძელება ან დააჭირეთ თქვენს კლავიატურას ან ტელეფონის კლავიატურას.",
    he: "להמשך, לחץ על המשך או לחץ על החזר על המקלדת או לוח המקשים שלך.",
    ar: "للمتابعة ، انقر فوق متابعة أو اضغط على العودة على لوحة المفاتيح أو لوحة مفاتيح الهاتف.",
    ur: "جاری رکھنے کے لئے ، آگے بڑھنے پر کلک کریں یا اپنے کی بورڈ یا فون کیپیڈ پر ریٹرن کو دبائیں۔",
    hi: "जारी रखने के लिए, अपने कीबोर्ड या फोन कीपैड पर आगे बढ़ने या हिट रिटर्न पर क्लिक करें।",
    ta: "தொடர, உங்கள் விசைப்பலகை அல்லது தொலைபேசி விசைப்பலகையில் திரும்புவதைத் தொடரவும் அல்லது அழுத்தவும்.",
    ml: "തുടരാൻ, നിങ്ങളുടെ കീബോർഡിലോ ഫോൺ കീപാഡിലോ മുന്നോട്ട് മടങ്ങുക ക്ലിക്കുചെയ്യുക.",
    te: "కొనసాగించడానికి, మీ కీబోర్డ్ లేదా ఫోన్ కీప్యాడ్‌లో కొనసాగండి లేదా రిటర్న్ నొక్కండి.",
    kn: "ಮುಂದುವರಿಸಲು, ನಿಮ್ಮ ಕೀಬೋರ್ಡ್ ಅಥವಾ ಫೋನ್ ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಮುಂದುವರಿಯಿರಿ ಅಥವಾ ಹಿಟ್ ರಿಟರ್ನ್ ಕ್ಲಿಕ್ ಮಾಡಿ.",
    bn: "চালিয়ে যেতে, আপনার কীবোর্ড বা ফোন কীপ্যাডে এগিয়ে যাওয়া বা হিট হিট ক্লিক করুন।",
    id: "Untuk melanjutkan, klik lanjutkan atau tekan pengembalian ke keyboard atau keypad telepon Anda.",
    "zh-CN": "要继续，请单击“继续或点击键盘或电话键盘上的返回。",
    "zh-HK": "要繼續，請單擊“繼續或點擊鍵盤或電話鍵盤上的返回。",
    ja: "続行するには、キーボードまたは電話キーパッドの[続行]または[返される]をクリックします。",
    ko: "계속하려면 키보드 또는 전화 키패드에서 진행 또는 반환을 클릭하십시오.",
  },
  T_continueNeitherClickNorType: {
    "en-US":
      "Can't proceed because responseTypedBool and responseClickedBool are both FALSE.",
    de: "Ich kann nicht fortfahren, da ResponTypedBool und ResponsedoclickedBool beide falsch sind.",
    fr: "Je ne peux pas continuer parce que ResponseTypedBool et ResponseClickedBool sont tous deux faux.",
    es: "No puedo proceder porque ResponseTetypedbool y ResponseClickedBool son falsos.",
    pt: "Não é possível prosseguir porque o ResponsetypedBool e o responseClickedBool são falsos.",
    it: "Non posso procedere perché ResponseTypedBool e RomesClickedBool sono entrambi falsi.",
    ...
    hy: "Չի կարող ընթանալ, քանի որ պատասխանատուբուլը եւ պատասխանողներն են, երկուսն էլ կեղծ են:",
    fi: "Ei voi edetä, koska ResponseTypeDBool ja ResponseClickedBool ovat molemmat vääriä.",
    ka: "ვერ გაგრძელდება, რადგან რეაგირებადი ბოლი და საპასუხო დაწესებულება ცრუა.",
    he: "לא ניתן להמשיך מכיוון ש- ReplistyPedbool ו- RepactEclickedBool שניהם שקריים.",
    ...
    ml: "തുടരാൻ കഴിയില്ലെന്ന് പ്രതികരണീകരണവും റെസ്പോസ്ലിക്ക്ഡ്ബൂളും തെറ്റാണ്.",
    ...
    id: "Tidak dapat melanjutkan karena responsetypedbool dan responseClickedBool keduanya salah.",
    "zh-CN": "无法继续进行，因为响应型型和反应式的bool都是错误的。",
    "zh-HK": "無法繼續進行，因為響應型型和反應式的bool都是錯誤的。",
  ...
  T_guessingGame: {
    ...
    de: "Die Buchstabengröße und der Buchstaben variieren von groß und einfach bis zu winzig und hart. Sie können nicht viel mehr als zwei Drittel richtig bekommen, also entspannen Sie sich. Betrachten Sie es als ein Ratenspiel und holen Sie sich so viele wie möglich. Sie werden einen Piepton hören, wenn Sie Recht haben.",
    fr: "La taille de la lettre et l'espacement varient de grand et facile à minuscule et dur. Vous ne pouvez pas obtenir beaucoup plus des deux tiers à droite, alors détendez-vous. Considérez-le comme un jeu de supposition et obtenez-en autant que vous le pouvez. Vous entendrez un bip quand vous avez raison.",
    es: "El tamaño y el espacio de la letra varían desde grandes y fáciles hasta pequeños y duros. No puedes tener mucho más de dos tercios, así que relájate. Piense en ello como un juego de adivinanzas, y simplemente obtenga tantos como pueda. Escucharás un pitido siempre que tengas razón.",
    pt: "O tamanho da letra e o espaçamento variam de grande e fácil para baixo a minúsculo e duro. Você não pode acertar muito mais do que dois terços, então relaxe. Pense nisso como um jogo de adivinhação e obtenha o máximo possível. Você ouvirá um sinal sonoro sempre que estiver certo.",
    it: "Le dimensioni e lo spazio della lettera variano da grandi e facili a piccoli e duri. Non puoi avere molto più di due terzi, quindi rilassati. Pensaci come un gioco di indovinello e ottieni semplicemente il maggior numero possibile. Sentirai un segnale acustico ogni volta che hai ragione.",
    ro: "Mărimea și spațiul scrisorii variază de la mare și ușor la mic și greu. Nu poți avea mult mai mult de două treimi, așa că relaxează -te. Gândiți -vă la asta ca la un joc de ghicitoare și pur și simplu obțineți cât pot. Vei auzi un bip ori de câte ori ai dreptate.",
    ...
    fi: "Kirjeen koko ja etäisyys vaihtelevat suuresta ja helposta alas pieneen ja kovasti. Et voi saada paljon enemmän kuin kaksi kolmasosaa oikein, joten rentoudu. Ajattele sitä arvauspelinä ja saat vain niin monta kuin pystyt. Kuulet piippauksen aina kun olet oikeassa.",
    ka: "ასოების ზომა და ინტერვალი განსხვავდება დიდი და მარტივად, პატარა და მძიმე და მძიმე. თქვენ ვერ მიიღებთ ბევრად მეტს ორ მესამედზე, ასე რომ დაისვენეთ. იფიქრეთ, როგორც გამოცნობის თამაში, და უბრალოდ მიიღეთ რაც შეიძლება მეტი. თქვენ მოისმენთ beep, როდესაც მართალი ხართ.",
    he: "גודל המכתב והמרווח משתנים מגדול וקל למטה לזעיר וקשה. אתה לא יכול להשיג הרבה יותר משני שלישים נכון, אז תירגע. חשוב על זה כמשחק ניחוש, ופשוט קבל כמה שיותר. תשמע צפצוף בכל פעם שאתה צודק.",
    ar: "يختلف حجم الحرف وتباعده من كبير وسهلين إلى صغر وصعب. لا يمكنك الحصول على أكثر من ثلثي بشكل صحيح ، لذا استرخ. فكر في الأمر على أنه لعبة تخمين ، واحصل على أكبر عدد ممكن من الأشياء. ستسمع صوتًا كلما كنت على حق.",
    ur: "خط کا سائز اور خالی جگہ چھوٹے اور سخت سے زیادہ اور آسان ہے۔ آپ کو دو تہائی سے زیادہ نہیں مل سکتے ہیں ، لہذا آرام کریں۔ اس کو تخمینہ کھیل کے طور پر سوچیں ، اور زیادہ سے زیادہ حاصل کریں۔ جب بھی آپ ٹھیک کہتے ہیں ، آپ کو بیپ سنی جائے گی۔",
    hi: "अक्षर का आकार और रिक्ति बड़े और आसान से छोटे और कठिन से भिन्न होती है। आप दो-तिहाई से अधिक सही नहीं पा सकते हैं, इसलिए आराम करें। इसे एक अनुमान लगाने के खेल के रूप में सोचें, और बस जितने भी हो सके उतने प्राप्त करें। जब भी आप सही हों तो आप एक बीप सुनेंगे।",
    ta: "கடித அளவு மற்றும் இடைவெளி பெரிய மற்றும் எளிதான முதல் சிறிய மற்றும் கடினமான வரை மாறுபடும். மூன்றில் இரண்டு பங்கிற்கு மேல் நீங்கள் பெற முடியாது, எனவே ஓய்வெடுங்கள். இதை ஒரு யூகிக்கும் விளையாட்டாக நினைத்துப் பாருங்கள், உங்களால் முடிந்தவரை பலவற்றைப் பெறுங்கள். நீங்கள் சரியாக இருக்கும்போதெல்லாம் ஒரு பீப்பைக் கேட்பீர்கள்.",
    ml: "കത്ത് വലുപ്പവും അകലവും വലുതും എളുപ്പത്തിൽ ചെറിയതും കഠിനവുമായത് വരെ വ്യത്യാസപ്പെട്ടിരിക്കുന്നു. നിങ്ങൾക്ക് മൂന്നിൽ രണ്ട് വലതുവശത്ത് കൂടുതൽ നേടാൻ കഴിയില്ല, അതിനാൽ വിശ്രമിക്കുക. ഇത് ഒരു ess ഹിക്കുന്ന ഗെയിമായി കരുതുക, നിങ്ങൾക്ക് കഴിയുന്നത്രയും നേടുക. നിങ്ങൾ ശരിയാകുമ്പോഴെല്ലാം നിങ്ങൾ ഒരു ബീപ്പ് കേൾക്കും.",
    te: "అక్షరాల పరిమాణం మరియు అంతరం పెద్ద మరియు తేలికైన మరియు చిన్న మరియు కఠినమైన వరకు మారుతూ ఉంటాయి. మీరు మూడింట రెండు వంతుల కంటే ఎక్కువ పొందలేరు, కాబట్టి విశ్రాంతి తీసుకోండి. దీన్ని game హించే ఆటగా భావించండి మరియు మీకు వీలైనన్ని ఎక్కువ పొందండి. మీరు సరైనప్పుడల్లా బీప్ వింటారు.",
    kn: "ಅಕ್ಷರ ಗಾತ್ರ ಮತ್ತು ಅಂತರವು ದೊಡ್ಡ ಮತ್ತು ಸುಲಭದಿಂದ ಸಣ್ಣ ಮತ್ತು ಗಟ್ಟಿಯಾದವರೆಗೆ ಬದಲಾಗುತ್ತದೆ. ನೀವು ಮೂರನೇ ಎರಡರಷ್ಟು ಸರಿಯಾಗಿ ಪಡೆಯಲು ಸಾಧ್ಯವಿಲ್ಲ, ಆದ್ದರಿಂದ ವಿಶ್ರಾಂತಿ ಪಡೆಯಿರಿ. ಇದನ್ನು ess ಹಿಸುವ ಆಟವೆಂದು ಯೋಚಿಸಿ, ಮತ್ತು ನಿಮಗೆ ಸಾಧ್ಯವಾದಷ್ಟು ಪಡೆಯಿರಿ. ನೀವು ಸರಿಯಾಗಿದ್ದಾಗಲೆಲ್ಲಾ ನೀವು ಬೀಪ್ ಕೇಳುತ್ತೀರಿ.",
    bn: "চিঠির আকার এবং ব্যবধানটি বড় এবং সহজ থেকে ছোট এবং শক্ত থেকে পৃথক হয়। আপনি দুই-তৃতীয়াংশের চেয়ে বেশি কিছু পেতে পারেন না, তাই শিথিল করুন। এটিকে একটি অনুমানের খেলা হিসাবে ভাবেন এবং যতটা পারেন আপনি পান। আপনি যখনই ঠিক আছেন তখন আপনি একটি বীপ শুনতে পাবেন।",
    id: "Ukuran dan jarak huruf bervariasi dari besar dan mudah hingga kecil dan keras. Anda tidak bisa mendapatkan lebih dari dua pertiga, jadi santai. Anggap saja sebagai permainan menebak, dan dapatkan sebanyak yang Anda bisa. Anda akan mendengar bunyi bip kapan pun Anda benar.",
    "zh-CN":
    ...
    ko: "문자 크기와 간격은 크고 쉽게 다르고 작고 단단하게 다릅니다. 3 분의 2 이상을 얻을 수 없으므로 긴장을 풀어주십시오. 그것을 추측 게임으로 생각하고 가능한 한 많은 것을 얻으십시오. 당신이 옳을 때마다 경고음이 들립니다.",
  },
  T_guessingGameVernier: {
    ...
    de: "Die Linienverschiebung variiert von groß und einfach bis zu winzig und hart. Sie können nicht viel mehr als zwei Drittel richtig bekommen, also entspannen Sie sich. Betrachten Sie es als ein Ratenspiel und holen Sie sich so viele wie möglich. Sie werden einen Piepton hören, wenn Sie Recht haben.",
    fr: "Le décalage de ligne varie de grand et facile à minuscule et dur. Vous ne pouvez pas obtenir beaucoup plus des deux tiers à droite, alors détendez-vous. Considérez-le comme un jeu de supposition et obtenez-en autant que vous le pouvez. Vous entendrez un bip quand vous avez raison.",
    es: "El cambio de línea varía de grande y fácil hasta pequeño y duro. No puedes tener mucho más de dos tercios, así que relájate. Piense en ello como un juego de adivinanzas, y simplemente obtenga tantos como pueda. Escucharás un pitido siempre que tengas razón.",
    pt: "A mudança de linha varia de grande e fácil para baixo a minúsculo e duro. Você não pode acertar muito mais do que dois terços, então relaxe. Pense nisso como um jogo de adivinhação e obtenha o máximo possível. Você ouvirá um sinal sonoro sempre que estiver certo.",
    it: "Il turno di linea varia da grande e facile fino a minuscolo e duro. Non puoi ottenere molto più di due terzi, quindi rilassati. Pensalo come un gioco di ipotesi e ottieni il maggior numero possibile. Sentirai un segnale acustico ogni volta che hai ragione.",
    ro: "Schimbarea liniei variază de la mare și ușor în jos la minuscul și greu. Nu puteți obține mult mai mult de două treimi corect, așa că relaxați-vă. Gândiți -vă la el ca la un joc de ghicire și obțineți doar cât puteți. Veți auzi un bip ori de câte ori ai dreptate.",
    pl: "Zmiana linii zmienia się od dużych i łatwych do małego i twardego. Nie możesz uzyskać znacznie więcej niż dwie trzecie, więc zrelaksuj się. Pomyśl o tym jak o zgadywaniu i po prostu zdobądź tyle, ile możesz. Usłyszysz sygnał dźwiękowy, gdy masz rację.",
    ru: "Сдвиг линии варьируется от большого и легкого до крошечного и тяжелого. Вы не можете получить гораздо более двух третей правильно, так что расслабьтесь. Думайте об этом как об игре догадков, и просто получите как можно больше. Вы услышите звуковой сигнал, когда вы правы.",
    hy: "Գծի հերթափոխը տատանվում է մեծից եւ հեշտությամբ դեպի փոքրիկ եւ ծանր: Դուք չեք կարող ստանալ շատ ավելին, քան երկու երրորդը ճիշտ, այնպես որ հանգստացեք: Մտածեք դրա մասին որպես գուշակության խաղ եւ պարզապես հնարավորինս շատ ստացեք: Դուք կօգտագործեք փղուկը, երբ ճիշտ եք:",
    fi: "Linjansiirto vaihtelee isoista ja helpoista pieneen ja kovasti. Et voi saada paljon enemmän kuin kaksi kolmasosaa oikein, joten rentoudu. Ajattele sitä arvauspelinä ja saat vain niin monta kuin pystyt. Kuulet piippauksen aina kun olet oikeassa.",
    ka: "ხაზის ცვლა მერყეობს დიდი და მარტივად და პატარა და მძიმე. თქვენ ვერ მიიღებთ ბევრად მეტს ორ მესამედზე, ასე რომ დაისვენეთ. იფიქრეთ, როგორც გამოცნობის თამაში, და უბრალოდ მიიღეთ რაც შეიძლება მეტი. თქვენ მოისმენთ beep, როდესაც მართალი ხართ.",
    he: "משמרת הקו משתנה מגדול וקל למטה לזעיר וקשה. אתה לא יכול להשיג הרבה יותר משני שלישים נכון, אז תירגע. חשוב על זה כמשחק ניחוש, ופשוט קבל כמה שיותר. תשמע צפצוף בכל פעם שאתה צודק.",
    ar: "يختلف خط التحول من كبير وسهل إلى صغر وصعب. لا يمكنك الحصول على أكثر من ثلثي بشكل صحيح ، لذا استرخ. فكر في الأمر على أنه لعبة تخمين ، واحصل على أكبر عدد ممكن من الأشياء. ستسمع صوتًا كلما كنت على حق.",
    ur: "لائن شفٹ بڑے اور آسان نیچے سے چھوٹے اور سخت تک مختلف ہوتی ہے۔ آپ کو دو تہائی سے زیادہ ٹھیک نہیں مل سکتا ، لہذا آرام کریں۔ اس کو ایک اندازہ لگانے والا کھیل سمجھیں ، اور جتنا ہو سکے حاصل کریں۔ جب بھی آپ ٹھیک ہوں گے آپ کو بیپ سنیں گے۔",
    hi: "लाइन शिफ्ट बड़े और आसान से नीचे से छोटे और कठिन में भिन्न होती है। आप दो-तिहाई से अधिक सही नहीं पा सकते हैं, इसलिए आराम करें। इसे एक अनुमान लगाने के खेल के रूप में सोचें, और बस जितने भी हो सके उतने प्राप्त करें। जब भी आप सही हों तो आप एक बीप सुनेंगे।",
    ta: "வரி மாற்றமானது பெரிய மற்றும் எளிதான முதல் சிறிய மற்றும் கடினமான வரை மாறுபடும். மூன்றில் இரண்டு பங்கிற்கு மேல் நீங்கள் பெற முடியாது, எனவே ஓய்வெடுங்கள். இதை ஒரு யூகிக்கும் விளையாட்டாக நினைத்துப் பாருங்கள், உங்களால் முடிந்தவரை பலவற்றைப் பெறுங்கள். நீங்கள் சரியாக இருக்கும்போதெல்லாம் ஒரு பீப்பைக் கேட்பீர்கள்.",
    ml: "ലൈൻ ഷിഫ്റ്റ് വലിയതും എളുപ്പത്തിൽ ചെറിയതും കഠിനവുമുള്ളവയിലേക്ക് വ്യത്യാസപ്പെടുന്നു. നിങ്ങൾക്ക് മൂന്നിൽ രണ്ട് വലതുവശത്ത് കൂടുതൽ നേടാൻ കഴിയില്ല, അതിനാൽ വിശ്രമിക്കുക. ഇത് ഒരു ess ഹിക്കുന്ന ഗെയിമായി കരുതുക, നിങ്ങൾക്ക് കഴിയുന്നത്രയും നേടുക. നിങ്ങൾ ശരിയാകുമ്പോഴെല്ലാം നിങ്ങൾ ഒരു ബീപ്പ് കേൾക്കും.",
    te: "లైన్ షిఫ్ట్ పెద్ద మరియు తేలికైన నుండి చిన్న మరియు కఠినమైన వరకు మారుతుంది. మీరు మూడింట రెండు వంతుల కంటే ఎక్కువ పొందలేరు, కాబట్టి విశ్రాంతి తీసుకోండి. దీన్ని game హించే ఆటగా భావించండి మరియు మీకు వీలైనన్ని ఎక్కువ పొందండి. మీరు సరైనప్పుడల్లా బీప్ వింటారు.",
    kn: "ಲೈನ್ ಶಿಫ್ಟ್ ದೊಡ್ಡ ಮತ್ತು ಸುಲಭದಿಂದ ಸಣ್ಣ ಮತ್ತು ಗಟ್ಟಿಯಾದವರೆಗೆ ಬದಲಾಗುತ್ತದೆ. ನೀವು ಮೂರನೇ ಎರಡರಷ್ಟು ಸರಿಯಾಗಿ ಪಡೆಯಲು ಸಾಧ್ಯವಿಲ್ಲ, ಆದ್ದರಿಂದ ವಿಶ್ರಾಂತಿ ಪಡೆಯಿರಿ. ಇದನ್ನು ess ಹಿಸುವ ಆಟವೆಂದು ಯೋಚಿಸಿ, ಮತ್ತು ನಿಮಗೆ ಸಾಧ್ಯವಾದಷ್ಟು ಪಡೆಯಿರಿ. ನೀವು ಸರಿಯಾಗಿದ್ದಾಗಲೆಲ್ಲಾ ನೀವು ಬೀಪ್ ಕೇಳುತ್ತೀರಿ.",
    bn: "লাইন শিফটটি বড় এবং সহজ থেকে ছোট এবং শক্ত থেকে পরিবর্তিত হয়। আপনি দুই-তৃতীয়াংশের চেয়ে বেশি কিছু পেতে পারেন না, তাই শিথিল করুন। এটিকে একটি অনুমানের খেলা হিসাবে ভাবেন এবং যতটা পারেন আপনি পান। আপনি যখনই ঠিক আছেন তখন আপনি একটি বীপ শুনতে পাবেন।",
    id: "Pergeseran garis bervariasi dari besar dan mudah ke kecil dan keras. Anda tidak bisa mendapatkan lebih dari dua pertiga, jadi santai. Anggap saja sebagai permainan menebak, dan dapatkan sebanyak yang Anda bisa. Anda akan mendengar bunyi bip kapan pun Anda benar.",
    "zh-CN":
      "线班的变化从大小易于往下变化，到微小而艰难。您不能获得超过三分之二的正确，所以放松。将其视为一个猜测游戏，只需获得尽可能多的游戏。每当您正确时，您都会听到蜂鸣声。",
    "zh-HK":
      "線班的變化從大小易於往下變化，到微小而艱難。您不能獲得超過三分之二的正確，所以放鬆。將其視為一個猜測遊戲，只需獲得盡可能多的遊戲。每當您正確時，您都會聽到蜂鳴聲。",
    ja: "ラインシフトは、大きくて簡単なものから小さくて硬いまでさまざまです。 3分の2を超えることはできないので、リラックスしてください。それを推測ゲームと考えて、できるだけ多くのことを手に入れてください。あなたが正しいときはいつでもビープ音が聞こえます。",
    ko: "라인 이동은 크고 쉬운 곳에서 작고 단단하게 다릅니다. 3 분의 2 이상을 얻을 수 없으므로 긴장을 풀어주십시오. 그것을 추측 게임으로 생각하고 가능한 한 많은 것을 얻으십시오. 당신이 옳을 때마다 경고음이 들립니다.",
  },
  ...
  T_identifyMiddleLetterPressIt: {
    ...
    de: "Bitte identifizieren Sie den mittleren Buchstaben, indem Sie ihn in der Tastatur/der Tastatur drücken.",
    fr: "Veuillez identifier la lettre du milieu en appuyant sur celui-ci dans le clavier / clavier.",
    es: "Identifique la letra central presionándola en el teclado/teclado.",
    pt: "Identifique a carta do meio pressionando -a no teclado/teclado.",
    it: "Si prega di identificare la lettera centrale premendola nella tastiera/tastiera.",
    ro: "Vă rugăm să identificați scrisoarea de mijloc apăsând -o în tastatură/tastatură.",
    pl: "Zidentyfikuj środkową literę, naciskając ją w klawiaturze/klawiaturze.",
    ru: "Пожалуйста, определите среднюю букву, нажав ее на клавиатуре/клавиатуру.",
    hy: "Խնդրում ենք նույնականացնել միջին տառը `սեղմելով այն ստեղնաշարի / ստեղնաշարի մեջ:",
    fi: "Tunnista keskimmäinen kirjain painamalla sitä näppäimistössä/näppäimistössä.",
    ka: "გთხოვთ, დაასახელოთ შუა ასო კლავიატურაზე/კლავიატურაში დაჭერით.",
    he: "אנא זהה את האות האמצעית על ידי לחיצה על המקלדת/לוח המקשים.",
    ar: "يرجى تحديد الحرف الأوسط عن طريق الضغط عليه في لوحة المفاتيح/لوحة المفاتيح.",
    ur: "براہ کرم کی بورڈ/کیپیڈ میں دباکر درمیانی خط کی شناخت کریں۔",
    hi: "कृपया इसे कीबोर्ड/कीपैड में दबाकर मध्य पत्र की पहचान करें।",
    ta: "விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம் நடுத்தர கடிதத்தை அடையாளம் காணவும்.",
    ml: "കീബോർഡ് / കീപാഡിൽ അമർത്തിക്കൊണ്ട് മധ്യ കത്ത് തിരിച്ചറിയുക.",
    te: "దయచేసి మధ్య లేఖను కీబోర్డ్/కీప్యాడ్‌లో నొక్కడం ద్వారా గుర్తించండి.",
    kn: "ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ ದಯವಿಟ್ಟು ಮಧ್ಯದ ಅಕ್ಷರವನ್ನು ಗುರುತಿಸಿ.",
    bn: "কিবোর্ড/কীপ্যাডে টিপে মাঝারি অক্ষরটি সনাক্ত করুন।",
    id: "Harap identifikasi huruf tengah dengan menekannya di keyboard/keypad.",
    "zh-CN": "请通过在键盘/键盘中按下中间字母。",
    "zh-HK": "請通過在鍵盤/鍵盤中按下中間字母。",
    ja: "キーボード/キーパッドに押して、中央の文字を特定してください。",
    ko: "키보드/키패드에서 중간 편지를 눌러 중간 편지를 식별하십시오.",
  },
  T_identifyMiddleLetterPressItOrClickIt: {
    ...
    de: "Bitte identifizieren Sie den mittleren Buchstaben, indem Sie darauf klicken oder auf die Tastatur/Tastatur drücken.",
    fr: "Veuillez identifier la lettre du milieu en cliquant dessus ci-dessous ou en appuyant sur le clavier / clavier.",
    es: "Identifique la letra central haciendo clic a continuación o presionándola en el teclado/teclado.",
    pt: "Identifique a letra do meio clicando nela abaixo ou pressionando -a no teclado/teclado.",
    it: "Si prega di identificare la lettera centrale facendo clic di seguito o premendola nella tastiera/tastiera.",
    ro: "Vă rugăm să identificați scrisoarea de mijloc făcând clic mai jos sau apăsându -l în tastatură/tastatură.",
    pl: "Zidentyfikuj środkową literę, klikając ją poniżej lub naciskając na klawiaturę/klawiaturę.",
    ru: "Пожалуйста, определите среднюю букву, нажав на нее ниже или нажав ее на клавиатуре/клавиатуру.",
    hy: "Խնդրում ենք նույնականացնել միջին նամակը `կտտացնելով այն ներքեւում կամ սեղմելով այն ստեղնաշարի մեջ / ստեղնաշարի մեջ:",
    fi: "Tunnista keskimmäinen kirjain napsauttamalla sitä alla tai painamalla sitä näppäimistössä/näppäimistössä.",
    ka: "გთხოვთ, დაადგინოთ შუა ასო, დააჭირეთ მას ქვემოთ ან დააჭირეთ მას კლავიატურაზე/კლავიატურაში.",
    he: "אנא זהה את האות האמצעית על ידי לחיצה עליו למטה או לחיצה עליו במקלדת/לוח המקשים.",
    ar: "يرجى تحديد الحرف الأوسط بالنقر فوقه أدناه أو الضغط عليه في لوحة المفاتيح/لوحة المفاتيح.",
    ur: "براہ کرم درمیانی خط کو نیچے کلک کرکے یا کی بورڈ/کیپیڈ میں دبانے سے شناخت کریں۔",
    hi: "कृपया इसे नीचे क्लिक करके या इसे कीबोर्ड/कीपैड में दबाकर मध्य पत्र की पहचान करें।",
    ta: "நடுத்தர கடிதத்தை கீழே கிளிக் செய்வதன் மூலம் அல்லது விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம் அடையாளம் காணவும்.",
    ml: "ചുവടെ ക്ലിക്കുചെയ്ത് അല്ലെങ്കിൽ കീബോർഡ് / കീപാഡിൽ അമർത്തിക്കൊണ്ട് മധ്യ കത്ത് തിരിച്ചറിയുക.",
    te: "దయచేసి మధ్య లేఖను క్రింద క్లిక్ చేయడం ద్వారా లేదా కీబోర్డ్/కీప్యాడ్‌లో నొక్కడం ద్వారా గుర్తించండి.",
    kn: "ದಯವಿಟ್ಟು ಮಧ್ಯದ ಅಕ್ಷರವನ್ನು ಕೆಳಗೆ ಕ್ಲಿಕ್ ಮಾಡುವುದರ ಮೂಲಕ ಅಥವಾ ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ ಗುರುತಿಸಿ.",
    bn: "নীচে ক্লিক করে বা কীবোর্ড/কীপ্যাডে টিপে মাঝারি অক্ষরটি সনাক্ত করুন।",
    id: "Harap identifikasi huruf tengah dengan mengkliknya di bawah ini atau menekannya di keyboard/keypad.",
    "zh-CN": "请通过在下面单击它或在键盘/键盘中按下中间字母。",
    "zh-HK": "請通過在下面單擊它或在鍵盤/鍵盤中按下中間字母。",
    ja: "下の文字を下にクリックするか、キーボード/キーパッドで押して、中央の文字を識別してください。",
    ko: "아래를 클릭하거나 키보드/키패드에서 눌러 중간 문자를 식별하십시오.",
  },
  T_identifyVernierClickIt: {
    "en-US":
      "What direction is the upper line shifted? Click a letter below for Left or Right.",
    de: "In welcher Richtung wird die obere Linie verschoben? Klicken Sie auf einen Buchstaben unten für links oder rechts.",
    fr: "Dans quelle direction la ligne supérieure est-elle déplacée? Cliquez sur une lettre ci-dessous pour la gauche ou la droite.",
    es: "¿En qué dirección se desplaza la línea superior? Haga clic en una carta a continuación para la izquierda o hacia la derecha.",
    pt: "Em que direção a linha superior muda? Clique em uma carta abaixo para esquerda ou direita.",
    it: "In che direzione viene spostata la linea superiore? Fai clic su una lettera in basso per sinistra o destra.",
    ro: "Ce direcție este deplasată linia superioară? Faceți clic pe o scrisoare de mai jos pentru stânga sau dreapta.",
    pl: "W jakim kierunku przesunięto górną linię? Kliknij literę poniżej dla lewej lub prawej.",
    ru: "В каком направлении смещается верхняя линия? Нажмите на букву ниже для слева или вправо.",
    hy: "Ինչ ուղղությամբ է անցնում վերին գիծը: Կտտացրեք ստորեւ նշված տառը ձախ կամ աջ:",
    fi: "Mihin suuntaan ylälinja siirtyy? Napsauta alla olevaa kirjettä vasemmalle tai oikealle.",
    ka: "რა მიმართულებით იცვლება ზედა ხაზი? დააჭირეთ ქვემოთ მოცემულ წერილს მარცხენა ან მარჯვნივ.",
    he: "לאיזה כיוון מועבר הקו העליון? לחץ על מכתב למטה לשמאל או ימינה.",
    ar: "ما هو الاتجاه الذي تحول الخط العلوي؟ انقر فوق رسالة أدناه للحصول على اليسار أو اليمين.",
    ur: "اوپری لائن کو کس سمت منتقل کیا گیا ہے؟ بائیں یا دائیں کے لئے نیچے ایک خط پر کلک کریں۔",
    hi: "ऊपरी रेखा किस दिशा में स्थानांतरित हो गई है? बाएं या दाएं के लिए नीचे एक पत्र पर क्लिक करें।",
    ta: "மேல் கோடு எந்த திசையில் மாற்றப்படுகிறது? இடது அல்லது வலதுபுறத்தில் கீழே உள்ள கடிதத்தைக் கிளிக் செய்க.",
    ml: "മുകളിലെ വരി ഏത് ദിശയാണ് മാറ്റിയത്? ഇടത്തോട്ടോ വലത്തോട്ടോ ചുവടെയുള്ള ഒരു അക്ഷരത്തിൽ ക്ലിക്കുചെയ്യുക.",
    te: "ఎగువ రేఖ ఏ దిశలో మార్చబడింది? ఎడమ లేదా కుడి కోసం క్రింద ఒక అక్షరాన్ని క్లిక్ చేయండి.",
    kn: "ಮೇಲಿನ ರೇಖೆಯನ್ನು ಯಾವ ದಿಕ್ಕಿನಲ್ಲಿ ಬದಲಾಯಿಸಲಾಗುತ್ತದೆ? ಎಡ ಅಥವಾ ಬಲಕ್ಕೆ ಕೆಳಗಿನ ಪತ್ರವನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ.",
    bn: "উপরের লাইনটি কোন দিক স্থানান্তরিত হয়? বাম বা ডান জন্য নীচের একটি চিঠি ক্লিক করুন।",
    id: "Ke arah mana garis atas bergeser? Klik huruf di bawah untuk kiri atau kanan.",
    "zh-CN": "上线移动了什么方向？单击下面的字母左右。",
    "zh-HK": "上線移動了什麼方向？單擊下面的字母左右。",
    ja: "上線はどの方向にシフトしていますか？左または右については、下の文字をクリックします。",
    ko: "상단 라인은 어떤 방향으로 이동합니까? 왼쪽 또는 오른쪽으로 아래 문자를 클릭하십시오.",
  },
  T_identifyVernierPressIt: {
    "en-US":
      "What direction is the upper line shifted? Press a key for Left or Right.",
    de: "In welcher Richtung wird die obere Linie verschoben? Drücken Sie eine Taste für links oder rechts.",
    fr: "Dans quelle direction la ligne supérieure est-elle déplacée? Appuyez sur une touche pour gauche ou droite.",
    es: "¿En qué dirección se desplaza la línea superior? Presione una tecla para izquierda o derecha.",
    pt: "Em que direção a linha superior muda? Pressione uma tecla para a esquerda ou direita.",
    it: "In che direzione viene spostata la linea superiore? Premere un tasto per sinistra o destra.",
    ro: "Ce direcție este deplasată linia superioară? Apăsați o tastă pentru stânga sau dreapta.",
    pl: "W jakim kierunku przesunięto górną linię? Naciśnij klawisz dla lewej lub prawej.",
    ru: "В каком направлении смещается верхняя линия? Нажмите клавишу для левой или вправо.",
    hy: "Ինչ ուղղությամբ է անցնում վերին գիծը: Սեղմեք ստեղնը ձախ կամ աջ:",
    fi: "Mihin suuntaan ylälinja siirtyy? Paina vasemman tai oikean tai oikean avaimen näppäintä.",
    ka: "რა მიმართულებით იცვლება ზედა ხაზი? დააჭირეთ ღილაკს მარცხენა ან მარჯვნივ.",
    he: "לאיזה כיוון מועבר הקו העליון? לחץ על מקש לשמאל או ימין.",
    ar: "ما هو الاتجاه الذي تحول الخط العلوي؟ اضغط على مفتاح لليسار أو اليمين.",
    ur: "اوپری لائن کو کس سمت منتقل کیا گیا ہے؟ بائیں یا دائیں کے لئے ایک چابی دبائیں۔",
    hi: "ऊपरी रेखा किस दिशा में स्थानांतरित हो गई है? बाएं या दाएं के लिए एक कुंजी दबाएं।",
    ta: "மேல் கோடு எந்த திசையில் மாற்றப்படுகிறது? இடது அல்லது வலதுபுறத்தில் ஒரு விசையை அழுத்தவும்.",
    ml: "മുകളിലെ വരി ഏത് ദിശയാണ് മാറ്റിയത്? ഇടത്തോട്ടോ വലത്തോട്ടോ ഒരു കീ അമർത്തുക.",
    te: "ఎగువ రేఖ ఏ దిశలో మార్చబడింది? ఎడమ లేదా కుడి కోసం కీని నొక్కండి.",
    kn: "ಮೇಲಿನ ರೇಖೆಯನ್ನು ಯಾವ ದಿಕ್ಕಿನಲ್ಲಿ ಬದಲಾಯಿಸಲಾಗುತ್ತದೆ? ಎಡ ಅಥವಾ ಬಲಕ್ಕೆ ಕೀಲಿಯನ್ನು ಒತ್ತಿ.",
    bn: "উপরের লাইনটি কোন দিক স্থানান্তরিত হয়? বাম বা ডান জন্য একটি কী টিপুন।",
    id: "Ke arah mana garis atas bergeser? Tekan tombol untuk kiri atau kanan.",
    "zh-CN": "上线移动了什么方向？按下左右的键。",
    "zh-HK": "上線移動了什麼方向？按下左右的鍵。",
    ja: "上線はどの方向にシフトしていますか？左または右のキーを押します。",
    ko: "상단 라인은 어떤 방향으로 이동합니까? 왼쪽 또는 오른쪽의 키를 누릅니다.",
  },
  T_identifyVernierPressItOrClickIt: {
    ...
    de: "In welcher Richtung wird die obere Linie verschoben? Klicken Sie auf einen Buchstaben oder drücken Sie eine Taste für links oder rechts.",
    fr: "Dans quelle direction la ligne supérieure est-elle déplacée? Cliquez sur une lettre ou appuyez sur une touche pour la gauche ou la droite.",
    es: "¿En qué dirección se desplaza la línea superior? Haga clic en una letra o presione una tecla para izquierda o derecha.",
    pt: "Em que direção a linha superior muda? Clique em uma carta ou pressione uma tecla para a esquerda ou direita.",
    it: "In che direzione viene spostata la linea superiore? Fare clic su una lettera o premere un tasto per sinistra o destra.",
    ro: "Ce direcție este deplasată linia superioară? Faceți clic pe o scrisoare sau apăsați o tastă pentru stânga sau dreapta.",
    pl: "W jakim kierunku przesunięto górną linię? Kliknij literę lub naciśnij klawisz dla lewej lub prawej.",
    ru: "В каком направлении смещается верхняя линия? Нажмите на букву или нажмите клавишу для левой или справа.",
    hy: "Ինչ ուղղությամբ է անցնում վերին գիծը: Կտտացրեք նամակը կամ սեղմեք ստեղնը ձախ կամ աջ:",
    fi: "Mihin suuntaan ylälinja siirtyy? Napsauta kirjainta tai paina näppäintä vasemmalle tai oikealle.",
    ka: "რა მიმართულებით იცვლება ზედა ხაზი? დააჭირეთ წერილს ან დააჭირეთ ღილაკს მარცხნივ ან მარჯვნივ.",
    he: "לאיזה כיוון מועבר הקו העליון? לחץ על אות או לחץ על מקש לשמאל או ימינה.",
    ar: "ما هو الاتجاه الذي تحول الخط العلوي؟ انقر فوق خطاب أو اضغط على مفتاح يسار أو يمين.",
    ur: "اوپری لائن کو کس سمت منتقل کیا گیا ہے؟ کسی خط پر کلک کریں یا بائیں یا دائیں کے لئے کسی کلید کو دبائیں۔",
    hi: "ऊपरी रेखा किस दिशा में स्थानांतरित हो गई है? एक पत्र पर क्लिक करें या बाएं या दाएं के लिए एक कुंजी दबाएं।",
    ta: "மேல் கோடு எந்த திசையில் மாற்றப்படுகிறது? ஒரு கடிதத்தைக் கிளிக் செய்க அல்லது இடது அல்லது வலதுபுறத்தில் ஒரு விசையை அழுத்தவும்.",
    ml: "മുകളിലെ വരി ഏത് ദിശയാണ് മാറ്റിയത്? ഒരു അക്ഷരത്തിൽ ക്ലിക്കുചെയ്യുക അല്ലെങ്കിൽ ഇടത്തോട്ടോ വലത്തോട്ടോ ഒരു കീ അമർത്തുക.",
    te: "ఎగువ రేఖ ఏ దిశలో మార్చబడింది? ఒక అక్షరం క్లిక్ చేయండి లేదా ఎడమ లేదా కుడి కోసం కీని నొక్కండి.",
    kn: "ಮೇಲಿನ ರೇಖೆಯನ್ನು ಯಾವ ದಿಕ್ಕಿನಲ್ಲಿ ಬದಲಾಯಿಸಲಾಗುತ್ತದೆ? ಅಕ್ಷರ ಕ್ಲಿಕ್ ಮಾಡಿ ಅಥವಾ ಎಡ ಅಥವಾ ಬಲಕ್ಕೆ ಕೀಲಿಯನ್ನು ಒತ್ತಿ.",
    bn: "উপরের লাইনটি কোন দিক স্থানান্তরিত হয়? একটি চিঠি ক্লিক করুন বা বাম বা ডান জন্য একটি কী টিপুন।",
    id: "Ke arah mana garis atas bergeser? Klik huruf atau tekan tombol untuk kiri atau kanan.",
    "zh-CN": "上线移动了什么方向？单击字母或按左右的键。",
    "zh-HK": "上線移動了什麼方向？單擊字母或按左右的鍵。",
    ja: "上線はどの方向にシフトしていますか？文字をクリックするか、左または右のキーを押します。",
    ko: "상단 라인은 어떤 방향으로 이동합니까? 편지를 클릭하거나 왼쪽 또는 오른쪽의 키를 누릅니다.",
  },
  ...
  T_identifyLetterPressIt: {
    ...
    de: "Bitte identifizieren Sie den Brief, indem Sie ihn in der Tastatur/der Tastatur drücken.",
    fr: "Veuillez identifier la lettre en appuyant sur celui-ci dans le clavier / clavier.",
    es: "Identifique la letra presionándola en el teclado/teclado.",
    pt: "Identifique a carta pressionando -a no teclado/teclado.",
    it: "Si prega di identificare la lettera premendola nella tastiera/tastiera.",
    ro: "Vă rugăm să identificați scrisoarea apăsând -o în tastatură/tastatură.",
    pl: "Zidentyfikuj list, naciskając ją w klawiaturze/klawiaturze.",
    ru: "Пожалуйста, определите букву, нажав ее на клавиатуре/клавиатуре.",
    hy: "Խնդրում ենք նույնականացնել նամակը `սեղմելով այն ստեղնաշարի / ստեղնաշարի մեջ:",
    fi: "Tunnista kirje painamalla sitä näppäimistössä/näppäimistössä.",
    ka: "გთხოვთ, დაასახელოთ წერილი კლავიატურაზე/კლავიატურაში დაჭერით.",
    he: "אנא זהה את המכתב על ידי לחיצה עליו במקלדת/לוח המקשים.",
    ar: "يرجى تحديد الحرف بالضغط عليه في لوحة المفاتيح/لوحة المفاتيح.",
    ur: "براہ کرم اس خط کو کی بورڈ/کیپیڈ میں دبانے سے شناخت کریں۔",
    hi: "कृपया इसे कीबोर्ड/कीपैड में दबाकर पत्र को पहचानें।",
    ta: "கடிதத்தை விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம் அடையாளம் காணவும்.",
    ml: "കീബോർഡ് / കീപാഡിൽ ഇത് അമർത്തി കത്ത് തിരിച്ചറിയുക.",
    te: "దయచేసి లేఖను కీబోర్డ్/కీప్యాడ్‌లో నొక్కడం ద్వారా గుర్తించండి.",
    kn: "ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಪತ್ರವನ್ನು ಒತ್ತುವ ಮೂಲಕ ದಯವಿಟ್ಟು ಅದನ್ನು ಗುರುತಿಸಿ.",
    bn: "কীবোর্ড/কীপ্যাডে টিপে চিঠিটি সনাক্ত করুন দয়া করে।",
    id: "Please identify the middle letter by clicking it below or pressing it in the keyboard.",
    "zh-CN": "请通过在键盘/键盘中按字母来识别该字母。",
    "zh-HK": "請通過在鍵盤/鍵盤中按字母來識別該信。",
    ja: "キーボード/キーパッドに押して文字を特定してください。",
    ko: "키보드/키패드에서 눌러 편지를 식별하십시오.",
  },
  T_identifyLetterPressItOrClickIt: {
    "en-US":
      "Please identify the letter by clicking it below or pressing it in the keyboard/keypad.",
    de: "Bitte identifizieren Sie den Brief, indem Sie unten auf ihn klicken oder auf die Tastatur/Tastatur drücken.",
    fr: "Veuillez identifier la lettre en cliquant dessus ci-dessous ou en appuyant sur le clavier / clavier.",
    es: "Identifique la letra haciendo clic a continuación o presionándola en el teclado/teclado.",
    pt: "Identifique a carta clicando abaixo ou pressionando -a no teclado/teclado.",
    it: "Si prega di identificare la lettera facendo clic di seguito o premendola nella tastiera/tastiera.",
    ro: "Vă rugăm să identificați scrisoarea făcând clic mai jos sau apăsându -l în tastatură/tastatură.",
    pl: "Zidentyfikuj list, klikając go poniżej lub naciskając na klawiaturę/klawiaturę.",
    ru: "Пожалуйста, определите букву, нажав ее ниже или нажав ее на клавиатуре/клавиатуре.",
    hy: "Խնդրում ենք նույնականացնել նամակը `կտտացնելով այն ներքեւում կամ սեղմելով այն ստեղնաշարի մեջ / ստեղնաշարի մեջ:",
    fi: "Tunnista kirjain napsauttamalla sitä alla tai painamalla sitä näppäimistössä/näppäimistössä.",
    ka: "გთხოვთ, დაასახელოთ წერილი ქვემოთ, დააჭირეთ მას ქვემოთ ან დააჭირეთ მას კლავიატურაზე/კლავიატურაში.",
    he: "אנא זהה את המכתב על ידי לחיצה עליו למטה או לחיצה עליו במקלדת/לוח המקשים.",
    ar: "يرجى تحديد الحرف بالنقر فوقه أدناه أو الضغط عليه في لوحة المفاتيح/لوحة المفاتيح.",
    ur: "براہ کرم اس خط کو نیچے کلک کرکے یا کی بورڈ/کیپیڈ میں دبانے سے شناخت کریں۔",
    hi: "कृपया इसे नीचे क्लिक करके या इसे कीबोर्ड/कीपैड में दबाकर पत्र को पहचानें।",
    ta: "கடிதத்தை கீழே கிளிக் செய்வதன் மூலம் அல்லது விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம் அடையாளம் காணவும்.",
    ml: "ചുവടെ ക്ലിക്കുചെയ്ത് അല്ലെങ്കിൽ കീബോർഡ് / കീപാഡിൽ അമർത്തുക എന്ന അക്ഷരം തിരിച്ചറിയുക.",
    te: "దయచేసి అక్షరాన్ని క్రింద క్లిక్ చేయడం ద్వారా లేదా కీబోర్డ్/కీప్యాడ్‌లో నొక్కడం ద్వారా గుర్తించండి.",
    kn: "ಅಕ್ಷರವನ್ನು ಕೆಳಗೆ ಕ್ಲಿಕ್ ಮಾಡುವುದರ ಮೂಲಕ ಅಥವಾ ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ ಗುರುತಿಸಿ.",
    bn: "নীচে ক্লিক করে বা কীবোর্ড/কীপ্যাডে টিপে চিঠিটি সনাক্ত করুন।",
    id: "Harap identifikasi surat itu dengan mengkliknya di bawah ini atau menekannya di keyboard/keypad.",
    "zh-CN": "请通过在下面单击它或在键盘/键盘中按下字母。",
    "zh-HK": "請通過在下面單擊它或在鍵盤/鍵盤中按下字母。",
    ja: "下をクリックするか、キーボード/キーパッドに押して文字を識別してください。",
    ko: "아래를 클릭하거나 키보드/키패드에서 눌러 편지를 식별하십시오.",
  },
  ...
  "❌T_identifyPressIt": {
    ...
    ka: "❌ CHANGE T_identifyPressIt → T_identifyMiddleLetterPressIt",
    ...
    ta: "❌ CHANGE T_identifyPressIt → T_identifyMiddleLetterPressIt",
    ml: "❌ CHANGE T_identifyPressIt → T_identifyMiddleLetterPressIt",
    te: "❌ CHANGE T_identifyPressIt → T_identifyMiddleLetterPressIt",
    kn: "❌ CHANGE T_identifyPressIt → T_identifyMiddleLetterPressIt",
    bn: "❌ CHANGE T_identifyPressIt → T_identifyMiddleLetterPressIt",
  ...
  "❌T_identifyPressItOrClickIt": {
    ...
    de: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    fr: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    es: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    pt: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    it: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ro: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    pl: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ru: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    hy: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    fi: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ka: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    he: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ar: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ur: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    hi: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ta: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ml: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    te: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    kn: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    bn: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    id: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    "zh-CN":
      "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    "zh-HK":
      "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ja: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
    ko: "❌ CHANGE T_identifyPressItOrClickIt → T_identifyMiddleLetterPressItOrClickIt",
  },
  T_identifyPressItOrClickItRepeatedLetters: {
    ...
    de: "Bitte identifizieren Sie die beiden mittleren Buchstaben, indem Sie sie unten klicken oder sie auf der Tastatur/der Tastatur drücken.",
    ...
    ka: "დაასახელეთ ორი შუალედური ასო კლავიატურაზე/კლავიატურაზე დაჭერით ან დაჭერით.",
    ...
    ta: "விசைப்பலகை/விசைப்பலகையில் கிளிக் செய்வதன் மூலம் அல்லது அழுத்துவதன் மூலம் இரண்டு இடைநிலை கடிதங்களை அடையாளம் காணவும்.",
    ml: "കീബോർഡ് / കീബോർഡിൽ ക്ലിക്കുചെയ്ത് അല്ലെങ്കിൽ അമർത്തിക്കൊണ്ട് രണ്ട് ഇന്റർമീഡിയറ്റ് അക്ഷരങ്ങൾ തിരിച്ചറിയുക.",
    te: "కీబోర్డ్/కీబోర్డ్‌లో క్లిక్ చేయడం లేదా నొక్కడం ద్వారా రెండు ఇంటర్మీడియట్ అక్షరాలను గుర్తించండి.",
    kn: "ಕೀಬೋರ್ಡ್/ಕೀಬೋರ್ಡ್‌ನಲ್ಲಿ ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ ಅಥವಾ ಒತ್ತುವ ಮೂಲಕ ಎರಡು ಮಧ್ಯಂತರ ಅಕ್ಷರಗಳನ್ನು ಗುರುತಿಸಿ.",
    bn: "কীবোর্ড/কীবোর্ডে ক্লিক করে বা টিপে দুটি মধ্যবর্তী অক্ষর সনাক্ত করুন।",
  ...
  T_identifyPressItRepeatedLetters: {
    ...
    de: "Bitte identifizieren Sie die beiden mittleren Buchstaben, indem Sie sie auf die Tastatur/Tastatur drücken.",
    fr: "Veuillez identifier les deux lettres du milieu, en les appuyant sur le clavier / clavier.",
    es: "Identifique las dos letras intermedias, presionándolas en el teclado/teclado.",
    pt: "Identifique as duas letras intermediárias, pressionando -as no teclado/teclado.",
    it: "Identifica le due lettere intermedie, premendole sulla tastiera/tastiera.",
    ro: "Identificați cele două litere intermediare, apăsându -le pe tastatură/tastatură.",
    pl: "Zidentyfikuj dwie pośrednie litery, naciskając je na klawiaturze/klawiaturze.",
    ru: "Определите две промежуточные буквы, нажимая их на клавиатуре/клавиатуре.",
    hy: "Նշեք երկու միջանկյալ տառերը, սեղմելով դրանք ստեղնաշարի վրա / ստեղնաշարի վրա:",
    fi: "Tunnista kaksi välikirjainta painamalla niitä näppäimistöllä/näppäimistöllä.",
    ka: "დაადგინეთ ორი შუალედური ასო, დააჭირეთ მათ კლავიატურაზე/კლავიატურაზე.",
    he: "זהה את שתי האותיות הביניים, לחץ עליהן על המקלדת/המקלדת.",
    ar: "حدد الحرفين الوسيطين ، والضغط عليهما على لوحة المفاتيح/لوحة المفاتيح.",
    ur: "دو انٹرمیڈیٹ خطوط کی شناخت کریں ، انہیں کی بورڈ/کی بورڈ پر دبائیں۔",
    hi: "दो मध्यवर्ती अक्षरों को पहचानें, उन्हें कीबोर्ड/कीबोर्ड पर दबाएं।",
    ta: "இரண்டு இடைநிலை கடிதங்களை அடையாளம் கண்டு, விசைப்பலகை/விசைப்பலகையில் அவற்றை அழுத்தவும்.",
    ml: "രണ്ട് ഇന്റർമീഡിയറ്റ് അക്ഷരങ്ങൾ തിരിച്ചറിയുക, കീബോർഡ് / കീബോർഡിൽ അമർത്തുക.",
    te: "రెండు ఇంటర్మీడియట్ అక్షరాలను గుర్తించండి, వాటిని కీబోర్డ్/కీబోర్డ్‌లో నొక్కండి.",
    kn: "ಎರಡು ಮಧ್ಯಂತರ ಅಕ್ಷರಗಳನ್ನು ಗುರುತಿಸಿ, ಅವುಗಳನ್ನು ಕೀಬೋರ್ಡ್/ಕೀಬೋರ್ಡ್‌ನಲ್ಲಿ ಒತ್ತಿ.",
    bn: "দুটি মধ্যবর্তী অক্ষর সনাক্ত করুন, কীবোর্ড/কীবোর্ডে টিপুন।",
    id: "Identifikasi dua huruf perantara, tekan pada keyboard/keyboard.",
    "zh-CN": "标识两个中间字母，将它们按在键盘/键盘上。",
    "zh-HK": "標識兩個中間字母，將它們按在鍵盤/鍵盤上。",
    ja: "2つの中間文字を識別し、キーボード/キーボードに押し付けます。",
    ko: "두 개의 중간 문자를 식별하여 키보드/키보드에 누릅니다.",
  },
  T_keypadInactive: {
    "en-US":
      "This keypad is disabled for this block. Use your computer's keyboard instead. The keypad is enabled only when the viewing distance exceeds 50 cm.",
    de: "Diese Tastatur ist für diesen Block deaktiviert. Verwenden Sie stattdessen die Tastatur Ihres Computers. Die Tastatur ist nur aktiviert, wenn der Betrachtungsabstand 50 cm überschreitet.",
    fr: "Ce clavier est désactivé pour ce bloc. Utilisez plutôt le clavier de votre ordinateur. Le clavier n'est activé que lorsque la distance de visualisation dépasse 50 cm.",
    es: "Este teclado está deshabilitado para este bloque. Use el teclado de su computadora en su lugar. El teclado se habilita solo cuando la distancia de visualización excede los 50 cm.",
    pt: "Este teclado está desativado para este bloco. Use o teclado do seu computador. O teclado é ativado apenas quando a distância de visualização exceder 50 cm.",
    it: "Questa tastiera è disabilitata per questo blocco. Usa invece la tastiera del tuo computer. La tastiera è abilitata solo quando la distanza di visualizzazione supera i 50 cm.",
    ro: "Această tastatură este dezactivată pentru acest bloc. Utilizați în schimb tastatura computerului. Tastatura este activată numai atunci când distanța de vizualizare depășește 50 cm.",
    pl: "Ta klawiatura jest wyłączona dla tego bloku. Zamiast tego użyj klawiatury komputera. Klucz jest włączony tylko wtedy, gdy odległość oglądania przekracza 50 cm.",
    ru: "Эта клавиатура отключена для этого блока. Вместо этого используйте клавиатуру вашего компьютера. Клавиатура включена только тогда, когда расстояние просмотра превышает 50 см.",
    hy: "Այս ստեղնաշարի այս բլոկն անջատված է այս բլոկի համար: Փոխարենը օգտագործեք ձեր համակարգչի ստեղնաշարը: Ստեղնաշարը միացված է միայն այն ժամանակ, երբ դիտման հեռավորությունը գերազանցում է 50 սմ:",
    fi: "Tämä näppäimistö on poistettu käytöstä tälle lohkolle. Käytä sen sijaan tietokoneesi näppäimistöä. Näppäimistö on käytössä vain, kun katseluetäisyys ylittää 50 cm.",
    ka: "ეს კლავიატურა გამორთულია ამ ბლოკისთვის. ამის ნაცვლად გამოიყენეთ თქვენი კომპიუტერის კლავიატურა. კლავიატურა ჩართულია მხოლოდ მაშინ, როდესაც სანახავი მანძილი აღემატება 50 სმ.",
    he: 'לוח מקשים זה מושבת לחסימה זו. השתמש במקום זאת במקלדת המחשב שלך. לוח המקשים מופעל רק כאשר מרחק הצפייה עולה על 50 ס"מ.',
    ar: "تم تعطيل لوحة المفاتيح هذه لهذه الكتلة. استخدم لوحة مفاتيح جهاز الكمبيوتر الخاص بك بدلاً من ذلك. يتم تمكين لوحة المفاتيح فقط عندما تتجاوز مسافة المشاهدة 50 سم.",
    ur: "یہ کیپیڈ اس بلاک کے لئے غیر فعال ہے۔ اس کے بجائے اپنے کمپیوٹر کا کی بورڈ استعمال کریں۔ کیپیڈ صرف اس وقت فعال ہے جب دیکھنے کا فاصلہ 50 سینٹی میٹر سے زیادہ ہو۔",
    hi: "यह कीपैड इस ब्लॉक के लिए अक्षम है। इसके बजाय अपने कंप्यूटर के कीबोर्ड का उपयोग करें। कीपैड केवल तभी सक्षम होता है जब देखने की दूरी 50 सेमी से अधिक हो।",
    ta: "இந்த தொகுதிக்கு இந்த விசைப்பலகை முடக்கப்பட்டுள்ளது. அதற்கு பதிலாக உங்கள் கணினியின் விசைப்பலகை பயன்படுத்தவும். பார்க்கும் தூரம் 50 செ.மீ தாண்டும்போது மட்டுமே விசைப்பலகையை இயக்கப்படுகிறது.",
    ml: "ഈ ബ്ലോക്കിനായി ഈ കീപാഡ് പ്രവർത്തനരഹിതമാക്കി. പകരം നിങ്ങളുടെ കമ്പ്യൂട്ടറിന്റെ കീബോർഡ് ഉപയോഗിക്കുക. 50 സെന്റിമീറ്റർ കവിയുമ്പോൾ മാത്രമേ കീപാഡ് പ്രവർത്തനക്ഷമമാകൂ.",
    te: "ఈ బ్లాక్ కోసం ఈ కీప్యాడ్ నిలిపివేయబడింది. బదులుగా మీ కంప్యూటర్ కీబోర్డ్‌ను ఉపయోగించండి. వీక్షణ దూరం 50 సెం.మీ మించి ఉన్నప్పుడు మాత్రమే కీప్యాడ్ ప్రారంభించబడుతుంది.",
    kn: "ಈ ಕೀಪ್ಯಾಡ್ ಅನ್ನು ಈ ಬ್ಲಾಕ್ಗಾಗಿ ನಿಷ್ಕ್ರಿಯಗೊಳಿಸಲಾಗಿದೆ. ಬದಲಿಗೆ ನಿಮ್ಮ ಕಂಪ್ಯೂಟರ್‌ನ ಕೀಬೋರ್ಡ್ ಬಳಸಿ. ವೀಕ್ಷಣೆಯ ಅಂತರವು 50 ಸೆಂ.ಮೀ ಮೀರಿದಾಗ ಮಾತ್ರ ಕೀಪ್ಯಾಡ್ ಅನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಲಾಗುತ್ತದೆ.",
    bn: "এই কীপ্যাড এই ব্লকের জন্য অক্ষম। পরিবর্তে আপনার কম্পিউটারের কীবোর্ড ব্যবহার করুন। কীপ্যাড কেবল তখনই সক্ষম হয় যখন দেখার দূরত্ব 50 সেমি ছাড়িয়ে যায়।",
    id: "Keypad ini dinonaktifkan untuk blok ini. Gunakan keyboard komputer Anda sebagai gantinya. Keypad diaktifkan hanya ketika jarak tampilan melebihi 50 cm.",
    "zh-CN":
      "此块为此块禁用了此键盘。改用计算机的键盘。仅当观看距离超过50厘米时才能启用键盘。",
    "zh-HK":
      "此塊為此塊禁用了此鍵盤。改用計算機的鍵盤。僅當觀看距離超過50厘米時才能啟用鍵盤。",
    ja: "このキーパッドは、このブロックに対して無効になっています。代わりにコンピューターのキーボードを使用してください。キーパッドは、表示距離が50 cmを超える場合にのみ有効になります。",
    ko: "이 키패드는이 블록의 경우 비활성화되었습니다. 대신 컴퓨터의 키보드를 사용하십시오. 키패드는보기 거리가 50cm를 초과 할 때만 활성화됩니다.",
  },
  T_keypadFrozen: {
    "en-US":
    ...
    de: "Wenn dieser Bildschirm gefriert, verbinden Sie bitte eine Verbindung, indem Sie Ihre Smartphone -Kamera auf den QR -Code auf Ihrem Computerbildschirm zeigen. Wenn ein Link angezeigt wird, berühren Sie ihn mit Ihrem Finger.",
    fr: "Si cet écran gèle, veuillez vous reconnecter en pointant votre appareil photo pour smartphone sur le code QR sur l'écran de votre ordinateur. Lorsqu'un lien apparaît, touchez-le avec votre doigt.",
    es: "Si esta pantalla se congela, vuelva a conectar señalando la cámara de su teléfono inteligente en el código QR en la pantalla de su computadora. Cuando aparezca un enlace, tócalo con el dedo.",
    pt: "Se essa tela congelar, reconecte -se apontando sua câmera para smartphone no código QR na tela do seu computador. Quando um link aparecer, toque -o com o dedo.",
    it: "Se questa schermata si blocca, si prega di riconnettersi puntando la fotocamera per smartphone sul codice QR sullo schermo del computer. Quando appare un collegamento, toccalo con il dito.",
    ro: "Dacă acest ecran îngheață, vă rugăm să vă reconectați arătând camera smartphone -ului către codul QR de pe ecranul computerului. Când apare o legătură, atinge -l cu degetul.",
    pl: "Jeśli ten ekran zamarza, ponownie podłącz się, wskazując aparat smartfona na kod QR na ekranie komputera. Kiedy pojawi się link, dotknij go palcem.",
    ru: "Если этот экран замерзает, пожалуйста, повторно подключите, указав камеру смартфона на QR -код на экране вашего компьютера. Когда появляется ссылка, коснитесь ее пальцем.",
    hy: "Եթե ​​այս էկրանը սառեցնում է, խնդրում ենք վերամիավորել, մատնանշելով ձեր սմարթֆոնների ֆոտոխցիկը QR կոդում ձեր համակարգչի էկրանին: Երբ հղումը հայտնվում է, դիպչեք ձեր մատով:",
    fi: "Jos tämä näyttö jäädyttää, kytke uudelleen osoittamalla älypuhelinkamerasi QR -koodiin tietokoneen näytöllä. Kun linkki tulee näkyviin, kosketa sitä sormellasi.",
    ka: "თუ ეს ეკრანი იყინება, გთხოვთ, დაუკავშირდეთ თქვენი სმარტფონის კამერას QR კოდზე თქვენს კომპიუტერის ეკრანზე მითითებით. როდესაც ბმული გამოჩნდება, შეეხეთ მას თითით.",
    he: "אם מסך זה קופא, אנא התחבר מחדש על ידי הפניית מצלמת הסמארטפון שלך בקוד ה- QR במסך המחשב שלך. כאשר מופיע קישור, גע בו באצבעך.",
    ar: "إذا كانت هذه الشاشة تتجمد ، فيرجى إعادة الاتصال عن طريق توجيه كاميرا الهاتف الذكي على رمز الاستجابة السريعة على شاشة الكمبيوتر الخاصة بك. عندما يظهر رابط ، المس بإصبعك.",
    ur: "اگر یہ اسکرین جم جاتی ہے تو ، براہ کرم اپنے کمپیوٹر اسکرین پر کیو آر کوڈ پر اپنے اسمارٹ فون کیمرا کی نشاندہی کرکے دوبارہ رابطہ کریں۔ جب کوئی لنک ظاہر ہوتا ہے تو ، اسے اپنی انگلی سے چھوئے۔",
    hi: "यदि यह स्क्रीन फ्रीज हो जाती है, तो कृपया अपने कंप्यूटर स्क्रीन पर QR कोड पर अपने स्मार्टफोन कैमरे को इंगित करके फिर से कनेक्ट करें। जब कोई लिंक दिखाई देता है, तो इसे अपनी उंगली से स्पर्श करें।",
    ta: "இந்தத் திரை உறைந்தால், உங்கள் கணினித் திரையில் QR குறியீட்டில் உங்கள் ஸ்மார்ட்போன் கேமராவை சுட்டிக்காட்டுவதன் மூலம் மீண்டும் இணைக்கவும். ஒரு இணைப்பு தோன்றும்போது, ​​அதை உங்கள் விரலால் தொடவும்.",
    ml: "ഈ സ്ക്രീൻ ഫ്രീസുചെയ്യുകയാണെങ്കിൽ, നിങ്ങളുടെ കമ്പ്യൂട്ടർ സ്ക്രീനിലെ QR കോഡിൽ നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ ക്യാമറ ചൂണ്ടിക്കാണിക്കുക. ഒരു ലിങ്ക് ദൃശ്യമാകുമ്പോൾ, നിങ്ങളുടെ വിരൽ ഉപയോഗിച്ച് സ്പർശിക്കുക.",
    te: "ఈ స్క్రీన్ స్తంభింపజేస్తే, దయచేసి మీ కంప్యూటర్ స్క్రీన్‌లోని QR కోడ్ వద్ద మీ స్మార్ట్‌ఫోన్ కెమెరాను చూపించడం ద్వారా తిరిగి కనెక్ట్ చేయండి. లింక్ కనిపించినప్పుడు, దాన్ని మీ వేలితో తాకండి.",
    kn: "ಈ ಪರದೆಯು ಹೆಪ್ಪುಗಟ್ಟಿದರೆ, ದಯವಿಟ್ಟು ನಿಮ್ಮ ಕಂಪ್ಯೂಟರ್ ಪರದೆಯಲ್ಲಿರುವ ಕ್ಯೂಆರ್ ಕೋಡ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಕ್ಯಾಮೆರಾವನ್ನು ಸೂಚಿಸುವ ಮೂಲಕ ಮರುಸಂಪರ್ಕಿಸಿ. ಲಿಂಕ್ ಕಾಣಿಸಿಕೊಂಡಾಗ, ಅದನ್ನು ನಿಮ್ಮ ಬೆರಳಿನಿಂದ ಸ್ಪರ್ಶಿಸಿ.",
    bn: "যদি এই স্ক্রিনটি হিমশীতল হয় তবে দয়া করে আপনার কম্পিউটারের স্ক্রিনে কিউআর কোডে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করে পুনরায় সংযোগ করুন। যখন কোনও লিঙ্ক উপস্থিত হয়, তখন এটি আপনার আঙুল দিয়ে স্পর্শ করুন।",
    id: "Jika layar ini membeku, silakan terhubung kembali dengan mengarahkan kamera ponsel cerdas Anda di kode QR di layar komputer Anda. Saat tautan muncul, sentuh dengan jari Anda.",
    "zh-CN":
      "如果此屏幕冻结，请通过将智能手机相机指向计算机屏幕上的QR码来重新连接。出现链接时，用手指触摸它。",
    "zh-HK":
      "如果此屏幕凍結，請通過將智能手機相機指向計算機屏幕上的QR碼來重新連接。出現鏈接時，用手指觸摸它。",
    ja: "この画面がフリーズした場合は、コンピューター画面のQRコードにスマートフォンカメラを向けて再接続してください。リンクが表示されたら、指で触れます。",
    ko: "이 화면이 정지되면 컴퓨터 화면의 QR 코드에서 스마트 폰 카메라를 포인트로 연결하여 다시 연결하십시오. 링크가 나타나면 손가락으로 터치하십시오.",
  },
  T_keypadReconnect: {
    "en-US":
    ...
    de: "Die Verbindung ging verloren. Bitte verbinden Sie sich wieder ein, indem Sie Ihre Smartphone -Kamera auf den QR -Code auf Ihrem Computerbildschirm zeigen. Wenn ein Link angezeigt wird, berühren Sie ihn mit Ihrem Finger.",
    fr: "La connexion a été perdue. Veuillez vous reconnecter en pointant votre appareil photo smartphone sur le code QR sur l'écran de votre ordinateur. Lorsqu'un lien apparaît, touchez-le avec votre doigt.",
    es: "La conexión se perdió. Vuelva a conectar señalando la cámara de su teléfono inteligente en el código QR en la pantalla de su computadora. Cuando aparezca un enlace, tócalo con el dedo.",
    pt: "A conexão foi perdida. Reconecte -se apontando a câmera do smartphone no código QR na tela do seu computador. Quando um link aparecer, toque -o com o dedo.",
    it: "La connessione è stata persa. Si prega di riconnettersi puntando la fotocamera dello smartphone sul codice QR sullo schermo del computer. Quando appare un collegamento, toccalo con il dito.",
    ro: "Conexiunea a fost pierdută. Vă rugăm să vă reconectați arătând camera smartphone -ului către codul QR de pe ecranul computerului. Când apare o legătură, atinge -l cu degetul.",
    pl: "Połączenie zostało utracone. Ponownie podłącz się, wskazując aparat smartfona na kod QR na ekranie komputera. Kiedy pojawi się link, dotknij go palcem.",
    ru: "Связь была потеряна. Пожалуйста, повторно подключитесь, указав камеру смартфона на QR -код на экране вашего компьютера. Когда появляется ссылка, коснитесь ее пальцем.",
    hy: "Կապը կորել է: Խնդրում ենք վերամիավորվել `մատնանշելով ձեր սմարթֆոնների տեսախցիկը QR կոդում ձեր համակարգչի էկրանին: Երբ հղումը հայտնվում է, դիպչեք ձեր մատով:",
    fi: "Yhteys katosi. Ota yhteys uudelleen osoittamalla älypuhelinkamerasi tietokoneen näytön QR -koodiin. Kun linkki tulee näkyviin, kosketa sitä sormellasi.",
    ka: "კავშირი დაიკარგა. გთხოვთ, დაუკავშირდეთ თქვენი სმარტფონის კამერას QR კოდზე მიუთითოთ თქვენი კომპიუტერის ეკრანზე. როდესაც ბმული გამოჩნდება, შეეხეთ მას თითით.",
    he: "החיבור אבד. אנא התחבר מחדש על ידי הצבת מצלמת הסמארטפון שלך בקוד ה- QR במסך המחשב שלך. כאשר מופיע קישור, גע בו באצבעך.",
    ar: "فقدت الاتصال. يرجى إعادة الاتصال عن طريق توجيه كاميرا الهاتف الذكي على رمز الاستجابة السريعة على شاشة الكمبيوتر. عندما يظهر رابط ، المس بإصبعك.",
    ur: "کنکشن کھو گیا تھا۔ براہ کرم اپنے کمپیوٹر اسکرین پر کیو آر کوڈ پر اپنے اسمارٹ فون کیمرا کی نشاندہی کرکے دوبارہ رابطہ کریں۔ جب کوئی لنک ظاہر ہوتا ہے تو ، اسے اپنی انگلی سے چھوئے۔",
    hi: "कनेक्शन खो गया था। कृपया अपने कंप्यूटर स्क्रीन पर QR कोड पर अपने स्मार्टफोन कैमरे को इंगित करके फिर से कनेक्ट करें। जब कोई लिंक दिखाई देता है, तो इसे अपनी उंगली से स्पर्श करें।",
    ta: "இணைப்பு இழந்தது. உங்கள் கணினி திரையில் QR குறியீட்டில் உங்கள் ஸ்மார்ட்போன் கேமராவை சுட்டிக்காட்டுவதன் மூலம் மீண்டும் இணைக்கவும். ஒரு இணைப்பு தோன்றும்போது, ​​அதை உங்கள் விரலால் தொடவும்.",
    ml: "കണക്ഷൻ നഷ്ടപ്പെട്ടു. നിങ്ങളുടെ കമ്പ്യൂട്ടർ സ്ക്രീനിലെ QR കോഡിൽ നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ ക്യാമറ ചൂണ്ടിക്കാണിക്കുക. ഒരു ലിങ്ക് ദൃശ്യമാകുമ്പോൾ, നിങ്ങളുടെ വിരൽ ഉപയോഗിച്ച് സ്പർശിക്കുക.",
    te: "కనెక్షన్ పోయింది. దయచేసి మీ స్మార్ట్‌ఫోన్ కెమెరాను మీ కంప్యూటర్ స్క్రీన్‌పై QR కోడ్ వద్ద చూపించడం ద్వారా తిరిగి కనెక్ట్ చేయండి. లింక్ కనిపించినప్పుడు, దాన్ని మీ వేలితో తాకండి.",
    kn: "ಸಂಪರ್ಕವು ಕಳೆದುಹೋಗಿದೆ. ನಿಮ್ಮ ಕಂಪ್ಯೂಟರ್ ಪರದೆಯಲ್ಲಿರುವ ಕ್ಯೂಆರ್ ಕೋಡ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಕ್ಯಾಮೆರಾವನ್ನು ಸೂಚಿಸುವ ಮೂಲಕ ದಯವಿಟ್ಟು ಮರುಸಂಪರ್ಕಿಸಿ. ಲಿಂಕ್ ಕಾಣಿಸಿಕೊಂಡಾಗ, ಅದನ್ನು ನಿಮ್ಮ ಬೆರಳಿನಿಂದ ಸ್ಪರ್ಶಿಸಿ.",
    bn: "সংযোগ হারিয়ে গেছে। আপনার কম্পিউটারের স্ক্রিনে কিউআর কোডে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করে পুনরায় সংযোগ করুন। যখন কোনও লিঙ্ক উপস্থিত হয়, তখন এটি আপনার আঙুল দিয়ে স্পর্শ করুন।",
    id: "Koneksi hilang. Harap terhubung kembali dengan mengarahkan kamera ponsel cerdas Anda di kode QR di layar komputer Anda. Saat tautan muncul, sentuh dengan jari Anda.",
    "zh-CN":
      "连接丢失了。请通过将智能手机相机指向计算机屏幕上的QR码来重新连接。出现链接时，用手指触摸它。",
    "zh-HK":
      "連接丟失了。請通過將智能手機相機指向計算機屏幕上的QR碼來重新連接。出現鏈接時，用手指觸摸它。",
    ja: "接続が失われました。スマートフォンカメラをコンピューター画面のQRコードに向けて、再接続してください。リンクが表示されたら、指で触れます。",
    ko: "연결이 손실되었습니다. 컴퓨터 화면의 QR 코드에서 스마트 폰 카메라를 가리키면 다시 연결하십시오. 링크가 나타나면 손가락으로 터치하십시오.",
  },
  ...
  T_keypadScanQRCode: {
    "en-US":
      "USE SMARTPHONE. To allow a long viewing distance, please recruit your smartphone to act as a wireless keypad. Point your smartphone camera at this QR code. Then use your finger to click the link that appears on your smartphone screen.",
    de: "Verwenden Sie Smartphone. Um eine lange Betrachtungsentfernung zu ermöglichen, rekrutieren Sie bitte Ihr Smartphone, um als drahtlose Tastatur zu fungieren. Zeigen Sie Ihre Smartphone -Kamera auf diesen QR -Code. Klicken Sie dann mit Ihrem Finger auf den Link, der auf Ihrem Smartphone -Bildschirm angezeigt wird.",
    fr: "Utilisez le smartphone. Pour permettre une longue distance de visualisation, veuillez recruter votre smartphone pour agir comme un clavier sans fil. Pointez votre appareil photo pour smartphone sur ce code QR. Utilisez ensuite votre doigt pour cliquer sur le lien qui apparaît sur l'écran de votre smartphone.",
    es: "Use teléfono inteligente. Para permitir una larga distancia de visualización, reclute su teléfono inteligente para actuar como un teclado inalámbrico. Apunte la cámara de su teléfono inteligente en este código QR. Luego use su dedo para hacer clic en el enlace que aparece en la pantalla de su teléfono inteligente.",
    pt: "Use smartphone. Para permitir uma distância de visualização longa, recrute seu smartphone para atuar como um teclado sem fio. Aponte sua câmera de smartphone para este código QR. Em seguida, use o dedo para clicar no link que aparece na tela do smartphone.",
    it: "Usa lo smartphone. Per consentire una lunga distanza di visualizzazione, assumi lo smartphone per fungere da tastiera wireless. Punta la fotocamera per smartphone su questo codice QR. Quindi usa il dito per fare clic sul collegamento che appare sullo schermo dello smartphone.",
    ro: "Folosiți smartphone. Pentru a permite o distanță lungă de vizualizare, vă rugăm să recrutați smartphone -ul pentru a acționa ca o tastatură wireless. Indicați camera smartphone -ului către acest cod QR. Apoi folosiți degetul pentru a face clic pe linkul care apare pe ecranul smartphone -ului.",
    pl: "Użyj smartfona. Aby umożliwić długą odległość oglądania, rekrutuj swój smartfon, aby działał jako klawiatura bezprzewodowa. Skieruj aparat smartfona na ten kod QR. Następnie użyj palca, aby kliknąć link, który pojawi się na ekranie smartfona.",
    ru: "Используйте смартфон. Чтобы разрешить длительное расстояние просмотра, пожалуйста, наберите свой смартфон, чтобы выступать в качестве беспроводной клавиатуры. Укажите камеру смартфона на этом QR -коде. Затем используйте свой палец, чтобы нажать на ссылку, которая появляется на экране вашего смартфона.",
    hy: "Օգտագործեք սմարթֆոնը: Երկար դիտման հեռավորություն թույլ տալու համար խնդրում ենք հավաքագրել ձեր սմարթֆոնը `որպես անլար ստեղնաշարի հանդես գալու համար: Նշեք ձեր սմարթֆոնների ֆոտոխցիկը QR այս կոդով: Այնուհետեւ օգտագործեք ձեր մատը `կտտացնելու հղումը, որը հայտնվում է ձեր սմարթֆոնի էկրանին:",
    fi: "Käytä älypuhelinta. Rekrytoi älypuhelimesi pitkän katseluetäisyyden sallimiseksi toimimaan langattomana näppäimistönä. Osoita älypuhelinkamera tässä QR -koodissa. Napsauta sitten sormella älypuhelimen näytöllä näkyvää linkkiä.",
    ka: "გამოიყენეთ სმარტფონი. გრძელი სანახავი მანძილის დასაშვებად, გთხოვთ, შეაგროვოთ თქვენი სმარტფონი, რომ იმოქმედოთ როგორც უკაბელო კლავიატურა. მიუთითეთ თქვენი სმარტფონის კამერა ამ QR კოდზე. შემდეგ გამოიყენეთ თითი, რომ დააჭირეთ ბმულს, რომელიც გამოჩნდება თქვენს სმარტფონის ეკრანზე.",
    he: "השתמש בסמארטפון. כדי לאפשר מרחק צפייה ארוך, אנא גייס את הסמארטפון שלך כדי לשמש כל לוח מקשים אלחוטי. כוון את מצלמת הסמארטפון שלך בקוד QR זה. לאחר מכן השתמש באצבע שלך כדי ללחוץ על הקישור שמופיע במסך הסמארטפון שלך.",
    ar: "استخدم الهاتف الذكي. للسماح بمسافة عرض طويلة ، يرجى توظيف هاتفك الذكي بالعمل كرسية مفاتيح لاسلكية. أشر كاميرا الهاتف الذكي على رمز الاستجابة السريعة هذا. ثم استخدم إصبعك للنقر على الرابط الذي يظهر على شاشة هاتفك الذكي.",
    ur: "اسمارٹ فون استعمال کریں۔ دیکھنے کے طویل فاصلے کی اجازت دینے کے لئے ، براہ کرم اپنے اسمارٹ فون کو وائرلیس کیپیڈ کے طور پر کام کرنے کے لئے بھرتی کریں۔ اس QR کوڈ پر اپنے اسمارٹ فون کیمرا کی نشاندہی کریں۔ اس کے بعد آپ کے اسمارٹ فون اسکرین پر ظاہر ہونے والے لنک پر کلک کرنے کے لئے اپنی انگلی کا استعمال کریں۔",
    hi: "स्मार्टफोन का उपयोग करें। एक लंबी देखने की दूरी की अनुमति देने के लिए, कृपया अपने स्मार्टफोन को वायरलेस कीपैड के रूप में कार्य करने के लिए भर्ती करें। इस QR कोड पर अपना स्मार्टफोन कैमरा इंगित करें। फिर अपने स्मार्टफोन स्क्रीन पर दिखाई देने वाले लिंक पर क्लिक करने के लिए अपनी उंगली का उपयोग करें।",
    ta: "ஸ்மார்ட்போன் பயன்படுத்தவும். நீண்ட பார்க்கும் தூரத்தை அனுமதிக்க, வயர்லெஸ் விசைப்பலகையாக செயல்பட உங்கள் ஸ்மார்ட்போனை நியமிக்கவும். இந்த QR குறியீட்டில் உங்கள் ஸ்மார்ட்போன் கேமராவை சுட்டிக்காட்டவும். உங்கள் ஸ்மார்ட்போன் திரையில் தோன்றும் இணைப்பைக் கிளிக் செய்ய உங்கள் விரலைப் பயன்படுத்தவும்.",
    ml: "സ്മാർട്ട്ഫോൺ ഉപയോഗിക്കുക. ഒരു നീണ്ട കാഴ്ചപ്പാടുകൾ അനുവദിക്കുന്നതിന്, വയർലെസ് കമാനമായി പ്രവർത്തിക്കാൻ ദയവായി നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ റിക്രൂട്ട് ചെയ്യുക. ഈ QR കോഡിൽ നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ ക്യാമറ പോയിന്റുചെയ്യുക. നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ സ്ക്രീനിൽ ദൃശ്യമാകുന്ന ലിങ്കിൽ ക്ലിക്കുചെയ്യുന്നതിന് നിങ്ങളുടെ വിരൽ ഉപയോഗിക്കുക.",
    te: "స్మార్ట్‌ఫోన్‌ను ఉపయోగించండి. సుదీర్ఘ వీక్షణ దూరాన్ని అనుమతించడానికి, దయచేసి మీ స్మార్ట్‌ఫోన్‌ను వైర్‌లెస్ కీప్యాడ్‌గా పనిచేయడానికి నియమించండి. ఈ QR కోడ్ వద్ద మీ స్మార్ట్‌ఫోన్ కెమెరాను సూచించండి. మీ స్మార్ట్‌ఫోన్ స్క్రీన్‌లో కనిపించే లింక్‌ను క్లిక్ చేయడానికి మీ వేలిని ఉపయోగించండి.",
    kn: "ಸ್ಮಾರ್ಟ್ಫೋನ್ ಬಳಸಿ. ದೀರ್ಘ ವೀಕ್ಷಣೆ ದೂರವನ್ನು ಅನುಮತಿಸಲು, ದಯವಿಟ್ಟು ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಅನ್ನು ವೈರ್‌ಲೆಸ್ ಕೀಪ್ಯಾಡ್ ಆಗಿ ಕಾರ್ಯನಿರ್ವಹಿಸಲು ನೇಮಕ ಮಾಡಿ. ಈ ಕ್ಯೂಆರ್ ಕೋಡ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಕ್ಯಾಮೆರಾವನ್ನು ಸೂಚಿಸಿ. ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಪರದೆಯಲ್ಲಿ ಗೋಚರಿಸುವ ಲಿಂಕ್ ಅನ್ನು ಕ್ಲಿಕ್ ಮಾಡಲು ನಿಮ್ಮ ಬೆರಳನ್ನು ಬಳಸಿ.",
    bn: "স্মার্টফোন ব্যবহার করুন। দীর্ঘ দেখার দূরত্বের অনুমতি দেওয়ার জন্য, দয়া করে আপনার স্মার্টফোনটিকে ওয়্যারলেস কীপ্যাড হিসাবে কাজ করার জন্য নিয়োগ করুন। এই কিউআর কোডটিতে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করুন। তারপরে আপনার স্মার্টফোনের স্ক্রিনে প্রদর্শিত লিঙ্কটি ক্লিক করতে আপনার আঙুলটি ব্যবহার করুন।",
    id: "Gunakan smartphone. Untuk mengizinkan jarak menonton yang panjang, silakan merekrut ponsel cerdas Anda untuk bertindak sebagai keypad nirkabel. Arahkan kamera ponsel cerdas Anda ke kode QR ini. Kemudian gunakan jari Anda untuk mengklik tautan yang muncul di layar ponsel cerdas Anda.",
    "zh-CN":
      "使用智能手机。为了延长观看距离，请招募您的智能手机充当无线键盘。将您的智能手机相机指向此QR码。然后用手指单击智能手机屏幕上出现的链接。",
    "zh-HK":
      "使用智能手機。為了延長觀看距離，請招募您的智能手機充當無線鍵盤。將您的智能手機相機指向此QR碼。然後用手指單擊智能手機屏幕上出現的鏈接。",
    ja: "スマートフォンを使用します。視聴距離が長くなるようにするには、スマートフォンを募集してワイヤレスキーパッドとして機能してください。このQRコードでスマートフォンカメラをポイントします。次に、指を使用して、スマートフォン画面に表示されるリンクをクリックします。",
    ko: "스마트 폰을 사용하십시오. 시청 거리가 길어 지려면 스마트 폰을 모집하여 무선 키패드 역할을하십시오. 이 QR 코드에서 스마트 폰 카메라를 가리 키십시오. 그런 다음 손가락을 사용하여 스마트 폰 화면에 나타나는 링크를 클릭하십시오.",
  },
  T_keypadScanQRCodeSubtitle: {
    "en-US":
      "This will allow you to respond using your phone as a keypad at any viewing distance.",
    ...
    fi: "Tämän avulla voit vastata puhelimesi käyttämällä näppäimistöä millä tahansa katseluetäisyydellä.",
    ka: "ეს საშუალებას მოგცემთ უპასუხოთ თქვენი ტელეფონის, როგორც კლავიშის გამოყენებით, ნებისმიერ სანახავი მანძილზე.",
  ...
  T_letterPopularDemandFeatures: {
    ...
    ka: "❌ T_letterPopularDemandFeatures is obsolete.",
    ...
    ta: "❌ T_letterPopularDemandFeatures is obsolete.",
    ml: "❌ T_letterPopularDemandFeatures is obsolete.",
    te: "❌ T_letterPopularDemandFeatures is obsolete.",
    kn: "❌ T_letterPopularDemandFeatures is obsolete.",
    bn: "❌ T_letterPopularDemandFeatures is obsolete.",
  ...
  T_VernierBrief: {
    ...
    de: "Es ist nach links verschoben. Diese Anzeige ist statisch, daher wäre es einfach, Ihre Augen in die Linien zu bewegen und die Verschiebung zu erzählen. Aber in einem echten Versuch werden die Linien geblitzt, so dass es keine Zeit gibt, Ihre Augen zu bewegen. Es ist wichtig, die Kreuzhaare zu betrachten, wenn Sie jeden Versuch einleiten. Die Linien blinken sofort. Es spielt keine Rolle, wohin Ihre Augen nach dem Blitz gehen. Der erste Testblock ist nur ein paar Versuche der Praxis, bevor wir ernsthaft anfangen.",
    fr: "Il est déplacé vers la gauche. Cet écran est statique, il serait donc facile de déplacer vos yeux vers les lignes et de dire le changement. Mais, dans un vrai essai, les lignes sont flashées, donc il n'y a pas de temps pour bouger vos yeux. Il est important de regarder les poils en vigueur lorsque vous lancez chaque essai. Les lignes clignoteront immédiatement. Peu importe où vos yeux vont après le flash. Le premier bloc de tests n'est que quelques essais de pratique, avant de commencer sérieusement.",
    es: "Se desplaza hacia la izquierda. Esta pantalla es estática, por lo que sería fácil mover los ojos a las líneas y decirle al cambio. Pero, en una prueba real, las líneas se muestran, por lo que no hay tiempo para mover los ojos. Es importante mirar los pelos transversales al iniciar cada prueba. Las líneas parpadearán de inmediato. No importa a dónde van tus ojos después del flash. El primer bloque de pruebas es solo unas pocas pruebas de práctica, antes de comenzar en serio.",
    pt: "Ele se move para a esquerda. Essa tela é estática, por isso seria fácil mover os olhos para as linhas e contar a mudança. Mas, em um teste real, as linhas são mostradas, então não há tempo para mover os olhos. É importante olhar para os cabelos transversais ao iniciar cada teste. As linhas piscarão imediatamente. Não importa onde seus olhos vão depois do flash. O primeiro bloco de teste são apenas alguns testes de prática, antes de começar seriamente.",
    it: "È spostato a sinistra. Questo display è statico, quindi sarebbe facile spostare gli occhi sulle linee e raccontare il turno. Ma, in una vera prova, le linee sono lampeggiate, quindi non c'è tempo per muovere gli occhi. È importante guardare i capelli incrociati mentre si inizia ogni prova. Le linee lamperanno immediatamente. Non importa dove vanno gli occhi dopo il flash. Il primo blocco di test è solo alcune prove di pratica, prima di iniziare sul serio.",
    ro: "Se deplasează spre stânga. Acest ecran este static, deci ar fi ușor să mutați ochii pe linii și să spuneți schimbarea. Dar, într -un test real, liniile sunt afișate, așa că nu există timp pentru a -ți mișca ochii. Este important să ne uităm la firele transversale atunci când începeți fiecare test. Liniile vor clipi imediat. Nu contează unde îți dau ochii după flash. Primul bloc de testare este doar câteva teste de practică, înainte de a începe serios.",
    ...
    fi: "Se on siirretty vasemmalle. Tämä näyttö on staattinen, joten olisi helppoa siirtää silmäsi linjoihin ja kertoa vuoro. Mutta todellisessa oikeudenkäynnissä linjat vilkkuvat, joten silmiäsi ei ole aikaa liikuttaa. On tärkeää tarkastella ristikarvoja aloittaessasi jokaista kokeilua. Linjat vilkkuvat heti. Ei ole väliä missä silmäsi menevät salaman jälkeen. Ensimmäinen testauslohko on vain muutama harjoittelukoe, ennen kuin aloitamme tosissaan.",
    ka: "ის მარცხნივ გადავიდა. ეს ეკრანი სტატიკურია, ასე რომ ადვილი იქნება თქვენი თვალების ხაზების გადატანა და ცვლა. მაგრამ, რეალურ განსაცდელში, ხაზები ააფეთქეს, ასე რომ, თვალების გადაადგილების დრო არ არის. მნიშვნელოვანია, რომ გადახედოთ ჯვრის თმას, როგორც თქვენ იწყებთ თითოეულ საცდელს. ხაზები დაუყოვნებლივ გაისვრის. არ აქვს მნიშვნელობა სად მიდის თქვენი თვალები flash- ის შემდეგ. ტესტირების პირველი ბლოკი მხოლოდ რამდენიმე პრაქტიკის გამოცდაა, სანამ სერიოზულად დავიწყებთ.",
    he: "זה עבר שמאלה. תצוגה זו סטטית, כך שיהיה קל להעביר את העיניים לקווים ולספר את המשמרת. אבל, במשפט אמיתי, הקווים מהבהבים, כך שאין זמן להזיז את העיניים. חשוב להסתכל על שערות הצלב כשאתה יוזם כל ניסוי. הקווים יבהבו מייד. לא משנה לאן העיניים שלך הולכות אחרי ההבזק. גוש הבדיקה הראשון הוא רק כמה ניסויים של תרגול, לפני שנתחיל ברצינות.",
    ar: "لقد تحول إلى اليسار. هذه الشاشة ثابتة ، لذلك سيكون من السهل تحريك عينيك إلى الخطوط وإخبار التحول. ولكن ، في تجربة حقيقية ، يتم تمييز الخطوط ، لذلك لا يوجد وقت لتحريك عينيك. من المهم أن ننظر إلى الشعر المتقاطع أثناء بدء كل تجربة. سوف تومض الخطوط على الفور. لا يهم أين تذهب عينيك بعد الفلاش. المجموعة الأولى من الاختبار هي مجرد تجارب قليلة من الممارسة ، قبل أن نبدأ بجدية.",
    ur: "یہ بائیں طرف چلا گیا۔ یہ کارکردگی مستحکم ہے ، لہذا آپ کی آنکھوں کو لائنوں میں منتقل کرنا اور شفٹوں کو بتانا آسان ہوگا۔ لیکن ، ایک حقیقی امتحان میں ، لکیریں چمکتی ہیں ، لہذا آپ کی آنکھیں منتقل کرنے کا وقت نہیں ہے۔ جب آپ ہر ٹیسٹ شروع کرتے ہیں تو ، کراس بال دیکھنا ضروری ہے۔ لائنیں فورا. ہی چمکیں گی۔ اس سے کوئی فرق نہیں پڑتا ہے کہ آپ کی آنکھیں فلیش کے بعد کہاں جاتی ہیں۔ بیانا میں شروع ہونے سے پہلے ، ٹیسٹ کا پہلا بلاک ورزش کے کچھ ٹیسٹ ہیں۔",
    hi: "यह बाईं ओर स्थानांतरित हो गया। यह प्रदर्शन स्थिर है, इसलिए अपनी आंखों को लाइनों में ले जाना और शिफ्ट बताना आसान होगा। लेकिन, एक वास्तविक परीक्षण में, लाइनें चमकती हैं, इसलिए आपकी आंखों को स्थानांतरित करने का समय नहीं है। जब आप प्रत्येक परीक्षण शुरू करते हैं, तो क्रॉस हेयर को देखना महत्वपूर्ण है। लाइनें तुरंत चमक जाएंगी। इससे कोई फर्क नहीं पड़ता कि आपकी आँखें फ्लैश के बाद कहां जाती हैं। परीक्षण का पहला ब्लॉक अभ्यास के कुछ परीक्षण हैं, इससे पहले कि हम बयाना में शुरू करें।",
    ta: "இது இடதுபுறமாக மாற்றப்பட்டுள்ளது. இந்த காட்சி நிலையானது, எனவே உங்கள் கண்களை வரிகளுக்கு நகர்த்தி மாற்றத்தைச் சொல்வது எளிது. ஆனால், ஒரு உண்மையான சோதனையில், கோடுகள் பறக்கப்படுகின்றன, எனவே உங்கள் கண்களை நகர்த்த நேரமில்லை. ஒவ்வொரு சோதனையையும் நீங்கள் தொடங்கும்போது குறுக்கு முடிகளைப் பார்ப்பது முக்கியம். கோடுகள் உடனடியாக ஒளிரும். ஃபிளாஷ் பின் உங்கள் கண்கள் எங்கு செல்கின்றன என்பது முக்கியமல்ல. சோதனையின் முதல் தொகுதி, நாங்கள் ஆர்வத்துடன் தொடங்குவதற்கு முன்பு, நடைமுறையின் சில சோதனைகள் மட்டுமே.",
    ml: "ഇത് ഇടത്തേക്ക് മാറ്റി. ഈ ഡിസ്പ്ലേ സ്റ്റാറ്റിക് ആണ്, അതിനാൽ നിങ്ങളുടെ കണ്ണുകൾ വരികളിലേക്ക് നീങ്ങാൻ എളുപ്പമായി മാറ്റാൻ എളുപ്പമായിരിക്കും. പക്ഷേ, ഒരു യഥാർത്ഥ ട്രയലിൽ, വരികൾ മിന്നുന്നു, അതിനാൽ നിങ്ങളുടെ കണ്ണുകൾ നീക്കാൻ സമയമില്ല. നിങ്ങൾ ഓരോ ട്രയലും ആരംഭിക്കുമ്പോൾ ക്രോസ് രോമങ്ങൾ നോക്കേണ്ടത് പ്രധാനമാണ്. വരികൾ ഉടനടി ഫ്ലാഷ് ചെയ്യും. നിങ്ങളുടെ കണ്ണുകൾ ഫ്ലാഷിനുശേഷം പോകുന്നത് പ്രശ്നമല്ല. പരിശോധനയുടെ ആദ്യ ബ്ലോക്ക് പരിശീലനത്തിന്റെ ഏതാനും പരീക്ഷണങ്ങൾ മാത്രമാണ്, ഞങ്ങൾ ആത്മാർത്ഥതയോടെ ആരംഭിക്കുന്നതിന് മുമ്പ്.",
    te: "ఇది ఎడమ వైపుకు మార్చబడుతుంది. ఈ ప్రదర్శన స్థిరంగా ఉంది, కాబట్టి మీ కళ్ళను పంక్తులకు తరలించి, షిఫ్ట్‌కు చెప్పడం సులభం. కానీ, నిజమైన విచారణలో, పంక్తులు వెలిగిపోతాయి, కాబట్టి మీ కళ్ళను కదిలించడానికి సమయం లేదు. మీరు ప్రతి ట్రయల్‌ను ప్రారంభించినప్పుడు క్రాస్ హెయిర్‌లను చూడటం చాలా ముఖ్యం. పంక్తులు వెంటనే ఫ్లాష్ అవుతాయి. ఫ్లాష్ తర్వాత మీ కళ్ళు ఎక్కడికి వెళ్తాడనేది పట్టింపు లేదు. పరీక్ష యొక్క మొదటి బ్లాక్ మేము ఆసక్తిగా ప్రారంభించడానికి ముందు, కొన్ని ప్రయత్నాలు సాధన.",
    kn: "ಇದನ್ನು ಎಡಕ್ಕೆ ವರ್ಗಾಯಿಸಲಾಗಿದೆ. ಈ ಪ್ರದರ್ಶನವು ಸ್ಥಿರವಾಗಿದೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ರೇಖೆಗಳಿಗೆ ಸರಿಸಿ ಶಿಫ್ಟ್ ಹೇಳುವುದು ಸುಲಭ. ಆದರೆ, ನಿಜವಾದ ಪ್ರಯೋಗದಲ್ಲಿ, ಸಾಲುಗಳು ಮಿನುಗುತ್ತವೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಸರಿಸಲು ಸಮಯವಿಲ್ಲ. ನೀವು ಪ್ರತಿ ಪ್ರಯೋಗವನ್ನು ಪ್ರಾರಂಭಿಸುವಾಗ ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವುದು ಮುಖ್ಯ. ಸಾಲುಗಳು ತಕ್ಷಣವೇ ಮಿನುಗುತ್ತವೆ. ನಿಮ್ಮ ಕಣ್ಣುಗಳು ಫ್ಲ್ಯಾಷ್ ನಂತರ ಎಲ್ಲಿಗೆ ಹೋಗುತ್ತವೆ ಎಂಬುದು ಮುಖ್ಯವಲ್ಲ. ನಾವು ಶ್ರದ್ಧೆಯಿಂದ ಪ್ರಾರಂಭಿಸುವ ಮೊದಲು ಪರೀಕ್ಷೆಯ ಮೊದಲ ಬ್ಲಾಕ್ ಅಭ್ಯಾಸದ ಕೆಲವು ಪ್ರಯೋಗಗಳು.",
    bn: "এটি বাম দিকে স্থানান্তরিত। এই প্রদর্শনটি স্থির, সুতরাং আপনার চোখগুলি লাইনে সরিয়ে নেওয়া এবং শিফটটি বলা সহজ হবে। তবে, একটি বাস্তব পরীক্ষায়, লাইনগুলি জ্বলজ্বল করা হয়েছে, তাই আপনার চোখ সরানোর কোনও সময় নেই। আপনি প্রতিটি ট্রায়াল শুরু করার সাথে সাথে ক্রস কেশগুলি দেখতে গুরুত্বপূর্ণ। লাইনগুলি তাত্ক্ষণিকভাবে ফ্ল্যাশ হবে। আপনার চোখ ফ্ল্যাশের পরে কোথায় যায় তা বিবেচ্য নয়। পরীক্ষার প্রথম ব্লকটি আমরা আন্তরিকভাবে শুরু করার আগে অনুশীলনের কয়েকটি পরীক্ষা।",
    id: "Itu bergeser ke kiri. Layar ini statis, jadi akan mudah untuk menggerakkan mata Anda ke garis dan memberi tahu shift. Tapi, dalam uji coba nyata, garis -garisnya muncul, jadi tidak ada waktu untuk menggerakkan mata Anda. Penting untuk melihat rambut silang saat Anda memulai setiap percobaan. Garis -garis akan segera berkedip. Tidak masalah ke mana mata Anda mengejar kilat. Blok pengujian pertama hanyalah beberapa percobaan latihan, sebelum kita mulai dengan sungguh -sungguh.",
    "zh-CN":
    ...
    ko: "왼쪽으로 이동했습니다. 이 디스플레이는 정적이므로 눈으로 눈을 움직여 쉽게 이동할 수 있습니다. 그러나 실제 시험에서는 선이 번쩍이므로 눈을 움직일 시간이 없습니다. 각 시험을 시작할 때 십자 머리카락을 보는 것이 중요합니다. 선이 즉시 깜박입니다. 플래시 후 눈이 어디로 가는지는 중요하지 않습니다. 테스트의 첫 번째 블록은 우리가 본격적으로 시작하기 전에 몇 가지 실무 시험입니다.",
  },
  T_middleLetterBrief: {
    "en-US":
    ...
    "zh-HK":
      "這是一個 R。因為字母一直顯示在屏幕上，所以您只需移動一下視線就能輕鬆認出它。在接下來的試驗中，字母都將一閃而過，所以您不會有時間來調整您的視線。",
    ja: "これはRです。この画面は動いていないため、目を文字の位置に動かして確認するのは容易でしょう。本番のテストでは、文字は一瞬しか映されないので、目を動かす時間はないでしょう。",
    ko: "이 디스플레이는 정적이므로 눈을 편지로 이동하여 식별하기가 쉽습니다. 그러나 실제 시험에서는 글자가 번쩍이므로 눈을 움직일 시간이 없습니다. 시험을 시작할 때 십자 머리카락을 보는 것이 중요합니다. 편지는 즉시 플래시됩니다. 플래시 후 눈이 어디로 가는지는 중요하지 않습니다. 테스트의 첫 번째 블록은 우리가 본격적으로 시작하기 전에 몇 가지 실무 시험입니다.",
  },
  T_VernierDemo: {
    "en-US":
    ...
    de: "Während Sie bei jedem Versuch die Kreuzhaare betrachten, blinken irgendwo zwei Linien. Vielleicht wo du siehst; Vielleicht im Augenwinkel. Nur ein Blitz. Um die Aufgabe zu lernen, versuchen wir es zuerst mit einer statischen Anzeige. Beim Betrachten der Kreuzhaare unten, ohne Ihre Augen zu bewegen: Ist die obere Linie nach links oder rechts, relativ zur unteren Linie?",
    fr: "À chaque essai, pendant que vous regardez les poils, une paire de lignes clignotera quelque part. Peut-être où vous cherchez; Peut-être dans le coin de votre œil. Juste un flash. Pour apprendre la tâche, essayons d'abord avec un écran statique. En regardant les poils, ci-dessous, sans bouger les yeux: la ligne supérieure est-elle décalée à gauche ou à droite, par rapport à la ligne inférieure?",
    es: "En cada prueba, mientras miras los pelos de la cruz, un par de líneas parpadearán en alguna parte. Tal vez donde estás mirando; Tal vez en la esquina de tu ojo. Solo un destello. Para aprender la tarea, intentémosla primero con una pantalla estática. Mientras mira los pelos transversales, debajo, sin mover los ojos: ¿la línea superior se desplaza hacia la izquierda o hacia la derecha, en relación con la línea inferior?",
    pt: "Em cada teste, enquanto você olha para os cabelos cruzados, um par de linhas piscará em algum lugar. Talvez onde você esteja olhando; Talvez no canto do seu olho. Apenas um instante. Para aprender a tarefa, vamos tentar primeiro com uma tela estática. Enquanto olha para os cabelos cruzados, abaixo, sem mover os olhos: a linha superior é deslocada para a esquerda ou para a direita, em relação à linha inferior?",
    it: "Ad ogni prova, mentre guardi i capelli incrociati, un paio di linee lampeggerà da qualche parte. Forse dove stai guardando; Forse nell'angolo dell'occhio. Solo un lampo. Per imparare l'attività, proviamo prima con un display statico. Mentre guardi i peli incrociati, sotto, senza muovere gli occhi: la linea superiore è spostata a sinistra o a destra, rispetto alla linea inferiore?",
    ro: "La fiecare încercare, în timp ce te uiți la părul încrucișat, o pereche de linii se va clipi undeva. Poate unde te uiți; Poate în colțul ochiului tău. Doar un bliț. Pentru a învăța sarcina, să o încercăm mai întâi cu un afișaj static. În timp ce te uiți la părul încrucișat, mai jos, fără să -ți mișci ochii: linia superioară este deplasată la stânga sau la dreapta, în raport cu linia inferioară?",
    pl: "Podczas każdej próby, patrząc na włosy krzyżowe, para linii gdzieś błysnę. Może gdzie szukasz; Może w rogu oka. Tylko błysk. Aby nauczyć się tego zadania, spróbujmy najpierw z wyświetlaczem statycznym. Patrząc na włosy krzyżowe, poniżej, bez poruszania oczu: czy górna linia jest przesunięta w lewo lub w prawo, w stosunku do dolnej linii?",
    ru: "На каждом испытании, пока вы смотрите на кросс -волосы, где -то будет мигает пара линий. Может, где вы ищете; Может быть, в углу глаза. Просто вспышка. Чтобы узнать задачу, давайте сначала попробуем ее со статическим дисплеем. Глядя на кросс -волоски, внизу, не двигая глазами: верхняя линия смещается влево или вправо относительно нижней линии?",
    hy: "Յուրաքանչյուր փորձության ընթացքում, մինչ դուք նայում եք խաչի մազերին, մի զույգ տող կփչանա ինչ-որ տեղ: Միգուցե որտեղ եք փնտրում; Միգուցե ձեր աչքի անկյունում: Պարզապես ֆլեշ: Առաջադրանքը սովորելու համար, եկեք նախ փորձենք ստատիկ էկրանով: Նայելով խաչի մազերը, ներքեւում, առանց ձեր աչքերը տեղափոխելու. Վերին գիծը ձախ կամ աջ է, համեմատած ստորին գծի հետ:",
    fi: "Jokaisessa kokeilussa katsot ristikarvoja, pari linjaa vilkkuu jossain. Ehkä missä etsit; Ehkä silmäsi nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun tarkastellaan ristikonoja, alla, liikkumatta silmiäsi: Onko ylempi linja siirtynyt vasemmalle tai oikealle, verrattuna alaviivaan?",
    ka: "თითოეულ განსაცდელზე, სანამ ჯვრის თმას უყურებთ, წყვილი ხაზები სადმე გაისვრის. იქნებ სადაც ეძებთ; შეიძლება თვალის კუთხეში. უბრალოდ ფლეშ. დავალების შესასწავლად, პირველ რიგში, ვცადოთ სტატიკური ჩვენებით. ჯვრის თმას გადახედვისას, ქვემოთ, თვალების გადაადგილების გარეშე: ზედა ხაზი მარცხნივ ან მარჯვნივ არის გადაკეთებული, ქვედა ხაზთან შედარებით?",
    he: "בכל ניסוי, בזמן שאתה מסתכל על שערות הצלב, זוג קווים יבהב איפשהו. אולי איפה שאתה מחפש; אולי בזווית העין שלך. רק פלאש. כדי ללמוד את המשימה, בואו ננסה אותה תחילה עם תצוגה סטטית. בזמן שהם מסתכלים על שערות הצלב, למטה, מבלי להזיז את העיניים: האם הקו העליון מועבר שמאלה או ימינה, יחסית לקו התחתון?",
    ar: "في كل تجربة ، بينما تنظر إلى الشعر المتقاطع ، سوف يومض زوج من الخطوط في مكان ما. ربما أين تبحث. ربما في زاوية عينيك. مجرد ومضة. لمعرفة المهمة ، دعنا نجربها أولاً بعرض ثابت. أثناء النظر إلى الشعر المتقاطع ، أدناه ، دون تحريك عينيك: هل تم تحول الخط العلوي إلى اليسار أو اليمين ، بالنسبة للخط السفلي؟",
    ur: "ہر آزمائش پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، لائنوں کا ایک جوڑا کہیں چمک اٹھے گا۔ شاید جہاں آپ دیکھ رہے ہو ؛ شاید آپ کی آنکھ کے کونے میں۔ صرف ایک فلیش۔ کام کو سیکھنے کے ل let ، آئیے پہلے جامد ڈسپلے کے ساتھ اسے آزمائیں۔ کراس بالوں کو دیکھتے ہوئے ، نیچے ، اپنی آنکھوں کو حرکت دیئے بغیر: کیا نچلی لائن کے نسبت اوپری لائن بائیں یا دائیں منتقل کی جاتی ہے؟",
    hi: "प्रत्येक परीक्षण पर, जब आप क्रॉस हेयर को देखते हैं, तो लाइनों की एक जोड़ी कहीं न कहीं चमकती है। शायद आप कहाँ देख रहे हैं; शायद आपकी आंख के कोने में। बस एक झलक। कार्य को जानने के लिए, इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आंखों को हिलाने के बिना, नीचे, नीचे के बालों को देखते हुए: क्या ऊपरी रेखा निचली रेखा के सापेक्ष बाएं या दाएं स्थानांतरित हो गई है?",
    ta: "ஒவ்வொரு சோதனையிலும், நீங்கள் குறுக்கு முடிகளைப் பார்க்கும்போது, ​​ஒரு ஜோடி கோடுகள் எங்காவது ஒளிரும். ஒருவேளை நீங்கள் தேடும் இடத்தில்; உங்கள் கண்ணின் மூலையில் இருக்கலாம். ஒரு ஃபிளாஷ். பணியைக் கற்றுக்கொள்ள, நிலையான காட்சியுடன் முதலில் முயற்சிப்போம். குறுக்கு முடிகளைப் பார்க்கும்போது, ​​கீழே, உங்கள் கண்களை நகர்த்தாமல்: மேல் கோடு இடது அல்லது வலதுபுறமாக மாற்றப்பட்டதா, கீழ் வரியுடன் ஒப்பிடும்போது?",
    ml: "ഓരോ വിചാരണയിലും, നിങ്ങൾ ക്രോസ് ഹെയർ നോക്കുമ്പോൾ, ഒരു ജോടി വരികൾ എവിടെയെങ്കിലും മിന്നുമാകും. നിങ്ങൾ എവിടെയാണ് നോക്കുന്നത്? ഒരുപക്ഷേ നിങ്ങളുടെ കണ്ണിന്റെ മൂലയിൽ. ഒരു ഫ്ലാഷ് മാത്രം. ടാസ്ക് പഠിക്കാൻ, ഒരു സ്റ്റാറ്റിക് ഡിസ്പ്ലേ ഉപയോഗിച്ച് ആദ്യം ഇത് പരീക്ഷിക്കാം. നിങ്ങളുടെ കണ്ണുകൾ നീക്കാതെ, ചുവടെയുള്ള രോമങ്ങൾ നോക്കുമ്പോൾ: മുകളിലെ ലൈൻ ഇടത്തോട്ടോ വലത്തോട്ടോ മാറ്റുന്നത് ലോവർ ലൈനുമായി താരതമ്യപ്പെടുത്തുമോ?",
    te: "ప్రతి ట్రయల్‌లో, మీరు క్రాస్ హెయిర్‌లను చూస్తున్నప్పుడు, ఒక జత పంక్తులు ఎక్కడో మెరుస్తాయి. బహుశా మీరు ఎక్కడ చూస్తున్నారు; మీ కంటి మూలలో ఉండవచ్చు. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో దీన్ని ప్రయత్నిద్దాం. మీ కళ్ళను కదిలించకుండా, క్రింద, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు: ఎగువ రేఖ ఎడమ లేదా కుడి వైపుకు మారుతుందా, దిగువ రేఖకు సంబంధించి?",
    kn: "ಪ್ರತಿ ಪ್ರಯೋಗದಲ್ಲೂ, ನೀವು ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವಾಗ, ಒಂದು ಜೋಡಿ ಸಾಲುಗಳು ಎಲ್ಲೋ ಮಿಂಚುತ್ತವೆ. ಬಹುಶಃ ನೀವು ಎಲ್ಲಿ ನೋಡುತ್ತಿದ್ದೀರಿ; ಬಹುಶಃ ನಿಮ್ಮ ಕಣ್ಣಿನ ಮೂಲೆಯಲ್ಲಿರಬಹುದು. ಕೇವಲ ಒಂದು ಫ್ಲ್ಯಾಷ್. ಕಾರ್ಯವನ್ನು ಕಲಿಯಲು, ಸ್ಥಿರ ಪ್ರದರ್ಶನದೊಂದಿಗೆ ಮೊದಲು ಇದನ್ನು ಪ್ರಯತ್ನಿಸೋಣ. ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವಾಗ, ಕೆಳಗೆ, ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಚಲಿಸದೆ: ಮೇಲಿನ ರೇಖೆಯು ಎಡ ಅಥವಾ ಬಲಕ್ಕೆ, ಕೆಳಗಿನ ಸಾಲಿಗೆ ಹೋಲಿಸಿದರೆ ಸ್ಥಳಾಂತರಗೊಂಡಿದೆಯೇ?",
    bn: "প্রতিটি পরীক্ষায়, আপনি ক্রস চুলের দিকে তাকানোর সময়, এক জোড়া লাইন কোথাও ফ্ল্যাশ হয়ে যাবে। আপনি যেখানে খুঁজছেন সেখানে হতে পারে; আপনার চোখের কোণে হতে পারে। শুধু একটা ঝলকানি. টাস্কটি শিখতে, আসুন প্রথমে এটি একটি স্থির প্রদর্শন দিয়ে চেষ্টা করি। আপনার চোখ না সরিয়ে নীচে ক্রস চুলের দিকে তাকানোর সময়: নীচের লাইনের তুলনায় উপরের রেখাটি বাম বা ডানদিকে স্থানান্তরিত হয়?",
    id: "Pada setiap percobaan, saat Anda melihat rambut silang, sepasang garis akan berkedip di suatu tempat. Mungkin tempat Anda mencari; Mungkin di sudut matamu. Hanya sekejap. Untuk mempelajari tugas ini, mari kita coba terlebih dahulu dengan tampilan statis. Saat melihat rambut silang, di bawah, tanpa menggerakkan mata Anda: apakah garis atas bergeser ke kiri atau kanan, relatif ke garis bawah?",
    "zh-CN":
      "在每个试验中，当您看着十字头发时，一条线条将在某个地方闪烁。也许您正在寻找的地方；也许在你的眼角。只是一个闪光。要学习任务，让我们先尝试使用静态显示器。在看下面的十字头发时，没有移动眼睛：相对于下线，上线是向左还是向右移动？",
    "zh-HK":
      "在每個試驗中，當您看著十字頭髮時，一條線條將在某個地方閃爍。也許您正在尋找的地方；也許在你的眼角。只是一個閃光。要學習任務，讓我們先嘗試使用靜態顯示器。在看下面的十字頭髮時，沒有移動眼睛：相對於下線，上線是向左還是向右移動？",
    ja: "各トライアルでは、交差毛を見ている間、一対の線がどこかに点滅します。たぶんあなたが探している場所。多分あなたの目の隅に。ちょっとしたフラッシュ。タスクを学ぶには、静的ディスプレイで最初に試してみましょう。下の目を動かすことなく、下の毛を見ている間、上線は下線に比べて左または右にシフトされていますか？",
    ko: "각 시험에서 십자형 머리카락을 보면서 한 쌍의 선이 어딘가에 번쩍입니다. 어쩌면 당신이보고있는 곳; 어쩌면 당신의 눈의 구석에있을 수도 있습니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보면서 : 상단 선이 왼쪽 또는 오른쪽으로 하단 라인에 비해 이동합니까?",
  },
  T_middleLetterDemo: {
    "en-US":
    ...
    de: "Während Sie bei jedem Versuch die Kreuzhaare betrachten, blinkt ein Drilltelaus mit drei zufälligen Buchstaben in Ihrem Augenwinkel. Nur ein Blitz. Um die Aufgabe zu lernen, versuchen wir es zuerst mit einer statischen Anzeige. Beim Betrachten der Kreuzhaare unten, ohne Ihre Augen zu bewegen: Was ist der mittlere Buchstaben?",
    fr: "À chaque essai, pendant que vous regardez les poils, un triplet de trois lettres aléatoires clignotera dans le coin de votre œil. Juste un flash. Pour apprendre la tâche, essayons d'abord avec un écran statique. En regardant les poils, ci-dessous, sans bouger les yeux: quelle est la lettre du milieu?",
    es: "En cada prueba, mientras mira la cruz, un triplete de tres letras aleatorias parpadeará en la esquina de su ojo. Solo un destello. Para aprender la tarea, intentémosla primero con una pantalla estática. Mientras mira los pelos de la cruz, a continuación, sin mover los ojos: ¿Cuál es la letra del medio?",
    pt: "Em cada teste, enquanto olha para a cruz, três letras de letras aleatórias piscam no canto do olho. Apenas um instante. Para aprender a tarefa, vamos tentar primeiro com uma tela estática. Enquanto olhava para os cabelos da cruz, então, sem mover os olhos: qual é a letra do meio?",
    it: "Ad ogni prova, mentre guardi i capelli incrociati, una tripletta di tre lettere casuali lampeggerà nell'angolo dell'occhio. Solo un lampo. Per imparare l'attività, proviamo prima con un display statico. Mentre guardi i capelli incrociati, sotto, senza muovere gli occhi: qual è la lettera di mezzo?",
    ro: "În fiecare test, în timp ce privești crucea, un trei -ștergători de litere aleatorii vor clipi la colțul ochiului său. Doar un bliț. Pentru a învăța sarcina, să încercăm mai întâi cu un ecran static. În timp ce privești părul crucii, atunci, fără a mișca ochii: care este litera mediului?",
    ...
    fi: "Jokaisessa kokeessa, kun tarkastellaan ristikarvoja, kolmen satunnaisen kirjaimen kolminkertainen vilkkuu silmäsi nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun katsot ristikkäitä hiuksia alla, liikkumatta silmiäsi: mikä on keskimmäinen kirjain?",
    ka: "თითოეულ განსაცდელზე, სანამ ჯვრის თმას უყურებთ, სამი შემთხვევითი ასოების ტრიპლეტი თქვენს თვალის კუთხეში გაისვრის. უბრალოდ ფლეშ. დავალების შესასწავლად, პირველ რიგში, ვცადოთ სტატიკური ჩვენებით. ჯვრის თმას გადახედვისას, ქვემოთ, თვალების გადაადგილების გარეშე: რა არის შუა ასო?",
    he: "בכל ניסיון, בזמן שאתה מסתכל על שערות הצלב, שלישייה של שלוש אותיות אקראיות תבהב בפינת העין שלך. רק פלאש. כדי ללמוד את המשימה, בואו ננסה אותה תחילה עם תצוגה סטטית. בזמן שאתה מסתכל על שערות הצלב, למטה, מבלי להזיז את העיניים: מה האות האמצעית?",
    ar: "في كل تجربة ، بينما تنظر إلى الشعر المتقاطع ، ستوضيب ثلاثة أحرف عشوائية في زاوية عينيك. مجرد ومضة. لمعرفة المهمة ، دعنا نجربها أولاً بعرض ثابت. أثناء النظر إلى الشعر المتقاطع ، أدناه ، دون تحريك عينيك: ما هي الرسالة الوسطى؟",
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو جاننے کے ل first ، پہلے اسے مستحکم کارکردگی کے ساتھ آزمائیں۔ آنکھیں ہلائے بغیر ، کراس بالوں کو نیچے ، نیچے ، درمیانی کاغذ کیا ہے؟",
    hi: "प्रत्येक परीक्षण पर, जब आप क्रॉस हेयर को देखते हैं, तो तीन यादृच्छिक अक्षरों का एक ट्रिपल आपकी आंख के कोने में चमक जाएगा। बस एक झलक। कार्य को जानने के लिए, इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। क्रॉस हेयर को देखते हुए, नीचे, अपनी आँखों को हिलाने के बिना: मध्य पत्र क्या है?",
    ta: "ஒவ்வொரு சோதனையிலும், நீங்கள் குறுக்கு முடிகளைப் பார்க்கும்போது, ​​மூன்று சீரற்ற எழுத்துக்களின் மும்மடங்கு உங்கள் கண்ணின் மூலையில் ஒளிரும். ஒரு ஃபிளாஷ். பணியைக் கற்றுக்கொள்ள, நிலையான காட்சியுடன் முதலில் முயற்சிப்போம். குறுக்கு முடிகளைப் பார்க்கும்போது, ​​கீழே, உங்கள் கண்களை நகர்த்தாமல்: நடுத்தர கடிதம் என்ன?",
    ml: "ഓരോ വിചാരണയിലും, നിങ്ങൾ ക്രോസ് ഹെയർ നോക്കുമ്പോൾ, ക്രമരഹിതമായ മൂന്ന് അക്ഷരങ്ങളുടെ ഒരു മൂന്നിരട്ടി നിങ്ങളുടെ കണ്ണിന്റെ മൂലയിൽ മിന്നുമാകും. ഒരു ഫ്ലാഷ് മാത്രം. ടാസ്ക് പഠിക്കാൻ, ഒരു സ്റ്റാറ്റിക് ഡിസ്പ്ലേ ഉപയോഗിച്ച് ആദ്യം ഇത് പരീക്ഷിക്കാം. നിങ്ങളുടെ കണ്ണുകൾ നീക്കാതെ, ചുവടെയുള്ള രോമങ്ങൾ നോക്കുമ്പോൾ: മധ്യ കത്ത് എന്താണ്?",
    te: "ప్రతి ట్రయల్‌లో, మీరు క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, మూడు యాదృచ్ఛిక అక్షరాల త్రిపాది మీ కంటి మూలలో మెరుస్తుంది. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో దీన్ని ప్రయత్నిద్దాం. మీ కళ్ళను కదిలించకుండా, క్రింద, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు: మధ్య అక్షరం ఏమిటి?",
    kn: "ಪ್ರತಿ ಪ್ರಯೋಗದಲ್ಲೂ, ನೀವು ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವಾಗ, ನಿಮ್ಮ ಕಣ್ಣಿನ ಮೂಲೆಯಲ್ಲಿ ಮೂರು ಯಾದೃಚ್ leters ಿಕ ಅಕ್ಷರಗಳ ತ್ರಿವಳಿಗಳು ಮಿಂಚುತ್ತವೆ. ಕೇವಲ ಒಂದು ಫ್ಲ್ಯಾಷ್. ಕಾರ್ಯವನ್ನು ಕಲಿಯಲು, ಸ್ಥಿರ ಪ್ರದರ್ಶನದೊಂದಿಗೆ ಮೊದಲು ಇದನ್ನು ಪ್ರಯತ್ನಿಸೋಣ. ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವಾಗ, ಕೆಳಗೆ, ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಚಲಿಸದೆ: ಮಧ್ಯದ ಅಕ್ಷರ ಎಂದರೇನು?",
    bn: "প্রতিটি পরীক্ষায়, আপনি ক্রস চুলের দিকে তাকানোর সময়, তিনটি এলোমেলো অক্ষরের একটি ট্রিপলেট আপনার চোখের কোণে ফ্ল্যাশ হয়ে যাবে। শুধু একটা ঝলকানি. টাস্কটি শিখতে, আসুন প্রথমে এটি একটি স্থির প্রদর্শন দিয়ে চেষ্টা করি। আপনার চোখ না সরিয়ে নীচে ক্রস চুলের দিকে তাকানোর সময়: মাঝের অক্ষরটি কী?",
    id: "Pada setiap percobaan, saat Anda melihat rambut silang, kembar tiga dari tiga huruf acak akan berkedip di sudut mata Anda. Hanya sekejap. Untuk mempelajari tugas ini, mari kita coba terlebih dahulu dengan tampilan statis. Sambil melihat rambut salib, di bawah, tanpa menggerakkan mata Anda: apa huruf tengahnya?",
    "zh-CN":
    ...
    ko: "각 시험에서 십자형 머리카락을 보면서 3 개의 임의의 문자가 눈의 모퉁이에서 번쩍입니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보면서 : 중간 편지는 무엇입니까?",
  },
  T_letterBrief: {
    "en-US":
  ...
  T_letterDemo: {
    ...
    de: "Bei jedem Versuch blinkt ein zufälliger Brief in den Augenwinkel. Nur ein Blitz. Um die Aufgabe zu lernen, versuchen wir es zuerst mit einer statischen Anzeige. Beim Betrachten der Kreuzhaare unten, ohne Ihre Augen zu bewegen: Welcher Buchstabe ist das?",
    fr: "À chaque essai, une lettre aléatoire clignote dans le coin de votre œil. Juste un flash. Pour apprendre la tâche, essayons d'abord avec un écran statique. En regardant les poils, ci-dessous, sans bouger les yeux: de quelle lettre s'agit-il?",
    es: "En cada prueba, una letra aleatoria parpadeará en la esquina de su ojo. Solo un destello. Para aprender la tarea, intentémosla primero con una pantalla estática. Mientras mira los pelos de la cruz, a continuación, sin mover los ojos: ¿Qué letra es?",
    pt: "Em cada teste, uma carta aleatória piscará no canto do olho. Apenas um instante. Para aprender a tarefa, vamos tentar primeiro com uma tela estática. Enquanto olha os cabelos cruzados, abaixo, sem mover os olhos: que carta é?",
    it: "Ad ogni prova, una lettera casuale lampeggerà nell'angolo dell'occhio. Solo un lampo. Per imparare l'attività, proviamo prima con un display statico. Mentre guardi i capelli incrociati, sotto, senza muovere gli occhi: che lettera è?",
    ro: "La fiecare proces, o scrisoare aleatorie se va clipi în colțul ochiului. Doar un bliț. Pentru a învăța sarcina, să o încercăm mai întâi cu un afișaj static. În timp ce privești părul încrucișat, mai jos, fără să -ți mișci ochii: ce scrisoare este?",
    pl: "Podczas każdej próby losowa litera błyszczy w rogu oka. Tylko błysk. Aby nauczyć się tego zadania, spróbujmy najpierw z wyświetlaczem statycznym. Patrząc na krzyżowe włosy poniżej, bez poruszania oczami: jaka to litera?",
    ru: "На каждом испытании случайная буква будет мигать в углу вашего глаза. Просто вспышка. Чтобы узнать задачу, давайте сначала попробуем ее со статическим дисплеем. Глядя на кросс -волосы, ниже, не двигая глазами: какая это буква?",
    hy: "Յուրաքանչյուր փորձության վրա պատահական նամակ կփչանա ձեր աչքի անկյունում: Պարզապես ֆլեշ: Առաջադրանքը սովորելու համար, եկեք նախ փորձենք ստատիկ էկրանով: Անցնելով խաչի մազերը, ներքեւում, առանց ձեր աչքերը տեղափոխելու. Ինչ նամակ է:",
    fi: "Jokaisessa kokeessa satunnainen kirje vilkkuu silmän nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun katsot ristikkäitä hiuksia alla, liikkumatta silmiäsi: mikä kirjain se on?",
    ka: "თითოეულ საცდელზე, შემთხვევითი წერილი თვალის კუთხეში გაისვრის. უბრალოდ ფლეშ. დავალების შესასწავლად, პირველ რიგში, ვცადოთ სტატიკური ჩვენებით. ჯვრის თმას გადახედვისას, ქვემოთ, თვალების გადაადგილების გარეშე: რა ასოა?",
    he: "בכל ניסיון, מכתב אקראי יבהב בפינת העין שלך. רק פלאש. כדי ללמוד את המשימה, בואו ננסה אותה תחילה עם תצוגה סטטית. בזמן שאתה מסתכל על שערות הצלב, למטה, מבלי להזיז את העיניים: איזה מכתב זה?",
    ar: "في كل تجربة ، سوف تومض رسالة عشوائية في زاوية عينيك. مجرد ومضة. لمعرفة المهمة ، دعنا نجربها أولاً بعرض ثابت. أثناء النظر إلى الشعر المتقاطع ، أدناه ، دون تحريك عينيك: ما هو الحرف؟",
    ur: "ہر آزمائش پر ، ایک بے ترتیب خط آپ کی آنکھ کے کونے میں چمکتا ہے۔ صرف ایک فلیش۔ کام کو سیکھنے کے ل let ، آئیے پہلے جامد ڈسپلے کے ساتھ اسے آزمائیں۔ اپنی آنکھیں حرکت کیے بغیر ، نیچے ، کراس بالوں کو دیکھتے ہوئے: یہ کون سا خط ہے؟",
    hi: "प्रत्येक परीक्षण पर, एक यादृच्छिक पत्र आपकी आंख के कोने में चमक जाएगा। बस एक झलक। कार्य को जानने के लिए, इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आँखों को हिलाने के बिना, नीचे, नीचे के बालों को देखते हुए: यह कौन सा पत्र है?",
    ta: "ஒவ்வொரு சோதனையிலும், ஒரு சீரற்ற கடிதம் உங்கள் கண்ணின் மூலையில் ஒளிரும். ஒரு ஃபிளாஷ். பணியைக் கற்றுக்கொள்ள, நிலையான காட்சியுடன் முதலில் முயற்சிப்போம். குறுக்கு முடிகளைப் பார்க்கும்போது, ​​கீழே, கண்களை நகர்த்தாமல்: அது என்ன கடிதம்?",
    ml: "ഓരോ വിചാരണയിലും, ക്രമരഹിതമായ ഒരു കത്ത് നിങ്ങളുടെ കണ്ണിന്റെ മൂലയിൽ ഫ്ലാഷ് ചെയ്യും. ഒരു ഫ്ലാഷ് മാത്രം. ടാസ്ക് പഠിക്കാൻ, ഒരു സ്റ്റാറ്റിക് ഡിസ്പ്ലേ ഉപയോഗിച്ച് ആദ്യം ഇത് പരീക്ഷിക്കാം. നിങ്ങളുടെ കണ്ണുകൾ നീക്കാതെ, ചുവടെയുള്ള രോമങ്ങൾ നോക്കുമ്പോൾ: ഇത് ഏത് കത്താണ്?",
    te: "ప్రతి విచారణలో, యాదృచ్ఛిక అక్షరం మీ కంటి మూలలో మెరుస్తుంది. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో దీన్ని ప్రయత్నిద్దాం. మీ కళ్ళను కదిలించకుండా, క్రింద, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు: ఇది ఏ లేఖ?",
    kn: "ಪ್ರತಿ ಪ್ರಯೋಗದಲ್ಲೂ, ನಿಮ್ಮ ಕಣ್ಣಿನ ಮೂಲೆಯಲ್ಲಿ ಯಾದೃಚ್ leter ವಾದ ಅಕ್ಷರವು ಮಿನುಗುತ್ತದೆ. ಕೇವಲ ಒಂದು ಫ್ಲ್ಯಾಷ್. ಕಾರ್ಯವನ್ನು ಕಲಿಯಲು, ಸ್ಥಿರ ಪ್ರದರ್ಶನದೊಂದಿಗೆ ಮೊದಲು ಇದನ್ನು ಪ್ರಯತ್ನಿಸೋಣ. ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವಾಗ, ಕೆಳಗೆ, ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಚಲಿಸದೆ: ಅದು ಯಾವ ಪತ್ರ?",
    bn: "প্রতিটি পরীক্ষায়, একটি এলোমেলো চিঠি আপনার চোখের কোণে ফ্ল্যাশ হবে। শুধু একটা ঝলকানি. টাস্কটি শিখতে, আসুন প্রথমে এটি একটি স্থির প্রদর্শন দিয়ে চেষ্টা করি। আপনার চোখ না সরিয়ে নীচে ক্রস চুলের দিকে তাকানোর সময়: এটি কী চিঠি?",
    id: "Pada setiap percobaan, surat acak akan berkedip di sudut mata Anda. Hanya sekejap. Untuk mempelajari tugas ini, mari kita coba terlebih dahulu dengan tampilan statis. Saat melihat rambut salib, di bawah, tanpa menggerakkan mata Anda: surat apa itu?",
    "zh-CN":
      "在每个试验中，随机字母将在您的眼角闪烁。只是一个闪光。要学习任务，让我们先尝试使用静态显示器。在下面看着十字的头发时，没有动眼睛：这是什么字母？",
    "zh-HK":
      "在每個試驗中，隨機字母將在您的眼角閃爍。只是一個閃光。要學習任務，讓我們先嘗試使用靜態顯示器。在下面看著十字的頭髮時，沒有動眼睛：這是什麼字母？",
    ja: "各トライアルでは、ランダムな文字が目の隅に点滅します。ちょっとしたフラッシュ。タスクを学ぶには、静的ディスプレイで最初に試してみましょう。目を動かすことなく、下の毛を見ている間、それはどんな文字ですか？",
    ko: "각 시험에서, 임의의 편지는 당신의 눈의 모퉁이에서 번쩍입니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보면서 : 어떤 편지입니까?",
  },
  T_ok: {
    "en-US": "OK",
    de: "OK",
  ...
  T_type: {
    ...
    it: "premendolo nella tastiera/tastiera.",
    ro: "apăsând -o pe tastatură.",
    pl: "naciskając literę na klawiaturze. ",
    ru: "нажав его на клавиатуре.",
    hy: "Սեղմելով այն ստեղնաշարի վրա:",
    fi: "painamalla sitä näppäimistössä/näppäimistössä.",
    ka: "კლავიატურაზე/კლავიატურაში დაჭერით.",
    he: "על ידי לחיצה עליו במקלדת.",
    ar: "بالضغط عليه في لوحة المفاتيح.",
    ur: "کی بورڈ پر دبانے سے۔",
    hi: "इसे कीबोर्ड पर दबाकर।",
    ta: "விசைப்பலகை/விசைப்பலகையில் அதை அழுத்துவதன் மூலம்.",
    ml: "കീബോർഡ് / കീപാഡിൽ ഇത് അമർത്തിക്കൊണ്ട്.",
    te: "కీబోర్డ్/కీప్యాడ్‌లో నొక్కడం ద్వారా.",
    kn: "ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಅದನ್ನು ಒತ್ತುವ ಮೂಲಕ.",
    bn: "এটি কীবোর্ড/কীপ্যাডে টিপে।",
    id: "Dengan menekannya di keyboard/keypad.",
    "zh-CN": "通过按下键盘上的对应按键",
    "zh-HK": "通過按下鍵盤上的對應按鍵",
  ...
  T_typeOrClickLetter: {
    ...
    fi: "Napsauttamalla sitä näytetyssä kirjainluettelossa tai painamalla sitä näppäimistössä/näppäimistössä.",
    ka: "ასოების ნაჩვენები სიაში დაჭერით ან კლავიატურაზე/კლავიატურაში დაჭერით.",
    ...
    ta: "காட்டப்படும் எழுத்துக்களின் பட்டியலில் அதைக் கிளிக் செய்வதன் மூலம் அல்லது விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம்.",
    ml: "പ്രദർശിപ്പിച്ച അക്ഷരങ്ങളുടെ പട്ടികയിൽ ക്ലിക്കുചെയ്യുന്നതിലൂടെ അല്ലെങ്കിൽ കീബോർഡ് / കീപാഡിൽ അമർത്തുക.",
    te: "ప్రదర్శించిన అక్షరాల జాబితాలో క్లిక్ చేయడం ద్వారా లేదా కీబోర్డ్/కీప్యాడ్‌లో నొక్కడం ద్వారా.",
    kn: "ಅದನ್ನು ಪ್ರದರ್ಶಿಸಿದ ಅಕ್ಷರಗಳ ಪಟ್ಟಿಯಲ್ಲಿ ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ ಅಥವಾ ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ.",
    bn: "অক্ষরগুলির প্রদর্শিত তালিকায় এটি ক্লিক করে বা কীবোর্ড/কীপ্যাডে টিপুন।",
    id: "Dengan mengkliknya dalam daftar huruf yang ditampilkan atau menekannya di keyboard/keypad.",
    "zh-CN": "通过按下键盘上的对应按键或者点击给出文字中的相应字母。",
    "zh-HK": "通過按下鍵盤上的對應按鍵或者點擊給出文字中的相應字母。",
    ja: "キーボードで対応するキーを押すか、表示されている文字のリストをクリックすることで",
    ko: "표시된 문자 목록에서 클릭하거나 키보드/키패드에서 눌러서.",
  },
  ...
  T_keypadLetter: {
    ...
    de: "durch Drücken Sie es auf Ihr Telefon auf die Tastatur.",
    fr: "en appuyant sur le clavier sur votre téléphone.",
    es: "presionándolo en el teclado de su teléfono.",
    pt: "pressionando -o no teclado no seu telefone.",
    it: "premendolo sulla tastiera sul telefono.",
    ro: "apăsându -l pe tastatura de pe telefon.",
    pl: "Naciskając go na klawiaturze na telefonie.",
    ru: "Нажав его на клавиатуре на телефоне.",
    hy: "Ձեր հեռախոսի ստեղնաշարի վրա սեղմելով:",
    fi: "painamalla sitä puhelimen näppäimistöllä.",
    ka: "თქვენს ტელეფონზე კლავიატურაზე დაჭერით.",
    he: "על ידי לחיצה על לוח המקשים בטלפון שלך.",
    ar: "بالضغط عليه على لوحة المفاتيح على هاتفك.",
    ur: "اسے اپنے فون پر کیپیڈ پر دبانے سے۔",
    hi: "इसे अपने फोन पर कीपैड पर दबाकर।",
    ta: "உங்கள் தொலைபேசியில் விசைப்பலகையில் அதை அழுத்துவதன் மூலம்.",
    ml: "നിങ്ങളുടെ ഫോണിലെ കീപാഡിൽ അത് അമർത്തിക്കൊണ്ട്.",
    te: "మీ ఫోన్‌లో కీప్యాడ్‌లో నొక్కడం ద్వారా.",
    kn: "ನಿಮ್ಮ ಫೋನ್‌ನಲ್ಲಿರುವ ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಅದನ್ನು ಒತ್ತುವ ಮೂಲಕ.",
    bn: "এটি আপনার ফোনে কীপ্যাডে টিপে।",
    id: "Dengan menekannya pada keypad di ponsel Anda.",
    "zh-CN": "通过将其按在手机上的键盘上。",
    "zh-HK": "通過將其按在手機上的鍵盤上。",
    ja: "携帯電話のキーパッドに押してください。",
    ko: "휴대 전화의 키패드에서 누르면.",
  },
  T_keypadLetterOrClickingLetter: {
    "en-US":
      "by clicking it in the displayed list of letters or pressing it on the keypad on your phone.",
    de: "Durch Klicken auf die angezeigte Liste der Buchstaben oder das Drücken auf der Tastatur auf Ihrem Telefon.",
    fr: "En cliquant dessus dans la liste affichée des lettres ou en appuyant sur le clavier sur votre téléphone.",
    es: "Al hacer clic en la lista mostrada de letras o presionándolo en el teclado de su teléfono.",
    pt: "Clicando -o na lista exibida de letras ou pressionando -a no teclado no seu telefone.",
    it: "Facendo clic nell'elenco visualizzato di lettere o premendola sulla tastiera sul telefono.",
    ro: "Făcând clic pe ea în lista afișată de litere sau apăsându -l pe tastatura de pe telefon.",
    pl: "Klikając go na wyświetlonej listy liter lub naciskając na klawiaturę w telefonie.",
    ru: "Нажав его в отображаемом списке букв или нажав на клавиатуру на вашем телефоне.",
    hy: "Կտտացնելով այն տառերի ցուցադրված ցուցակում կամ սեղմելով այն ձեր հեռախոսի ստեղնաշարի վրա:",
    fi: "Napsauttamalla sitä näytetyssä kirjainluettelossa tai painamalla sitä puhelimen näppäimistöllä.",
    ka: "დააჭირეთ მას ასოების ნაჩვენები ჩამონათვალში ან დააჭირეთ მას თქვენს ტელეფონზე კლავიატურაზე.",
    he: "על ידי לחיצה עליו ברשימת האותיות המוצגת או לחיצה על לוח המקשים בטלפון שלך.",
    ar: "بالنقر فوقه في قائمة الرسائل المعروضة أو الضغط عليها على لوحة المفاتيح على هاتفك.",
    ur: "خطوط کی ظاہر کردہ فہرست میں اس پر کلک کرکے یا اپنے فون پر کیپیڈ پر دبانے سے۔",
    hi: "पत्रों की प्रदर्शित सूची में इसे क्लिक करके या इसे अपने फोन पर कीपैड पर दबाकर।",
    ta: "காண்பிக்கப்படும் எழுத்துக்களின் பட்டியலில் அதைக் கிளிக் செய்வதன் மூலம் அல்லது உங்கள் தொலைபேசியில் விசைப்பலகையில் அழுத்துவதன் மூலம்.",
    ml: "പ്രദർശിപ്പിച്ച അക്ഷരങ്ങളുടെ പട്ടികയിൽ ക്ലിക്കുചെയ്യുന്നതിലൂടെ അല്ലെങ്കിൽ നിങ്ങളുടെ ഫോണിലെ കീപാഡിൽ അമർത്തുക.",
    te: "ప్రదర్శించిన అక్షరాల జాబితాలో క్లిక్ చేయడం ద్వారా లేదా మీ ఫోన్‌లో కీప్యాడ్‌లో నొక్కడం ద్వారా.",
    kn: "ಅದನ್ನು ಪ್ರದರ್ಶಿಸಿದ ಅಕ್ಷರಗಳ ಪಟ್ಟಿಯಲ್ಲಿ ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ ಅಥವಾ ನಿಮ್ಮ ಫೋನ್‌ನಲ್ಲಿರುವ ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ.",
    bn: "এটি চিঠির প্রদর্শিত তালিকায় ক্লিক করে বা আপনার ফোনে কীপ্যাডে টিপুন।",
    id: "Dengan mengkliknya dalam daftar huruf yang ditampilkan atau menekannya pada keypad di ponsel Anda.",
    "zh-CN": "通过在显示的字母列表中单击或在手机上的键盘上按下它。",
    "zh-HK": "通過在顯示的字母列表中單擊或在手機上的鍵盤上按下它。",
    ja: "表示されている文字のリストでクリックするか、携帯電話のキーパッドに押し付けます。",
    ko: "표시된 문자 목록에서 클릭하거나 휴대 전화의 키패드에서 눌러서.",
  },
  T_keypadLetterOrPressingKey: {
    "en-US": "by pressing it on the keyboard/keypad.",
    de: "Durch Drücken von Tastatur/Tastatur.",
    fr: "En appuyant sur celui-ci sur le clavier / clavier.",
    es: "presionándolo en el teclado/teclado.",
    pt: "pressionando -o no teclado/teclado.",
    it: "premendolo sulla tastiera/tastiera.",
    ro: "apăsând -o pe tastatură/tastatură.",
    pl: "Naciskając go na klawiaturze/klawiaturze.",
    ru: "Нажав его на клавиатуре/клавиатуру.",
    hy: "սեղմելով այն ստեղնաշարի վրա / ստեղնաշարի վրա:",
    fi: "painamalla sitä näppäimistöllä/näppäimistöllä.",
    ka: "კლავიატურაზე/კლავიატურაზე დაჭერით.",
    he: "על ידי לחיצה עליו על המקלדת/לוח המקשים.",
    ar: "عن طريق الضغط عليه على لوحة المفاتيح/لوحة المفاتيح.",
    ur: "اسے کی بورڈ/کیپیڈ پر دبانے سے۔",
  ...
  T_keypadLetterOrClickingLetterOrPressingKey: {
    ...
    ka: "ასოების ნაჩვენები სიაში დაჭერით, კლავიატურაზე დაჭერით ან კლავიატურაზე დაჭერით.",
    ...
    ta: "காட்டப்பட்ட எழுத்துக்களின் பட்டியலில் அதைக் கிளிக் செய்வதன் மூலம், விசைப்பலகையில் அழுத்துவதன் மூலம் அல்லது விசைப்பலகையில் அழுத்துவதன் மூலம்.",
    ml: "പ്രദർശിപ്പിച്ച അക്ഷരങ്ങളുടെ പട്ടികയിൽ ക്ലിക്കുചെയ്ത് കീബോർഡിൽ അമർത്തുക, അല്ലെങ്കിൽ കീപാഡിൽ അമർത്തുക.",
    te: "ప్రదర్శించిన అక్షరాల జాబితాలో క్లిక్ చేయడం ద్వారా, కీబోర్డ్‌లో నొక్కడం లేదా కీప్యాడ్‌లో నొక్కడం ద్వారా.",
    kn: "ಪ್ರದರ್ಶಿತ ಅಕ್ಷರಗಳ ಪಟ್ಟಿಯಲ್ಲಿ ಅದನ್ನು ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ, ಕೀಬೋರ್ಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ ಅಥವಾ ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ.",
    bn: "অক্ষরগুলির প্রদর্শিত তালিকায় এটি ক্লিক করে, কীবোর্ডে টিপুন, বা এটি কীপ্যাডে টিপুন।",
  ...
  T_typeOrClickRepeatedLetters: {
    ...
    de: "Durch Klicken auf die angezeigte Liste der Buchstaben oder das Drücken auf der Tastatur/Tastatur.",
    fr: "En cliquant dessus dans la liste des lettres affichée ou en appuyant sur le clavier / clavier.",
    es: "Al hacer clic en la lista mostrada de letras, o presionándolo en el teclado/teclado.",
    pt: "Clicando -o na lista exibida de letras ou pressionando -a no teclado/teclado.",
    it: "Facendo clic su di esso nell'elenco visualizzato delle lettere o premendola sulla tastiera/tastiera.",
    ro: "făcând clic pe ea în lista afișată de litere sau apăsându -l pe tastatură/tastatură.",
    pl: "Klikając go na wyświetlonej listy liter lub naciskając na klawiaturę/klawiaturę.",
    ru: "Нажав его в отображаемом списке букв или нажав на клавиатуру/клавиатуру.",
    hy: "Կտտացնելով այն տառերի ցուցադրված ցուցակում կամ սեղմելով այն ստեղնաշարի վրա / ստեղնաշարի վրա:",
    fi: "Napsauttamalla sitä näytetyssä kirjainluettelossa tai painamalla sitä näppäimistöllä/näppäimistöllä.",
    ka: "დააჭირეთ მას ასოების ნაჩვენები სიაში, ან დააჭირეთ მას კლავიატურაზე/კლავიატურაზე.",
    he: "על ידי לחיצה עליו ברשימת האותיות המוצגת, או לחיצה על המקלדת/לוח המקשים.",
    ar: "بالنقر فوقها في قائمة الرسائل المعروضة ، أو الضغط عليها على لوحة المفاتيح/لوحة المفاتيح.",
    ur: "خطوط کی ظاہر کردہ فہرست میں اس پر کلک کرکے ، یا کی بورڈ/کیپیڈ پر دبانے سے۔",
    hi: "पत्रों की प्रदर्शित सूची में इसे क्लिक करके, या इसे कीबोर्ड/कीपैड पर दबाकर।",
    ta: "காட்டப்படும் எழுத்துக்களின் பட்டியலில் அதைக் கிளிக் செய்வதன் மூலம் அல்லது விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம்.",
    ml: "പ്രദർശിപ്പിച്ച അക്ഷരങ്ങളുടെ പട്ടികയിൽ ക്ലിക്കുചെയ്ത് അല്ലെങ്കിൽ കീബോർഡ് / കീപാഡിൽ അമർത്തുക.",
    te: "ప్రదర్శించిన అక్షరాల జాబితాలో క్లిక్ చేయడం ద్వారా లేదా కీబోర్డ్/కీప్యాడ్‌లో నొక్కడం ద్వారా.",
    kn: "ಪ್ರದರ್ಶಿತ ಅಕ್ಷರಗಳ ಪಟ್ಟಿಯಲ್ಲಿ ಅದನ್ನು ಕ್ಲಿಕ್ ಮಾಡುವುದರ ಮೂಲಕ ಅಥವಾ ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಒತ್ತುವ ಮೂಲಕ.",
    bn: "অক্ষরগুলির প্রদর্শিত তালিকায় এটি ক্লিক করে বা কীবোর্ড/কীপ্যাডে টিপুন।",
    id: "Dengan mengkliknya dalam daftar huruf yang ditampilkan, atau menekannya pada keyboard/keypad.",
    "zh-CN": "通过在显示的字母列表中单击它，或将其按在键盘/键盘上。",
    "zh-HK": "通過在顯示的字母列表中單擊它，或將其按在鍵盤/鍵盤上。",
    ja: "表示された文字のリストでクリックするか、キーボード/キーパッドで押します。",
    ko: "표시된 문자 목록에서 클릭하거나 키보드/키패드에서 누르면됩니다.",
  },
  ...
  T_typeRepeatedLetters: {
    ...
    de: "Durch Drücken von Tastatur/Tastatur.",
    fr: "en les appuyant sur le clavier / clavier.",
    es: "presionándolos en el teclado/teclado.",
    pt: "pressionando -os no teclado/teclado.",
    it: "premendoli sulla tastiera/tastiera.",
    ro: "apăsându -le pe tastatură/tastatură.",
    pl: "Naciskając je na klawiaturze/klawiaturze.",
    ru: "Нажав их на клавиатуре/клавиатуру.",
    hy: "սեղմելով դրանք ստեղնաշարի վրա / ստեղնաշարի վրա:",
    fi: "painamalla niitä näppäimistöllä/näppäimistöllä.",
    ka: "კლავიატურაზე/კლავიატურაზე დაჭერით.",
    he: "על ידי לחיצה עליהם על המקלדת/לוח המקשים.",
    ar: "عن طريق الضغط عليها على لوحة المفاتيح/لوحة المفاتيح.",
    ur: "انہیں کی بورڈ/کیپیڈ پر دبانے سے۔",
    hi: "उन्हें कीबोर्ड/कीपैड पर दबाकर।",
    ta: "விசைப்பலகை/விசைப்பலகையில் அவற்றை அழுத்துவதன் மூலம்.",
    ml: "കീബോർഡ് / കീപാഡിൽ അവ അമർത്തിക്കൊണ്ട്.",
    te: "కీబోర్డ్/కీప్యాడ్‌లో వాటిని నొక్కడం ద్వారా.",
    kn: "ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಅವುಗಳನ್ನು ಒತ್ತುವ ಮೂಲಕ.",
    bn: "এগুলি কীবোর্ড/কীপ্যাডে টিপুন।",
    id: "Dengan menekannya pada keyboard/keypad.",
    "zh-CN": "通过在键盘/键盘上按下它们。",
    "zh-HK": "通過在鍵盤/鍵盤上按下它們。",
    ja: "キーボード/キーパッドでそれらを押すことにより。",
    ko: "키보드/키패드에서 눌러서.",
  },
  ...
  T_readingTask: {
    ...
    "zh-HK":
      "講故事的時間！您會從一本書中閱讀111頁。一旦開始，請盡可能快地靜靜地閱讀所有頁面，同時保持完全理解，直到到達末尾。然後，我們會問您一些有關這個故事的問題。在每個頁面上，按下下一頁的空格欄。準備就緒時，請按空格。",
  ...
  T_readyClickCrosshair: {
    ...
    fi: "Valmis? Napsauta ristikästen keskustaa.",
    ka: "მზად? დააჭირეთ ჯვრის თმას ცენტრს.",
    ...
    ta: "தயாரா? குறுக்கு முடிகளின் மையத்தைக் கிளிக் செய்க.",
    ml: "തയ്യാറാണ്? ക്രോസ് ഹെയർ സെന്ററിൽ ക്ലിക്കുചെയ്യുക.",
    te: "సిద్ధంగా ఉన్నారా? క్రాస్ హెయిర్స్ మధ్యలో క్లిక్ చేయండి.",
    kn: "ಸಿದ್ಧ? ಅಡ್ಡ ಕೂದಲಿನ ಮಧ್ಯಭಾಗವನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ.",
    bn: "প্রস্তুত? ক্রস হেয়ারগুলির কেন্দ্রে ক্লিক করুন।",
    id: "Siap? Klik tengah rambut silang.",
    "zh-CN": "准备好了吗？保持注视十字准线，并点击十字准线。",
    "zh-HK": "準備好了嗎？保持注視十字準線，並點擊十字準線。",
    ja: "準備はできましたか？十字線を直視しながら、十字線をクリックしてください。",
    ko: "준비가 된? 십자 머리카락의 중앙을 클릭하십시오.",
  },
  T_readyTrackCrosshair: {
    "en-US":
      "Ready? Use the cursor to track the center of the cross hair until the target appears.",
    de: "Bereit? Verwenden Sie den Cursor, um die Mitte des Kreuzhaars zu verfolgen, bis das Ziel erscheint.",
    fr: "Prêt? Utilisez le curseur pour suivre le centre de la transmission jusqu'à ce que la cible apparaisse.",
    es: "¿Listo? Use el cursor para rastrear el centro de la cruz hasta que aparezca el objetivo.",
    pt: "Preparar? Use o cursor para rastrear o centro do cabelo cruzado até que o alvo apareça.",
    it: "Pronto? Usa il cursore per tenere traccia del centro dei capelli incrociati fino a quando non appare il bersaglio.",
    ro: "Gata? Folosiți cursorul pentru a urmări centrul părului încrucișat până când apare ținta.",
    pl: "Gotowy? Użyj kursora, aby śledzić środek włosów krzyżowych, aż pojawi się cel.",
    ru: "Готовый? Используйте курсор, чтобы отслеживать центр кросс -волос, пока не появится цель.",
    hy: "Պատրաստ? Օգտագործեք կուրսորը `խաչմերուկի կենտրոնը հետեւելու համար, մինչեւ թիրախը հայտնվի:",
    fi: "Valmis? Seuraa kohdistinta ristikarvojen keskustaa, kunnes kohde ilmestyy.",
    ka: "მზად? გამოიყენეთ კურსორი, რომ აკონტროლოთ ჯვრის თმის ცენტრი, სანამ სამიზნე გამოჩნდება.",
    he: "מוּכָן? השתמש בסמן כדי לעקוב אחר מרכז שיער הצלב עד להופעת היעד.",
    ar: "مستعد؟ استخدم المؤشر لتتبع مركز الصليب حتى يظهر الهدف.",
    ur: "تیار؟ کراس بالوں کے مرکز کو ٹریک کرنے کے لئے کرسر کا استعمال کریں جب تک کہ ہدف ظاہر نہ ہو۔",
    hi: "तैयार? जब तक लक्ष्य प्रकट न हो, क्रॉस बालों के केंद्र को ट्रैक करने के लिए कर्सर का उपयोग करें।",
    ta: "தயாரா? இலக்கு தோன்றும் வரை குறுக்கு முடியின் மையத்தைக் கண்காணிக்க கர்சரைப் பயன்படுத்தவும்.",
    ml: "തയ്യാറാണ്? ടാർഗെറ്റ് ദൃശ്യമാകുന്നതുവരെ ക്രോസ് ഹെയർ സെന്റർ ട്രാക്കുചെയ്യുന്നതിന് കഴ്സർ ഉപയോഗിക്കുക.",
    te: "సిద్ధంగా ఉన్నారా? లక్ష్యం కనిపించే వరకు క్రాస్ హెయిర్ మధ్యలో ట్రాక్ చేయడానికి కర్సర్‌ను ఉపయోగించండి.",
    kn: "ಸಿದ್ಧ? ಗುರಿ ಕಾಣಿಸಿಕೊಳ್ಳುವವರೆಗೆ ಅಡ್ಡ ಕೂದಲಿನ ಮಧ್ಯಭಾಗವನ್ನು ಪತ್ತೆಹಚ್ಚಲು ಕರ್ಸರ್ ಬಳಸಿ.",
    bn: "প্রস্তুত? লক্ষ্যটি উপস্থিত না হওয়া পর্যন্ত ক্রস চুলের কেন্দ্রটি ট্র্যাক করতে কার্সারটি ব্যবহার করুন।",
    id: "Siap? Gunakan kursor untuk melacak tengah rambut silang sampai target muncul.",
    "zh-CN": "准备好？使用光标跟踪横发的中心，直到目标出现为止。",
    "zh-HK": "準備好？使用光標跟踪橫發的中心，直到目標出現為止。",
    ja: "準備ができて？カーソルを使用して、ターゲットが表示されるまで交差髪の中心を追跡します。",
    ko: "준비가 된? 커서를 사용하여 대상이 나타날 때까지 크로스 헤어의 중심을 추적하십시오.",
  },
  ...
  T_readyTrackCrosshairRepeatedLetters: {
    ...
    id: "Siap mengidentifikasi surat -surat itu? Lacak bagian tengah rambut silang sampai surat -surat itu muncul.",
  ...
  T_readyPressSpace: {
    ...
    ru: "Готовый? Глядя прямо на перекрестие, нажмите пробел.",
    hy: "Պատրաստ? Նայելով անմիջապես խաչմերուկին, կտտացրեք բացը:",
    fi: "Valmis? Kun katsot suoraan ristikäsien keskellä, paina avaruuspalkki.",
    ka: "მზად? ჯვრის თმების ცენტრში პირდაპირ დათვალიერებისას, გთხოვთ, დააჭირეთ კოსმოსურ ზოლს.",
    he: "מוּכָן? תוך התבוננות ישירה על השיער, לחץ על מקש הרווח.",
    ar: "مستعد؟ أثناء النظر مباشرة إلى علامة التقاطع ، يرجى الضغط على زر المسافة.",
    ur: "تیار؟ براہ راست کراس ہیر کو دیکھ کر ، براہ کرم اسپیس بار دبائیں۔",
    hi: "तैयार? सीधे क्रॉसहेयर को देखते हुए, कृपया SPACE बार दबाएं।",
    ta: "தயாரா? குறுக்கு முடிகளின் மையத்தை நேரடியாகப் பார்க்கும்போது, ​​தயவுசெய்து விண்வெளி பட்டியை அழுத்தவும்.",
    ml: "തയ്യാറാണ്? ക്രോസ് ഹെയർ മധ്യഭാഗത്ത് നേരിട്ട് നോക്കുമ്പോൾ, ദയവായി സ്പേസ് ബാർ അമർത്തുക.",
    te: "సిద్ధంగా ఉన్నారా? క్రాస్ హెయిర్స్ మధ్యలో నేరుగా చూస్తున్నప్పుడు, దయచేసి స్పేస్ బార్‌ను నొక్కండి.",
    kn: "ಸಿದ್ಧ? ಅಡ್ಡ ಕೂದಲಿನ ಮಧ್ಯಭಾಗವನ್ನು ನೇರವಾಗಿ ನೋಡುವಾಗ, ದಯವಿಟ್ಟು ಸ್ಪೇಸ್ ಬಾರ್ ಒತ್ತಿರಿ.",
    bn: "প্রস্তুত? ক্রস চুলের কেন্দ্রে সরাসরি দেখার সময়, দয়া করে স্পেস বারটি টিপুন।",
    id: "Siap? Sambil melihat langsung di tengah rambut silang, silakan tekan bilah ruang angkasa.",
    "zh-CN": "准备好了吗？保持注视十字准线，并按下空格键。",
    "zh-HK": "準備好了嗎？保持注視十字準線，並按下空格鍵。",
    ja: "準備はできましたか？十字線を直視しながら、スペースキーを押してください。",
    ko: "준비가 된? 크로스 털의 중앙을 직접 보면서 우주 막대를 누릅니다.",
  },
  ...
  T_readyPressSpaceOrClickCrosshairLetter: {
    ...
    ka: "მზად ხართ წერილის იდენტიფიცირებისთვის? ჯვრის თმების ცენტრში პირდაპირ დათვალიერებისას, გთხოვთ, დააჭირეთ მას, ან დააჭირეთ კოსმოსურ ზოლს.",
  ...
  T_readyPressSpaceOrClickCrosshair: {
    ...
    ru: "Готовый? Глядя прямо на перекрестие, нажмите пробел или щелкните на перекрестии.",
    hy: "Պատրաստ? Նայելով ճիշտ խաչմերուկին, կտտացրեք բացը կամ կտտացրեք խաչմերուկում:",
    fi: "Valmis? Kun tarkastellaan suoraan ristikäsien keskustaa, napsauta sitä tai paina välilyöntiä.",
    ka: "მზად? ჯვრის თმების ცენტრში პირდაპირ დათვალიერებისას, გთხოვთ, დააჭირეთ მას, ან დააჭირეთ კოსმოსურ ზოლს.",
    he: "מוּכָן? תוך התבוננות ישירה על הכוונת, לחץ על מקש הרווח או לחץ על הכוונת.",
    ar: "مستعد؟ أثناء النظر مباشرة إلى علامة التقاطع ، يرجى الضغط على زر المسافة أو الضغط على علامة التقاطع.",
    ur: "تیار؟ براہ راست کراس ہیر کو دیکھ کر ، براہ کرم اسپیس بار دبائیں یا کراس ہیر پر کلک کریں۔",
    hi: "तैयार? सीधे क्रॉसहेयर को देखते हुए, कृपया SPACE बार दबाएं या क्रॉसहेयर पर क्लिक करें।",
    ta: "தயாரா? குறுக்கு முடிகளின் மையத்தை நேரடியாகப் பார்க்கும்போது, ​​தயவுசெய்து அதைக் கிளிக் செய்க அல்லது ஸ்பேஸ் பட்டியை அழுத்தவும்.",
    ml: "തയ്യാറാണ്? ക്രോസ് ഹെയറുകളുടെ മധ്യഭാഗത്ത് നേരിട്ട് നോക്കുമ്പോൾ, ദയവായി അതിൽ ക്ലിക്കുചെയ്യുക, അല്ലെങ്കിൽ സ്പേസ് ബാർ അമർത്തുക.",
    te: "సిద్ధంగా ఉన్నారా? క్రాస్ హెయిర్స్ మధ్యలో నేరుగా చూస్తున్నప్పుడు, దయచేసి దాన్ని క్లిక్ చేయండి లేదా స్పేస్ బార్‌ను నొక్కండి.",
    kn: "ಸಿದ್ಧ? ಅಡ್ಡ ಕೂದಲಿನ ಮಧ್ಯಭಾಗವನ್ನು ನೇರವಾಗಿ ನೋಡುವಾಗ, ದಯವಿಟ್ಟು ಅದನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ, ಅಥವಾ ಸ್ಪೇಸ್ ಬಾರ್ ಒತ್ತಿರಿ.",
    bn: "প্রস্তুত? ক্রস চুলের কেন্দ্রে সরাসরি দেখার সময়, দয়া করে এটি ক্লিক করুন, বা স্পেস বার টিপুন।",
    id: "Siap? Sambil melihat langsung di tengah rambut silang, silakan klik, atau tekan bilah ruang angkasa.",
    "zh-CN": "准备好了吗？保持注视十字准线，并按下空格键或者点击十字准线。",
    "zh-HK": "準備好了嗎？保持注視十字準線，並按下空格鍵或者點擊十字準線。",
    ja: "準備はできましたか？十字線を直視しながら、スペースキーを押すか、十字線をクリックしてください。",
  ...
  T_sentenceGuessingGame: {
    ...
    ar: "سوف تختلف وضوح الجملة من السهل إلى الصلب أو المستحيل. لا يمكنك الحصول على أكثر من ثلثي بشكل صحيح ، لذا استرخ. فكر في الأمر على أنه لعبة تخمين ، واحصل على أكبر عدد ممكن من الأشياء. ستسمع صوتًا كلما كنت على حق.",
    ...
    hi: "वाक्य की समझदारी आसान से कठिन या असंभव तक भिन्न होगी। आप दो-तिहाई से अधिक सही नहीं पा सकते हैं, इसलिए आराम करें। इसे एक अनुमान लगाने के खेल के रूप में सोचें, और बस जितने भी हो सके उतने प्राप्त करें। जब भी आप सही हों तो आप एक बीप सुनेंगे।",
  ...
  T_thresholdBeginBlock: {
    ...
    ka: "❌ CHANGE T_thresholdBeginBlock→ T_thresholdMiddleLetterBeginBlock",
    ...
    ta: "❌ CHANGE T_thresholdBeginBlock→ T_thresholdMiddleLetterBeginBlock",
    ml: "❌ CHANGE T_thresholdBeginBlock→ T_thresholdMiddleLetterBeginBlock",
    te: "❌ CHANGE T_thresholdBeginBlock→ T_thresholdMiddleLetterBeginBlock",
    kn: "❌ CHANGE T_thresholdBeginBlock→ T_thresholdMiddleLetterBeginBlock",
    bn: "❌ CHANGE T_thresholdBeginBlock→ T_thresholdMiddleLetterBeginBlock",
  ...
  T_thresholdMiddleLetterBeginBlock: {
    ...
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu beginnen. In jeder Versuch werden drei Buchstaben ein Triplett enthält, zum Beispiel: Z R N. Bitte melden Sie nur den mittleren Buchstaben.",
    fr: "Vous êtes sur le point de commencer un bloc d'essais xxx. Chaque essai présentera un triplet de trois lettres, par exemple: Z R N. Veuillez signaler uniquement la lettre du milieu,",
    ...
    pt: "Você está prestes a iniciar um bloco de ensaios xxx. Cada teste apresentará o trigêmeo de três letras, por exemplo: Z R N. Por favor, relate apenas a carta do meio,",
    it: "Stai per iniziare un blocco di prove xxx. Ogni prova presenterà tripletta di tre lettere, ad esempio: Z R N. Segnala solo la lettera di mezzo,",
    ro: "Ești pe cale să începi un bloc de încercări xxx. Fiecare proces va prezenta triplet de trei litere, de exemplu: Z R N. Vă rugăm să raportați doar scrisoarea de mijloc,",
    pl: "Niedługo rozpoczniecie blok prób xxx. Każda próba przedstawi Triplet trzech liter, na przykład: Z R N. Proszę zgłosić tylko środkowy litera,",
    ru: "Вы собираетесь начать блок xxx испытаний. Каждое испытание представит триплет из трех букв, например: Z R N. Пожалуйста, сообщите только о средней букве,",
    hy: "Դուք պատրաստվում եք սկսել xxx փորձարկումների բլոկ: Յուրաքանչյուր դատավարություն կներկայացնի երեք տառի եռյակը, օրինակ, z r n. Խնդրում ենք զեկուցել միայն միջին տառին,",
    fi: "Olet aloittamassa xxx -kokeiden lohkon. Jokainen kokeilu esittelee kolmesta kirjeestä, esimerkiksi: Z R N. Ilmoita vain keskikirjeestä,",
    ka: "თქვენ დაიწყებთ xxx ტესტების ბლოკს. თითოეული სასამართლო პროცესი წარმოგიდგენთ სამ ასოებს, მაგალითად: Z R N. გთხოვთ, შეატყობინოთ მხოლოდ შუა წერილს,",
    he: "אתה עומד להתחיל בלוק של ניסויים ב- xxx. כל ניסיון יציג שלישייה של שלוש אותיות, למשל: Z R N. אנא דווח רק על המכתב האמצעי,",
    ar: "أنت على وشك البدء في كتلة من تجارب xxx. ستقدم كل تجربة ثلاثية من ثلاثة رسائل ، على سبيل المثال: Z R N. يرجى الإبلاغ عن الرسالة الوسطى فقط ،",
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر مقدمے کی سماعت تین خطوط کے ٹرپلٹ پیش کرے گی ، مثال کے طور پر: زیڈ آر این۔ براہ کرم صرف درمیانی خط کی اطلاع دیں ،",
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण तीन पत्रों के ट्रिपल को प्रस्तुत करेगा, उदाहरण के लिए: z r N. कृपया केवल मध्य पत्र की रिपोर्ट करें,",
    ta: "நீங்கள் xxx சோதனைகளின் ஒரு தொகுதியைத் தொடங்க உள்ளீர்கள். ஒவ்வொரு சோதனையும் மூன்று எழுத்துக்களின் மும்மடங்கை வழங்கும், எடுத்துக்காட்டாக: Z R N. தயவுசெய்து நடுத்தர கடிதத்தை மட்டுமே புகாரளிக்கவும்,",
    ml: "നിങ്ങൾ xxx പരീക്ഷണങ്ങളുടെ ഒരു ബ്ലോക്ക് ആരംഭിക്കാൻ പോകുന്നു. ഓരോ വിചാരണയും മൂന്ന് അക്ഷരങ്ങളുടെ മൂന്നിരട്ടിയുണ്ടാക്കും, ഉദാഹരണത്തിന്: z R N. ദയവായി മധ്യ അക്ഷരം മാത്രം റിപ്പോർട്ട് ചെയ്യുക,",
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. ప్రతి ట్రయల్ మూడు అక్షరాల త్రిపాదిని ప్రదర్శిస్తుంది, ఉదాహరణకు: Z R N. దయచేసి మధ్య లేఖను మాత్రమే నివేదించండి,",
    kn: "ನೀವು xxx ಪ್ರಯೋಗಗಳ ಬ್ಲಾಕ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಲಿದ್ದೀರಿ. ಪ್ರತಿ ಪ್ರಯೋಗವು ಮೂರು ಅಕ್ಷರಗಳ ತ್ರಿವಳಿಗಳನ್ನು ಪ್ರಸ್ತುತಪಡಿಸುತ್ತದೆ, ಉದಾಹರಣೆಗೆ: Z R N. ದಯವಿಟ್ಟು ಮಧ್ಯಮ ಅಕ್ಷರವನ್ನು ಮಾತ್ರ ವರದಿ ಮಾಡಿ,",
    bn: "আপনি xxx ট্রায়ালগুলির একটি ব্লক শুরু করতে চলেছেন। প্রতিটি ট্রায়াল তিনটি অক্ষরের ট্রিপলেট উপস্থাপন করবে, উদাহরণস্বরূপ: জেড আর এন। দয়া করে কেবল মাঝের চিঠির প্রতিবেদন করুন,",
    id: "Anda akan memulai blok uji coba xxx. Setiap percobaan akan menyajikan tiga surat dari tiga surat, misalnya: Z R N. Harap hanya melaporkan surat tengahnya,",
    "zh-CN":
      "您即将开始一个xxx试验。每个试验都会呈现三个字母的三胞胎，例如：z r n。请仅报告中间字母，",
    "zh-HK":
      "您即將開始一個xxx試驗。每個試驗都會呈現三個字母的三胞胎，例如：z r n。請僅報告中間字母，",
    ja: "xxxトライアルのブロックを開始しようとしています。各試験では、3文字のトリプレットを提示します。たとえば、Z R N。中央の文字のみを報告してください。",
    ko: "xxx 시험 블록을 시작하려고합니다. 각 시험은 예를 들어 Z R N. 중간 편지 만보 고하십시오.",
  },
  T_thresholdVenierBeginBlock: {
    ...
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu beginnen. Jeder Versuch wird ein neues Paar Linien vorstellen. Bitte melden Sie, ob die obere Linie nach links oder rechts verschoben ist (L oder R),",
    fr: "Vous êtes sur le point de commencer un bloc d'essais xxx. Chaque essai présentera une nouvelle paire de lignes. Veuillez signaler si la ligne supérieure est décalée à gauche ou à droite (L ou R),",
    es: "Estás a punto de comenzar un bloque de pruebas xxx. Cada prueba presentará un nuevo par de líneas. Informe si la línea superior se desplaza hacia la izquierda o hacia la derecha (L o R),",
    pt: "Você está prestes a iniciar um bloco de ensaios xxx. Cada teste apresentará um novo par de linhas. Por favor, relate se a linha superior é deslocada para a esquerda ou direita (L ou R),",
    it: "Stai per iniziare un blocco di prove xxx. Ogni prova presenterà una nuova coppia di linee. Si prega di segnalare se la linea superiore viene spostata a sinistra o a destra (L o R),",
    ro: "Ești pe cale să începi un bloc de încercări xxx. Fiecare proces va prezenta o nouă pereche de linii. Vă rugăm să raportați dacă linia superioară este deplasată la stânga sau la dreapta (L sau R),",
    pl: "Niedługo rozpoczniecie blok prób xxx. Każda próba przedstawi nową parę linii. Proszę zgłosić, czy górna linia jest przesunięta w lewo, czy w prawo (L lub R),",
    ru: "Вы собираетесь начать блок xxx испытаний. Каждое испытание представит новую пару линий. Пожалуйста, сообщите, сдвинута ли верхняя линия влево или вправо (L или R),",
    hy: "Դուք պատրաստվում եք սկսել xxx փորձարկումների բլոկ: Յուրաքանչյուր փորձություն կներկայացնի նոր զույգ տող: Խնդրում ենք զեկուցել, թե արդյոք վերին գիծը տեղափոխվում է ձախ կամ աջ (L կամ R),",
    fi: "Olet aloittamassa xxx -kokeiden lohkon. Jokainen kokeilu esittelee uuden linjaparin. Ilmoita, siirretäänkö ylempi linja vasemmalle tai oikealle (l tai r),",
    ka: "თქვენ დაიწყებთ xxx ტესტების ბლოკს. თითოეული სასამართლო პროცესი წარმოგიდგენთ ახალ წყვილს. გთხოვთ, შეატყობინოთ თუ არა ზედა ხაზი მარცხნივ ან მარჯვნივ (L ან R),",
    he: "אתה עומד להתחיל בלוק של ניסויים ב- xxx. כל ניסיון יציג זוג שורות חדש. אנא דווח אם הקו העליון מועבר שמאלה או ימינה (L או R),",
    ar: "أنت على وشك البدء في كتلة من تجارب xxx. ستقدم كل تجربة زوجًا جديدًا من الخطوط. يرجى الإبلاغ عما إذا كان الخط العلوي قد تم تحويله إلى اليسار أو اليمين (L أو R) ،",
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر مقدمے کی سماعت لائنوں کی ایک نئی جوڑی پیش کرے گی۔ براہ کرم اطلاع دیں کہ آیا اوپری لائن کو بائیں یا دائیں (L یا R) منتقل کیا گیا ہے ،",
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण लाइनों की एक नई जोड़ी प्रस्तुत करेगा। कृपया रिपोर्ट करें कि ऊपरी रेखा को बाएं या दाएं (एल या आर) को स्थानांतरित कर दिया गया है,",
    ta: "நீங்கள் xxx சோதனைகளின் ஒரு தொகுதியைத் தொடங்க உள்ளீர்கள். ஒவ்வொரு சோதனையும் ஒரு புதிய ஜோடி வரிகளை வழங்கும். மேல் வரி இடது அல்லது வலதுபுறம் (எல் அல்லது ஆர்) மாற்றப்பட்டதா என்பதைப் புகாரளிக்கவும்,",
    ml: "നിങ്ങൾ xxx പരീക്ഷണങ്ങളുടെ ഒരു ബ്ലോക്ക് ആരംഭിക്കാൻ പോകുന്നു. ഓരോ വിചാരണയും ഒരു പുതിയ ജോഡി ലൈനുകൾ അവതരിപ്പിക്കും. മുകളിലെ വരി ഇടത്തോട്ടോ വലത്തോട്ടോ മാറ്റുമോ എന്ന് ദയവായി റിപ്പോർട്ടുചെയ്യുക,",
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. ప్రతి ట్రయల్ కొత్త జత పంక్తులను ప్రదర్శిస్తుంది. దయచేసి ఎగువ రేఖ ఎడమ లేదా కుడి (L లేదా R) మార్చబడిందా అని నివేదించండి,",
    kn: "ನೀವು xxx ಪ್ರಯೋಗಗಳ ಬ್ಲಾಕ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಲಿದ್ದೀರಿ. ಪ್ರತಿ ಪ್ರಯೋಗವು ಹೊಸ ಜೋಡಿ ಸಾಲುಗಳನ್ನು ಪ್ರಸ್ತುತಪಡಿಸುತ್ತದೆ. ಮೇಲಿನ ರೇಖೆಯನ್ನು ಎಡ ಅಥವಾ ಬಲಕ್ಕೆ (ಎಲ್ ಅಥವಾ ಆರ್) ಸ್ಥಳಾಂತರಿಸಲಾಗಿದೆಯೆ ಎಂದು ದಯವಿಟ್ಟು ವರದಿ ಮಾಡಿ,",
    bn: "আপনি xxx ট্রায়ালগুলির একটি ব্লক শুরু করতে চলেছেন। প্রতিটি ট্রায়াল লাইনগুলির একটি নতুন জুড়ি উপস্থাপন করবে। উপরের লাইনটি বাম বা ডান (এল বা আর) স্থানান্তরিত হয়েছে কিনা তা দয়া করে রিপোর্ট করুন,",
    id: "Anda akan memulai blok uji coba xxx. Setiap percobaan akan menyajikan sepasang garis baru. Harap laporkan apakah garis atas digeser ke kiri atau kanan (L atau R),",
    "zh-CN":
      "您即将开始一个xxx试验。每个试验都会呈现一条新的线条。请报告上线是向左还是向右移动（L或R），",
    "zh-HK":
      "您即將開始一個xxx試驗。每個試驗都會呈現一條新的線條。請報告上線是向左還是向右移動（L或R），",
    ja: "xxxトライアルのブロックを開始しようとしています。各トライアルは、新しいラインのペアを提示します。上線が左または右にシフトされているか（LまたはR）かどうかを報告してください。",
    ko: "xxx 시험 블록을 시작하려고합니다. 각 시험에는 새로운 라인이 나타납니다. 상단 라인이 왼쪽 또는 오른쪽으로 이동했는지 (L 또는 R),",
  },
  T_thresholdLetterBeginBlock: {
    ...
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu beginnen. Jeder Versuch wird einen Brief vorlegen. Bitte melden Sie es,",
    fr: "Vous êtes sur le point de commencer un bloc d'essais xxx. Chaque essai présentera une lettre. Veuillez le signaler,",
    es: "Estás a punto de comenzar un bloque de pruebas xxx. Cada juicio presentará una letra. Por favor denunciarlo,",
    pt: "Você está prestes a iniciar um bloco de ensaios xxx. Cada julgamento apresentará uma carta. Por favor, relate,",
    it: "Stai per iniziare un blocco di prove xxx. Ogni prova presenterà una lettera. Si prega di segnalarlo,",
    ro: "Ești pe cale să începi un bloc de încercări xxx. Fiecare proces va prezenta o scrisoare. Vă rugăm să îl raportați,",
    pl: "Niedługo rozpoczniecie blok prób xxx. Każda próba przedstawi list. Zgłoś to,",
    ru: "Вы собираетесь начать блок xxx испытаний. Каждое испытание представит письмо. Пожалуйста, сообщите об этом,",
    hy: "Դուք պատրաստվում եք սկսել xxx փորձարկումների բլոկ: Յուրաքանչյուր փորձություն կներկայացնի նամակ: Խնդրում ենք զեկուցել այն,",
    fi: "Olet aloittamassa xxx -kokeiden lohkon. Jokainen oikeudenkäynti esittelee kirjeen. Ilmoita siitä,",
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. თითოეულ სასამართლო პროცესს წარუდგენს წერილს. გთხოვთ, შეატყობინოთ,",
    he: "אתה עומד להתחיל בלוק של ניסויים ב- xxx. כל משפט יציג מכתב. אנא דווח על כך,",
    ar: "أنت على وشك البدء في كتلة من تجارب xxx. ستقدم كل تجربة رسالة. الرجاء الإبلاغ عنها ،",
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر مقدمے کی سماعت ایک خط پیش کرے گی۔ براہ کرم اس کی اطلاع دیں ،",
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण एक पत्र प्रस्तुत करेगा। कृपया इसकी रिपोर्ट करें,",
    ta: "நீங்கள் xxx சோதனைகளின் ஒரு தொகுதியைத் தொடங்க உள்ளீர்கள். ஒவ்வொரு சோதனையும் ஒரு கடிதத்தை வழங்கும். தயவுசெய்து அதைப் புகாரளிக்கவும்,",
    ml: "നിങ്ങൾ xxx പരീക്ഷണങ്ങളുടെ ഒരു ബ്ലോക്ക് ആരംഭിക്കാൻ പോകുന്നു. ഓരോ വിചാരണയും ഒരു കത്ത് അവതരിപ്പിക്കും. ദയവായി അത് റിപ്പോർട്ടുചെയ്യുക,",
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. ప్రతి ట్రయల్ ఒక లేఖను ప్రదర్శిస్తుంది. దయచేసి దాన్ని నివేదించండి,",
    kn: "ನೀವು xxx ಪ್ರಯೋಗಗಳ ಬ್ಲಾಕ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಲಿದ್ದೀರಿ. ಪ್ರತಿ ಪ್ರಯೋಗವು ಪತ್ರವನ್ನು ಪ್ರಸ್ತುತಪಡಿಸುತ್ತದೆ. ದಯವಿಟ್ಟು ಅದನ್ನು ವರದಿ ಮಾಡಿ,",
    bn: "আপনি xxx ট্রায়ালগুলির একটি ব্লক শুরু করতে চলেছেন। প্রতিটি বিচার একটি চিঠি উপস্থাপন করবে। দয়া করে এটি রিপোর্ট করুন,",
    id: "Anda akan memulai blok uji coba xxx. Setiap percobaan akan menyajikan surat. Tolong laporkan,",
    "zh-CN": "您即将开始一个xxx试验。每个审判都会出示一封信。请报告，",
    "zh-HK": "您即將開始一個xxx試驗。每個審判都會出示一封信。請報告，",
    ja: "xxxトライアルのブロックを開始しようとしています。各トライアルには手紙が提示されます。報告してください、",
    ko: "xxx 시험 블록을 시작하려고합니다. 각 재판은 편지를 제시합니다. 보고 해주세요.",
  },
  ...
  T_thresholdRepeatedLettersBeginBlock: {
    ...
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu starten. In jedem Versuch wird ein Buchstabenfeld vorhanden. Melden Sie die beiden mittleren Charaktere, die Sie sehen",
    fr: "Vous êtes sur le point de démarrer un bloc d'essais xxx. Chaque essai présentera un champ de lettres. Signaler les deux personnages du milieu que vous voyez",
    ...
    pt: "Você está prestes a iniciar um bloco de ensaios xxx. Cada teste apresentará o campo de letras. Relate os dois personagens do meio que você vê",
    it: "Stai per avviare un blocco di prove xxx. Ogni prova presenterà un campo di lettere. Segnala i due personaggi medi che vedi",
    ro: "Sunteți pe cale să începeți un bloc de încercări xxx. Fiecare proces va prezenta câmpul de scrisori. Raportați cele două personaje de mijloc pe care le vedeți",
    pl: "Zaraz rozpoczniesz blok prób xxx. Każda próba przedstawi pole liter. Zgłoś dwie środkowe postacie, które widzisz",
    ru: "Вы собираетесь начать блок xxx испытаний. Каждое испытание будет представлять поле букв. Сообщите о двух средних персонажах, которые вы видите",
    hy: "Դուք պատրաստվում եք սկսել xxx փորձարկումների բլոկ: Յուրաքանչյուր փորձություն կներկայացնի տառերի դաշտ: Հաղորդեք ձեր տեսած երկու միջին նիշերի մասին",
    fi: "Olet aloittamassa xxx -kokeiden lohkon. Jokainen kokeilu esittelee kirjeiden kentän. Ilmoita kaksi keskimmäistä merkkiä, jotka näet",
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკის დაწყებას. თითოეული სასამართლო პროცესი წარუდგენს წერილების სფეროს. შეატყობინეთ ორი საშუალო პერსონაჟის, რომელსაც ხედავთ",
    he: "אתה עומד להתחיל בלוק של ניסויים ב- xxx. כל משפט יציג שדה מכתבים. דווח על שתי הדמויות הבינוניות שאתה רואה",
    ar: "أنت على وشك بدء كتلة من تجارب xxx. ستقدم كل تجربة مجال الرسائل. أبلغ عن الشخصين الأوسطين اللذين تراهما",
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر مقدمے کی سماعت خطوط کے میدان کو پیش کرے گی۔ آپ دیکھتے ہیں کہ دو درمیانی کرداروں کی اطلاع دیں",
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण पत्रों के क्षेत्र को प्रस्तुत करेगा। उन दो मध्य वर्णों की रिपोर्ट करें जिन्हें आप देखते हैं",
    ta: "நீங்கள் xxx சோதனைகளின் ஒரு தொகுதியைத் தொடங்க உள்ளீர்கள். ஒவ்வொரு சோதனையும் கடிதங்களின் துறையை வழங்கும். நீங்கள் பார்க்கும் இரண்டு நடுத்தர எழுத்துக்களைப் புகாரளிக்கவும்",
    ml: "നിങ്ങൾ xxx ട്രയലുകളുടെ ഒരു ബ്ലോക്ക് ആരംഭിക്കാൻ പോകുന്നു. ഓരോ വിചാരണയും അക്ഷരങ്ങളുടെ മേഖലയിലാകും. നിങ്ങൾ കാണുന്ന രണ്ട് മധ്യ പ്രതീകങ്ങൾ റിപ്പോർട്ടുചെയ്യുക",
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. ప్రతి ట్రయల్ అక్షరాల రంగాన్ని ప్రదర్శిస్తుంది. మీరు చూసే రెండు మధ్య అక్షరాలను నివేదించండి",
    kn: "ನೀವು xxx ಪ್ರಯೋಗಗಳ ಬ್ಲಾಕ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಲಿದ್ದೀರಿ. ಪ್ರತಿ ಪ್ರಯೋಗವು ಅಕ್ಷರಗಳ ಕ್ಷೇತ್ರವನ್ನು ಪ್ರಸ್ತುತಪಡಿಸುತ್ತದೆ. ನೀವು ನೋಡುವ ಎರಡು ಮಧ್ಯದ ಅಕ್ಷರಗಳನ್ನು ವರದಿ ಮಾಡಿ",
    bn: "আপনি xxx ট্রায়ালগুলির একটি ব্লক শুরু করতে চলেছেন। প্রতিটি পরীক্ষা চিঠির ক্ষেত্র উপস্থাপন করবে। আপনি যে দুটি মাঝারি চরিত্র দেখেন তা রিপোর্ট করুন",
    id: "Anda akan memulai blok uji coba xxx. Setiap percobaan akan menyajikan bidang surat. Laporkan dua karakter tengah yang Anda lihat",
    "zh-CN":
      "您即将开始一个xxx试验。每个试验都会呈现字母字段。报告您看到的两个中间字符",
    "zh-HK":
      "您即將開始一個xxx試驗。每個試驗都會呈現字母字段。報告您看到的兩個中間字符",
    ja: "xxxトライアルのブロックを開始しようとしています。各トライアルは、文字のフィールドを提示します。あなたが見る2つの中間文字を報告してください",
    ko: "xxx 시험 블록을 시작하려고합니다. 각 시험은 편지 분야를 제시합니다. 당신이 보는 두 개의 중간 문자를보고하십시오",
  },
  ...
  T_thresholdSoundCheck: {
    ...
    it: "Ciao. Puoi testare se il suono di questo computer funziona facendo clic sul pulsante segnale acustico. Sentirai un segnale acustico così ogni volta che la tua risposta è giusta.",
    ...
    fi: "Hei. Voit testata, toimiiko tämän tietokoneen ääni napsauttamalla piippauspainiketta. Kuulet sellaisen piippauksen joka kerta, kun vastauksesi on oikein.",
    ka: "გამარჯობა. თქვენ შეგიძლიათ შეამოწმოთ, მუშაობს თუ არა ამ კომპიუტერის ხმა BEEP ღილაკის დაჭერით. თქვენ მოისმენთ beep- ს, როგორც ყოველთვის, როდესაც თქვენი პასუხი სწორია.",
    ...
    ta: "வணக்கம். பீப் பொத்தானைக் கிளிக் செய்வதன் மூலம் இந்த கணினியின் ஒலி செயல்படுகிறதா என்பதை நீங்கள் சோதிக்கலாம். ஒவ்வொரு முறையும் உங்கள் பதில் சரியாக இருக்கும் ஒரு பீப்பைக் கேட்பீர்கள்.",
    ml: "ഹലോ. ബീപ്പ് ബട്ടൺ ക്ലിക്കുചെയ്തുകൊണ്ട് ഈ കമ്പ്യൂട്ടറിന്റെ ശബ്ദം പ്രവർത്തിക്കുന്നുണ്ടോ എന്ന് നിങ്ങൾക്ക് പരിശോധിക്കാൻ കഴിയും. നിങ്ങളുടെ ഉത്തരം ശരിയാണെല്ലാം നിങ്ങൾ ഒരു ബീപ്പ് കേൾക്കും.",
    te: "హలో. బీప్ బటన్‌ను క్లిక్ చేయడం ద్వారా ఈ కంప్యూటర్ శబ్దం పనిచేస్తుందో లేదో మీరు పరీక్షించవచ్చు. మీ సమాధానం సరైన ప్రతిసారీ మీరు అలాంటి బీప్ వింటారు.",
    kn: "ಹಲೋ. ಬೀಪ್ ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ ಈ ಕಂಪ್ಯೂಟರ್‌ನ ಧ್ವನಿ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತಿದೆಯೇ ಎಂದು ನೀವು ಪರೀಕ್ಷಿಸಬಹುದು. ನಿಮ್ಮ ಉತ್ತರವು ಸರಿಯಾಗಿದ್ದಾಗಲೆಲ್ಲಾ ನೀವು ಬೀಪ್ ಅನ್ನು ಕೇಳುತ್ತೀರಿ.",
    bn: "হ্যালো. এই কম্পিউটারের শব্দ বীপ বোতামটি ক্লিক করে কাজ করছে কিনা তা আপনি পরীক্ষা করতে পারেন। আপনি প্রতিবার আপনার উত্তরটি ঠিক থাকাকালীন এমন একটি বীপ শুনতে পাবেন।",
    ...
    ja: "こんにちは。ピーボタンをクリックしてこのコンピュータの音が機能していることを確認してください。ちなみに、テストでは正解する度にこの音が鳴ります。",
    ko: "안녕하세요. 경고음 버튼을 클릭 하여이 컴퓨터의 사운드가 작동하는지 테스트 할 수 있습니다. 당신은 당신의 대답이 옳을 때마다 그런 경고음을들을 것입니다.",
  },
  ...
  T_safeToClose: {
    ...
    de: "Erledigt. Ergebnisse gespeichert. Es ist jetzt sicher, diese Registerkarte zu schließen.",
    fr: "Fait. Résultats enregistrés. Il est maintenant sûr de fermer cet onglet.",
    es: "Hecho. Resultados guardados. Ahora es seguro cerrar esta pestaña.",
    pt: "Feito. Resultados salvos. Agora é seguro fechar esta guia.",
    it: "Fatto. Risultati salvati. Ora è sicuro chiudere questa scheda.",
    ro: "Terminat. Rezultate salvate. Acum este sigur să închideți această filă.",
    pl: "Zrobione. Zapisane wyniki. Zamknięcie tej zakładki jest teraz bezpieczne.",
    ru: "Сделанный. Результаты сохранены. Теперь безопасно закрыть эту вкладку.",
    hy: "Կատարած. Արդյունքները պահպանվել են: Այժմ անվտանգ է այս ներդիրը փակելու համար:",
    fi: "Tehty. Tulokset tallennetaan. Tämän välilehden sulkeminen on nyt turvallista.",
    ka: "Შესრულებულია. შედეგები შენახულია. ახლა უსაფრთხოა ამ ჩანართის დახურვა.",
    he: "בוצע. תוצאות נשמרו. כעת בטוח לסגור את הכרטיסייה זו.",
    ar: "منتهي. النتائج المحفوظة. من الآمن الآن إغلاق علامة التبويب هذه.",
    ur: "کیا نتائج بچ گئے۔ اب اس ٹیب کو بند کرنا محفوظ ہے۔",
    hi: "हो गया। परिणाम बच गए। इस टैब को बंद करना अब सुरक्षित है।",
    ta: "முடிந்தது. முடிவுகள் சேமிக்கப்பட்டன. இந்த தாவலை மூடுவது இப்போது பாதுகாப்பானது.",
    ml: "ചെയ്തു. ഫലങ്ങൾ സംരക്ഷിച്ചു. ഈ ടാബ് അടയ്ക്കുന്നത് ഇപ്പോൾ സുരക്ഷിതമാണ്.",
    te: "పూర్తి. ఫలితాలు సేవ్ చేయబడ్డాయి. ఈ ట్యాబ్‌ను మూసివేయడం ఇప్పుడు సురక్షితం.",
    kn: "ಮುಗಿದಿದೆ. ಫಲಿತಾಂಶಗಳನ್ನು ಉಳಿಸಲಾಗಿದೆ. ಈ ಟ್ಯಾಬ್ ಅನ್ನು ಮುಚ್ಚುವುದು ಈಗ ಸುರಕ್ಷಿತವಾಗಿದೆ.",
    bn: "সম্পন্ন. ফলাফল সংরক্ষণ। এই ট্যাবটি বন্ধ করা এখন নিরাপদ।",
    id: "Selesai. Hasil disimpan. Sekarang aman untuk menutup tab ini.",
    "zh-CN": "完毕。结果保存了。现在可以安全地关闭此选项卡。",
    "zh-HK": "完畢。結果保存了。現在可以安全地關閉此選項卡。",
    ja: "終わり。結果が保存されました。このタブを閉じるのは安全です。",
    ko: "완료. 결과가 저장되었습니다. 이제이 탭을 닫는 것이 안전합니다.",
  },
};

...
export const phrases = {
  ...
  RC_distanceTrackingCloseR: {
    ...
    fr: "1. Fermez votre œil droit. (C'est le côté droit de l'écran.)\n2. Utilisez la touche flèche ◀ pour faire glisser le point scintillant. Tout en regardant les cheveux, surveillez le point scintillant dans le coin de votre œil et faites-le glisser à gauche et à droite jusqu'à ce qu'il disparaisse dans votre point mort.\n3. Appuyez sur Retour.\nRemarque: Gardez l'œil sur les poils. Le point vacillant ne disparaîtra pas pendant que votre œil le suit.",
  ...
  T_continueHitReturnOrKeypad: {
    "en-US": "To continue, hit RETURN on your keyboard or phone keypad.",
    de: "",
    fr: "",
    es: "",
    pt: "",
  ...
  T_continueClickProceedOrKeypad: {
    "en-US": "To continue, click PROCEED or hit RETURN on the phone keypad.",
    de: "",
    fr: "",
    es: "",
    pt: "",
  ...
  T_identifyMiddleLetterPressIt: {
    ...
    ro: "Vă rugăm să identificați scrisoarea de mijloc apăsând tasta tastatură.",
  ...
  T_identifyLetterClickIt: {
    ...
    ur: "براہ کرم ذیل پر کلک کرکے خط کی شناخت کریں۔",
  ...
  T_identifyLetterPressIt: {
    ...
    es: "Identifique la letra presionando su tecla de teclado.",
  ...
  "❌T_identifyPressItOrClickIt": {
    ...
    ta: "T_identifiefrositorClickit → T_identifymiddleletterpressitorclickit ஐ மாற்றவும்",
  ...
  T_keypadLetterOrPressingKey: {
    "en-US": "by pressing it on the keypad on your phone or on the keyboard.",
    de: "",
    fr: "",
    es: "",
    pt: "",
  ...
  T_readyClickCrosshair: {
    "en-US":
      "Ready? Click the center of the cross hairs to make the letter(s) appear.",
  ...
  T_readyTrackCrosshair: {
    ...
    ka: "მზად? გამოიყენეთ კურსორი, რომ აკონტროლოთ ჯვრის თმის ცენტრი, სანამ ასო (ებ) ი გამოჩნდება.",

...
export const phrases = {
  ...
  "🕑RC_distanceTrackingGuide": {
    ...
    it: "I tuoi occhi sono a 111 cm dallo schermo, ma l'esperimento ha bisogno di circa 222 cm. L'esperimento riprenderà quando raggiungi la distanza corretta.",
    ...
    ru: "Ваши глаза находятся в 111 см от экрана, но эксперимент требует приблизительно 222 см. Эксперимент возобновится, когда вы достигнете правильного расстояния.",
    hy: "Ձեր աչքերը էկրանից 111 սմ են, բայց փորձը պահանջում է մոտավորապես 222 սմ: Փորձը կվերսկսվի ճիշտ հեռավորության վրա:",
    fi: "Silmäsi ovat 111 cm näytöltä, mutta koe tarvitsee noin 222 cm. Koe jatkuu, kun saavutat oikean etäisyyden.",
    ka: "თქვენი თვალები ეკრანიდან 111 სმ არის, მაგრამ ექსპერიმენტს დაახლოებით 222 სმ სჭირდება. ექსპერიმენტი განახლდება, როდესაც მიაღწევთ სწორ მანძილს.",
    ...
    bn: "আপনার চোখ স্ক্রিন থেকে 111 সেন্টিমিটার দূরে, তবে পরীক্ষায় প্রায় 222 সেন্টিমিটার প্রয়োজন। আপনি যখন সঠিক দূরত্বে পৌঁছেছেন তখন পরীক্ষাটি আবার শুরু হবে।",

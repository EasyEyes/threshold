...
export const phrases = {
  ...
  RC_nearPointIntro: {
    ...
    ru: "Мы измеряем расстояние между вашими глазами. Используйте видео изображение, чтобы посмотреть свои глаза. Держите ручку горизонтально к лицу перед глазами. Выровняйте свои правые и левые пальцы с помощью центров ваших зрачков правого и левого. Затем принесите ручку к линейке на экране, чтобы измерить разделение между большими пальцами. Выравнивайте левый большой палец с нулем и обратите внимание, где находится правый большой палец. Положите ручку и щелкните правителя в этот момент. Наконец, нажмите ОК, чтобы продолжить.",
  ...
  T_sentenceGuessingGame: {
    ...
    "zh-HK":
      "該句子的可理解性將從輕鬆到硬或不可能不等。您的收入不能超過三分之二，所以放鬆。將其視為一個猜測遊戲，只需獲得盡可能多的遊戲。每當您正確時，您都會聽到蜂鳴聲。",
  ...
  T_soundPhraseBlock: {
    ...
    "zh-HK":
      "在每個審判中，您都會聽到一句話，然後要求您記住兩個單詞。聲音被扭曲，可能很難識別，因此您無法使它們正確。不用擔心。只需將其視為遊戲，並儘力而為。祝你好運。點擊返回或單擊繼續繼續進行。\n\n繼續按鈕將立即消失，一旦加載聲音，實驗將開始，這取決於Internet連接的速度，需要40秒或更長時間。我們正在努力在以後的版本中縮短這一延遲。\n\n加載聲音...",

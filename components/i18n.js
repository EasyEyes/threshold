...
export const phrases = {
  ...
  T_keypadScanQRCode: {
    "en-US":
      "To allow a long viewing distance, please recruit your smartphone to act as a wireless keypad. Point your smartphone camera at this QR code. When a link appears on your smartphone screen, tap it with your finger.",
    de: "Um eine lange Betrachtungsentfernung zu ermöglichen, rekrutieren Sie bitte Ihr Smartphone, um als drahtlose Tastatur zu fungieren. Zeigen Sie Ihre Smartphone -Kamera auf diesen QR -Code. Wenn ein Link auf Ihrem Smartphone -Bildschirm angezeigt wird, tippen Sie mit dem Finger darauf.",
    fr: "Pour permettre une longue distance de visualisation, veuillez recruter votre smartphone pour agir comme un clavier sans fil. Pointez votre appareil photo pour smartphone sur ce code QR. Lorsqu'un lien apparaît sur l'écran de votre smartphone, appuyez-le avec votre doigt.",
    es: "Para permitir una larga distancia de visualización, reclute su teléfono inteligente para actuar como un teclado inalámbrico. Apunte la cámara de su teléfono inteligente en este código QR. Cuando aparezca un enlace en la pantalla de su teléfono inteligente, toque con su dedo.",
    pt: "Para permitir uma distância de visualização longa, recrute seu smartphone para atuar como um teclado sem fio. Aponte sua câmera de smartphone para este código QR. Quando um link aparecer na tela do seu smartphone, toque nele com o dedo.",
    it: "Per consentire una lunga distanza di visualizzazione, assumi lo smartphone per fungere da tastiera wireless. Punta la fotocamera per smartphone su questo codice QR. Quando viene visualizzato un collegamento sullo schermo dello smartphone, toccalo con il dito.",
    ro: "Pentru a permite o distanță lungă de vizualizare, vă rugăm să recrutați smartphone -ul pentru a acționa ca o tastatură wireless. Indicați camera smartphone -ului către acest cod QR. Când apare un link pe ecranul smartphone -ului, atingeți -l cu degetul.",
    pl: "Aby umożliwić długą odległość oglądania, rekrutuj swój smartfon, aby działał jako klawiatura bezprzewodowa. Skieruj aparat smartfona na ten kod QR. Gdy na ekranie smartfona pojawi się link, dotknij go palcem.",
    ru: "Чтобы разрешить длительное расстояние просмотра, пожалуйста, наберите свой смартфон, чтобы выступать в качестве беспроводной клавиатуры. Укажите камеру смартфона на этом QR -коде. Когда на экране смартфона появляется ссылка, нажмите ее пальцем.",
    hy: "Երկար դիտման հեռավորություն թույլ տալու համար խնդրում ենք հավաքագրել ձեր սմարթֆոնը `որպես անլար ստեղնաշարի հանդես գալու համար: Նշեք ձեր սմարթֆոնների ֆոտոխցիկը QR այս կոդով: Երբ հղումը հայտնվում է ձեր սմարթֆոնի էկրանին, ձեր մատով հպեք:",
    fi: "Rekrytoi älypuhelimesi pitkän katseluetäisyyden sallimiseksi toimimaan langattomana näppäimistönä. Osoita älypuhelinkamera tässä QR -koodissa. Kun linkki näkyy älypuhelimen näytöllä, napauta sitä sormella.",
    ka: "გრძელი სანახავი მანძილის დასაშვებად, გთხოვთ, შეაგროვოთ თქვენი სმარტფონი, რომ იმოქმედოთ როგორც უკაბელო კლავიატურა. მიუთითეთ თქვენი სმარტფონის კამერა ამ QR კოდზე. როდესაც ბმული გამოჩნდება თქვენს სმარტფონის ეკრანზე, შეეხეთ მას თითით.",
    he: "כדי לאפשר מרחק צפייה ארוך, אנא גייס את הסמארטפון שלך כדי לשמש כל לוח מקשים אלחוטי. כוון את מצלמת הסמארטפון שלך בקוד QR זה. כאשר מופיע קישור על מסך הסמארטפון שלך, הקש עליו באצבע.",
    ar: "للسماح بمسافة عرض طويلة ، يرجى توظيف هاتفك الذكي بالعمل كرسية مفاتيح لاسلكية. أشر كاميرا الهاتف الذكي على رمز الاستجابة السريعة هذا. عندما يظهر رابط على شاشة الهاتف الذكي ، انقر عليه بإصبعك.",
    ur: "دیکھنے کے طویل فاصلے کی اجازت دینے کے لئے ، براہ کرم اپنے اسمارٹ فون کو وائرلیس کیپیڈ کے طور پر کام کرنے کے لئے بھرتی کریں۔ اس QR کوڈ پر اپنے اسمارٹ فون کیمرا کی نشاندہی کریں۔ جب آپ کے اسمارٹ فون اسکرین پر کوئی لنک ظاہر ہوتا ہے تو ، اسے اپنی انگلی سے تھپتھپائیں۔",
    hi: "एक लंबी देखने की दूरी की अनुमति देने के लिए, कृपया अपने स्मार्टफोन को वायरलेस कीपैड के रूप में कार्य करने के लिए भर्ती करें। इस QR कोड पर अपना स्मार्टफोन कैमरा इंगित करें। जब आपके स्मार्टफोन स्क्रीन पर कोई लिंक दिखाई देता है, तो इसे अपनी उंगली से टैप करें।",
    ta: "நீண்ட பார்க்கும் தூரத்தை அனுமதிக்க, வயர்லெஸ் விசைப்பலகையாக செயல்பட உங்கள் ஸ்மார்ட்போனை நியமிக்கவும். இந்த QR குறியீட்டில் உங்கள் ஸ்மார்ட்போன் கேமராவை சுட்டிக்காட்டவும். உங்கள் ஸ்மார்ட்போன் திரையில் ஒரு இணைப்பு தோன்றும்போது, ​​அதை உங்கள் விரலால் தட்டவும்.",
    ml: "ഒരു നീണ്ട കാഴ്ചപ്പാടുകൾ അനുവദിക്കുന്നതിന്, വയർലെസ് കമാനമായി പ്രവർത്തിക്കാൻ ദയവായി നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ റിക്രൂട്ട് ചെയ്യുക. ഈ QR കോഡിൽ നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ ക്യാമറ പോയിന്റുചെയ്യുക. നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ സ്ക്രീനിൽ ഒരു ലിങ്ക് ദൃശ്യമാകുമ്പോൾ, നിങ്ങളുടെ വിരൽ ഉപയോഗിച്ച് ടാപ്പുചെയ്യുക.",
    te: "సుదీర్ఘ వీక్షణ దూరాన్ని అనుమతించడానికి, దయచేసి మీ స్మార్ట్‌ఫోన్‌ను వైర్‌లెస్ కీప్యాడ్‌గా పనిచేయడానికి నియమించండి. ఈ QR కోడ్ వద్ద మీ స్మార్ట్‌ఫోన్ కెమెరాను సూచించండి. మీ స్మార్ట్‌ఫోన్ స్క్రీన్‌లో లింక్ కనిపించినప్పుడు, దాన్ని మీ వేలితో నొక్కండి.",
    kn: "ದೀರ್ಘ ವೀಕ್ಷಣೆ ದೂರವನ್ನು ಅನುಮತಿಸಲು, ದಯವಿಟ್ಟು ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಅನ್ನು ವೈರ್‌ಲೆಸ್ ಕೀಪ್ಯಾಡ್ ಆಗಿ ಕಾರ್ಯನಿರ್ವಹಿಸಲು ನೇಮಕ ಮಾಡಿ. ಈ ಕ್ಯೂಆರ್ ಕೋಡ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಕ್ಯಾಮೆರಾವನ್ನು ಸೂಚಿಸಿ. ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಪರದೆಯಲ್ಲಿ ಲಿಂಕ್ ಕಾಣಿಸಿಕೊಂಡಾಗ, ಅದನ್ನು ನಿಮ್ಮ ಬೆರಳಿನಿಂದ ಟ್ಯಾಪ್ ಮಾಡಿ.",
    bn: "দীর্ঘ দেখার দূরত্বের অনুমতি দেওয়ার জন্য, দয়া করে আপনার স্মার্টফোনটিকে ওয়্যারলেস কীপ্যাড হিসাবে কাজ করার জন্য নিয়োগ করুন। এই কিউআর কোডটিতে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করুন। যখন আপনার স্মার্টফোনের স্ক্রিনে কোনও লিঙ্ক উপস্থিত হয়, তখন এটি আপনার আঙুল দিয়ে আলতো চাপুন।",
    id: "Untuk mengizinkan jarak menonton yang panjang, silakan merekrut ponsel cerdas Anda untuk bertindak sebagai keypad nirkabel. Arahkan kamera ponsel cerdas Anda ke kode QR ini. Saat tautan muncul di layar ponsel cerdas Anda, ketuk dengan jari Anda.",
    "zh-CN":
      "为了延长观看距离，请招募您的智能手机充当无线键盘。将您的智能手机相机指向此QR码。当您的智能手机屏幕上出现链接时，用手指点击它。",
    "zh-HK":
      "為了延長觀看距離，請招募您的智能手機充當無線鍵盤。將您的智能手機相機指向此QR碼。當您的智能手機屏幕上出現鏈接時，用手指點擊它。",
    ja: "視聴距離が長くなるようにするには、スマートフォンを募集してワイヤレスキーパッドとして機能してください。このQRコードでスマートフォンカメラをポイントします。スマートフォン画面にリンクが表示されたら、指でタップします。",
    ko: "시청 거리가 길어 지려면 스마트 폰을 모집하여 무선 키패드 역할을하십시오. 이 QR 코드에서 스마트 폰 카메라를 가리 키십시오. 스마트 폰 화면에 링크가 나타나면 손가락으로 탭하십시오.",
  },

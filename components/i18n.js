...
export const phrases = {
  ...
  RC_privacyIphoneMicrophone: {
    ...
    te: "మైక్రోఫోన్ గోప్యత యొక్క భరోసా. వాడుకలో లేని వెర్షన్. Rc_privacyiphonemicrophone నుండి RC_PRIVACYMICROCALIBRATION వరకు నవీకరణ",

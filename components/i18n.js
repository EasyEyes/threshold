...
export const phrases = {
  ...
  RC_findModelAndroid: {
    ...
    "zh-CN":
      "转到“设置或选项”菜单，滚动到列表的底部，然后检查“关于电话”，“关于设备”或类似方式。将模型名称和数字复制到下面的相应字段。",
    "zh-HK":
  ...
  RC_findModelIOs: {
    ...
    "zh-CN":
      "转到设置>一般>关于。在“型号”的右侧，您会找到零件号。要查找型号（“ A”，然后是一个数字），请点击零件号。将模型名称和数字复制到下面的相应字段。",
    "zh-HK":
  ...
  RC_citeSoundCompressionModel: {
    ...
    it: 'Basato sull\'Eq. 4 di Giannoulis et al. (2012). <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicrangecompression-jaes2012.pdf"> design del compressore dinamico digitale. </a> J. Audio Eng. Soc. 6 (6): 399-408.',
    ...
    ja: '式に基づいています。 Giannoulis et al。 （2012）。 <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicrangecression-jaes2012.pdf">デジタルダイナミックレンジコンプレッサーデザイン。 Soc。 6（6）：399-408。',
  ...
  RC_backToExperimentWindow: {
    ...
    ru: "Прогресс отображается в основном окне эксперимента. Пожалуйста, перейдите туда, нажав на вкладку «Easyeyes Experime» (или слева в браузере в дуге).",
  ...
  T_clickingWordRsvpReading: {
    ...
    kn: "ಪದಗಳ ಪಟ್ಟಿಯಲ್ಲಿ ಅವುಗಳನ್ನು ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ. ಪ್ರತಿ ಕಾಲಂನಲ್ಲಿ ಒಂದು ಪದವನ್ನು ಆಯ್ಕೆಮಾಡಿ.",
    ...
    "zh-HK": "通過在單詞列表中單擊它們。在每一列中選擇一個單詞。",
  ...
  T_identifyVernierPressIt: {
    ...
    fi: "Mihin suuntaan ylälinja siirtyy? Paina vasemmalle tai oikealle.",
  ...
  T_middleLetterDemo: {
    ...
    ka: "თითოეულ განსაცდელზე, სანამ ჯვრის თმას უყურებთ, სამი შემთხვევითი ასოების ტრიპლეტი თქვენს თვალის კუთხეში გაისვრის. უბრალოდ ფლეშ. დავალების შესასწავლად, პირველ რიგში, ვცადოთ სტატიკური ჩვენებით. ჯვრის თმას გადახედვისას, ქვემოთ, თვალების გადაადგილების გარეშე, შეეცადეთ დაადგინოთ შუა ასო.",

...
export const phrases = {
  ...
  RC_FindModelAndroid: {
    ...
    pl: "Ponieważ jest to Android, przejdź do menu Ustawienia lub Opcji, przewiń do dołu listy i sprawdź „About Phone”, „About Device” lub podobne. Skopiuj nazwę modelu i numer do odpowiednich pól poniżej.",
    ...
    ko: "이것은 Android이므로 설정 또는 옵션 메뉴로 이동하여 목록 하단으로 스크롤하여‘전화 정보’,‘장치 정보’또는 이와 유사한 것을 확인하십시오. 모델 이름과 번호를 아래의 해당 필드에 복사하십시오.",
  },
  RC_FindModelIOs: {
    "en-US":
  ...
  RC_privacyIphoneMicrophone: {
    ...
    fr: "❌ Assurance de la confidentialité des microphones. Version obsolète. Mise à jour de rc_privacyiphonémicrophone à rc_privacymicrophonecalibration",

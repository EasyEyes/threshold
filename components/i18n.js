...
export const phrases = {
  ...
  EE_ID_noLocalStorage: {
    ...
    "zh-HK":
      "研究人員要求您提供上一個會話中的EasyEyes ID，請在此處輸入，或在上一個會話結束時上傳下載的文件。",
  ...
  EE_incompatibleReturnToProlific: {
    ...
    bn: "এই অধ্যয়নটি আপনার কম্পিউটার বা ব্রাউজারের সাথে বেমানান, সুতরাং দয়া করে এটি প্রলিফিক.কম এ ফিরিয়ে দিন। অর্থ প্রদানের জন্য জমা দেওয়া প্রত্যাখ্যান করা হবে (যা আপনার খ্যাতির ক্ষতি করে), তাই দয়া করে এটি ফিরিয়ে দিন।",
  ...
  RC_gazeTrackingIntro: {
    ...
    id: 'Mainkan "Tangkap Salib!" Sekarang kami akan mengatur pelacakan tatapan, untuk memantau posisi mata. Simpan wajah Anda di umpan video (lihat di bawah). Klik di tengah rambut silang, di mana pun itu. Pastikan mata Anda tertuju pada itu saat Anda mengkliknya. Saat Anda mengkliknya, Cross Hairs akan pindah ke lokasi baru. Klik di setiap lokasi baru, sampai kalibrasi selesai. Ini permainan. Tangkap salib!',
    "zh-CN":
  ...
  RC_privacyIphoneMicrophone: {
    ...
    fr: "Assurance de l'intimité des microphones. EasyEyes utilise votre microphone iPhone / iPad, plutôt que le microphone intégré de votre bureau, car le microphone iPhone / iPad est calibré du fabricant. Le microphone enregistre uniquement tandis qu'un son bruyant joue dans le haut-parleur de l'ordinateur de bureau, et l'ordinateur de bureau affiche bien en vue \"silencieux s'il vous plaît! Maintenant l'enregistrement\". L'enregistrement est utilisé uniquement pour estimer les caractéristiques des haut-parleurs, puis effacée, dans les 30 secondes. Seules les caractéristiques du haut-parleur sont conservées.",
    ...
    pt: 'Garantia da privacidade do microfone. O Easyeyes usa seu microfone para iPhone/iPad, em vez do microfone embutido da sua área de trabalho, porque o microfone para iPhone/iPad é calibrado ao fabricante. O microfone registra apenas enquanto um som alto joga pelo alto -falante de computadores da área de trabalho, e o computador da área de trabalho exibe com destaque "silencioso por favor! Agora, gravação". A gravação é usada apenas para estimar as características do alto -falante e depois apagada, dentro de 30 segundos. Somente as características do alto -falante são retidas.',
    ...
    "zh-CN":
      "保证麦克风隐私。 EasyEyes使用您的iPhone/iPad麦克风，而不是台式机的内置麦克风，因为iPhone/iPad麦克风是制造商校准的。麦克风仅在台式计算机扬声器上播放麦克风时，并且台式计算机都显着地显示“请安静！现在正在录制”。该录制仅用于估计扬声器特征，然后在30秒内删除。仅保留扬声器特性。",
    "zh-HK":
      "保證麥克風隱私。 EasyEyes使用您的iPhone/iPad麥克風，而不是台式機的內置麥克風，因為iPhone/iPad麥克風是製造商校準的。麥克風僅在台式計算機揚聲器上播放麥克風，而台式計算機都顯著地顯示“請安靜！現在錄製”。該錄製僅用於估計揚聲器特徵，然後在30秒內刪除。僅保留揚聲器特性。",
  ...
  RC_soundCalibrationDone: {
    ...
    fi: "Kiitos. Kalibrointi on tehty, ja voit laittaa iPhonen/iPadin pois. Tärkeää: Älä kosketa äänenvoimakkuuden säätöä ennen kuin koe on tehty. Tängomentin muuttaminen voittaa kalibroinnin ja mitätöidä kaikki tulokset.",
  ...
  T_guessingGame: {
    ...
    ka: "ასოების ზომა და ინტერვალი განსხვავდება დიდი და მარტივი და რთული და რთული ან შეუძლებელი. თქვენ ვერ მიიღებთ ბევრად მეტს, ვიდრე ორ მესამედს, ასე რომ დაისვენეთ. იფიქრეთ მასზე, როგორც გამოცნობის თამაში და უბრალოდ მიიღეთ რაც შეიძლება მეტი. თქვენ მოისმენთ beep, როდესაც მართალი ხართ.",
  ...
  T_identifyClickIt: {
    ...
    ka: "გთხოვთ, დაადგინოთ შუა წერილი, ქვემოთ დაჭერით.",
  ...
  T_pressingKeyOrClickingLetterRepeatedLetters: {
    ...
    ur: "خطوط کی نمائش شدہ فہرست پر ان پر کلک کرکے ، یا کی بورڈ پر دبانے سے۔",
  ...
  T_sentenceGuessingGame: {
    ...
    ka: "სასჯელის გააზრება განსხვავდება მარტივად ქვემოთ ან შეუძლებლად. თქვენ ვერ მიიღებთ ბევრად მეტს, ვიდრე ორ მესამედს, ასე რომ დაისვენეთ. იფიქრეთ მასზე, როგორც გამოცნობის თამაში და უბრალოდ მიიღეთ რაც შეიძლება მეტი. თქვენ მოისმენთ beep, როდესაც მართალი ხართ.",
  ...
  T_soundPhraseBlock: {
    ...
    hi: "प्रत्येक परीक्षण पर आप एक वाक्य सुनेंगे, और फिर आपको दो शब्दों को याद करने के लिए कहा जाएगा। ध्वनि विकृत है और पहचानना मुश्किल हो सकता है, इसलिए आप उन्हें ठीक नहीं कर सकते। चिंता मत करो। बस इसे एक खेल के रूप में मानें और अपना सर्वश्रेष्ठ करें। आपको कामयाबी मिले। रिटर्न हिट करें या जारी रखने के लिए आगे बढ़ें पर क्लिक करें।\n\nआगे बटन तुरंत गायब हो जाएगा, और ध्वनि लोड होने के बाद प्रयोग शुरू हो जाएगा, जिसमें इंटरनेट कनेक्शन की गति के आधार पर 40 सेकंड या उससे अधिक समय लगता है। हम भविष्य की रिलीज में इस देरी को कम करने के लिए काम कर रहे हैं।\n\nलोड हो रहा है ...",

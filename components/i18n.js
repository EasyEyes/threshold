...
export const phrases = {
  ...
  RC_findModelIOs: {
    ...
    hi: 'सेटिंग्स> सामान्य> के बारे में जाएं। "मॉडल नंबर" के दाईं ओर, आपको भाग संख्या मिलेगी। मॉडल नंबर (एक संख्या के बाद "ए") को खोजने के लिए, भाग संख्या पर टैप करें। मॉडल नाम और संख्या को नीचे दिए गए संबंधित फ़ील्ड में कॉपी करें।',
  ...
  RC_allowMicrophoneUse: {
    ...
    fr: 'Si une pop-up demande la permission d\'utiliser le microphone, cliquez sur "Autoriser".',
    ...
    ar: 'إذا طلبت المنبثقة الإذن لاستخدام الميكروفون ، فانقر فوق "السماح".',
  ...
  RC_distanceTrackingBeyond50Cm: {
    "en-US":
      "Beyond 50 cm, it’s harder to reach your computer’s keyboard, so feel free to use the keypad on your smartphone instead.",
    de: "Abgesehen von 50 cm ist es schwieriger, die Tastatur Ihres Computers zu erreichen. Verwenden Sie also stattdessen die Tastatur auf Ihrem Smartphone.",
    fr: "Au-delà de 50 cm, il est plus difficile d'atteindre le clavier de votre ordinateur, alors n'hésitez pas à utiliser le clavier sur votre smartphone à la place.",
    es: "Más de 50 cm, es más difícil llegar al teclado de su computadora, así que siéntase libre de usar el teclado en su teléfono inteligente.",
    pt: "Além de 50 cm, é mais difícil alcançar o teclado do seu computador; portanto, fique à vontade para usar o teclado no seu smartphone.",
    it: "Oltre 50 cm, è più difficile raggiungere la tastiera del tuo computer, quindi non esitare a utilizzare la tastiera sul tuo smartphone.",
    ro: "Dincolo de 50 cm, este mai greu să ajungi la tastatura computerului, așa că nu ezitați să folosiți tastatura pe smartphone -ul dvs. în schimb.",
    pl: "Poza 50 cm trudniej jest dotrzeć do klawiatury komputera, więc zamiast tego użyj klawiatury na smartfonie.",
    ru: "Помимо 50 см, труднее достичь клавиатуры вашего компьютера, поэтому вместо этого не стесняйтесь использовать клавиатуру на своем смартфоне.",
    hy: "50 սմ-ից այն կողմ, ավելի դժվար է հասնել ձեր համակարգչի ստեղնաշարի վրա, այնպես որ ազատ զգալ փոխարենը օգտագործել ձեր սմարթֆոնի ստեղնաշարը:",
    fi: "50 cm: n yli on vaikeampaa tavoittaa tietokoneesi näppäimistö, joten voit käyttää sen sijaan näppäimistöä älypuhelimessa.",
    ka: "50 სმ -ის მიღმა, უფრო რთულია თქვენი კომპიუტერის კლავიატურას მისასვლელად, ასე რომ მოგერიდებათ გამოიყენოთ კლავიატურა თქვენს სმარტფონზე.",
    he: 'מעבר ל 50 ס"מ, קשה יותר להגיע למקלדת של המחשב שלך, אז אל תהסס להשתמש בלוח המקשים בסמארטפון שלך במקום.',
    ar: "إلى ما بعد 50 سم ، من الصعب الوصول إلى لوحة المفاتيح بجهاز الكمبيوتر الخاص بك ، لذلك لا تتردد في استخدام لوحة المفاتيح على هاتفك الذكي بدلاً من ذلك.",
    ur: "50 سینٹی میٹر سے آگے ، آپ کے کمپیوٹر کے کی بورڈ تک پہنچنا مشکل ہے ، لہذا اس کے بجائے اپنے اسمارٹ فون پر کیپیڈ کو بلا جھجھک استعمال کریں۔",
    hi: "50 सेमी से परे, आपके कंप्यूटर के कीबोर्ड तक पहुंचना कठिन है, इसलिए इसके बजाय अपने स्मार्टफोन पर कीपैड का उपयोग करने के लिए स्वतंत्र महसूस करें।",
    ta: "50 செ.மீ தாண்டி, உங்கள் கணினியின் விசைப்பலகையை அடைவது கடினம், எனவே அதற்கு பதிலாக உங்கள் ஸ்மார்ட்போனில் விசைப்பலகையைப் பயன்படுத்தலாம்.",
    ml: "50 സെന്റിമീറ്ററിനപ്പുറം, നിങ്ങളുടെ കമ്പ്യൂട്ടറിന്റെ കീബോർഡിൽ എത്താൻ പ്രയാസമാണ്, അതിനാൽ പകരം നിങ്ങളുടെ സ്മാർട്ട്ഫോണിൽ കീപാഡ് ഉപയോഗിക്കാൻ മടിക്കേണ്ട.",
    te: "50 సెం.మీ దాటి, మీ కంప్యూటర్ కీబోర్డ్‌ను చేరుకోవడం చాలా కష్టం, కాబట్టి బదులుగా మీ స్మార్ట్‌ఫోన్‌లో కీప్యాడ్‌ను ఉపయోగించడానికి సంకోచించకండి.",
    kn: "50 ಸೆಂ.ಮೀ ಮೀರಿ, ನಿಮ್ಮ ಕಂಪ್ಯೂಟರ್‌ನ ಕೀಬೋರ್ಡ್ ತಲುಪುವುದು ಕಷ್ಟ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್‌ನಲ್ಲಿ ಕೀಪ್ಯಾಡ್ ಅನ್ನು ಬಳಸಲು ಹಿಂಜರಿಯಬೇಡಿ.",
    bn: "50 সেমি ছাড়িয়ে আপনার কম্পিউটারের কীবোর্ডে পৌঁছানো আরও শক্ত, তাই পরিবর্তে আপনার স্মার্টফোনে কীপ্যাড ব্যবহার করতে নির্দ্বিধায়।",
    id: "Di luar 50 cm, lebih sulit untuk mencapai keyboard komputer Anda, jadi jangan ragu untuk menggunakan keypad di ponsel cerdas Anda sebagai gantinya.",
    "zh-CN":
      "超过50厘米，很难到达计算机的键盘，因此请随意使用智能手机上的键盘。",
    "zh-HK":
      "超過50厘米，很難到達計算機的鍵盤，因此請隨意使用智能手機上的鍵盤。",
    ja: "50 cmを超えて、コンピューターのキーボードに到達するのが難しいので、代わりにスマートフォンでキーパッドを自由に使用してください。",
    ko: "50cm를 넘어서 컴퓨터 키보드에 도달하기가 더 어렵 기 때문에 대신 스마트 폰에서 키패드를 사용하십시오.",
  },
  ...
  RC_screenSizeIntro: {
    ...
    ru: "Мы измеряем размер этого экрана. Используйте выпадающее меню, чтобы выбрать что-то удобное. Вы можете использовать любой общий USB -разъем (включая тот, который обеспечивает питание для вашего компьютера) или кредитную карту (или любую карту того же размера). Поместите свой объект на экран и переместите ползунок, чтобы настроить изображение, чтобы соответствовать размеру вашего объекта. Когда они соответствуют, нажмите «Возврат» (или нажмите ОК), чтобы продолжить.",
  ...
  RC_selectMicrophoneIncludeUSB: {
    ...
    ta: 'உங்கள் ஒலிபெருக்கியை அளவீடு செய்யத் தயாராகி, உங்களிடம் ஸ்மார்ட்போன் (அல்லது யூ.எஸ்.பி மைக்ரோஃபோன்) எளிதாக இருந்தால், அதன் தயாரிப்பையும் மாதிரியையும் கீழே உள்ள பட்டியலில் பார்க்கிறீர்களா? அப்படியானால், அதைத் தேர்ந்தெடுக்கவும். இல்லையெனில், "பொருந்தவில்லை" என்பதைத் தேர்ந்தெடுக்கவும். பின்னர் தொடரவும் என்பதைக் கிளிக் செய்க.\n',
  ...
  RC_sound1000HzRecordingLevels: {
    ...
    ja: "最も大きな1000 Hz録音：222の一意の値で111 dB。",
  ...
  RC_soundAllHzRecordingLevels: {
    ...
    it: "Registrazione All-Hz: 111 dB con 222 valori univoci.",
  ...
  RC_soundAllHzDetails: {
    ...
    ru: "Частотная характеристика, откалиброванная с 111 повторением (после 222 разминки) взрыва 333 секунд, отобрана при 444 Гц.",
    ...
    ka: "სიხშირეზე რეაგირება დაკომპლექტებულია 111 გამეორებით (222 თბილი რითის შემდეგ) 333 წამის ადიდებული, რომელიც შერჩეულია 444 ჰც -ზე.",
    ...
    hi: "एक 333 सेकंड के फट के 111 दोहराव (222 वार्मअप के बाद) के साथ आवृत्ति प्रतिक्रिया कैलिब्रेटेड, 444 हर्ट्ज पर नमूना लिया गया।",
    ...
    te: "ఫ్రీక్వెన్సీ ప్రతిస్పందన 333 సెకన్ల పేలుడు యొక్క 111 రిపీట్స్‌తో (222 వారప్‌ల తరువాత) క్రమాంకనం చేయబడింది, ఇది 444 Hz వద్ద నమూనా చేయబడింది.",
    ...
    id: "Respons frekuensi dikalibrasi dengan 111 pengulangan (setelah 222 pemanasan) dari semburan 333 detik, sampel pada 444 Hz.",
    "zh-CN":
  ...
  RC_citeSoundCompressionModel: {
    ...
    ru: 'На основе уравнения. 4 Giannoulis et al. (2012). <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicrangecompression-jaes2012.pdf"> Дизайн компрессора цифрового динамического диапазона. </a> J. Audio Eng. Соц 6 (6): 399-408.',
    ...
    bn: 'একের উপর ভিত্তি করে। জিয়ান্নলিস এট আল এর 4। (2012)। <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergregreiss-dynamicrangecompress-jaes2012.pdf"> ডিজিটাল ডায়নামিক রেঞ্জ কমপ্রেস ডিজাইন। </a> জে। সোস। 6 (6): 399-408।',
    ...
    "zh-HK":
      '基於等式。 Giannoulis等人4。 （2012）。 <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicrangecompression-jaes2012.pdf">數字動態動態範圍壓縮機設計。 Soc。 6（6）：399-408。',
  ...
  RC_soundCalibrationDone: {
    ...
    hi: "धन्यवाद। लाउडस्पीकर को अब कैलिब्रेट किया गया है, और आप स्मार्टफोन (या यूएसबी माइक्रोफोन) को दूर कर सकते हैं। महत्वपूर्ण: जब तक प्रयोग नहीं किया जाता है तब तक वॉल्यूम नियंत्रण को न छूएं। वॉल्यूम बदलने से लाउडस्पीकर अंशांकन बर्बाद हो जाएगा और सभी परिणामों को अमान्य कर देगा।",
  ...
  T_continueKeypad: {
    ...
    ru: "Чтобы продолжить, нажмите «Возвращение на клавиатуре телефона».",
  ...
  T_continueHitReturnOrKeypad: {
    ...
    ur: "جاری رکھنے کے لئے ، کی بورڈ/کیپیڈ پر واپسی کو ہٹائیں۔",
    ...
    te: "కొనసాగించడానికి, కీబోర్డ్/కీప్యాడ్‌లో రాబడిని నొక్కండి.",
    kn: "ಮುಂದುವರಿಸಲು, ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ರಿಟರ್ನ್ ಅನ್ನು ಒತ್ತಿರಿ.",
    bn: "চালিয়ে যেতে, কীবোর্ড/কীপ্যাডে রিটার্ন হিট করুন।",
    id: "Untuk melanjutkan, tekan kembali ke keyboard/keypad.",
  ...
  T_continueClickProceedOrHitReturnOrKeypad: {
    ...
    it: "Per continuare, fare clic su procedi o premi restituzione sulla tastiera o sulla tastiera del telefono.",
  ...
  T_guessingGame: {
    ...
    ar: "يختلف حجم الرسالة وتباعدها من كبيرة وسهلة إلى صغيرة وصعبة. لا يمكنك الحصول على أكثر من ثلثي بشكل صحيح ، لذا استرخ. فكر في الأمر على أنه لعبة تخمين ، واحصل على أكبر عدد ممكن من الأشياء. ستسمع صوتًا كلما كنت على حق.",
  ...
  T_guessingGameVernier: {
    ...
    ar: "يختلف خط التحول من كبير وسهل إلى صغيري وصعب. لا يمكنك الحصول على أكثر من ثلثي بشكل صحيح ، لذا استرخ. فكر في الأمر على أنه لعبة تخمين ، واحصل على أكبر عدد ممكن من الأشياء. ستسمع صوتًا كلما كنت على حق.",
    ...
    kn: "ಲೈನ್ ಶಿಫ್ಟ್ ದೊಡ್ಡ ಮತ್ತು ಸುಲಭದಿಂದ ಸಣ್ಣ ಮತ್ತು ಕಠಿಣಕ್ಕೆ ಬದಲಾಗುತ್ತದೆ. ನೀವು ಮೂರನೇ ಎರಡರಷ್ಟು ಸರಿಯಾಗಿ ಪಡೆಯಲು ಸಾಧ್ಯವಿಲ್ಲ, ಆದ್ದರಿಂದ ವಿಶ್ರಾಂತಿ ಪಡೆಯಿರಿ. ಇದನ್ನು ess ಹಿಸುವ ಆಟವೆಂದು ಯೋಚಿಸಿ, ಮತ್ತು ನಿಮಗೆ ಸಾಧ್ಯವಾದಷ್ಟು ಪಡೆಯಿರಿ. ನೀವು ಸರಿಯಾಗಿದ್ದಾಗಲೆಲ್ಲಾ ನೀವು ಬೀಪ್ ಕೇಳುತ್ತೀರಿ.",
  ...
  T_identifyMiddleLetterPressIt: {
    ...
    ka: "გთხოვთ, დაადგინოთ შუა ასო კლავიატურაზე/კლავიატურაში დაჭერით.",
    ...
    ur: "براہ کرم درمیانی خط کو کی بورڈ/کیپیڈ میں دبانے سے شناخت کریں۔",
  ...
  T_identifyVernierClickIt: {
    ...
    ja: "上線はどの方向にシフトしていますか？左または右については、以下の文字をクリックします。",
  ...
  T_identifyLetterPressIt: {
    ...
    "zh-HK": "請通過在鍵盤/鍵盤中按字母來識別該字母。",
    ja: "キーボード/キーパッドに押して文字を特定してください。",
    ko: "키보드/키패드에 눌러 편지를 식별하십시오.",
  },
  ...
  T_identifyPressItRepeatedLetters: {
    ...
    ta: "இரண்டு இடைநிலை கடிதங்களை அடையாளம் கண்டு, அவற்றை விசைப்பலகை/விசைப்பலகையில் அழுத்தவும்.",
  ...
  T_keypadFrozen: {
    ...
    de: "Wenn dieser Bildschirm gefriert, verbinden Sie bitte wieder, indem Sie Ihre Smartphone -Kamera auf den QR -Code auf Ihrem Computerbildschirm zeigen. Wenn ein Link angezeigt wird, berühren Sie ihn mit Ihrem Finger.",
    ...
    he: "אם מסך זה קופא, אנא התחבר מחדש על ידי הפניית מצלמת הסמארטפון שלך בקוד ה- QR במסך המחשב שלך. כאשר מופיע קישור, גע בו באצבע שלך.",
    ar: "إذا كانت هذه الشاشة تتجمد ، فيرجى إعادة الاتصال عن طريق توجيه كاميرا الهاتف الذكي على رمز الاستجابة السريعة على شاشة الكمبيوتر. عندما يظهر رابط ، المس بإصبعك.",
    ...
    bn: "যদি এই স্ক্রিনটি হিমশীতল হয় তবে দয়া করে আপনার কম্পিউটারের স্ক্রিনে কিউআর কোডে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করে পুনরায় সংযোগ করুন। যখন কোনও লিঙ্ক উপস্থিত হয়, এটি আপনার আঙুল দিয়ে স্পর্শ করুন।",
  ...
  T_keypadReconnect: {
    ...
    he: "החיבור אבד. אנא התחבר מחדש על ידי הצבת מצלמת הסמארטפון שלך בקוד ה- QR במסך המחשב שלך. כאשר מופיע קישור, גע בו באצבע שלך.",
    ...
    bn: "সংযোগ হারিয়ে গেছে। আপনার কম্পিউটারের স্ক্রিনে কিউআর কোডে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করে পুনরায় সংযোগ করুন। যখন কোনও লিঙ্ক উপস্থিত হয়, এটি আপনার আঙুল দিয়ে স্পর্শ করুন।",
  ...
  T_keypadScanQRCode: {
    ...
    ta: "ஸ்மார்ட்போனைப் பயன்படுத்தவும். நீண்ட பார்க்கும் தூரத்தை அனுமதிக்க, வயர்லெஸ் விசைப்பலகையாக செயல்பட உங்கள் ஸ்மார்ட்போனை நியமிக்கவும். இந்த QR குறியீட்டில் உங்கள் ஸ்மார்ட்போன் கேமராவை சுட்டிக்காட்டவும். உங்கள் ஸ்மார்ட்போன் திரையில் தோன்றும் இணைப்பைக் கிளிக் செய்ய உங்கள் விரலைப் பயன்படுத்தவும்.",
  ...
  T_VernierDemo: {
    ...
    fi: "Jokaisessa kokeilussa katsot ristikarvoja, pari linjaa vilkkuu jossain. Ehkä missä etsit; Ehkä silmäsi nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun tarkastellaan ristikoneita, alla, liikkumatta silmiäsi: Onko ylempi linja siirtynyt vasemmalle tai oikealle, verrattuna alaviivaan?",
    ka: "თითოეულ განსაცდელზე, სანამ ჯვრის თმას უყურებთ, წყვილი ხაზები სადმე გაისვრის. იქნებ სადაც ეძებთ; შეიძლება თვალის კუთხეში. უბრალოდ ფლეშ. დავალების შესასწავლად, პირველ რიგში, ვცადოთ სტატიკური ჩვენებით. ჯვრის თმას დათვალიერებისას, ქვემოთ, თვალების გადაადგილების გარეშე: ზედა ხაზი მარცხნივ ან მარჯვნივ გადაინაცვლებს, ქვედა ხაზთან შედარებით?",
    ...
    ur: "ہر آزمائش پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، لائنوں کا ایک جوڑا کہیں چمک اٹھے گا۔ شاید جہاں آپ دیکھ رہے ہو ؛ شاید آپ کی آنکھ کے کونے میں۔ صرف ایک فلیش۔ کام کو سیکھنے کے ل let ، آئیے پہلے جامد ڈسپلے کے ساتھ اسے آزمائیں۔ کراس کے بالوں کو دیکھتے ہوئے ، نیچے ، اپنی آنکھیں منتقل کیے بغیر: کیا نچلی لائن کے نسبت اوپری لائن بائیں یا دائیں منتقل کی جاتی ہے؟",
  ...
  T_middleLetterDemo: {
    ...
    fr: "À chaque essai, pendant que vous regardez les cheveux, un triplet de trois lettres aléatoires clignotera dans le coin de votre œil. Juste un flash. Pour apprendre la tâche, essayons d'abord avec un écran statique. En regardant les poils, ci-dessous, sans bouger les yeux: quelle est la lettre du milieu?",
    ...
    fi: "Jokaisessa kokeessa, kun tarkastellaan ristikarvoja, kolmen satunnaisen kirjaimen kolmoinen vilkkuu silmäsi nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun katsot ristikkäitä hiuksia alla, liikkumatta silmiäsi: mikä on keskimmäinen kirjain?",
    ...
    ko: "각 시험에서 십자형 머리카락을 보면서 3 개의 임의의 문자가 눈의 모퉁이에 번쩍입니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보면서 : 중간 편지는 무엇입니까?",
  },
  T_letterBrief: {
    "en-US":
  ...
  T_letterDemo: {
    ...
    fi: "Jokaisessa kokeessa satunnainen kirje vilkkuu silmän nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun tarkastellaan ristikkäitä hiuksia alla, liikkumatta silmiäsi: mikä kirjain se on?",
  ...
  T_type: {
    ...
    ta: "விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம்.",
  ...
  T_keypadLetterOrClickingLetter: {
    ...
    ru: "Нажав его в отображаемом списке букв или нажав на клавиатуру на своем телефоне.",
    ...
    ar: "بالنقر فوقها في قائمة الرسائل المعروضة أو الضغط عليها على لوحة المفاتيح على هاتفك.",
    ...
    ja: "表示されている文字のリストでクリックするか、携帯電話のキーパッドで押します。",
  ...
  T_typeOrClickRepeatedLetters: {
    ...
    hi: "इसे पत्रों की प्रदर्शित सूची में क्लिक करके, या इसे कीबोर्ड/कीपैड पर दबाकर।",
    ta: "காட்டப்படும் எழுத்துக்களின் பட்டியலில் அதைக் கிளிக் செய்வதன் மூலம் அல்லது விசைப்பலகை/விசைப்பலகையில் அழுத்துவதன் மூலம்.",
  ...
  T_rsvpReadingTask: {
    ...
    ko: "xxx 시험 블록을 시작하려고합니다. 한 번에 몇 마디 씩 이야기를 읽을 것입니다. 각 시험은 다른 사람의 문장 가치에 대해 빨리 보여줄 것입니다. 그런 다음 읽은 단어를 기억하도록 요청합니다.",
  },
  T_readingTask: {
    "en-US":
  ...
  T_readyTrackCrosshair: {
    ...
    de: "Bereit? Verwenden Sie den Cursor, um die Mitte des Kreuzhaars zu verfolgen, bis das Ziel angezeigt wird.",
  ...
  T_readyPressSpaceOrClickCrosshair: {
    ...
    ru: "Готовый? Глядя прямо на перекрестие, нажмите пробел или щелкните на перекрестии.",
    hy: "Պատրաստ? Նայելով ճիշտ խաչմերուկին, կտտացրեք բացը կամ կտտացրեք խաչմերուկում:",
    fi: "Valmis? Kun tarkastellaan suoraan ristikäsien keskustaa, napsauta sitä tai paina avaruuspalkkia.",
  ...
  T_sentenceGuessingGame: {
    ...
    "zh-HK":
      "該句子的可理解性將從輕鬆到難或不可能。您不能獲得超過三分之二的正確，所以放鬆。將其視為一個猜測遊戲，只需獲得盡可能多的遊戲。每當您正確時，您都會聽到蜂鳴聲。",
  ...
  T_thresholdMiddleLetterBeginBlock: {
    ...
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. თითოეული სასამართლო პროცესი წარმოგიდგენთ სამ ასოებს, მაგალითად: Z R N. გთხოვთ, შეატყობინოთ მხოლოდ შუა წერილს,",
  ...
  T_thresholdVenierBeginBlock: {
    ...
    fi: "Olet aloittamassa xxx -kokeiden lohkon. Jokainen kokeilu esittelee uuden linjaparin. Ilmoita, siirretäänkö ylälinja vasemmalle tai oikealle (l tai r),",
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. თითოეული სასამართლო პროცესი წარმოგიდგენთ ახალ წყვილს. გთხოვთ, შეატყობინოთ თუ არა ზედა ხაზი მარცხნივ ან მარჯვნივ (L ან R),",
  ...
  T_thresholdRepeatedLettersBeginBlock: {
    ...
    pl: "Zaraz rozpoczniesz blok prób xxx. Każda próba przedstawi pole listów. Zgłoś dwie środkowe postacie, które widzisz",
    ...
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण पत्रों का क्षेत्र प्रस्तुत करेगा। उन दो मध्य वर्णों की रिपोर्ट करें जिन्हें आप देखते हैं",
  ...
  T_thresholdSoundCheck: {
    ...
    kn: "ಹಲೋ. ಬೀಪ್ ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ ಈ ಕಂಪ್ಯೂಟರ್‌ನ ಧ್ವನಿ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತಿದೆಯೇ ಎಂದು ನೀವು ಪರೀಕ್ಷಿಸಬಹುದು. ನಿಮ್ಮ ಉತ್ತರವು ಸರಿಯಾಗಿರುವಾಗಲೆಲ್ಲಾ ನೀವು ಬೀಪ್ ಅನ್ನು ಕೇಳುತ್ತೀರಿ.",
  ...
  T_safeToClose: {
    ...
    he: "בוצע. תוצאות נשמרו. כעת בטוח לסגור את הכרטיסייה הזו.",

...
export const phrases = {
  ...
  RC_angleDistanceIntro: {
    ...
    ur: "ذرا مڑیں ، اور ہمیں آپ کے دیکھنے کا فاصلہ مل جائے گا! جب ان سے پوچھا گیا تو ، براہ کرم اپنے کیمرے تک رسائی دیں۔",
  ...
  RC_gazeTrackingIntro: {
    ...
    fi: 'Pelaa "kiinni risti!" Nyt asetamme katseen seurannan tarkkailemaan silmäasennoa. Pidä kasvosi videosyötteessä (katso alla). Napsauta ristikästen keskustaa missä tahansa. Varmista, että silmäsi ovat siinä, kun napsautat sitä. Kun napsautat sitä, ristikarvat siirtyvät uuteen sijaintiin. Napsauta sitä jokaisessa uudessa paikassa, kunnes kalibrointi on valmis. Se on peli. Pudota risti!',

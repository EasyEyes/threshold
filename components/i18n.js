...
export const phrases = {
  ...
  RC_findModelAndroid: {
    ...
    fi: "Siirry Asetukset- tai Asetukset -valikkoon, vieritä luettelon alaosaan ja tarkista 'About About Phone', 'About Device' tai vastaava. Kopioi mallin nimi ja numero alla oleviin vastaaviin kenttiin.",
  ...
  "❌T_identifyClickIt": {
    ...
    te: "T_identifyClickit ను t_identifymidleletterClickit ద్వారా మార్చండి",
  ...
  T_identifyVernierClickIt: {
    ...
    ta: "மேல் வரி எந்த திசையில் மாற்றப்படுகிறது? இடது அல்லது வலதுபுறத்தில் கீழே உள்ள கடிதத்தைக் கிளிக் செய்க.",
  ...
  T_identifyVernierPressIt: {
    ...
    ta: "மேல் வரி எந்த திசையில் மாற்றப்படுகிறது? இடது அல்லது வலதுபுறத்தில் ஒரு விசையை அழுத்தவும்.",
  ...
  T_identifyVernierPressItOrClickIt: {
    ...
    ta: "மேல் வரி எந்த திசையில் மாற்றப்படுகிறது? ஒரு கடிதத்தைக் கிளிக் செய்க அல்லது இடது அல்லது வலதுபுறத்தில் ஒரு விசையை அழுத்தவும்.",
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو سیکھنے کے ل let ، آئیے مستحکم کارکردگی کے ساتھ پہلے اسے آزمائیں۔ نیچے کے بالوں کو دیکھتے ہوئے آنکھیں ہلائے بغیر درمیانی خط کی شناخت کرنے کی کوشش کریں۔",
    hi: "प्रत्येक परीक्षण पर, जब आप क्रॉस हेयर को देखते हैं, तो तीन यादृच्छिक अक्षरों का एक ट्रिपल आपकी आंख के कोने में चमक जाएगा। बस एक झलक। कार्य को सीखने के लिए, आइए इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आँखों को हिलाने के बिना, नीचे, नीचे के बालों को देखते हुए, मध्य पत्र की पहचान करने का प्रयास करें।",
  ...
  T_letterDemo: {
    ...
    hi: "प्रत्येक परीक्षण पर, एक यादृच्छिक पत्र आपकी आंख के कोने में चमक जाएगा। बस एक झलक। कार्य को सीखने के लिए, आइए इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आँखों को स्थानांतरित किए बिना, नीचे, नीचे के बालों को देखते हुए, पत्र को पहचानने का प्रयास करें।",
  ...
  T_sentenceGuessingGame: {
    ...
    fr: "L'intelligibilité de la phrase variera de la dure à la dure ou impossible. Vous ne pouvez pas obtenir beaucoup plus des deux tiers à droite, alors détendez-vous. Considérez-le comme un jeu de supposition et obtenez-en autant que vous le pouvez. Vous entendrez un bip quand vous avez raison.",
  ...
  T_sentenceIdentifyClick: {
    ...
    ka: "ქვემოთ მოყვანილი სიები გვიჩვენებს წინადადებაში თითოეული სიტყვის ყველა შესაძლებლობას. შეატყობინეთ წინადადებას, ან თქვენს საუკეთესო გამოცნობას, დააჭირეთ თქვენს მიერ მოსმენილი სიტყვების დაჭერით.",
  ...
  T_sentenceProcedure: {
    ...
    ka: "თითოეულ სასამართლო პროცესზე, თქვენ მოისმენთ წინადადებას, ჩვეულებრივ, ხმაურით. შემდეგ ნახავთ წინადადებათა თითოეული სიტყვის ყველა შესაძლებლობის ჩამონათვალს. შეატყობინეთ წინადადებას, ან თქვენს საუკეთესო გამოცნობას, დააჭირეთ თქვენს მიერ მოსმენილი სიტყვების დაჭერით.",
  ...
  T_thresholdMiddleLetterBeginBlock: {
    ...
    bn: "আপনি xxx ট্রায়ালগুলির একটি ব্লক শুরু করতে চলেছেন। তিনটি চিঠির একটি ট্রিপলেট প্রতিটি পরীক্ষায় উপস্থিত হবে, উদাহরণস্বরূপ: জেড আর এন। দয়া করে কেবল মাঝের চিঠির প্রতিবেদন করুন,",
  ...
  T_thresholdLetterBeginBlock: {
    ...
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. წერილი გამოჩნდება თითოეულ სასამართლო პროცესზე. გთხოვთ, შეატყობინოთ მას,",
    ...
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر آزمائش میں ایک خط ظاہر ہوگا۔ براہ کرم اس کی اطلاع دیں ،",
    ...
    kn: "ನೀವು xxx ಪ್ರಯೋಗಗಳ ಬ್ಲಾಕ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಲಿದ್ದೀರಿ. ಪ್ರತಿ ಪ್ರಯೋಗದಲ್ಲಿ ಪತ್ರ ಕಾಣಿಸುತ್ತದೆ. ದಯವಿಟ್ಟು ಅದನ್ನು ವರದಿ ಮಾಡಿ,",

...
export const phrases = {
  ...
  RC_backToExperimentWindow: {
    ...
    ur: 'مرکزی تجربہ ونڈو میں پیشرفت ظاہر ہوتی ہے۔ براہ کرم اوپر "ایزیئس تجربہ" ٹیب پر کلک کرکے (یا آرک براؤزر میں بائیں طرف) پر کلک کریں۔',
    ...
    te: 'ప్రధాన ప్రయోగ విండోలో పురోగతి ప్రదర్శించబడుతుంది. పైన ఉన్న "ఈజీయెస్ ప్రయోగం" టాబ్‌ను క్లిక్ చేయడం ద్వారా ఇప్పుడే అక్కడకు వెళ్లండి (లేదా ఆర్క్ బ్రౌజర్‌లో ఎడమ వైపుకు)',
    ...
    ja: "メイン実験ウィンドウに進行状況が表示されます。上の「Easyeyes Experiment」タブ（またはARCブラウザの左側）をクリックして、今すぐそこに行ってください",

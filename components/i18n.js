...
export const phrases = {
  ...
  RC_FindModelAndroid: {
    ...
    "zh-CN":
      "由于这是一个Android，请转到“设置或选项”菜单，滚动到列表的底部，然后检查“关于电话”，“关于设备”或类似的“关于电话”。将模型名称和数字复制到下面的相应字段。",
    "zh-HK":
  ...
  RC_noSounds: {
    ...
    "zh-CN": "该实验没有提供TargetSoundFolder，因此没有声音可供播放。",
  ...
  RC_placeSmartphoneMicrophone: {
    ...
    "zh-CN":
      "将手机放在折叠的布上，将此⇧手机边缘指向您的计算机，将其推到折叠布的边缘。按下。",
    "zh-HK":
      "將手機放在折疊的布上，將此⇧手機邊緣指向您的計算機，將其推到折疊布的邊緣。按下。",

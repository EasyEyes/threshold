...
export const phrases = {
  ...
  EE_compatibleBrowserVersionNotOSDeviceCores: {
    ...
    te: "దాని వర్ణనలో చెప్పినట్లుగా, ఈ అధ్యయనం OOO కి విరుద్ధంగా ఉంది మరియు కనీసం 222 CPU కోర్లతో DDD లో నడుస్తున్న BBB బ్రౌజర్ (వెర్షన్ కనీసం 111) అవసరం",
  ...
  EE_ID_noLocalStorage: {
    ...
    ro: "Cercetătorul solicită să furnizați ID -ul dvs. EasyEyes din sesiunea anterioară, vă rugăm să -l tastați aici sau să încărcați fișierul descărcat când se încheie ultima sesiune.",
    ...
    ta: "முந்தைய அமர்விலிருந்து உங்கள் ஈஸி ஐடியை வழங்குமாறு ஆராய்ச்சியாளர் கோருகிறார், தயவுசெய்து அதை இங்கே தட்டச்சு செய்க அல்லது கடைசி அமர்வு முடிவடையும் போது பதிவிறக்கம் செய்யப்பட்ட கோப்பை பதிவேற்றவும்.",
    ...
    kn: "ಹಿಂದಿನ ಅಧಿವೇಶನದಿಂದ ನಿಮ್ಮ ಸುಲಭವಾದ ID ಯನ್ನು ಒದಗಿಸಬೇಕು ಎಂದು ಸಂಶೋಧಕರು ವಿನಂತಿಸುತ್ತಾರೆ, ದಯವಿಟ್ಟು ಅದನ್ನು ಇಲ್ಲಿ ಟೈಪ್ ಮಾಡಿ, ಅಥವಾ ಕೊನೆಯ ಅಧಿವೇಶನ ಮುಗಿದಾಗ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿದ ಫೈಲ್ ಅನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.",
    ...
    id: "Peneliti meminta agar Anda memberikan ID EXYEYES Anda dari sesi sebelumnya, silakan ketik di sini, atau unggah file yang diunduh saat sesi terakhir berakhir.",
    "zh-CN":
  ...
  RC_findModelAndroid: {
    ...
    ur: "ترتیبات یا اختیارات کے مینو پر جائیں ، فہرست کے نیچے سکرول کریں ، اور 'فون کے بارے میں' ، 'آلہ کے بارے میں' یا اسی طرح کی جانچ کریں۔ ماڈل کے نام اور نمبر کو نیچے سے متعلقہ فیلڈز میں کاپی کریں۔",
    ...
    "zh-CN":
      "转到“设置或选项”菜单，滚动到列表的底部，然后检查“关于电话”，“关于设备”或类似方法。将型号和数字复制到下面的相应字段。",
    "zh-HK":
      "轉到“設置或選項”菜單，滾動到列表的底部，然後檢查“關於電話”，“關於設備”或類似方式。將模型名稱和數字複製到下面的相應字段。",
  ...
  RC_findModelMacOs: {
    ...
    "zh-CN":
      "在按选项键时，转到Apple菜单🍏>系统信息。从硬件概述中，将模型名称和模型标识符复制到下面的相应字段。",
    "zh-HK":
  ...
  RC_findModelSamsung: {
    "en-US":
      '❌ Check the back of the handset. Samsung includes the model number at the very bottom of the device - underneath where it reads "Designed & Engineered by Samsung". Copy the Model Number and Name to the corresponding fields below. Or go to your Settings app and then to About Phone. Here, you should be able to find the Model Number and Name.',
    de: '❌ Überprüfen Sie die Rückseite des Mobilteils. Samsung enthält die Modellnummer ganz unten im Gerät - darunter, wo sie "Entworfen und entwickelt von Samsung" liest. Kopieren Sie die Modellnummer und den Namen in die entsprechenden Felder unten. Oder gehen Sie zu Ihrer Einstellungs -App und dann zum Telefon. Hier sollten Sie in der Lage sein, die Modellnummer und den Namen zu finden.',
    fr: "❌ Vérifiez l'arrière du combiné. Samsung comprend le numéro de modèle tout en bas de l'appareil - sous l'endroit où il se lit \"conçu et conçu par Samsung\". Copiez le numéro de modèle et le nom dans les champs correspondants ci-dessous. Ou accédez à votre application de paramètres, puis au téléphone. Ici, vous devriez pouvoir trouver le numéro de modèle et le nom.",
    es: '❌ Verifique la parte posterior del teléfono. Samsung incluye el número de modelo en la parte inferior del dispositivo, debajo donde lee "diseñado y diseñado por Samsung". Copie el número de modelo y el nombre a los campos correspondientes a continuación. O vaya a su aplicación de configuración y luego a un teléfono. Aquí, debería poder encontrar el número de modelo y el nombre.',
    pt: '❌ Verifique a parte de trás do aparelho. A Samsung inclui o número do modelo na parte inferior do dispositivo - embaixo, onde diz "Projetado e projetado pela Samsung". Copie o número do modelo e o nome para os campos correspondentes abaixo. Ou vá para o seu aplicativo de configurações e depois para o telefone. Aqui, você deve encontrar o número e o nome do modelo.',
    it: '❌ Controllare il retro del telefono. Samsung include il numero di modello nella parte inferiore del dispositivo - sotto dove legge "progettato e progettato da Samsung". Copia il numero di modello e il nome nei campi corrispondenti di seguito. Oppure vai all\'app Impostazioni e poi al telefono. Qui, dovresti essere in grado di trovare il numero e il nome del modello.',
    ro: "❌ Verificați partea din spate a receptorului. Samsung include numărul modelului chiar în partea de jos a dispozitivului - dedesubt unde citește „Proiectat și proiectat de Samsung”. Copiați numărul și numele modelului în câmpurile corespunzătoare de mai jos. Sau accesați aplicația de setări și apoi la telefon. Aici, ar trebui să puteți găsi numărul și numele modelului.",
    pl: "❌ Sprawdź tył słuchawki. Samsung zawiera numer modelu na samym dole urządzenia - pod tym, gdzie odczytuje „zaprojektowany i zaprojektowany przez Samsung”. Skopiuj numer modelu i nazwę do odpowiednich pól poniżej. Lub przejdź do aplikacji Ustawienia, a następnie do telefonu. Tutaj powinieneś być w stanie znaleźć numer modelu i nazwę.",
    ru: "❌ Проверьте заднюю часть телефона. Samsung включает номер модели на самом нижнем устройстве - под тем местом, где он читает «разработан и разработан Samsung». Скопируйте номер модели и имя в соответствующие поля ниже. Или перейдите в приложение для настройки, а затем на телефон. Здесь вы сможете найти номер модели и имя.",
    hy: "❌ Ստուգեք հեռախոսի հետեւը: Samsung- ը պարունակում է մոդելի համարը սարքի հենց ներքեւում `տակը, որտեղ կարդում է« նախագծված եւ ինժեներական Samsung »- ը: Պատճենեք մոդելի համարը եւ անունը ստորեւ նշված համապատասխան ոլորտներին: Կամ գնացեք ձեր պարամետրերի ծրագրին, ապա հեռախոսի մասին: Այստեղ դուք պետք է կարողանաք գտնել մոդելի համարը եւ անունը:",
    fi: '❌ Tarkista luurin takaosa. Samsung sisältää mallinumeron laitteen alaosassa - alla, jossa se lukee "Suunniteltu ja suunnitellut Samsung". Kopioi mallinumero ja nimi alla oleviin vastaaviin kenttiin. Tai siirry asetussovellukseen ja sitten noin puhelimeen. Täältä sinun pitäisi pystyä löytämään mallinumero ja nimi.',
    ka: '❌ შეამოწმეთ ტელეფონის უკანა მხარე. Samsung მოიცავს მოდელის ნომერს მოწყობილობის ბოლოში - ქვეშ, სადაც იგი კითხულობს "შექმნილია და ინჟინერია Samsung". დააკოპირეთ მოდელის ნომერი და სახელი ქვემოთ მოცემულ შესაბამის ველებში. ან გადადით თქვენი პარამეტრების აპლიკაციაში და შემდეგ ტელეფონით. აქ, თქვენ უნდა შეეძლოთ იპოვოთ მოდელის ნომერი და სახელი.',
    he: '❌ בדוק את החלק האחורי של המכשיר. סמסונג כוללת את מספר הדגם בתחתית המכשיר - מתחת למקום בו הוא קורא "מעוצב והנדסה על ידי סמסונג". העתק את מספר הדגם ואת השם לשדות המתאימים למטה. או עבור לאפליקציית ההגדרות שלך ואז לטלפון. כאן, אתה אמור להיות מסוגל למצוא את מספר הדגם ואת השם.',
    ar: '❌ تحقق من الجزء الخلفي من الهاتف. تتضمن Samsung رقم الطراز في أسفل الجهاز - أسفل المكان الذي يقرأ فيه "مصمم وهندسة بواسطة Samsung". انسخ رقم الطراز والاسم إلى الحقول المقابلة أدناه. أو انتقل إلى تطبيق الإعدادات الخاص بك ثم إلى الهاتف. هنا ، يجب أن تكون قادرًا على العثور على رقم الطراز والاسم.',
    ur: 'hand ہینڈسیٹ کے پچھلے حصے کو چیک کریں۔ سیمسنگ میں ڈیوائس کے بالکل نیچے ماڈل نمبر شامل ہوتا ہے - اس کے نیچے جہاں "سیمسنگ کے ذریعہ ڈیزائن کیا ہوا اور انجنیئر" پڑھتا ہے۔ ماڈل نمبر اور نام کو نیچے سے متعلقہ فیلڈز میں کاپی کریں۔ یا اپنی ترتیبات کی ایپ پر اور پھر فون کے بارے میں جائیں۔ یہاں ، آپ کو ماڈل نمبر اور نام تلاش کرنے کے قابل ہونا چاہئے۔',
    hi: '❌ हैंडसेट के पीछे की जाँच करें। सैमसंग में डिवाइस के बहुत नीचे मॉडल नंबर शामिल है - जहां यह "सैमसंग द्वारा डिज़ाइन और इंजीनियर" पढ़ता है। मॉडल नंबर और नाम को नीचे दिए गए संबंधित फ़ील्ड में कॉपी करें। या अपने सेटिंग्स ऐप पर जाएं और फिर फोन के बारे में। यहां, आपको मॉडल नंबर और नाम खोजने में सक्षम होना चाहिए।',
    ta: 'The கைபேசியின் பின்புறத்தை சரிபார்க்கவும். சாம்சங் சாதனத்தின் அடிப்பகுதியில் உள்ள மாதிரி எண்ணை உள்ளடக்கியது - அது "சாம்சங் வடிவமைத்து வடிவமைக்கப்பட்டுள்ளது" என்று படிக்கும் இடத்திற்கு அடியில். மாதிரி எண் மற்றும் பெயரை கீழே உள்ள தொடர்புடைய புலங்களுக்கு நகலெடுக்கவும். அல்லது உங்கள் அமைப்புகள் பயன்பாட்டிற்குச் சென்று பின்னர் தொலைபேசியில் செல்லுங்கள். இங்கே, நீங்கள் மாதிரி எண் மற்றும் பெயரைக் கண்டுபிடிக்க முடியும்.',
    ml: 'Stood ഹാൻഡ്സെറ്റിന്റെ പിൻഭാഗം പരിശോധിക്കുക. ഉപകരണത്തിന്റെ ഏറ്റവും താഴെയുള്ള മോഡൽ നമ്പർ സാംസങ്ങിൽ ഉൾപ്പെടുന്നു - ഇത് "രൂപകൽപ്പന ചെയ്യുകയും എഞ്ചിനീയറിംഗ് ചെയ്യുകയും ചെയ്യുന്നു". മോഡൽ നമ്പറും പേരും ചുവടെയുള്ള അനുബന്ധ ഫീൽഡുകൾക്ക് പകർത്തുക. അല്ലെങ്കിൽ നിങ്ങളുടെ ക്രമീകരണ അപ്ലിക്കേഷനിലേക്ക് പോയി ഫോണിനെക്കുറിച്ച്. ഇവിടെ, നിങ്ങൾക്ക് മോഡൽ നമ്പറും പേരും കണ്ടെത്താൻ കഴിയണം.',
    te: 'The హ్యాండ్‌సెట్ వెనుక భాగాన్ని తనిఖీ చేయండి. శామ్సంగ్ పరికరం యొక్క దిగువన ఉన్న మోడల్ నంబర్‌ను కలిగి ఉంటుంది - ఇక్కడ "శామ్సంగ్ చేత రూపొందించబడిన మరియు ఇంజనీరింగ్" అని చదివే కింద. మోడల్ సంఖ్య మరియు పేరును దిగువ సంబంధిత ఫీల్డ్‌లకు కాపీ చేయండి. లేదా మీ సెట్టింగ్‌ల అనువర్తనానికి వెళ్లి, ఆపై ఫోన్‌కు వెళ్లండి. ఇక్కడ, మీరు మోడల్ నంబర్ మరియు పేరును కనుగొనగలుగుతారు.',
    kn: 'The ಹ್ಯಾಂಡ್‌ಸೆಟ್‌ನ ಹಿಂಭಾಗವನ್ನು ಪರಿಶೀಲಿಸಿ. ಸ್ಯಾಮ್‌ಸಂಗ್ ಸಾಧನದ ಅತ್ಯಂತ ಕೆಳಭಾಗದಲ್ಲಿರುವ ಮಾದರಿ ಸಂಖ್ಯೆಯನ್ನು ಒಳಗೊಂಡಿದೆ - ಅಲ್ಲಿ "ಸ್ಯಾಮ್‌ಸಂಗ್‌ನಿಂದ ವಿನ್ಯಾಸಗೊಳಿಸಲಾಗಿದೆ ಮತ್ತು ವಿನ್ಯಾಸಗೊಳಿಸಲಾಗಿದೆ" ಎಂದು ಓದುತ್ತದೆ. ಮಾದರಿ ಸಂಖ್ಯೆ ಮತ್ತು ಹೆಸರನ್ನು ಕೆಳಗಿನ ಅನುಗುಣವಾದ ಕ್ಷೇತ್ರಗಳಿಗೆ ನಕಲಿಸಿ. ಅಥವಾ ನಿಮ್ಮ ಸೆಟ್ಟಿಂಗ್‌ಗಳ ಅಪ್ಲಿಕೇಶನ್‌ಗೆ ಮತ್ತು ನಂತರ ಫೋನ್‌ಗೆ ಹೋಗಿ. ಇಲ್ಲಿ, ನೀವು ಮಾದರಿ ಸಂಖ್ಯೆ ಮತ್ತು ಹೆಸರನ್ನು ಕಂಡುಹಿಡಿಯಲು ಸಾಧ್ಯವಾಗುತ್ತದೆ.',
    bn: 'Hands হ্যান্ডসেটের পিছনে পরীক্ষা করুন। স্যামসুং ডিভাইসের একেবারে নীচে মডেল নম্বর অন্তর্ভুক্ত করে - যেখানে এটি "স্যামসাং দ্বারা ডিজাইন করা এবং ইঞ্জিনিয়ারড" পড়ার নীচে রয়েছে। নীচের সংশ্লিষ্ট ক্ষেত্রগুলিতে মডেল নম্বর এবং নামটি অনুলিপি করুন। বা আপনার সেটিংস অ্যাপ্লিকেশন এবং তারপরে ফোনে যান। এখানে, আপনার মডেল নম্বর এবং নামটি সন্ধান করতে সক্ষম হওয়া উচিত।',
    id: '❌ Periksa bagian belakang handset. Samsung mencakup nomor model di bagian paling bawah perangkat - di bawahnya di mana ia membaca "dirancang & direkayasa oleh Samsung". Salin nomor model dan nama ke bidang yang sesuai di bawah ini. Atau buka aplikasi Pengaturan Anda dan kemudian ke Tentang Telepon. Di sini, Anda harus dapat menemukan nomor model dan nama.',
    "zh-CN":
      "❌检查手机的背面。三星包括设备底部的型号 - 在其读取“三星设计和设计”的下方。将型号和名称复制到下面的相应字段。或转到您的设置应用程序，然后转到有关电话。在这里，您应该能够找到型号和名称。",
    "zh-HK":
      "❌檢查手機的背面。三星包括設備底部的型號 - 在其讀取“三星設計和設計”的下方。將型號和名稱複製到下面的相應字段。或轉到您的設置應用程序，然後轉到有關電話。在這裡，您應該能夠找到型號和名稱。",
    ja: "handhset携帯電話の背面を確認します。 Samsungには、デバイスの最下部にモデル番号が含まれています。その下には、「Samsungが設計および設計した」と書かれています。モデル番号と名前を以下の対応するフィールドにコピーします。または、設定アプリに移動してから、電話に行きます。ここでは、モデル番号と名前を見つけることができるはずです。",
    ko: 'handset 핸드셋의 뒷면을 확인하십시오. 삼성에는 장치의 바닥에 모델 번호가 포함되어 있습니다. 그 아래에는 "삼성이 설계 및 엔지니어링 된"이 읽습니다. 모델 번호와 이름을 아래의 해당 필드에 복사하십시오. 또는 설정 앱으로 이동 한 다음 전화로 이동하십시오. 여기에서는 모델 번호와 이름을 찾을 수 있어야합니다.',
  },
  RC_findModelWindows: {
    "en-US":
  ...
  RC_distanceTrackingCloseL: {
    ...
    fi: "1. Sulje vasen silmä. (Tämä on näytön vasen puoli.)\n2. Liu'uta välkkyvä piste ▶ nuolinäppäimellä. (Tai vain vedä sitä, jos se ei vastaa nuolinäppäimeen.) Tarkastele silmän nurkassa olevaa vilkkuvaa pistettä katsellessasi ja liu'uta sitä vasemmalle ja oikealle, kunnes se katoaa blindspot -laitteeseesi.\n3. Osu paluu.\nHUOMAUTUS: Pidä silmällä ristikarvoja. Vilkkuva piste ei katoa, kun silmäsi seuraa sitä.",
  ...
  RC_distanceTrackingCloseR: {
    ...
    fi: "1. Sulje oikea silmä. (Tämä on näytön oikea puoli.)\n2. Liu'uta välkkyvä pisteen nuolinäppäintä. Kun katsot ristikarvoja, seuraa vilkkuvaa pistettä silmäsi nurkassa ja liu'uta se vasemmalle ja oikealle, kunnes se katoaa blindspotisi.\n3. Osu paluu.\nHUOMAUTUS: Pidä silmällä ristikarvoja. Vilkkuva piste ei katoa, kun silmäsi seuraa sitä.",
    ka: "1. დახურეთ თქვენი მარჯვენა თვალი. (ეს არის ეკრანის მარჯვენა მხარე.)\n2. გამოიყენეთ ◀ ისრის ღილაკი, რომ გააფართოვოთ მბჟუტავი წერტილი. ჯვრის თმას ათვალიერებთ, თვალის კუთხეში შეანელეთ მბჟუტავი წერტილი და გადაიტანეთ მარცხნივ და მარჯვნივ, სანამ ის არ ქრება თქვენს ჟალუზაში.\n3. მოხვდი დაბრუნებას.\nშენიშვნა: მიადევნეთ თვალი ჯვრის თმას. მბჟუტავი წერტილი არ გაქრება, სანამ შენი თვალი მისდევს.",
  ...
  RC_errorNoCamera: {
    ...
    ka: "ამ კვლევას უნდა გამოიყენოს ვებკამერა. თქვენს ვებკამერაზე წვდომის მინიჭება არჩევითია, მაგრამ ამის გარეშე ვერ გავაგრძელებთ. თუ შეცდომით უთქვამთ და ახლა გსურთ მოგვმართოთ თქვენი კამერა, გთხოვთ, იპოვოთ კამერის ხატი მისამართის ზოლში, დააჭირეთ მას, დაუშვით კამერის წვდომა და განაახლეთ გვერდი.",
  ...
  RC_backToExperimentWindow: {
    ...
    de: 'Der Fortschritt wird im Hauptfenster des Hauptversuchs angezeigt. Bitte gehen Sie jetzt dorthin, indem Sie oben auf die Registerkarte "Easyeyes Experiment" klicken (oder links im Bowser links)',
    ...
    ar: 'يتم عرض التقدم في نافذة التجربة الرئيسية. يرجى الانتقال إلى هناك الآن ، من خلال النقر فوق علامة التبويب "Easyeyes Experience" أعلاه (أو إلى اليسار في متصفح القوس)',
    ...
    ta: 'முக்கிய சோதனை சாளரத்தில் முன்னேற்றம் காட்டப்படும். மேலே உள்ள "எளிதான பரிசோதனை" தாவலைக் கிளிக் செய்வதன் மூலம் (அல்லது வில் உலாவியில் இடதுபுறமாக) கிளிக் செய்வதன் மூலம் தயவுசெய்து இப்போது அங்கு செல்லுங்கள்)',

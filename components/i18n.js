...
export const phrases = {
  ...
  RC_howLongToCalibrate: {
    "en-US": "Calibration takes about 4.5 minutes.",
    de: "Die Kalibrierung dauert ungefähr 4,5 Minuten.",
    fr: "L'étalonnage dure environ 4,5 minutes.",
    es: "La calibración dura aproximadamente 4.5 minutos.",
    pt: "A calibração leva cerca de 4,5 minutos.",
    it: "La calibrazione dura circa 4,5 minuti.",
    ro: "Calibrarea durează aproximativ 4,5 minute.",
    pl: "Kalibracja zajmuje około 4,5 minuty.",
    ru: "Калибровка занимает около 4,5 минут.",
    hy: "Կալիբրացումը տեւում է մոտ 4,5 րոպե:",
    fi: "Kalibrointi kestää noin 4,5 minuuttia.",
    ka: "კალიბრაციას დაახლოებით 4.5 წუთი სჭირდება.",
    he: "הכיול אורך כ -4.5 דקות.",
    ar: "يستغرق المعايرة حوالي 4.5 دقيقة.",
    ur: "انشانکن میں لگ بھگ 4.5 منٹ لگتے ہیں۔",
    hi: "अंशांकन में लगभग 4.5 मिनट लगते हैं।",
    ta: "அளவுத்திருத்தம் சுமார் 4.5 நிமிடங்கள் ஆகும்.",
    ml: "കാലിബ്രേഷന് ഏകദേശം 4.5 മിനിറ്റ് എടുക്കും.",
    te: "అమరిక 4.5 నిమిషాలు పడుతుంది.",
    kn: "ಮಾಪನಾಂಕ ನಿರ್ಣಯವು ಸುಮಾರು 4.5 ನಿಮಿಷಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳುತ್ತದೆ.",
    bn: "ক্রমাঙ্কন প্রায় 4.5 মিনিট সময় নেয়।",
    id: "Kalibrasi membutuhkan waktu sekitar 4,5 menit.",
    "zh-CN": "校准大约需要4.5分钟。",
    "zh-HK": "校準大約需要4.5分鐘。",
    ja: "キャリブレーションには約4.5分かかります。",
    ko: "교정은 약 4.5 분이 걸립니다.",
  },
  RC_requestCamera: {
  ...
  RC_selectMicrophone: {
    ...
    ro: "Pregătiți -vă să vă calibrați difuzorul, dacă aveți un smartphone la îndemână, vedeți make -ul și modelul său în lista de mai jos? Dacă da, selectați -l. În caz contrar, selectați „Fără potrivire”. Apoi faceți clic pe Continuați.\n",

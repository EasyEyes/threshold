...
export const phrases = {
  ...
  EE_compatibleBrowserVersionNotOSDeviceCores: {
    ...
    ar: "كما ذكر في وصفها ، فإن هذه الدراسة غير متوافقة مع OOO ، وتحتاج إلى متصفح BBB (الإصدار 111 على الأقل) الذي يعمل على DDD مع ما لا يقل عن 222 نوى وحدة المعالجة المركزية",
  ...
  RC_allowMicrophoneUse: {
    ...
    te: 'ఒక పాప్ అప్ మైక్రోఫోన్‌ను ఉపయోగించడానికి అనుమతి అడిగితే, "అనుమతించు" క్లిక్ చేయండి.',
    kn: 'ಮೈಕ್ರೊಫೋನ್ ಬಳಸಲು ಪಾಪ್ ಅಪ್ ಅನುಮತಿ ಕೇಳಿದರೆ, "ಅನುಮತಿಸಿ" ಕ್ಲಿಕ್ ಮಾಡಿ.',
    bn: 'যদি কোনও পপ আপ মাইক্রোফোনটি ব্যবহার করার অনুমতি চায় তবে "অনুমতি দিন" এ ক্লিক করুন।',
  ...
  "🕑RC_distanceTrackingGuide": {
    ...
    fi: "Silmäsi ovat 111 cm: n päässä näytöltä, mutta koe tarvitsee noin 222 cm. Koe jatkuu, kun saavutat oikean etäisyyden.",
  ...
  RC_distanceTrackingGuide: {
    ...
    te: "మీ కళ్ళు స్క్రీన్ నుండి xx1 సెం.మీ., కానీ ప్రయోగానికి సుమారు xx2 సెం.మీ అవసరం. మీరు సరైన దూరానికి చేరుకున్నప్పుడు ప్రయోగం తిరిగి ప్రారంభమవుతుంది.",
  ...
  RC_soundAllHzDetails: {
    ...
    ta: "333 நொடி வெடிப்பின் 111 மறுபடியும் (222 வெப்பமயமாதல்களுக்குப் பிறகு) அளவீடு செய்யப்பட்ட அதிர்வெண் பதில், 444 ஹெர்ட்ஸ் மாதிரியாகும்.",
  ...
  RC_noSounds: {
    ...
    bn: "পরীক্ষাটি কোনও টার্গাউন্ডফোল্ডার সরবরাহ করে নি, তাই খেলার মতো কোনও শব্দ নেই।",
  ...
  T_continueHitReturnOrKeypad: {
    ...
    pl: "Aby kontynuować, naciśnij powrót na klawiaturze/klawiaturę.",
  ...
  T_continueClickProceedOrHitReturnOrKeypad: {
    ...
    ur: "جاری رکھنے کے لئے ، آگے بڑھنے پر کلک کریں یا کی بورڈ/کیپیڈ میں ریٹرن کو دبائیں۔",
    ...
    ja: "続行するには、キーボード/キーパッドで[続行]または[返される]をクリックします。",
    ko: "계속하려면 키보드/키패드에서 진행 또는 반환을 클릭하십시오.",
  },
  T_continueNeitherClickNorType: {
    ...
    ro: "Nu se poate proceda pentru că RespotyeTypedBool și ResponseClickedBool sunt ambele false.",
  ...
  "🕑T_counterReadingPageBlock": {
    ...
    hi: "222 का पृष्ठ 111. 444 का ब्लॉक 333।",
  ...
  T_identifyVernierClickIt: {
    ...
    ka: "რა მიმართულებით იცვლება ზედა ხაზი? დააჭირეთ ქვემოთ მოცემულ წერილს მარცხნივ ან მარჯვნივ.",
    he: "לאיזה כיוון מועבר הקו העליון? לחץ על אות למטה לשמאל או ימינה.",
  ...
  T_readyClickCrosshair: {
    ...
    bn: "প্রস্তুত? ক্রস চুলের কেন্দ্রে ক্লিক করুন।",

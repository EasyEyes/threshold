...
export const phrases = {
  ...
  T_readingTask: {
    ...
    "zh-HK":
      "講故事的時間！您會從一本書中閱讀111頁。一旦開始，請盡可能快地靜靜地閱讀所有頁面，同時保持充分的理解，直到到達末尾。然後，我們會問您有關這個故事的幾個問題。在每個頁面上，按下下一頁的空格欄。準備就緒時，請按空格。",

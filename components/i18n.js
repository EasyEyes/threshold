...
export const phrases = {
  ...
  RC_viewingBlindSpotRejected: {
    ...
    ka: "უკაცრავად, მარცხენა და მარჯვენა უახლესი გაზომვები არათანმიმდევრული იყო. შეგვიძლია ისევ ვცადოთ? ერთი თვალი დახუჭე. ფოკუსირება მოახდინეთ ჯვრის თმებზე და აკონტროლეთ მოციმციმე წერტილი თქვენი თვალის კუთხიდან. გადაიტანეთ წერტილი მარცხნივ და მარჯვნივ, სანამ ის არ ქრება თქვენს ჟალუზაში, შემდეგ კი მოხვდით. შეინარჩუნეთ თქვენი სანახავი მანძილი, როდესაც ორივე თვალს შეამოწმებთ.",

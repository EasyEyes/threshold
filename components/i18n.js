...
export const phrases = {
  ...
  EE_compatibilityTitle: {
    "en-US": "xxx requirements",
    de: "Xxx Anforderungen",
    fr: "Exigences xxx",
    es: "Requisitos xxx",
    pt: "Requisitos xxx",
    it: "Requisiti xxx",
  ...
  EE_ID_noLocalStorage: {
    ...
    es: "El investigador le solicitó que proporcione su ID de EasyEyes desde la sesión anterior, escriba aquí o cargue el archivo descargado cuando finalice la última sesión.",
    pt: "O pesquisador solicitou que você forneça seu ID easia da sessão anterior, digite -o aqui ou faça o upload do arquivo baixado quando a última sessão terminar.",
    ...
    fi: "Tutkija pyysi sinua toimittamaan Easyeyes -tunnuksen edellisestä istunnosta, kirjoita se tähän tai lataa tiedosto, joka on ladattu, kun viimeinen istunto päättyy.",
    ...
    he: "החוקר ביקש ממך לספק את מזהה ה- EasyEyes שלך מהפגישה הקודמת, אנא הקלד אותו כאן, או להעלות את הקובץ שהורדה כאשר ההפעלה האחרונה מסתיימת.",
    ...
    "zh-CN":
      "研究人员要求您提供上一个会话中的EasyEyes ID，请在此处输入，或在上一个会话结束时上传下载的文件。",
    "zh-HK":
      "研究人員要求您從上一個會話中提供EasyEyes ID，請在此處輸入，或在上次會話結束時上傳下載的文件。",
  ...
  EE_ID_invalidID: {
    ...
    ka: "EasyEyes ID შეიცავს არასწორი სიმბოლოები. დასაშვებია მხოლოდ ასოები და ციფრები",
  ...
  EE_ID_invalidFile: {
    ...
    hi: "क्षमा मांगना। एक easyeyes id फ़ाइल के लिए गलत प्रारूप। एक और फ़ाइल आज़माएं, या कुछ टाइप करें।",
  ...
  EE_incompatible: {
    ...
    fi: "❌ yhteensopimattomia. Anteeksi. Palauta tämä tutkimus tuotteelle tuotteelle.",
  ...
  EE_incompatibleReturnToProlific: {
    ...
    id: "Studi ini tidak sesuai dengan komputer atau browser Anda, jadi silakan kembalikan ke Prolific.co. Pengajuan pembayaran akan ditolak (yang merusak reputasi Anda), jadi silakan kembalikan.",
    "zh-CN":
  ...
  RC_distanceTrackingCloseL: {
    ...
    "zh-HK":
      "1.閉上左眼。 （這是屏幕的左側。）\n2.使用▶箭頭鍵滑動閃爍的點。 （或者只是拖動它，如果它沒有響應箭頭鑰匙。）看著十字頭髮時，監視眼角的閃爍點，然後向左和向右滑動，直到它消失在盲點中。\n3.命中返回。\n注意：請密切關註十字頭髮。當您的眼睛跟隨它時，閃爍的點不會消失。",
  ...
  RC_distanceTrackingCloseR: {
    ...
    pt: "1. Feche o olho direito. (Este é o lado direito da tela.)\n2. Use ◀ Tecla de seta para deslizar o ponto piscador. Enquanto olha para os cabelos cruzados, monitore o ponto trêmulo no canto do olho e deslize -o para a esquerda e para a direita até desaparecer no seu ponto cego.\n3. Bata o retorno.\nNota: Fique de olho nos cabelos cruzados. O ponto piscador não desaparecerá enquanto seu olho o segue.",
  ...
  RC_distanceTrackingGuide: {
    ...
    ar: "عيناك هي xx1 سم من الشاشة ، لكن التجربة تحتاج إلى حوالي xx2 سم. ستستأنف التجربة عندما تصل إلى المسافة الصحيحة.",
  ...
  RC_privacyIphoneMicrophone: {
    ...
    fr: "Assurance de la confidentialité des microphones. EasyEyes utilise votre microphone iPhone / iPad, plutôt que le microphone intégré de votre bureau, car le microphone iPhone / iPad est calibré du fabricant. Le microphone enregistre uniquement tandis qu'un son bruyant joue dans le haut-parleur de l'ordinateur de bureau, et l'ordinateur de bureau affiche en évidence \"silencieux s'il vous plaît! Maintenant enregistrer\". L'enregistrement est utilisé uniquement pour estimer les caractéristiques des haut-parleurs, puis effacée, dans les 30 secondes. Seules les caractéristiques du haut-parleur sont conservées.",
    ...
    pt: 'Garantia da privacidade do microfone. O Easyeyes usa seu microfone para iPhone/iPad, em vez do microfone embutido da sua área de trabalho, porque o microfone para iPhone/iPad é calibrado ao fabricante. O microfone registra apenas enquanto um som alto é exibido pelo alto -falante de computadores da área de trabalho, e o computador da área de trabalho exibe com destaque "silencioso por favor! Agora, gravação". A gravação é usada apenas para estimar as características do alto -falante e depois apagada, dentro de 30 segundos. Somente as características do alto -falante são retidas.',
    ...
    ro: "Asigurarea confidențialității microfonului. EasyEyes folosește microfonul dvs. iPhone/iPad, mai degrabă decât microfonul încorporat al desktopului, deoarece microfonul iPhone/iPad este calibrat de producător. Microfonul se înregistrează doar în timp ce un sunet puternic se joacă prin difuzorul computerului desktop, iar atât computerul desktop afișează în mod proeminent „Liniște vă rog! Acum înregistrare”. Înregistrarea este utilizată exclusiv pentru a estima caracteristicile difuzoarelor și apoi șterse, în 30 de secunde. Sunt păstrate doar caracteristicile difuzoarelor.",
    pl: "Zapewnienie prywatności mikrofonu. Easyeyes używa mikrofonu iPhone'a/iPada, a nie wbudowanego mikrofonu komputera stacjonarnego, ponieważ mikrofon iPhone/iPad jest kalibrowany producentem. Mikrofon rejestruje tylko podczas głośnego dźwięku przez głośnik komputerowy komputerowy, a oba komputer stacjonarny wyświetla „Ciche proszę! Teraz nagrywanie”. Nagrywanie służy wyłącznie do oszacowania właściwości głośnika, a następnie usuniętego, w ciągu 30 sekund. Zatrzymywane są tylko charakterystyka głośnika.",
    ru: "Гарантия конфиденциальности микрофона. EasyEyes использует ваш микрофон iPhone/iPad, а не встроенный микрофон на рабочем столе, потому что микрофон iPhone/iPad откалиброван производителем. Микрофон записывается только в то время, когда громкий звук играет через настольный компьютер, и оба настольного компьютера заметно отображают «тихо, пожалуйста! Теперь запись». Запись используется исключительно для оценки характеристик громкоговорителей, а затем стерла в течение 30 секунд. Только характеристики громкоговорителя сохраняются.",
    ...
    he: 'הבטחה לפרטיות המיקרופון. EasyEyes משתמש במיקרופון ה- iPhone/iPad שלך, ולא במיקרופון המובנה של שולחן העבודה שלך, מכיוון שמיקרופון ה- iPhone/iPad מכויל יצרן. המיקרופון מתעדכן רק בזמן שצליל חזק משחק ברמקול המחשב השולחני, ושני המחשב השולחני מציג באופן בולט "שקט בבקשה! עכשיו הקלטה." ההקלטה משמשת אך ורק כדי להעריך את מאפייני הרמקול ואז למחוק, תוך 30 שניות. רק מאפייני הרמקול נשמרים.',
    ...
    ta: 'மைக்ரோஃபோன் தனியுரிமையின் உறுதி. உங்கள் டெஸ்க்டாப்பின் உள்ளமைக்கப்பட்ட மைக்ரோஃபோனைக் காட்டிலும் ஈஸிபீஸ் உங்கள் ஐபோன்/ஐபாட் மைக்ரோஃபோனைப் பயன்படுத்துகிறது, ஏனெனில் ஐபோன்/ஐபாட் மைக்ரோஃபோன் உற்பத்தியாளர்-அளவீடு செய்யப்படுகிறது. மைக்ரோஃபோன் பதிவுசெய்கிறது, டெஸ்க்டாப் கம்ப்யூட்டர் ஒலிபெருக்கி மூலம் உரத்த ஒலி இயங்குகிறது, மேலும் டெஸ்க்டாப் கணினி இரண்டும் முக்கியமாக "அமைதியாக தயவுசெய்து! இப்போது பதிவுசெய்கின்றன" என்று காட்டுகிறது. ஒலிபெருக்கி பண்புகளை மதிப்பிடுவதற்கு மட்டுமே பதிவு பயன்படுத்தப்படுகிறது, பின்னர் 30 வினாடிகளுக்குள் அழிக்கப்படுகிறது. ஒலிபெருக்கி பண்புகள் மட்டுமே தக்கவைக்கப்படுகின்றன.',
    ...
    id: 'Jaminan privasi mikrofon. EyyEyes menggunakan mikrofon iPhone/iPad Anda, daripada mikrofon built-in desktop Anda, karena mikrofon iPhone/iPad dikalibrasi. Mikrofon hanya merekam saat suara keras diputar melalui pengeras suara komputer desktop, dan kedua komputer desktop menampilkan "sunyi! Sunyi! Sekarang perekaman." Rekaman digunakan semata -mata untuk memperkirakan karakteristik pengeras suara dan kemudian dihapus, dalam waktu 30 detik. Hanya karakteristik pengeras suara yang dipertahankan.',
    "zh-CN":
      "保证麦克风隐私。 EasyEyes使用您的iPhone/iPad麦克风，而不是台式机的内置麦克风，因为iPhone/iPad麦克风是制造商校准的。麦克风仅在台式计算机扬声器上播放麦克风，而台式计算机都显着地显示“请安静！现在录制”。该录制仅用于估计扬声器特征，然后在30秒内删除。仅保留扬声器特性。",
    "zh-HK":
    ...
    ko: '마이크 프라이버시의 보증. EasyEyes는 iPhone/iPad 마이크가 제조업체 계산되기 때문에 Desktop의 내장 마이크 대신 iPhone/iPad 마이크를 사용합니다. 마이크는 데스크탑 컴퓨터 라우드 스피커를 통해 큰 소리가 재생되는 동안에 만 기록되며, 데스크탑 컴퓨터는 "조용히 해주세요! 지금 녹음"을 표시합니다. 기록은 스피커 특성을 추정 한 다음 30 초 이내에 지워집니다. 라우드 스피커 특성 만 유지됩니다.',
  },
  RC_requestCamera: {
  ...
  RC_soundCalibrationDone: {
    ...
    fr: "Merci. L'étalonnage est fait et vous pouvez ranger l'iPhone / iPad. IMPORTANT: Ne touchez pas le contrôle du volume avant la fin de l'expérience. La modification du volume vaincra l'étalonnage et invalidera tous les résultats.",
    ...
    fi: "Kiitos. Kalibrointi on tehty, ja voit laittaa iPhone/iPadin pois. Tärkeää: Älä kosketa äänenvoimakkuuden säätöä ennen kuin koe on tehty. Tängomentin muuttaminen voittaa kalibroinnin ja mitätöidä kaikki tulokset.",
    ...
    he: "תודה. הכיול נעשה, ותוכלו להרחיק את ה- iPhone/iPad. חשוב: אל תיגע בבקרת עוצמת הקול עד לסיום הניסוי. שינוי הנפח יביס את הכיול ויבטל את כל התוצאות.",
    ...
    ur: "شکریہ. انشانکن ہوچکا ہے ، اور آپ آئی فون/آئی پیڈ کو دور کرسکتے ہیں۔ اہم: جب تک تجربہ نہ ہو اس وقت تک حجم کے کنٹرول کو مت لگائیں۔ حجم کو تبدیل کرنے سے انشانکن کو شکست دی جائے گی اور تمام نتائج کو باطل کردیا جائے گا۔",
  ...
  RC_soundCalibrationQR: {
    ...
    fr: "Lorsque le code QR apparaît ci-dessous, pointez votre caméra iPhone ou iPad et cliquez sur le lien qui apparaît sur votre écran iPhone / iPad. Suivez ensuite les instuces sur l'écran iPhone / iPad.\n—————————————————————————————————————————————\nSILENCE S.V.P! Maintenant enregistrer. Ne touchez pas le contrôle du volume.\n—————————————————————————————————————————————\nPROBLÈME?\n1. Cela nécessite le WiFi. Si votre téléphone et votre ordinateur ne sont pas tous les deux sur le même réseau WiFi, l'iPhone n'obtiendra pas jusqu'à demander votre autorisation d'utiliser le microphone et vous attendez pour toujours. Connectez donc l'ordinateur et l'iPhone au même WiFi ou à quitter.\n                                                                                                                                 \n2. Si l'iPhone signale une erreur dans la connexion, essayez de quitter et de redémarrer le navigateur iPhone ou même de redémarrer l'iPhone.\n                                                                                                                             \n3. C'est rare, mais, si le son ne joue pas, ou, après son jeu, aucun bouton de procédure n'apparaît, cela signifie que l'étalonnage a échoué. Vous pouvez réessayer en rafraîchissant cette page de navigateur. Cela fait généralement l'affaire.",
  ...
  RC_soundCalibrationRedo: {
    ...
    ur: "افسوس ، 111 ڈی بی کی آر ایم ایس فٹنگ کی غلطی 222 ڈی بی رواداری سے زیادہ ہے ، لہذا لاؤڈ اسپیکر کو دوبارہ کیلیبریٹ کرنا چاہئے۔",
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    "zh-HK":
      "解釋。對於此步驟，如有必要，靠近，因此您的寬度不超過屏幕寬度的兩倍。每隻眼睛都有一個盲點。我們會找到您的，以發現您的眼睛離屏幕有多遠。您會被要求閉上或遮住一隻眼睛以隔離另一隻眼睛。當您專注於十字頭頭髮時，請觀察眼角閃爍的點，並在盲點消失時擊中返回。根據查看距離和屏幕尺寸，閃爍的點通常會在盲點到達屏幕中間之前到達盲點。您將用每隻眼睛交替進行此操作，直到最後兩個測量一致。測試雙眼時，請保持觀看距離。筆記。如果點永遠不會消失，則意味著您的眼睛正在跟隨點，而不是呆在十字頭髮上。該測試需要您在監視眼角的閃爍點時密切關注叉頭髮。一開始很難，但是練習變得更加容易。",
  ...
  T_guessingGame: {
    ...
    ka: "ასოების ზომა და ინტერვალი განსხვავდება დიდი და მარტივი და რთული და რთული ან შეუძლებელი. თქვენ ვერ მიიღებთ ბევრად მეტს, ვიდრე ორ მესამედს, ასე რომ დაისვენეთ. იფიქრეთ, როგორც გამოცნობის თამაში, და უბრალოდ მიიღეთ რაც შეიძლება მეტი. თქვენ მოისმენთ beep, როდესაც მართალი ხართ.",
  ...
  T_middleLetterBrief: {
    ...
    ro: "Este un R. Acest ecran este static, așa că ar fi ușor să mutați ochii în scrisoare și să -l identificați. Dar, într -un test real, versurile sunt afișate, așa că nu există timp să vă mișcați ochii. Este important să ne uităm la părul Cruz în timp ce faceți clic. Literele vor clipi imediat. Nu contează unde îți dau ochii după flash. Primul bloc de testare este doar câteva teste de practică, înainte de a începe serios.",
    ...
    ka: "ეს არის R. ეს ეკრანი სტატიკურია, ასე რომ ადვილი იქნება თქვენი თვალების გადატანა წერილზე და იდენტიფიცირება. მაგრამ, რეალურ განსაცდელში, წერილები ააფეთქეს, ასე რომ, თვალების გადაადგილების დრო არ არის. მნიშვნელოვანია, რომ გადახედოთ ჯვრის თმას, როგორც დააჭირეთ მას. ასოები დაუყოვნებლივ გაისვრის. არ აქვს მნიშვნელობა სად მიდის თქვენი თვალები flash- ის შემდეგ. ტესტირების პირველი ბლოკი მხოლოდ რამდენიმე პრაქტიკის გამოცდაა, სანამ სერიოზულად დავიწყებთ.",
    he: "זה R. תצוגה זו היא סטטית, כך שיהיה קל להעביר את העיניים למכתב ולזהות אותו. אבל, במשפט אמיתי, המכתבים מבהיקים, כך שאין זמן להזיז את העיניים. חשוב להסתכל על שערות הצלב בזמן שאתה לוחץ עליו. האותיות יבהבו מייד. לא משנה לאן העיניים שלך הולכות אחרי ההבזק. גוש הבדיקה הראשון הוא רק כמה ניסויים של תרגול, לפני שנתחיל ברצינות.",
    ...
    id: "Ini adalah R. Tampilan ini statis, jadi akan mudah untuk memindahkan mata Anda ke surat dan mengidentifikasinya. Tapi, dalam uji coba nyata, surat -surat itu muncul, jadi tidak ada waktu untuk menggerakkan mata Anda. Penting untuk melihat rambut silang saat Anda mengkliknya. Surat akan segera berkedip. Tidak masalah ke mana mata Anda mengejar kilat. Blok pengujian pertama hanyalah beberapa percobaan latihan, sebelum kita mulai dengan sungguh -sungguh.",
    "zh-CN":
  ...
  T_middleLetterDemo: {
    ...
    fr: "À chaque essai, pendant que vous regardez les poils, un triplet de trois lettres aléatoires clignotera dans le coin de votre œil. Juste un flash. Pour apprendre la tâche, essayons d'abord avec un écran statique. Pendant que vous regardez les poils, ci-dessous, sans bouger les yeux, essayez d'identifier la lettre du milieu.",
    ...
    fi: "Jokaisessa kokeessa, kun tarkastellaan ristikarvoja, kolmen satunnaisen kirjaimen kolminkertainen vilkkuu silmäsi nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun tarkastellaan ristikkäitä hiuksia, yritä tunnistaa keskimmäinen kirjain.",
    ...
    te: "ప్రతి ట్రయల్‌లో, మీరు క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, మూడు యాదృచ్ఛిక అక్షరాల త్రిపాది మీ కంటి మూలలో మెరుస్తుంది. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో ప్రయత్నిద్దాం. మీరు కళ్ళు కదిలించకుండా, క్రింద, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, మధ్య అక్షరాన్ని గుర్తించడానికి ప్రయత్నించండి.",
  ...
  T_sentenceGuessingGame: {
    ...
    ka: "სასჯელის გააზრება განსხვავდება მარტივად ქვემოთ ან შეუძლებლად. თქვენ ვერ მიიღებთ ბევრად მეტს, ვიდრე ორ მესამედს, ასე რომ დაისვენეთ. იფიქრეთ, როგორც გამოცნობის თამაში, და უბრალოდ მიიღეთ რაც შეიძლება მეტი. თქვენ მოისმენთ beep, როდესაც მართალი ხართ.",
  ...
  T_sentenceIdentifyClick: {
    ...
    bn: "সমস্ত সম্ভাব্য বাক্য প্রদর্শিত হয়। আপনি যে শুনেছেন তা ক্লিক করুন বা আপনার সেরা অনুমান করুন।",
    id: "Semua kalimat yang mungkin ditampilkan. Silakan klik yang Anda dengar, atau tebakan terbaik Anda.",
    "zh-CN": "显示所有可能的句子。请点击您所听到的，或最好的猜测。",
    "zh-HK": "顯示所有可能的句子。請點擊您所聽到的，或最好的猜測。",
  ...
  T_sentenceProcedure: {
    ...
    fr: "À chaque essai, vous entendrez une phrase, généralement en bruit. Ensuite, vous verrez une liste de toutes les phrases possibles, et vous cliquez sur celui que vous avez entendu, ou votre meilleure supposition.",
    ...
    it: "Ad ogni prova, sentirai una frase, di solito con rumore. Quindi vedrai un elenco di tutte le frasi possibili e fai clic su quello che hai sentito o la tua ipotesi migliore.",
    ...
    ru: "На каждом испытании вы услышите предложение, обычно в шуме. Затем вы увидите список всех возможных предложений, и вы нажмете тот, который вы слышали, или ваше лучшее предположение.",
    ...
    fi: "Jokaisessa kokeessa kuulet lauseen, yleensä melu. Sitten näet luettelon kaikista mahdollisista lauseista, ja napsautat kuulemasi tai parhaan arvauksen.",
    ...
    ta: "ஒவ்வொரு சோதனையிலும், நீங்கள் ஒரு வாக்கியத்தைக் கேட்பீர்கள், பொதுவாக சத்தம். சாத்தியமான அனைத்து வாக்கியங்களின் பட்டியலையும் நீங்கள் காண்பீர்கள், மேலும் நீங்கள் கேட்டதை அல்லது உங்கள் சிறந்த யூகத்தை கிளிக் செய்வீர்கள்.",
    ...
    kn: "ಪ್ರತಿ ಪ್ರಯೋಗದಲ್ಲೂ, ನೀವು ಸಾಮಾನ್ಯವಾಗಿ ಶಬ್ದದಲ್ಲಿ ಒಂದು ವಾಕ್ಯವನ್ನು ಕೇಳುತ್ತೀರಿ. ನಂತರ ನೀವು ಸಂಭವನೀಯ ಎಲ್ಲಾ ವಾಕ್ಯಗಳ ಪಟ್ಟಿಯನ್ನು ನೋಡುತ್ತೀರಿ, ಮತ್ತು ನೀವು ಕೇಳಿದ ಒಂದು ಅಥವಾ ನಿಮ್ಮ ಉತ್ತಮ .ಹೆಯನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ.",
    ...
    "zh-CN":
      "在每个审判中，通常会在噪音中听到一个句子。然后，您将看到所有可能的句子的列表，然后单击所听到的句子，或者您的最佳猜测。",
    "zh-HK":
      "在每個審判中，通常會在噪音中聽到一個句子。然後，您將看到所有可能的句子的列表，然後單擊所聽到的句子，或者您的最佳猜測。",
    ja: "各トライアルでは、通常はノイズで文が聞こえます。次に、考えられるすべての文のリストが表示され、聞いた文、または最善の推測をクリックします。",
  ...
  T_thresholdSoundCheck: {
    ...
    ja: "こんにちは。ピーボタンをクリックしてこのコンピュータの音が機能していることを確認してください。ちなみに、テストでは正解する度にこの音が鳴ります。",
    ko: "안녕하세요. 경고음 버튼을 클릭 하여이 컴퓨터의 사운드가 작동하는지 확인하십시오. 당신의 대답이 옳을 때마다 그런 경고음이 들립니다.",
  },

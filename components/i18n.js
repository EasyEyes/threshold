...
export const phrases = {
  ...
  T_rsvpReadingTask: {
    ...
    de: "Sie sind dabei, einen Block von xxx -Versuchen zu starten. Sie werden eine Geschichte lesen, ein paar Worte gleichzeitig. Jeder Versuch zeigt Ihnen schnell über ein Satz von Wörtern nach dem anderen und bittet Sie dann, sich zu erinnern, welche Wörter Sie lesen.",
  ...
  T_sentenceIdentifyClick: {
    ...
    ru: "Списки ниже показывают все возможности для каждого слова в предложении. Сообщите о предложении или о вашем лучшем предположении, нажав на слова, которые вы слышали.",
  ...
  T_sentenceProcedure: {
    ...
    ru: "На каждом испытании вы услышите предложение, обычно в шуме. Затем вы увидите список всех возможностей для каждого слова в предложении. Сообщите о предложении или о вашем лучшем предположении, нажав на слова, которые вы слышали.",
  ...
  T_soundPhraseBlock: {
    ...
    ko: "각 시험에서 문장을 듣고 두 단어를 기억하도록 요청받을 것입니다. 소리가 왜곡되어 인식하기 어려울 수 있으므로 올바르게 얻을 수는 없습니다. 괜찮아요. 게임으로 취급하고 최선을 다하십시오. 행운을 빌어요. 반품을 누르거나 계속 진행하십시오.\n\n진행 버튼은 즉시 사라지고 사운드가로드되면 실험이 시작되며 인터넷 연결 속도에 따라 40 초 이상이 걸립니다. 우리는 향후 릴리스 에서이 지연을 단축하기 위해 노력하고 있습니다.\n\n소리로드 ...",
  },
  ...
  T_thresholdRepeatedLettersBeginBlock: {
    ...
    de: "Sie sind dabei, einen Block von xxx -Versuchen zu starten. In jedem Versuch erscheint ein Buchstabenfeld. Melden Sie die beiden mittleren Charaktere, die Sie sehen",

...
export const phrases = {
  ...
  EE_compatibleBrowserVersionNotOSDeviceCores: {
    ...
    ro: "După cum s -a menționat în descrierea sa, acest studiu este incompatibil cu OOO și are nevoie de browserul BBB (versiunea cel puțin 111) care rulează pe un DDD cu cel puțin 222 de nuclee CPU",
    ...
    ar: "كما هو مذكور في وصفها ، لا تتوافق هذه الدراسة مع OOO ، وتحتاج إلى متصفح BBB (الإصدار 111 على الأقل) الذي يعمل على DDD مع ما لا يقل عن 222 نوى وحدة المعالجة المركزية",
  ...
  EE_compatibleDeviceCores: {
    ...
    kn: "ಅದರ ವಿವರಣೆಯಲ್ಲಿ ಹೇಳಿದಂತೆ, ಈ ಅಧ್ಯಯನಕ್ಕೆ ಕನಿಷ್ಠ 222 ಸಿಪಿಯು ಕೋರ್ಗಳೊಂದಿಗೆ ಡಿಡಿಡಿ ಅಗತ್ಯವಿದೆ",
  ...
  EE_compatibleNotBrowserNotOSDeviceCores: {
    ...
    pl: "Jak stwierdzono w swoim opisie, badanie to jest niezgodne z przeglądarką BBB, a także niekompatybilną z OOO. Potrzebuje DDD z co najmniej 222 rdzeniami procesora",
    ...
    ar: "كما هو مذكور في وصفها ، لا تتوافق هذه الدراسة مع متصفح (متصفح) BBB وأيضًا غير متوافق مع OOO. يحتاج إلى DDD مع 222 نوى وحدة المعالجة المركزية على الأقل",
    ...
    hi: "जैसा कि इसके विवरण में कहा गया है, यह अध्ययन बीबीबी ब्राउज़र (एस) के साथ असंगत है और ओओओ के साथ भी असंगत है। इसे कम से कम 222 सीपीयू कोर के साथ डीडीडी की आवश्यकता है",
  ...
  EE_compatibleNotBrowserOSDeviceCores: {
    ...
    ar: "كما ذكر في وصفها ، لا تتوافق هذه الدراسة مع متصفح (متصفح) BBB وتحتاج إلى DDD مع ما لا يقل عن 222 نوى وحدة المعالجة المركزية",
    ur: "جیسا کہ اس کی تفصیل میں کہا گیا ہے ، یہ مطالعہ بی بی بی براؤزر (زبانیں) سے مطابقت نہیں رکھتا ہے اور اسے کم از کم 222 سی پی یو کور کے ساتھ اوو ڈی ڈی ڈی کی ضرورت ہے۔",
  ...
  EE_compatibleNotOSDeviceCores: {
    ...
    ro: "După cum s -a menționat în descrierea sa, acest studiu este incompatibil cu OOO. Are nevoie de un DDD cu cel puțin 222 de nuclee de procesare",
  ...
  RC_errorNoCamera: {
    ...
    ar: "تحتاج هذه الدراسة إلى استخدام كاميرا الويب. يعد منح الوصول إلى كاميرا الويب الخاصة بك اختياريًا ، لكن لا يمكننا المتابعة بدونها. إذا قلت لا عن طريق الخطأ وترغب الآن في منحنا الوصول إلى الكاميرا ، فيرجى العثور على أيقونة الكاميرا في شريط العناوين ، وانقر فوقه ، والسماح للوصول إلى الكاميرا ، وتحديث الصفحة.",
  ...
  RC_soundCalibrationNeedsIPhone: {
    ...
    pl: "Aby uzyskać dokładny dźwięk, eksperyment musi skalibrować głośniki. Wymaga to iPhone'a lub iPada, które są podłączone do Internetu. Czy masz jeden przydatny?\n",

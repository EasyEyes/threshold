...
export const phrases = {
  ...
  RC_FindModelMacBook: {
    ...
    ka: "თქვენ შეგიძლიათ იპოვოთ თქვენი MacBook მოდელის ნომერი, რომელიც დაბეჭდილია თქვენი MacBook- ის ბოლოში. ეს იწყება ასო A- ით, რომელსაც მოჰყვება 4 ნომერი. დააკოპირეთ მოდელის ნომერი და სახელი ქვემოთ მოცემულ შესაბამის ველებში.",
  ...
  RC_gazeTrackingIntro: {
    ...
    it: 'Gioca "Catch the Cross!" Ora imposteremo il monitoraggio dello sguardo, per monitorare la posizione degli occhi. Tieni la faccia nel feed video (vedi sotto). Fai clic sul centro dei capelli incrociati, ovunque si trovi. Assicurati che i tuoi occhi siano su di esso quando fai clic. Quando fai clic su di esso, i capelli incrociati si sposteranno in una nuova posizione. Fare clic su ogni nuova posizione, fino a quando la calibrazione è terminata. È un gioco. Cattura la croce!',

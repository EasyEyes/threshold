...
export const phrases = {
  ...
  EE_compatibleNotOSDeviceCores: {
    ...
    ru: "Как указано в его описании, это исследование несовместимо с OOO. Он нуждается в DDD с не менее 222 ядрами процессора",
  ...
  EE_incompatibleReturnToProlific: {
    ...
    fi: "Tämä tutkimus ei ole yhteensopiva tietokoneesi tai selaimesi kanssa, joten palauta se tuotteelle Lensific.co. Maksujen lähettäminen hylätään (mikä vahingoittaa mainetta), joten palauta se.",
  ...
  RC_gazeTrackingIntro: {
    ...
    fi: 'Pelaa "Catch the Risti!" Nyt asetamme katseenseurannan silmien sijainnin seuraamiseksi. Pidä kasvosi videosyötteessä (katso alla). Napsauta ristikarvojen keskustaa missä tahansa. Varmista, että silmäsi ovat siinä, kun napsautat sitä. Kun napsautat sitä, ristikarvat siirtyvät uuteen sijaintiin. Napsauta sitä jokaisessa uudessa paikassa, kunnes kalibrointi on tehty. Se on peli. Pudota risti!',
  ...
  RC_soundCalibrationDone: {
    ...
    ta: "நன்றி. அளவுத்திருத்தம் செய்யப்படுகிறது, மேலும் நீங்கள் ஐபோன்/ஐபாட் ஒதுக்கி வைக்கலாம். முக்கியமானது: சோதனை செய்யப்படும் வரை தொகுதி கட்டுப்பாட்டைத் தொட வேண்டாம். அளவை மாற்றுவது அளவுத்திருத்தத்தை தோற்கடித்து அனைத்து முடிவுகளையும் செல்லாது.",

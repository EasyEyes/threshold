...
export const phrases = {
  ...
  T_readyPressSpaceRepeatedLetters: {
    ...
    ru: "Готовы идентифицировать буквы? Глядя прямо на центр кросс -волос, пожалуйста, нажмите на космическую планку.",
  ...
  T_readyPressSpaceRsvpReading: {
    ...
    ru: "Готовы прочитать несколько слов? Глядя прямо на центр кросс -волос, пожалуйста, нажмите на космическую планку.",

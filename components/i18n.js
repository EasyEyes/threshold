...
export const phrases = {
  ...
  RC_distanceTrackingCloseL: {
    ...
    ru: "1. Закройте левый глаз. (Это левая сторона экрана.)\n2. Используйте ▶ Ключ стрелка, чтобы скользить мерцающую точку. (Или просто перетащите его, если он не отвечает на ключ стрелки.), Глядя на кросс -волоски, следите за мерцающей точкой в ​​углу глаз и скользите влево и вправо, пока не исчезнет в вашем слепой точке.\n3. Нажмите на возврат.\nПримечание: следите за кросс -волосами. Мерцающая точка не исчезнет, ​​пока ваш глаз следует за ней.",
  ...
  RC_screenSizeIntro: {
    ...
    it: "Misurare le dimensioni di questa schermata. Usa il menu a discesa per scegliere qualcosa di utile. È possibile utilizzare qualsiasi connettore USB comune (incluso quello che fornisce energia al tuo computer) o una carta di credito (o qualsiasi carta della stessa dimensione). Posiziona l'oggetto sullo schermo e sposta il cursore per regolare l'immagine in modo che corrisponda alle dimensioni del tuo oggetto. Quando corrispondono, premere return (o fare clic su OK) per procedere.",
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    "zh-HK":
      "解釋。對於此步驟，如有必要，靠近，因此您的屏幕寬度不超過兩倍。每隻眼睛都有一個盲點。我們會發現您的眼睛離屏幕有多遠。您會被要求閉上或遮住一隻眼睛以隔離另一隻眼睛。當您專注於十字頭髮時，請觀察眼角閃爍的點，並在盲點消失時擊中回報。根據觀看距離和屏幕尺寸，閃爍的點通常會在盲點到達屏幕中間之前到達盲點。您將用每隻眼睛交替進行此操作，直到最後兩個測量一致。測試雙眼時，請保持觀看距離。筆記。如果點永遠不會消失，則意味著您的眼睛正在跟隨點，而不是留在十字頭髮上。該測試要求您在監視眼角的閃爍點時密切注意十字頭髮。一開始很難，但是練習變得更加容易。",

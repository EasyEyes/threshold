...
export const phrases = {
  ...
  EE_incompatible: {
    ...
    ko: "❌ 호환되지 않습니다. 죄송합니다. 이 연구를 Prolific.co로 돌려주십시오.",
  },
  ...
  RC_soundCalibrationDone: {
    ...
    ur: "شکریہ. انشانکن ہو گیا ہے ، اور آپ آئی فون/آئی پیڈ کو دور کرسکتے ہیں۔ اہم: جب تک تجربہ نہ ہو اس وقت تک حجم کے کنٹرول کو مت لگائیں۔ حجم کو تبدیل کرنے سے انشانکن کو شکست ملے گی اور تمام نتائج کو باطل کردے گا۔",
  ...
  T_rsvpReadingTask: {
    ...
    "zh-CN":
      "您即将开始xxx试验。您会读一个故事，一次几句话。每个审判都会迅速向您展示一个值得一句话的句子，然后要求您记住您阅读的单词。",
    "zh-HK":
      "您即將開始xxx試驗。您會讀一個故事，一次幾句話。每個審判都會迅速向您展示一個值得一句話的句子，然後要求您記住您閱讀的單詞。",

...
export const phrases = {
  ...
  RC_soundCalibrationDone: {
    ...
    he: "תודה. הכיול נעשה, ותוכלו להניח את ה- iPhone/iPad. חשוב: אל תיגע בבקרת עוצמת הקול עד לסיום הניסוי. שינוי הנפח יהרוס את הכיול ויבטל את כל התוצאות.",
  ...
  T_middleLetterBrief: {
    ...
    te: "ఇది R. ఈ ప్రదర్శన స్థిరంగా ఉంది, కాబట్టి మీ కళ్ళను లేఖకు తరలించి గుర్తించడం సులభం. కానీ, నిజమైన విచారణలో, అక్షరాలు వెలిగిపోతాయి, కాబట్టి మీ కళ్ళను కదిలించడానికి సమయం లేదు. మీరు ట్రయల్‌ను ప్రారంభించినప్పుడు క్రాస్ హెయిర్‌లను చూడటం చాలా ముఖ్యం. అక్షరాలు వెంటనే ఫ్లాష్ అవుతాయి. ఫ్లాష్ తర్వాత మీ కళ్ళు ఎక్కడికి వెళతాయో అది పట్టింపు లేదు. పరీక్ష యొక్క మొదటి బ్లాక్ మేము ఆసక్తిగా ప్రారంభించడానికి ముందు, కొన్ని ప్రయత్నాలు సాధన.",
  ...
  T_middleLetterDemo: {
    ...
    he: "בכל ניסיון, בזמן שאתה מסתכל על שערות הצלב, שלישייה של שלוש אותיות אקראיות תבהב בפינת העין שלך. רק פלאש. כדי ללמוד את המשימה, בואו ננסה אותה תחילה עם תצוגה סטטית. תוך כדי התבוננות בשערות הצלב, למטה, מבלי להזיז את העיניים, נסה לזהות את האות האמצעית.",
  ...
  T_letterBrief: {
    ...
    te: "ఇది R. ఈ ప్రదర్శన స్థిరంగా ఉంది, కాబట్టి మీ కళ్ళను లేఖకు తరలించి గుర్తించడం సులభం. కానీ, నిజమైన విచారణలో, లేఖ వెలిగింది, కాబట్టి మీ కళ్ళను కదిలించడానికి సమయం లేదు. మీరు ట్రయల్‌ను ప్రారంభించినప్పుడు క్రాస్ హెయిర్‌లను చూడటం చాలా ముఖ్యం. లేఖ వెంటనే ఫ్లాష్ అవుతుంది. ఫ్లాష్ తర్వాత మీ కళ్ళు ఎక్కడికి వెళతాయో అది పట్టింపు లేదు. పరీక్ష యొక్క మొదటి బ్లాక్ మేము ఆసక్తిగా ప్రారంభించడానికి ముందు, కొన్ని ప్రయత్నాలు సాధన.",
  ...
  T_thresholdSoundBeginBlock: {
    ...
    he: 'איתור קול. אתה עומד להתחיל גוש של ניסויים רבים. אתה מנסה לאתר צליל יעד מסוים: הערה אחת, חוזרת על עצמה 8 פעמים, תמיד אותה תו. יעד זה קיים רק במחצית הניסויים, באופן אקראי. בכל משפט, התפקיד שלך הוא להקשיב ולהחליט אם הוא נוכח, כן או לא. כשאתה מתקדם ממשפט למשפט, בהתבסס על התגובות שלך, עוצמת הקול של היעד תסתגל כך שהוא בקושי ניתן לגילוי. בבלוק התרגול הראשוני היעד יהיה לבד. בבלוקים מאוחרים יותר, יהיה קשה יותר לאתר את היעד בגלל צלילים אחרים. תמיד התעלם מהצלילים האחרים, ונסה לדווח, כן או לא, האם צליל היעד היה קיים. השתמש במפתח "Y" עבור YES ובמפתח "N" עבור לא.\n\nלחץ על החזרה או לחץ על המשך ברגע שאתה מוכן. כפתור ההמשך ייעלם מייד והניסוי יתחיל ברגע שהצלילים יועברו, שנמשך 40 שניות ומעלה, תלוי במהירות החיבור לאינטרנט. אנו פועלים לקצר את העיכוב הזה במהדורה עתידית.\n\nטוען צלילי ...',

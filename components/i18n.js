...
export const phrases = {
  ...
  EE_ID_noLocalStorage: {
    ...
    he: "החוקר מבקש שתספק את מזהה ה- EasyEyes שלך מהפגישה הקודמת, אנא הקלד אותו כאן, או העלה את הקובץ שהורדת כאשר ההפעלה האחרונה מסתיימת.",
  ...
  RC_privacyCamera: {
    ...
    fi: "Kameran yksityisyyden varmuus. Valokuvia tai videoita ei ole tallennettu. Jokaista verkkokamerakehystä käytetään vain tämän tietokoneen sisällä, pelkästään silmä- ja katselututkintojen arvioimiseksi ja poistetaan sitten 10 sekunnissa. Vain silmä- ja katseasennot säilytetään.",
  ...
  T_middleLetterBrief: {
    ...
    kn: "ಇದು ಆರ್. ಈ ಪ್ರದರ್ಶನವು ಸ್ಥಿರವಾಗಿದೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಪತ್ರಕ್ಕೆ ಸರಿಸಿ ಅದನ್ನು ಗುರುತಿಸುವುದು ಸುಲಭ. ಆದರೆ, ನಿಜವಾದ ಪ್ರಯೋಗದಲ್ಲಿ, ಅಕ್ಷರಗಳು ಮಿನುಗುತ್ತವೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಸರಿಸಲು ಸಮಯವಿಲ್ಲ. ನೀವು ಪ್ರಯೋಗವನ್ನು ಪ್ರಾರಂಭಿಸುವಾಗ ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವುದು ಮುಖ್ಯ. ಅಕ್ಷರಗಳು ತಕ್ಷಣ ಮಿಂಚುತ್ತವೆ. ಫ್ಲ್ಯಾಷ್ ನಂತರ ನಿಮ್ಮ ಕಣ್ಣುಗಳು ಎಲ್ಲಿಗೆ ಹೋಗುತ್ತವೆ ಎಂಬುದು ಅಪ್ರಸ್ತುತವಾಗುತ್ತದೆ. ನಾವು ಶ್ರದ್ಧೆಯಿಂದ ಪ್ರಾರಂಭಿಸುವ ಮೊದಲು ಪರೀಕ್ಷೆಯ ಮೊದಲ ಬ್ಲಾಕ್ ಅಭ್ಯಾಸದ ಕೆಲವು ಪ್ರಯೋಗಗಳು.",
    bn: "এটি একটি আর। এই প্রদর্শনটি স্থির, সুতরাং আপনার চোখটি চিঠির দিকে নিয়ে যাওয়া এবং এটি সনাক্ত করা সহজ হবে। তবে, সত্যিকারের পরীক্ষায়, চিঠিগুলি ঝলকানো হয়, তাই আপনার চোখ সরানোর কোনও সময় নেই। আপনি যখন ট্রায়ালটি শুরু করেন তখন ক্রস কেশগুলি দেখার বিষয়টি গুরুত্বপূর্ণ। চিঠিগুলি তাত্ক্ষণিকভাবে ফ্ল্যাশ হবে। ফ্ল্যাশের পরে আপনার চোখ কোথায় যায় তা বিবেচ্য নয়। পরীক্ষার প্রথম ব্লকটি আমরা আন্তরিকভাবে শুরু করার আগে অনুশীলনের কয়েকটি পরীক্ষা।",
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں گے تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمکتا ہے۔ صرف ایک جھلک کام کو جاننے کے ل first ، پہلے اسے مستحکم کارکردگی کے ساتھ آزمائیں۔ نیچے کے بالوں کو دیکھتے ہوئے ، آنکھیں ہلاتے ہوئے درمیانی کاغذ کی شناخت کرنے کی کوشش کریں۔",
    hi: "प्रत्येक परीक्षण पर, जब आप क्रॉस हेयर को देखते हैं, तो तीन यादृच्छिक अक्षरों का एक ट्रिपल आपकी आंख के कोने में फ्लैश होगा। बस एक झलक। कार्य को जानने के लिए, इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आँखों को हिलाने के बिना, नीचे, नीचे के बालों को देखते हुए, मध्य पत्र की पहचान करने का प्रयास करें।",
    ...
    ko: "각 시험에서 십자형 머리카락을 보면서 3 개의 임의의 문자가 눈의 모퉁이에 번쩍입니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보면서 중간 문자를 식별하십시오.",
  },
  T_letterBrief: {
    "en-US":
  ...
  T_sentenceProcedure: {
    ...
    ko: "각 시험에서 일반적으로 소음으로 문장이 들립니다. 그런 다음 문장의 각 단어에 대한 모든 가능성 목록이 표시됩니다. 들었던 단어를 클릭하여 문장이나 최선의 추측을보고하십시오.",
  },
  T_session: {
    "en-US": "",
    de: "",
  ...
  T_thresholdMiddleLetterBeginBlock: {
    ...
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. სამი ასოების ტრიპლეტი გამოჩნდება თითოეულ სასამართლო პროცესზე, მაგალითად: Z R N. გთხოვთ, შეატყობინოთ მხოლოდ შუა წერილს,",

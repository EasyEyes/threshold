...
export const phrases = {
  ...
  EE_compatibleNotOSDeviceCores: {
    ...
    ro: "După cum se spune în descrierea sa, acest studiu este incompatibil cu OOO. Are nevoie de un DDD cu cel puțin 222 de nuclee de procesare",
  ...
  EE_ID_noLocalStorage: {
    ...
    bn: "গবেষক আপনাকে পূর্ববর্তী সেশন থেকে আপনার ইজিয়েয়েস আইডি সরবরাহ করার জন্য অনুরোধ করেছিলেন, দয়া করে এটি এখানে টাইপ করুন, বা শেষ অধিবেশন শেষ হলে ডাউনলোড করা ফাইলটি আপলোড করুন।",
  ...
  RC_gazeTrackingNudge: {
    ...
    kn: "ಶಿಲುಬೆಯನ್ನು ಹಿಡಿಯಿರಿ! ನಿಮ್ಮ ಸಹಾಯ ನಮಗೆ ಬೇಕು. ಕಣ್ಣಿನ ಟ್ರ್ಯಾಕರ್‌ಗೆ ಹೆಚ್ಚಿನ ತರಬೇತಿ ಅಗತ್ಯವಿದೆ. ಬಾಣವು ತೋರಿಸಿದಂತೆ, ನೀವು ಕ್ಲಿಕ್ ಮಾಡಿದಾಗ, ನಿಮ್ಮ ನೋಟವು ಅಡ್ಡ ಕೂದಲಿನಿಂದ ದೂರವಿದೆ ಎಂದು ಟ್ರ್ಯಾಕರ್ ಭಾವಿಸಿದ್ದಾನೆ. ದಯವಿಟ್ಟು ಪ್ರತಿ ಹೊಸ ಸ್ಥಾನದಲ್ಲಿ ಅಡ್ಡ ಕೂದಲನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ. ಇದು ಒಂದು ಆಟ. ಶಿಲುಬೆಯನ್ನು ಹಿಡಿಯಿರಿ!",
  ...
  RC_privacyIphoneMicrophone: {
    ...
    de: 'Gewissheit der Privatsphäre von Mikrofon. Easyeyes verwendet Ihr iPhone/iPad-Mikrofon anstelle des integrierten Mikrofons Ihres Desktops, da das iPhone/iPad-Mikrofon Hersteller kalibriert ist. Das Mikrofon zeichnet nur auf, während ein lauter Sound den Desktop -Computerlautsprecher durchläuft, und sowohl im Desktop -Computer zeigen prominent "Quiet bitte! Jetzt aufnehmen". Die Aufzeichnung wird ausschließlich zur Schätzung von Lautsprechereigenschaften verwendet und dann innerhalb von 30 Sekunden gelöscht. Nur die Lautsprechermerkmale werden erhalten.',
    ...
    te: 'మైక్రోఫోన్ గోప్యత యొక్క హామీ. మీ డెస్క్‌టాప్ యొక్క అంతర్నిర్మిత మైక్రోఫోన్ కాకుండా ఈజీయెస్ మీ ఐఫోన్/ఐప్యాడ్ మైక్రోఫోన్‌ను ఉపయోగిస్తుంది, ఎందుకంటే ఐఫోన్/ఐప్యాడ్ మైక్రోఫోన్ తయారీదారు-క్రమాంకనం. మైక్రోఫోన్ డెస్క్‌టాప్ కంప్యూటర్ లౌడ్‌స్పీకర్ ద్వారా బిగ్గరగా ధ్వని ఆడుతున్నప్పుడు మాత్రమే రికార్డ్ చేస్తుంది మరియు డెస్క్‌టాప్ కంప్యూటర్ రెండూ ప్రముఖంగా "నిశ్శబ్దమైన ప్లీజ్! ఇప్పుడు రికార్డింగ్" అని ప్రదర్శిస్తాయి. రికార్డింగ్ లౌడ్‌స్పీకర్ లక్షణాలను అంచనా వేయడానికి మాత్రమే ఉపయోగించబడుతుంది మరియు తరువాత 30 సెకన్లలో తొలగించబడుతుంది. లౌడ్‌స్పీకర్ లక్షణాలు మాత్రమే అలాగే ఉంచబడతాయి.',
    ...
    bn: 'মাইক্রোফোন গোপনীয়তার আশ্বাস। ইজিয়েয়েস আপনার ডেস্কটপের অন্তর্নির্মিত মাইক্রোফোনের পরিবর্তে আপনার আইফোন/আইপ্যাড মাইক্রোফোন ব্যবহার করে, কারণ আইফোন/আইপ্যাড মাইক্রোফোনটি নির্মাতা-ক্যালিব্রেটেড। মাইক্রোফোনটি কেবলমাত্র ডেস্কটপ কম্পিউটার লাউডস্পিকারের মাধ্যমে একটি জোরে শব্দ বাজানোর সময় রেকর্ড করে এবং ডেস্কটপ কম্পিউটার উভয়ই স্পষ্টতই "শান্ত দয়া করে! এখন রেকর্ডিং" প্রদর্শন করে। রেকর্ডিংটি সম্পূর্ণরূপে লাউডস্পিকারের বৈশিষ্ট্যগুলি অনুমান করার জন্য ব্যবহৃত হয় এবং তারপরে 30 সেকেন্ডের মধ্যে মুছে ফেলা হয়। শুধুমাত্র লাউডস্পিকারের বৈশিষ্ট্যগুলি ধরে রাখা হয়।',
  ...
  RC_soundCalibrationDone: {
    ...
    bn: "ধন্যবাদ। ক্রমাঙ্কনটি সম্পন্ন হয় এবং আপনি আইফোন/আইপ্যাডটি ফেলে দিতে পারেন। গুরুত্বপূর্ণ: পরীক্ষাটি না হওয়া পর্যন্ত ভলিউম নিয়ন্ত্রণটি স্পর্শ করবেন না। ভলিউম পরিবর্তন করা ক্রমাঙ্কনকে পরাস্ত করবে এবং সমস্ত ফলাফলকে অকার্যকর করবে।",
    ...
    ko: "감사해요. 교정이 완료되며 iPhone/iPad를 제거 할 수 있습니다. 중요 : 실험이 완료 될 때까지 볼륨 컨트롤에 닿지 마십시오. 볼륨을 변경하면 교정이 무효화되고 모든 결과가 무효화됩니다.",
  },
  ...
  RC_soundCalibrationQR: {
    ...
    de: "Wenn der QR -Code unten angezeigt wird, weisen Sie Ihre iPhone oder iPad -Kamera auf und klicken Sie auf den Link, der auf Ihrem iPhone/iPad -Bildschirm angezeigt wird. Folgen Sie dann den Instuktionen auf dem iPhone/iPad -Bildschirm.\n—————————————————————————————————————————————————————————————————————————————————————–\nRUHIG BITTE! Jetzt aufnehmen. Berühren Sie die Lautstärkekontrolle nicht.\n—————————————————————————————————————————————————————————————————————————————————————–\nPROBLEM?\n1. Dies braucht WLAN. Wenn Ihr Telefon und Ihr Computer nicht beide im selben WLAN -Netzwerk sind, wird das iPhone nicht so weit wie möglich auffordert, das Mikrofon zu verwenden, und Sie werden ewig warten. Schließen Sie also den Computer und das iPhone mit demselben WLAN an oder beenden Sie.\n                                                                                                                                 \n2. Wenn das iPhone einen Fehler in der Verbindung meldet, beenden Sie den iPhone -Browser an und starten Sie das iPhone sogar neu.\n                                                                                                                             \n3. Es ist selten, aber wenn der Sound nicht spielt oder nach dem Spielen keine Taste erscheint, bedeutet dies, dass die Kalibrierung fehlgeschlagen ist. Sie können es erneut versuchen, indem Sie diese Browser -Seite aktualisieren. Das macht normalerweise den Trick.",
  ...
  RC_viewingBlindSpotRejected: {
    ...
    ar: "آسف ، كانت القياسات اليمنى واليسرى الأحدث غير متسقة. أيمكننا المحاولة مرة أخرى؟ الحفاظ على عين واحدة مغلقة. ركز على الشعر المتقاطع ومراقبة النقطة الوامضة من زاوية عينيك. حرك النقطة اليسرى واليمين حتى تختفي في Plindspot ، ثم ضرب العودة. حافظ على مسافة المشاهدة الخاصة بك وأنت تختبر كلتا العينين.",
  ...
  T_guessingGame: {
    ...
    hy: "Նամակների չափը եւ տառերի հեռավորությունը փոխվում են մեծ եւ թոքերի միջեւ `փոքրիկ եւ ծանր կամ անհնարին: Դուք չեք կարող շատ ավելին ստանալ, քան երկուսը, այնպես էլ հանգստացեք: Մտածեք դրա մասին, որպես կռահում եւ պարզապես հնարավորինս ստացեք: Դուք կլսեք ձայնային ազդանշան, երբ ճիշտ եք:",
  ...
  T_identifyClickIt: {
    ...
    ka: "გთხოვთ, დაადგინოთ შუა წერილი, ქვემოთ დააჭირეთ ქვემოთ.",
  ...
  T_middleLetterBrief: {
    ...
    te: "ఇది R. ఈ ప్రదర్శన స్థిరంగా ఉంది, కాబట్టి మీ కళ్ళను లేఖకు తరలించి గుర్తించడం సులభం. కానీ, నిజమైన విచారణలో, అక్షరాలు వెలిగిపోతాయి, కాబట్టి మీ కళ్ళను కదిలించడానికి సమయం లేదు. మీరు క్లిక్ చేస్తున్నప్పుడు క్రాస్ వెంట్రుకలను చూడటం చాలా ముఖ్యం. అక్షరాలు వెంటనే ఫ్లాష్ అవుతాయి. ఫ్లాష్ తర్వాత మీ కళ్ళు ఎక్కడికి వెళ్తాడనేది పట్టింపు లేదు. పరీక్ష యొక్క మొదటి బ్లాక్ మేము ఆసక్తిగా ప్రారంభించడానికి ముందు, కొన్ని ప్రయత్నాలు సాధన.",
    ...
    bn: "এটি একটি আর। এই প্রদর্শনটি স্থির, সুতরাং আপনার চোখটি চিঠির দিকে নিয়ে যাওয়া এবং এটি সনাক্ত করা সহজ হবে। তবে, সত্যিকারের পরীক্ষায়, চিঠিগুলি ঝলকানো হয়, তাই আপনার চোখ সরানোর কোনও সময় নেই। আপনি এটি ক্লিক করার সাথে সাথে ক্রস চুলগুলি দেখতে গুরুত্বপূর্ণ। চিঠিগুলি তাত্ক্ষণিকভাবে ফ্ল্যাশ হবে। আপনার চোখ ফ্ল্যাশের পরে কোথায় যায় তা বিবেচ্য নয়। পরীক্ষার প্রথম ব্লকটি আমরা আন্তরিকভাবে শুরু করার আগে অনুশীলনের কয়েকটি পরীক্ষা।",
    ...
    ko: "이 디스플레이는 정적이므로 눈을 편지로 이동하여 식별하기가 쉽습니다. 그러나 실제 시험에서는 편지가 번쩍이므로 눈을 움직일 시간이 없습니다. 클릭 할 때 십자 머리카락을 보는 것이 중요합니다. 편지는 즉시 플래시됩니다. 플래시 후 눈이 어디로 가는지는 중요하지 않습니다. 테스트의 첫 번째 블록은 우리가 본격적으로 시작하기 전에 몇 가지 실무 시험입니다.",
  },
  T_middleLetterDemo: {
    "en-US":
    ...
    de: "Während Sie bei jedem Versuch die Kreuzhaare betrachten, blinkt ein Drilltelaus mit drei zufälligen Buchstaben in Ihrem Augenwinkel. Nur ein Blitz. Um die Aufgabe zu lernen, versuchen wir es zuerst mit einer statischen Anzeige. Versuchen Sie, den mittleren Buchstaben zu identifizieren, während Sie sich die Kreuzhaare unten ansehen, ohne Ihre Augen zu bewegen.",
    ...
    ro: "În fiecare test, în timp ce privești crucea, un trei -șlefuitori care rulează trei -ștergători vor clipi la colțul ochiului. Doar un bliț. Pentru a învăța sarcina, să încercăm mai întâi cu un ecran static. În timp ce privești părul crucii, apoi fără să -ți mișci ochii, încearcă să identifici litera centrală.",
    ...
    ka: "თითოეულ განსაცდელზე, სანამ ჯვრის თმას უყურებთ, სამი შემთხვევითი ასოების ტრიპლეტი თქვენს თვალის კუთხეში გაისვრის. უბრალოდ ფლეშ. დავალების შესასწავლად, პირველ რიგში, ვცადოთ სტატიკური ჩვენებით. სანამ ჯვრის თმას უყურებთ, ქვემოთ, თვალების გადაადგილების გარეშე, შეეცადეთ დაადგინოთ შუა ასო.",
    ...
    te: "ప్రతి ట్రయల్‌లో, మీరు క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, మూడు యాదృచ్ఛిక అక్షరాల త్రిపాది మీ కంటి మూలలో మెరుస్తుంది. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో దీన్ని ప్రయత్నిద్దాం. మీరు కళ్ళు కదిలించకుండా, క్రింద, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, మధ్య అక్షరాన్ని గుర్తించడానికి ప్రయత్నించండి.",
    ...
    ko: "각 시험에서 십자형 머리카락을 보면서 3 개의 임의의 문자가 눈의 모퉁이에서 번쩍입니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보는 동안 중간 문자를 식별하십시오.",
  },
  T_ok: {
    "en-US": "OK",
    de: "OK",
  ...
  T_rsvpReadingTask: {
    ...
    pl: "Zaraz rozpoczniesz blok prób xxx. Będziesz czytał historię, kilka słów na raz. Każda próba szybko pokaże ci o wartości zdania, jeden po drugim, a następnie poprosi o pamiętanie, jakie słowa przeczytasz.",
    ...
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. మీరు ఒక కథను, ఒకేసారి కొన్ని పదాలు రీడింగులు చేస్తారు. ప్రతి ట్రయల్ పదాల వాక్య-విలువ గురించి, ఒకదాని తరువాత ఒకటి తర్వాత మీకు త్వరగా చూపిస్తుంది, ఆపై మీరు ఏ పదాలు చదివారో గుర్తుంచుకోవాలని మిమ్మల్ని అడగండి.",
  ...
  T_readyClickCrosshair: {
    ...
    bn: "একটি চিঠি সনাক্ত করতে প্রস্তুত? ক্রস হেয়ারগুলির কেন্দ্রে ক্লিক করুন।",
  ...
  T_sentenceIdentifyClick: {
    ...
    ar: "يتم عرض جميع الجمل الممكنة. الرجاء النقر فوق الشخص الذي سمعته ، أو أفضل تخمين لك.",
    ...
    te: "సాధ్యమయ్యే అన్ని వాక్యాలు చూపించబడ్డాయి. దయచేసి మీరు విన్నదాన్ని క్లిక్ చేయండి లేదా మీ ఉత్తమ అంచనా.",
    kn: "ಸಾಧ್ಯವಿರುವ ಎಲ್ಲಾ ವಾಕ್ಯಗಳನ್ನು ತೋರಿಸಲಾಗಿದೆ. ದಯವಿಟ್ಟು ನೀವು ಕೇಳಿದ ಒಂದು ಅಥವಾ ನಿಮ್ಮ ಉತ್ತಮ .ಹೆಯನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ.",
    bn: "সমস্ত সম্ভাব্য বাক্য দেখানো হয়। আপনি যে শুনেছেন তা দয়া করে ক্লিক করুন বা আপনার সেরা অনুমান করুন।",
    ...
    ko: "가능한 모든 문장이 표시됩니다. 듣는 것을 클릭하거나 최선의 추측을 클릭하십시오.",
  },
  T_sentenceProcedure: {
    "en-US":
    ...
    ko: "각 시험에서는 일반적으로 소음으로 문장이 들립니다. 그런 다음 가능한 모든 문장 목록이 표시되며, 듣는 문장을 클릭하거나 최선의 추측을 클릭합니다.",
  },
  T_session: {
    "en-US": "",
    de: "",

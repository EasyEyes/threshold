...
export const phrases = {
  ...
  RC_gazeTrackingNudge: {
    ...
    ru: "Поймай крест! Мы нуждаемся в твоей помощи. Глаза требует больше тренировок. Как показано стрелкой, когда вы нажимаете, трекер думал, что ваш взгляд был далеко от кросс -волос. Пожалуйста, нажмите на кросс -волоски в каждой новой позиции. Это игра. Поймай крест!",
  ...
  RC_nearPointIntro: {
    ...
    ja: "目の間の距離を測定します。ビデオ画像を使用して目を見る。目の前で顔に水平にペンを保持します。右と左の親指の爪を右と左の生徒の中心に合わせます。次に、画面上の支配者にペンを持ってきて、親指の分離を測定します。左手の親指をゼロで割り当て、右親指がどこにあるかに注意してください。ペンを置いて、その時点で定規をクリックします。最後に、[OK]をクリックして続行します。",
  ...
  RC_privacyIphoneMicrophone: {
    ...
    ta: 'மைக்ரோஃபோன் தனியுரிமையின் உறுதி. உங்கள் டெஸ்க்டாப்பின் உள்ளமைக்கப்பட்ட மைக்ரோஃபோனைக் காட்டிலும் ஈஸிஇஸ் உங்கள் ஐபோன்/ஐபாட் மைக்ரோஃபோனைப் பயன்படுத்துகிறது, ஏனெனில் ஐபோன்/ஐபாட் மைக்ரோஃபோன் உற்பத்தியாளர்-அளவீடு செய்யப்படுகிறது. மைக்ரோஃபோன் பதிவுசெய்கிறது, டெஸ்க்டாப் கம்ப்யூட்டர் ஒலிபெருக்கி மூலம் உரத்த ஒலி இயங்குகிறது, மேலும் டெஸ்க்டாப் கம்ப்யூட்டர் இரண்டும் "அமைதியாக தயவுசெய்து! இப்போது பதிவுசெய்கின்றன" என்று முக்கியமாகக் காட்டுகிறது. ஒலிபெருக்கி பண்புகளை மதிப்பிடுவதற்கு மட்டுமே பதிவு பயன்படுத்தப்படுகிறது, பின்னர் 30 வினாடிகளுக்குள் அழிக்கப்படுகிறது. ஒலிபெருக்கி பண்புகள் மட்டுமே தக்கவைக்கப்படுகின்றன.',
  ...
  RC_viewingBlindSpotRejected: {
    ...
    fr: "Désolé, les mesures les plus récentes gauche et droite étaient incohérentes. Pouvons-nous réessayer? Gardez un œil fermé. Concentrez-vous sur les poils et surveillez le point clignotant du coin de votre œil. Faites glisser le point à gauche et à droite jusqu'à ce qu'il disparaisse dans votre point mort, puis appuyez sur Return. Maintenez votre distance de visualisation lorsque vous testez les deux yeux.",
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    ru: "ОБЪЯСНЕНИЕ. Для этого шага, при необходимости приходите ближе, так что вы не дальше, чем вдвое больше ширины экрана. У каждого глаз есть слепое место. Мы найдем ваш, чтобы узнать, как далеко ваш взгляд от экрана. Вас попросят закрыть или прикрыть один глаз, чтобы изолировать другой. Пока вы сосредотачиваетесь на кросс -волосах, наблюдайте за мерцающей точкой из -за угла глаза и ударяйте возвращение, когда он исчезает в вашей слепой точке. В зависимости от расстояния просмотра и размера экрана, мерцающая точка обычно достигает вашей слепой точки, прежде чем добраться до середины экрана. Вы делаете это с каждым глазом, чередующиеся, пока последние два измерения не станут последовательными. Пожалуйста, сохраните свое просмотр, когда вы тестируете оба глаза. ПРИМЕЧАНИЕ. Если точка никогда не исчезает, это означает, что ваш глаз следует точке, вместо того, чтобы оставаться на кросс -волосках. Этот тест нуждается в том, чтобы вы следили за кросс -волосами, следив за мерцающей точкой в ​​углу глаза. Сначала это сложно, но с практикой становится легче.",
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو سیکھنے کے ل let ، آئیے مستحکم کارکردگی کے ساتھ پہلے اسے آزمائیں۔ نیچے کے بالوں کو دیکھتے ہوئے ، آنکھیں ہلاتے ہوئے درمیانی کاغذ کی شناخت کرنے کی کوشش کریں۔",
  ...
  T_letterBrief: {
    ...
    ja: "RはRです。このディスプレイは静的なので、目を文字に移動して識別するのは簡単です。しかし、実際の裁判では、手紙が点滅するので、目を動かす時間はありません。試練を開始するときに、十字毛を見ることが重要です。手紙はすぐに点滅します。フラッシュの後に目がどこに行くかは関係ありません。テストの最初のブロックは、本格的に始める前の実践試験のほんの一部です。",
    ko: "이 디스플레이는 정적이므로 눈을 편지로 이동하여 식별하기가 쉽습니다. 그러나 실제 시험에서는 편지가 번쩍이므로 눈을 움직일 시간이 없습니다. 시험을 시작할 때 십자 머리카락을 보는 것이 중요합니다. 편지는 즉시 플래시됩니다. 플래시 후 눈이 어디로 가는지는 중요하지 않습니다. 테스트의 첫 번째 블록은 우리가 본격적으로 시작하기 전에 몇 가지 실무 시험입니다.",
  },
  T_letterDemo: {
    "en-US":
  ...
  T_readyTrackCrosshair: {
    "en-US":
      "Ready? Track the center of the cross hairs until the letter(s) appear.",
    ...
    pl: "Gotowy? Śledź środek włosów krzyżowych, aż pojawią się litera.",
    ...
    bn: "প্রস্তুত? চিঠিটি (গুলি) উপস্থিত না হওয়া পর্যন্ত ক্রস হেয়ারগুলির কেন্দ্রটি ট্র্যাক করুন।",
  ...
  T_sentenceIdentifyClick: {
    ...
    de: "Die folgenden Listen zeigen alle Möglichkeiten für jedes Wort im Satz an. Melden Sie den Satz oder Ihre beste Vermutung, indem Sie auf die Wörter klicken, die Sie gehört haben.",
    ...
    it: "Gli elenchi seguenti mostrano tutte le possibilità per ogni parola nella frase. Segnala la frase o la tua migliore ipotesi, facendo clic sulle parole che hai sentito.",
  ...
  T_sentenceProcedure: {
    ...
    it: "Ad ogni prova, sentirai una frase, di solito con rumore. Quindi vedrai un elenco di tutte le possibilità per ogni parola nella frase. Segnala la frase o la tua migliore ipotesi, facendo clic sulle parole che hai sentito.",
  ...
  T_soundPhraseBlock: {
    ...
    ko: "각 시험에서 문장을 듣고 두 단어를 기억하도록 요청받을 것입니다. 소리가 왜곡되어 인식하기 어려울 수 있으므로 올바르게 얻을 수는 없습니다. 괜찮아요. 게임으로 대우하고 최선을 다하십시오. 행운을 빌어요. 반품을 누르거나 계속 진행하십시오.\n\n진행 버튼은 즉시 사라지고 사운드가로드되면 실험이 시작되며 인터넷 연결 속도에 따라 40 초 이상이 걸립니다. 우리는 향후 릴리스 에서이 지연을 단축하기 위해 노력하고 있습니다.\n\n소리로드 ...",
  },
  ...
  T_thresholdMiddleLetterBeginBlock: {
    ...
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر مقدمے میں تین خطوط کا ایک ٹرپلٹ نظر آئے گا ، مثال کے طور پر: Z R N. براہ کرم صرف درمیانی خط کی اطلاع دیں ،",

...
export const phrases = {
  ...
  T_identifyMiddleLetterPressItOrClickIt: {
    ...
    it: "Identifica la lettera centrale facendo clic di seguito o premendola nella tastiera/tastiera.",
  ...
  T_keypadScanQRCode: {
    ...
    de: "Bei langen Entfernungen verwenden Sie Ihr Telefon als Tastatur. Verbinden Sie es jetzt für die Verwendung später. Zeigen Sie Ihre Smartphone -Kamera auf diesen QR -Code. Klicken Sie dann mit Ihrem Finger auf den Link, der auf Ihrem Smartphone -Bildschirm angezeigt wird.",
    fr: "Sur de longues distances, vous utiliserez votre téléphone comme clavier. Connectez-le maintenant pour une utilisation plus tard. Pointez votre appareil photo pour smartphone sur ce code QR. Utilisez ensuite votre doigt pour cliquer sur le lien qui apparaît sur l'écran de votre smartphone.",
    es: "A largas distancias, usará su teléfono como teclado. Conéctelo ahora para su uso más tarde. Apunte la cámara de su teléfono inteligente en este código QR. Luego use su dedo para hacer clic en el enlace que aparece en la pantalla de su teléfono inteligente.",
    pt: "A longas distâncias, você usará seu telefone como teclado. Conecte -o agora para uso mais tarde. Aponte sua câmera de smartphone para este código QR. Em seguida, use o dedo para clicar no link que aparece na tela do smartphone.",
    it: "A lunghe distanze, utilizzerai il telefono come tastiera. Collegalo ora per l'uso più tardi. Punta la fotocamera per smartphone su questo codice QR. Quindi usa il dito per fare clic sul collegamento che appare sullo schermo dello smartphone.",
    ro: "La distanțe lungi, veți folosi telefonul ca tastatură. Conectați -l acum pentru utilizare mai târziu. Indicați camera smartphone -ului către acest cod QR. Apoi folosiți degetul pentru a face clic pe linkul care apare pe ecranul smartphone -ului.",
    pl: "Na duże odległości użyjesz swojego telefonu jako klawiatury. Podłącz go teraz, aby użyć później. Skieruj aparat smartfona na ten kod QR. Następnie użyj palca, aby kliknąć link, który pojawi się na ekranie smartfona.",
    ru: "На больших расстояниях вы используете свой телефон в качестве клавиатуры. Подключите его сейчас для использования позже. Укажите камеру смартфона на этом QR -коде. Затем используйте свой палец, чтобы нажать на ссылку, которая появляется на экране вашего смартфона.",
    hy: "Երկար հեռավորության վրա դուք կօգտագործեք ձեր հեռախոսը որպես ստեղնաշար: Միացրեք այն այժմ `ավելի ուշ օգտագործման համար: Նշեք ձեր սմարթֆոնների ֆոտոխցիկը QR այս կոդով: Այնուհետեւ օգտագործեք ձեր մատը `կտտացնելու հղումը, որը հայտնվում է ձեր սմարթֆոնի էկրանին:",
    fi: "Pitkillä etäisyyksillä käytät puhelinta näppäimistönä. Kytke se nyt käytettäväksi myöhemmin. Osoita älypuhelinkamera tässä QR -koodissa. Napsauta sitten sormella älypuhelimen näytöllä näkyvää linkkiä.",
    ka: "დიდ დისტანციებზე, თქვენ გამოიყენებთ თქვენს ტელეფონს, როგორც კლავიატურას. დააკავშირეთ ახლა მოგვიანებით გამოსაყენებლად. მიუთითეთ თქვენი სმარტფონის კამერა ამ QR კოდზე. შემდეგ გამოიყენეთ თითი, რომ დააჭირეთ ბმულს, რომელიც გამოჩნდება თქვენს სმარტფონის ეკრანზე.",
    he: "במרחקים ארוכים, תשתמש בטלפון שלך כלפד מקשים. חבר אותו כעת לשימוש מאוחר יותר. כוון את מצלמת הסמארטפון שלך בקוד QR זה. לאחר מכן השתמש באצבע שלך כדי ללחוץ על הקישור שמופיע במסך הסמארטפון שלך.",
    ar: "على مسافات طويلة ، ستستخدم هاتفك كطريقة مفاتيح. قم بتوصيله الآن للاستخدام لاحقًا. أشر كاميرا الهاتف الذكي على رمز الاستجابة السريعة هذا. ثم استخدم إصبعك للنقر على الرابط الذي يظهر على شاشة هاتفك الذكي.",
    ur: "طویل فاصلے پر ، آپ اپنے فون کو بطور کیپیڈ استعمال کریں گے۔ بعد میں استعمال کے لئے ابھی اسے مربوط کریں۔ اس QR کوڈ پر اپنے اسمارٹ فون کیمرا کی نشاندہی کریں۔ اس کے بعد آپ کے اسمارٹ فون اسکرین پر ظاہر ہونے والے لنک پر کلک کرنے کے لئے اپنی انگلی کا استعمال کریں۔",
    hi: "लंबी दूरी पर, आप अपने फोन को कीपैड के रूप में उपयोग करेंगे। बाद में उपयोग के लिए अब इसे कनेक्ट करें। इस QR कोड पर अपना स्मार्टफोन कैमरा इंगित करें। फिर अपने स्मार्टफोन स्क्रीन पर दिखाई देने वाले लिंक पर क्लिक करने के लिए अपनी उंगली का उपयोग करें।",
    ta: "நீண்ட தூரத்தில், உங்கள் தொலைபேசியை ஒரு விசைப்பலகையாகப் பயன்படுத்துவீர்கள். பின்னர் பயன்படுத்த இப்போது அதை இணைக்கவும். இந்த QR குறியீட்டில் உங்கள் ஸ்மார்ட்போன் கேமராவை சுட்டிக்காட்டவும். உங்கள் ஸ்மார்ட்போன் திரையில் தோன்றும் இணைப்பைக் கிளிக் செய்ய உங்கள் விரலைப் பயன்படுத்தவும்.",
    ml: "വളരെ ദൂരം, നിങ്ങൾ നിങ്ങളുടെ ഫോൺ ഒരു കീപാഡായി ഉപയോഗിക്കും. ഇത് പിന്നീട് ഉപയോഗിക്കുന്നതിന് ഇപ്പോൾ ബന്ധിപ്പിക്കുക. ഈ QR കോഡിൽ നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ ക്യാമറ പോയിന്റുചെയ്യുക. നിങ്ങളുടെ സ്മാർട്ട്ഫോൺ സ്ക്രീനിൽ ദൃശ്യമാകുന്ന ലിങ്കിൽ ക്ലിക്കുചെയ്യുന്നതിന് നിങ്ങളുടെ വിരൽ ഉപയോഗിക്കുക.",
    te: "చాలా దూరం వద్ద, మీరు మీ ఫోన్‌ను కీప్యాడ్‌గా ఉపయోగిస్తారు. తరువాత ఉపయోగం కోసం ఇప్పుడే కనెక్ట్ చేయండి. ఈ QR కోడ్ వద్ద మీ స్మార్ట్‌ఫోన్ కెమెరాను సూచించండి. మీ స్మార్ట్‌ఫోన్ స్క్రీన్‌లో కనిపించే లింక్‌ను క్లిక్ చేయడానికి మీ వేలిని ఉపయోగించండి.",
    kn: "ದೂರದವರೆಗೆ, ನೀವು ನಿಮ್ಮ ಫೋನ್ ಅನ್ನು ಕೀಪ್ಯಾಡ್ ಆಗಿ ಬಳಸುತ್ತೀರಿ. ನಂತರ ಬಳಸಲು ಈಗ ಅದನ್ನು ಸಂಪರ್ಕಿಸಿ. ಈ ಕ್ಯೂಆರ್ ಕೋಡ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಕ್ಯಾಮೆರಾವನ್ನು ಸೂಚಿಸಿ. ನಿಮ್ಮ ಸ್ಮಾರ್ಟ್‌ಫೋನ್ ಪರದೆಯಲ್ಲಿ ಗೋಚರಿಸುವ ಲಿಂಕ್ ಅನ್ನು ಕ್ಲಿಕ್ ಮಾಡಲು ನಿಮ್ಮ ಬೆರಳನ್ನು ಬಳಸಿ.",
    bn: "দীর্ঘ দূরত্বে, আপনি আপনার ফোনটি কীপ্যাড হিসাবে ব্যবহার করবেন। পরে এটি ব্যবহারের জন্য এখনই সংযুক্ত করুন। এই কিউআর কোডটিতে আপনার স্মার্টফোন ক্যামেরাটি নির্দেশ করুন। তারপরে আপনার স্মার্টফোনের স্ক্রিনে প্রদর্শিত লিঙ্কটি ক্লিক করতে আপনার আঙুলটি ব্যবহার করুন।",
    id: "Di jarak jauh, Anda akan menggunakan ponsel Anda sebagai keypad. Hubungkan sekarang untuk digunakan nanti. Arahkan kamera ponsel cerdas Anda ke kode QR ini. Kemudian gunakan jari Anda untuk mengklik tautan yang muncul di layar ponsel cerdas Anda.",
    "zh-CN":
      "长距离，您将使用手机作为键盘。立即连接以供以后使用。将您的智能手机相机指向此QR码。然后用手指单击智能手机屏幕上出现的链接。",
    "zh-HK":
      "長距離，您將使用手機作為鍵盤。立即連接以供以後使用。將您的智能手機相機指向此QR碼。然後用手指單擊智能手機屏幕上出現的鏈接。",
    ja: "長距離では、携帯電話をキーパッドとして使用します。後で使用するために今すぐ接続してください。このQRコードでスマートフォンカメラをポイントします。次に、指を使用して、スマートフォン画面に表示されるリンクをクリックします。",
    ko: "장거리에서는 휴대 전화를 키패드로 사용합니다. 나중에 사용하기 위해 지금 연결하십시오. 이 QR 코드에서 스마트 폰 카메라를 가리 키십시오. 그런 다음 손가락을 사용하여 스마트 폰 화면에 나타나는 링크를 클릭하십시오.",
  },
  ...
  T_thresholdLetterBeginBlock: {
    ...
    ka: "თქვენ დაიწყებთ xxx ტესტების ბლოკს. თითოეულ სასამართლო პროცესს წარუდგენს წერილს. გთხოვთ, შეატყობინოთ მას,",

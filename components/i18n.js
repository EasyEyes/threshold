...
export const phrases = {
  ...
  RC_distanceTrackingCloseL: {
    ...
    ru: "1. Закройте левый глаз. (Это левая сторона экрана.)\n2. Используйте ▶ Ключ стрелка, чтобы скользить мерцающую точку. (Или просто перетащите его, если он не отвечает на ключ стрелы.), Глядя на кросс -волоски, следите за мерцающей точкой в ​​углу глаз и скользите влево и направо, пока он не исчезнет в вашем слепой точке.\n3. Нажмите на возврат.\nПримечание: следите за кросс -волосами. Мерцающая точка не исчезнет, ​​пока ваш глаз следует за ней.",

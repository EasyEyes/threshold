...
export const phrases = {
  ...
  EE_ID_noLocalStorage: {
    ...
    de: "Die Forscheranfragen wenden Sie sich an Ihre Easyeyes -ID aus der vorherigen Sitzung, bitte geben Sie sie hier ein oder laden Sie die Datei hoch, die beim Ende der letzten Sitzung heruntergeladen wurde.",
  ...
  RC_citeSoundCompressionModel: {
    ...
    de: 'Basierend auf Gl. 4 von Giannoulis et al. (2012). <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergriss-dynamicrangeCompression-jaes2012.pdf"> Digital Dynamic Range Compressor-Design. </a> J. Audio Eng. SOC. 6 (6): 399-408.',
  ...
  "❌T_identifyClickIt": {
    "en-US": "REPLACE T_identifyClickIt BY T_identifyMiddleLetterClickIt",
    de: "Bitte identifizieren Sie den mittleren Buchstaben, indem Sie unten darauf klicken.",
    fr: "Remplacer T_IdentifyClickit par T_IdentifymiddleletterClickit",
    es: "Identifica la letra del medio haciendo clic en ella abajo.",
    pt: "Substitua T_IdentifyClickit por T_IdentifyMidDleLetterClickit",
    ...
    fi: "Korvaa T_IdentifyClickit by t_identifyMiddlotterClickit",
    ka: "შეცვალეთ t_identifyClickit by t_identifymiddleletterClickit",
    ...
    ta: "T_identifyclickit ஐ t_identifymiddleletterclickit ஆல் மாற்றவும்",
    ml: "T_indipipdmidleetterttertickity to മാറ്റിസ്ഥാപിക്കുക",
    te: "T_identifyClickit ను t_identifimidleletterclickit ద్వారా మార్చండి",
    kn: "T_IDENTIFYMIDLELETETTERCLICKIT ಅವರಿಂದ T_IDENTIFYCLICKIT ಅನ್ನು ಬದಲಾಯಿಸಿ",
    bn: "T_identifyclickit প্রতিস্থাপন করুন t_identifidleteterclickit দ্বারা",
    id: "Ganti T_IdentifyClickit oleh T_IdentifyMidDleletterClickit",
    "zh-CN": "请点击下方的字母来报告您认出的中间字母。",
    "zh-HK": "請點擊下方的字母來報告您認出的中間字母。",
    ja: "下をクリックして、認識した真ん中の文字を報告してください。",
    ko: "t_identifyclickit으로 t_identifymiddleletterclickit을 교체하십시오",
  },
  ...
  T_identifyMiddleLetterPressIt: {
    "en-US":
      "To continue, click PROCEED or hit RETURN on your keyboard/keypad.",
    de: "Um fortzufahren, klicken Sie auf fortfahren oder klicken Sie auf Ihre Tastatur/Tastatur zurück.",
    fr: "Pour continuer, cliquez sur Procéder ou appuyez sur Retour sur votre clavier / clavier.",
    es: "Para continuar, haga clic en continuar o presione la devolución en su teclado/teclado.",
    pt: "Para continuar, clique em prosseguir ou pressionar o retorno no teclado/teclado.",
    it: "Per continuare, fare clic su Procedi o premi restituzione sulla tastiera/tastiera.",
    ro: "Pentru a continua, faceți clic pe continuați sau apăsați returnarea pe tastatură/tastatură.",
    pl: "Aby kontynuować, kliknij, kontynuuj lub naciśnij Zwróć na klawiaturę/klawiaturę.",
    ru: "Чтобы продолжить, нажмите «Продолжить» или нажмите «Возврат» на клавиатуре/клавиатуре.",
    hy: "Շարունակելու համար կտտացրեք ձեր ստեղնաշարի / ստեղնաշարի վերադարձը:",
    fi: "Jatka jatka napsauttamalla tai napsauttamalla näppäimistön/näppäimistön palauttamista.",
    ka: "გასაგრძელებლად, დააჭირეთ ღილაკს გაგრძელება ან დააჭირეთ თქვენს კლავიატურას/კლავიატურას.",
    he: "להמשך, לחץ על המשך או לחץ על החזרה על המקלדת/לוח המקשים שלך.",
    ar: "للمتابعة ، انقر فوق متابعة أو ضرب الإرجاع على لوحة المفاتيح/لوحة المفاتيح.",
    ur: "جاری رکھنے کے لئے ، آگے بڑھنے پر کلک کریں یا اپنے کی بورڈ/کیپیڈ پر ریٹرن کو دبائیں۔",
    hi: "जारी रखने के लिए, अपने कीबोर्ड/कीपैड पर आगे बढ़ने या हिट रिटर्न पर क्लिक करें।",
    ta: "தொடர, உங்கள் விசைப்பலகை/விசைப்பலகையில் திரும்புவதைத் தொடரவும் அல்லது அழுத்தவும்.",
    ml: "തുടരാൻ, നിങ്ങളുടെ കീബോർഡ് / കീപാഡിൽ തുടരുക ക്ലിക്കുചെയ്യുക അല്ലെങ്കിൽ അമർത്തുക.",
    te: "కొనసాగించడానికి, మీ కీబోర్డ్/కీప్యాడ్‌లో కొనసాగండి లేదా రిటర్న్ నొక్కండి.",
    kn: "ಮುಂದುವರಿಸಲು, ನಿಮ್ಮ ಕೀಬೋರ್ಡ್/ಕೀಪ್ಯಾಡ್‌ನಲ್ಲಿ ಮುಂದುವರಿಯಿರಿ ಅಥವಾ ಹಿಟ್ ರಿಟರ್ನ್ ಕ್ಲಿಕ್ ಮಾಡಿ.",
    bn: "চালিয়ে যেতে, আপনার কীবোর্ড/কীপ্যাডে এগিয়ে যাওয়া বা হিট হিট ক্লিক করুন।",
    id: "Untuk melanjutkan, klik lanjutkan atau tekan kembali pada keyboard/keypad Anda.",
    "zh-CN": "要继续，请单击“继续或击中键盘/键盘上的返回。",
    "zh-HK": "要繼續，請單擊“繼續或點擊鍵盤/鍵盤上的返回。",
    ja: "続行するには、キーボード/キーパッドの[続行]または[返される]をクリックします。",
    ko: "계속하려면 키보드/키패드에서 진행 또는 반환을 클릭하십시오.",
  },
  ...
  T_VernierDemo: {
    "en-US":
      "On each trial, while you look at the cross hairs, a pair of lines will FLASH somewhere. Maybe where you're looking; maybe in the corner of your eye. Just a flash. To learn the task, let’s try it first with a STATIC display. While looking at the cross hairs, below, without moving your eyes, try to identify whether the upper line is shifted left or right, relative to the lower line.",
    de: "Während Sie bei jedem Versuch die Kreuzhaare betrachten, blinken irgendwo zwei Linien. Vielleicht wo du siehst; Vielleicht im Augenwinkel. Nur ein Blitz. Um die Aufgabe zu lernen, versuchen wir es zuerst mit einer statischen Anzeige. Versuchen Sie beim Betrachten der Kreuzhaare unten, ohne Ihre Augen zu bewegen, festzustellen, ob die obere Linie relativ zur unteren Linie nach links oder rechts verschoben wird.",
    fr: "À chaque essai, pendant que vous regardez les poils, une paire de lignes clignotera quelque part. Peut-être où vous cherchez; Peut-être dans le coin de votre œil. Juste un flash. Pour apprendre la tâche, essayons d'abord avec un écran statique. Tout en regardant les poils, ci-dessous, sans bouger les yeux, essayez de déterminer si la ligne supérieure est décalée à gauche ou à droite, par rapport à la ligne inférieure.",
    es: "En cada prueba, mientras miras los pelos de la cruz, un par de líneas parpadearán en alguna parte. Tal vez donde estás mirando; Tal vez en la esquina de tu ojo. Solo un destello. Para aprender la tarea, intentémosla primero con una pantalla estática. Mientras mira los pelos de la cruz, a continuación, sin mover los ojos, trate de identificar si la línea superior se desplaza hacia la izquierda o hacia la derecha, en relación con la línea inferior.",
    pt: "Em cada teste, enquanto você olha para os cabelos cruzados, um par de linhas piscará em algum lugar. Talvez onde você esteja olhando; Talvez no canto do seu olho. Apenas um instante. Para aprender a tarefa, vamos tentar primeiro com uma tela estática. Enquanto olha os cabelos cruzados, abaixo, sem mover os olhos, tente identificar se a linha superior é deslocada para a esquerda ou direita, em relação à linha inferior.",
    it: "Ad ogni prova, mentre guardi i capelli incrociati, un paio di linee lampeggerà da qualche parte. Forse dove stai guardando; Forse nell'angolo dell'occhio. Solo un lampo. Per imparare l'attività, proviamo prima con un display statico. Mentre guardi i peli incrociati, sotto, senza muovere gli occhi, prova a identificare se la linea superiore è spostata a sinistra o a destra, rispetto alla linea inferiore.",
    ro: "La fiecare încercare, în timp ce te uiți la părul încrucișat, o pereche de linii se va clipi undeva. Poate unde te uiți; Poate în colțul ochiului tău. Doar un bliț. Pentru a învăța sarcina, să o încercăm mai întâi cu un afișaj static. În timp ce privești părul încrucișat, mai jos, fără a -ți mișca ochii, încearcă să identifici dacă linia superioară este deplasată la stânga sau la dreapta, în raport cu linia inferioară.",
    pl: "Podczas każdej próby, patrząc na włosy krzyżowe, para linii gdzieś błysnę. Może gdzie szukasz; Może w rogu oka. Tylko błysk. Aby nauczyć się tego zadania, spróbujmy najpierw z wyświetlaczem statycznym. Patrząc na włosy krzyżowe, poniżej, nie poruszając oczami, spróbuj określić, czy górna linia jest przesunięta w lewo czy w prawo, w stosunku do dolnej linii.",
    ru: "На каждом испытании, пока вы смотрите на кросс -волосы, где -то будет мигает пара линий. Может, где вы ищете; Может быть, в углу глаза. Просто вспышка. Чтобы узнать задачу, давайте сначала попробуем ее со статическим дисплеем. Глядя на кросс -волосы, внизу, не двигая глазами, попробуйте определить, сместится ли верхняя линия влево или вправо, по сравнению с нижней линией.",
    hy: "Յուրաքանչյուր փորձության ընթացքում, մինչ դուք նայում եք խաչի մազերին, մի զույգ տող կփչանա ինչ-որ տեղ: Միգուցե որտեղ եք փնտրում; Միգուցե ձեր աչքի անկյունում: Պարզապես ֆլեշ: Առաջադրանքը սովորելու համար, եկեք նախ փորձենք ստատիկ էկրանով: Խաչի մազերը նայելով, ներքեւում, առանց ձեր աչքերը տեղափոխելու, փորձեք պարզել, թե վերին գիծը տեղափոխվում է ձախ կամ աջ, համեմատած ստորին գծի համեմատ:",
    fi: "Jokaisessa kokeilussa katsot ristikarvoja, pari linjaa vilkkuu jossain. Ehkä missä etsit; Ehkä silmäsi nurkassa. Vain salama. Kokeilemme sitä ensin staattisella näytöllä. Kun tarkastellaan ristikarvoja alla, liikuttamatta silmiäsi, yritä tunnistaa, siirretäänkö yläviiva vasemmalle vai oikealle, verrattuna alaviivaan.",
    ka: "თითოეულ განსაცდელზე, სანამ ჯვრის თმას უყურებთ, წყვილი ხაზები სადმე გაისვრის. იქნებ სადაც ეძებთ; შეიძლება თვალის კუთხეში. უბრალოდ ფლეშ. დავალების შესასწავლად, პირველ რიგში, ვცადოთ სტატიკური ჩვენებით. ჯვრის თმას გადახედვისას, ქვემოთ, თვალების გადაადგილების გარეშე, შეეცადეთ დაადგინოთ, არის თუ არა ზედა ხაზი მარცხნივ ან მარჯვნივ, ქვედა ხაზთან შედარებით.",
    he: "בכל ניסוי, בזמן שאתה מסתכל על שערות הצלב, זוג קווים יבהב איפשהו. אולי איפה שאתה מחפש; אולי בזווית העין שלך. רק פלאש. כדי ללמוד את המשימה, בואו ננסה אותה תחילה עם תצוגה סטטית. תוך כדי התבוננות בשערות הצלב, למטה, מבלי להזיז את העיניים, נסו לזהות אם הקו העליון מועבר שמאלה או ימינה, יחסית לקו התחתון.",
    ar: "في كل تجربة ، بينما تنظر إلى الشعر المتقاطع ، سوف يومض زوج من الخطوط في مكان ما. ربما أين تبحث. ربما في زاوية عينيك. مجرد ومضة. لمعرفة المهمة ، دعنا نجربها أولاً بعرض ثابت. أثناء النظر إلى الشعر المتقاطع ، أدناه ، دون تحريك عينيك ، حاول تحديد ما إذا كان الخط العلوي قد تم تحويله إلى اليسار أو اليمين ، بالنسبة للخط السفلي.",
    ur: "ہر آزمائش پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، لائنوں کا ایک جوڑا کہیں چمک اٹھے گا۔ شاید جہاں آپ دیکھ رہے ہو ؛ شاید آپ کی آنکھ کے کونے میں۔ صرف ایک فلیش۔ کام کو سیکھنے کے ل let ، آئیے پہلے جامد ڈسپلے کے ساتھ اسے آزمائیں۔ کراس بالوں کو دیکھتے ہوئے ، نیچے ، اپنی آنکھیں منتقل کیے بغیر ، یہ شناخت کرنے کی کوشش کریں کہ اوپری لائن کو بائیں یا دائیں منتقل کیا گیا ہے ، نچلی لائن کے نسبت۔",
    hi: "प्रत्येक परीक्षण पर, जब आप क्रॉस हेयर को देखते हैं, तो लाइनों की एक जोड़ी कहीं न कहीं चमकती है। शायद आप कहाँ देख रहे हैं; शायद आपकी आंख के कोने में। बस एक झलक। कार्य को जानने के लिए, इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। क्रॉस हेयर को देखते हुए, नीचे, अपनी आंखों को हिलाने के बिना, यह पहचानने की कोशिश करें कि ऊपरी रेखा को निचली रेखा के सापेक्ष बाएं या दाएं स्थानांतरित किया गया है या नहीं।",
    ta: "ஒவ்வொரு சோதனையிலும், நீங்கள் குறுக்கு முடிகளைப் பார்க்கும்போது, ​​ஒரு ஜோடி கோடுகள் எங்காவது ஒளிரும். ஒருவேளை நீங்கள் தேடும் இடத்தில்; உங்கள் கண்ணின் மூலையில் இருக்கலாம். ஒரு ஃபிளாஷ். பணியைக் கற்றுக்கொள்ள, நிலையான காட்சியுடன் முதலில் முயற்சிப்போம். குறுக்கு முடிகளைப் பார்க்கும்போது, ​​கீழே, உங்கள் கண்களை நகர்த்தாமல், கீழ் வரியுடன் ஒப்பிடும்போது, ​​மேல் கோடு இடது அல்லது வலதுபுறமாக மாற்றப்பட்டதா என்பதை அடையாளம் காண முயற்சிக்கவும்.",
    ml: "ഓരോ വിചാരണയിലും, നിങ്ങൾ ക്രോസ് ഹെയർ നോക്കുമ്പോൾ, ഒരു ജോടി വരികൾ എവിടെയെങ്കിലും മിന്നുമാകും. നിങ്ങൾ എവിടെയാണ് നോക്കുന്നത്? ഒരുപക്ഷേ നിങ്ങളുടെ കണ്ണിന്റെ മൂലയിൽ. ഒരു ഫ്ലാഷ് മാത്രം. ടാസ്ക് പഠിക്കാൻ, ഒരു സ്റ്റാറ്റിക് ഡിസ്പ്ലേ ഉപയോഗിച്ച് ആദ്യം ഇത് പരീക്ഷിക്കാം. നിങ്ങളുടെ കണ്ണുകൾ നീക്കാതെ, ചുവടെയുള്ള രോമങ്ങൾ നോക്കുമ്പോൾ, മുകളിലെ വരി ഇടത്തോട്ടോ വലത്തോട്ടോ മാറ്റുമോ എന്ന് ശ്രമിക്കുക, ലോവർ ലൈനുമായി താരതമ്യപ്പെടുത്തുമ്പോൾ.",
    te: "ప్రతి ట్రయల్‌లో, మీరు క్రాస్ హెయిర్‌లను చూస్తున్నప్పుడు, ఒక జత పంక్తులు ఎక్కడో మెరుస్తాయి. బహుశా మీరు ఎక్కడ చూస్తున్నారు; మీ కంటి మూలలో ఉండవచ్చు. కేవలం ఒక ఫ్లాష్. పనిని తెలుసుకోవడానికి, మొదట స్టాటిక్ డిస్ప్లేతో దీన్ని ప్రయత్నిద్దాం. దిగువ, మీ కళ్ళను కదిలించకుండా, దిగువ, క్రింద ఉన్న క్రాస్ హెయిర్స్ వైపు చూస్తున్నప్పుడు, దిగువ రేఖకు సంబంధించి, ఎగువ రేఖ ఎడమ లేదా కుడి వైపుకు మార్చబడిందో లేదో గుర్తించడానికి ప్రయత్నించండి.",
    kn: "ಪ್ರತಿ ಪ್ರಯೋಗದಲ್ಲೂ, ನೀವು ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವಾಗ, ಒಂದು ಜೋಡಿ ಸಾಲುಗಳು ಎಲ್ಲೋ ಮಿಂಚುತ್ತವೆ. ಬಹುಶಃ ನೀವು ಎಲ್ಲಿ ನೋಡುತ್ತಿದ್ದೀರಿ; ಬಹುಶಃ ನಿಮ್ಮ ಕಣ್ಣಿನ ಮೂಲೆಯಲ್ಲಿರಬಹುದು. ಕೇವಲ ಒಂದು ಫ್ಲ್ಯಾಷ್. ಕಾರ್ಯವನ್ನು ಕಲಿಯಲು, ಸ್ಥಿರ ಪ್ರದರ್ಶನದೊಂದಿಗೆ ಮೊದಲು ಇದನ್ನು ಪ್ರಯತ್ನಿಸೋಣ. ಅಡ್ಡ ಕೂದಲನ್ನು ನೋಡುವಾಗ, ಕೆಳಗೆ, ನಿಮ್ಮ ಕಣ್ಣುಗಳನ್ನು ಚಲಿಸದೆ, ಕೆಳಗಿನ ರೇಖೆಗೆ ಹೋಲಿಸಿದರೆ ಮೇಲಿನ ರೇಖೆಯನ್ನು ಎಡ ಅಥವಾ ಬಲಕ್ಕೆ ಸ್ಥಳಾಂತರಿಸಲಾಗಿದೆಯೆ ಎಂದು ಗುರುತಿಸಲು ಪ್ರಯತ್ನಿಸಿ.",
    bn: "প্রতিটি পরীক্ষায়, আপনি ক্রস চুলের দিকে তাকানোর সময়, এক জোড়া লাইন কোথাও ফ্ল্যাশ হয়ে যাবে। আপনি যেখানে খুঁজছেন সেখানে হতে পারে; আপনার চোখের কোণে হতে পারে। শুধু একটা ঝলকানি. টাস্কটি শিখতে, আসুন প্রথমে এটি একটি স্থির প্রদর্শন দিয়ে চেষ্টা করি। আপনার চোখ না সরিয়ে নীচে ক্রস কেশগুলি দেখার সময়, নীচের লাইনের তুলনায় উপরের রেখাটি বাম বা ডানদিকে স্থানান্তরিত হয়েছে কিনা তা সনাক্ত করার চেষ্টা করুন।",
    id: "Pada setiap percobaan, saat Anda melihat rambut silang, sepasang garis akan berkedip di suatu tempat. Mungkin tempat Anda mencari; Mungkin di sudut matamu. Hanya sekejap. Untuk mempelajari tugas ini, mari kita coba terlebih dahulu dengan tampilan statis. Saat melihat rambut silang, di bawah, tanpa menggerakkan mata, cobalah untuk mengidentifikasi apakah garis atas digeser ke kiri atau kanan, relatif ke garis bawah.",
    "zh-CN":
      "在每个试验中，当您看着十字头发时，一条线条将在某个地方闪烁。也许您正在寻找的地方；也许在你的眼角。只是一个闪光。要学习任务，让我们先尝试使用静态显示器。在看下方的十字头发时，没有移动眼睛，请尝试确定上线是相对于下线的左还是右移动。",
    "zh-HK":
      "在每個試驗中，當您看著十字頭髮時，一條線條將在某個地方閃爍。也許您正在尋找的地方；也許在你的眼角。只是一個閃光。要學習任務，讓我們先嘗試使用靜態顯示器。在看下方的十字頭髮時，沒有移動眼睛，請嘗試確定上線是相對於下線的左還是右移動。",
    ja: "各トライアルでは、交差毛を見ている間、一対の線がどこかに点滅します。たぶんあなたが探している場所。多分あなたの目の隅に。ちょっとしたフラッシュ。タスクを学ぶには、静的ディスプレイで最初に試してみましょう。下の目を動かすことなく、下の毛を見ながら、下の線が下の線に比べて左または右にシフトされているかどうかを特定してみてください。",
    ko: "각 시험에서 십자형 머리카락을 보면서 한 쌍의 선이 어딘가에 번쩍입니다. 어쩌면 당신이보고있는 곳; 어쩌면 당신의 눈의 구석에있을 수도 있습니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보면서 상단 선이 하단 라인에 비해 왼쪽 또는 오른쪽으로 이동되어 있는지 확인하십시오.",
  },
  T_middleLetterDemo: {
    "en-US":
  ...
  T_readyPressSpaceOrClickCrosshair: {
    ...
    ka: "მზად? ჯვრის თმას ცენტრის პირდაპირ დათვალიერებისას, გთხოვთ, დააჭირეთ მას, ან დააჭირეთ კოსმოსურ ზოლს.",
    he: "מוּכָן? תוך התבוננות ישירה על הכוונת, לחץ על מקש הרווח או לחץ על הכוונת.",
    ar: "مستعد؟ أثناء النظر مباشرة إلى علامة التقاطع ، يرجى الضغط على زر المسافة أو الضغط على علامة التقاطع.",
    ur: "تیار؟ براہ راست کراس ہیر کو دیکھ کر ، براہ کرم اسپیس بار دبائیں یا کراس ہیر پر کلک کریں۔",
    hi: "तैयार? सीधे क्रॉसहेयर को देखते हुए, कृपया SPACE बार दबाएं या क्रॉसहेयर पर क्लिक करें।",
  ...
  T_thresholdVenierBeginBlock: {
    ...
    ka: "თქვენ დაიწყებთ xxx ტესტების ბლოკს. თითოეული სასამართლო პროცესი წარმოგიდგენთ ახალ წყვილს. გთხოვთ, შეატყობინოთ თუ არა ზედა ხაზი მარცხნივ ან მარჯვნივ,",

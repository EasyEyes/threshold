...
export const phrases = {
  ...
  EE_compatibleNotBrowserNotOSDeviceCores: {
    ...
    te: "దాని వర్ణనలో చెప్పినట్లుగా, ఈ అధ్యయనం BBB బ్రౌజర్ (ల) కు విరుద్ధంగా లేదు మరియు OOO కి కూడా విరుద్ధంగా లేదు. దీనికి కనీసం 222 సిపియు కోర్లతో డిడిడి అవసరం",
  ...
  EE_ID: {
    ...
    "zh-HK":
      "需要一個唯一的ID來鏈接跨會話的數據。這台計算機先前參加了有關** ddd **的會話，並帶有EasyEyes ID“ ** sss **”。如果是你，請按確定。否則，如果您有EasyEyes ID文件，請按下面的文件選擇按鈕打開它。 （該文件名以“ EasyEyes”開頭，以“ .txt”結尾，通常在您的下載文件夾中。）如果您沒有文件，但是知道您的EasyEyes ID，請輸入它。否則，只需構成自己的ID，即至少有5個字符的字符串長。如果您願意，可以是您的名字。我們會在這台計算機上為您記住它，但是如果您轉到另一台計算機，請獲取EasyEyes ID文件（您的下載文件夾中的最新文件），或者至少寫下您的EasyEyes ID。每次使用它將您的數據從會話鏈接到會話。",
  ...
  RC_findModelMacOs: {
    ...
    pl: "Naciskając klawisz opcji, przejdź do menu Apple 🍏> Informacje o systemie. Z przeglądu sprzętu skopiuj nazwę modelu i identyfikator modelu do odpowiednich pól poniżej.",
    ...
    ka: "ვარიანტის ღილაკზე დაჭერისას გადადით Apple მენიუში 🍏> სისტემის ინფორმაცია. აპარატურის მიმოხილვიდან დააკოპირეთ მოდელის სახელი და მოდელის იდენტიფიკატორი ქვემოთ მოცემულ შესაბამის ველებზე.",
  ...
  RC_gazeTrackingNudge: {
    ...
    hi: "क्रॉस को पकड़ो! हमे आपकी मदद की जरूरत है। आई ट्रैकर को अधिक प्रशिक्षण की आवश्यकता है। जैसा कि तीर द्वारा दिखाया गया है, जब आपने क्लिक किया, तो ट्रैकर ने सोचा कि आपका टकटकी क्रॉस हेयर से बहुत दूर है। कृपया प्रत्येक नई स्थिति पर क्रॉस हेयर पर क्लिक करें। यह एक खेल है। क्रॉस को पकड़ो!",
  ...
  RC_soundCalibrationHoldIPhoneOk: {
    ...
    ko: "rc_soundcalibrationholdiphoneok는 더 이상 사용되지 않습니다.\n",
  },
  ...
  RC_soundCalibrationNeedsIPhone: {
    ...
    pl: "❌ RC_SoundCalibationneedsiphone jest przestarzały. Zamiast tego użyj RC_SoundcalibrationNeedsmicrofone.",
  ...
  T_continueClickProceedOrHitReturnOrKeypad: {
    ...
    pt: "Para continuar, clique em Continuar ou pressionar o retorno no teclado ou no teclado.",
    ...
    "zh-HK": "要繼續，請單擊“繼續或擊中鍵盤或電話鍵盤上的返回”。",
  ...
  T_guessingGame: {
    ...
    fi: "Kirjeen koko ja etäisyys vaihtelevat suuresta ja helposta alas pieneen ja kovasti. Et voi saada paljon enemmän kuin kaksi kolmasosaa oikein, joten rentoudu. Ajattele sitä arvauspelinä ja hanki vain niin monta kuin pystyt. Kuulet piippauksen aina kun olet oikeassa.",
    ...
    hi: "पत्र का आकार और रिक्ति बड़े और आसान से छोटे और कठिन से भिन्न होती है। आप दो-तिहाई से अधिक सही नहीं पा सकते हैं, इसलिए आराम करें। इसे एक अनुमान लगाने के खेल के रूप में सोचें, और बस जितने भी हो सके उतने प्राप्त करें। जब भी आप सही हों तो आप एक बीप सुनेंगे।",
  ...
  T_guessingGameVernier: {
    ...
    pl: "Zmiana linii różni się od dużych i łatwych do małego i twardego. Nie możesz uzyskać znacznie więcej niż dwie trzecie, więc zrelaksuj się. Pomyśl o tym jak o zgadywaniu i po prostu zdobądź tyle, ile możesz. Usłyszysz sygnał dźwiękowy, gdy masz rację.",
    ...
    fi: "Linjansiirto vaihtelee isoista ja helpoista pieneen ja kovasti. Et voi saada paljon enemmän kuin kaksi kolmasosaa oikein, joten rentoudu. Ajattele sitä arvauspelinä ja hanki vain niin monta kuin pystyt. Kuulet piippauksen aina kun olet oikeassa.",
    ...
    bn: "লাইন শিফটটি বড় এবং সহজ থেকে ছোট এবং শক্ত হয়ে পরিবর্তিত হয়। আপনি দুই-তৃতীয়াংশের চেয়ে বেশি কিছু পেতে পারেন না, তাই শিথিল করুন। এটিকে একটি অনুমানের খেলা হিসাবে ভাবেন এবং যতটা পারেন আপনি পান। আপনি যখনই ঠিক আছেন তখন আপনি একটি বীপ শুনতে পাবেন।",
    id: "Geser garis bervariasi dari besar dan mudah ke kecil dan keras. Anda tidak bisa mendapatkan lebih dari dua pertiga, jadi santai. Anggap saja sebagai permainan menebak, dan dapatkan sebanyak yang Anda bisa. Anda akan mendengar bunyi bip kapan pun Anda benar.",
    "zh-CN":
  ...
  T_identifyMiddleLetterPressIt: {
    ...
    ja: "キーボード/キーパッドで押して、中央の文字を特定してください。",
  ...
  T_identifyLetterPressIt: {
    ...
    it: "Identifica la lettera facendo clic di seguito o premendola nella tastiera/tastiera.",
  ...
  "❌T_identifyPressIt": {
    ...
    kn: "T_IDENTIFYPRESSIT → T_IDEDIFYMIDLELETELTERSPERIT ಅನ್ನು ಬದಲಾಯಿಸಿ",
  ...
  "❌T_identifyPressItOrClickIt": {
    ...
    te: "T_identifyPressitorclickit → T_IDENTIFIMIDLETERPRESSITORCLICKIT ని మార్చండి",
  ...
  T_middleLetterDemo: {
    ...
    ro: "În fiecare test, în timp ce privești crucea, un trei -ștergători de litere aleatorii vor clipi la colțul ochiului său. Doar un bliț. Pentru a învăța sarcina, să încercăm mai întâi cu un ecran static. În timp ce privești părul crucii, fără a mișca ochii: care este litera mediului?",
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو جاننے کے ل first ، پہلے اسے مستحکم کارکردگی کے ساتھ آزمائیں۔ نیچے آنکھیں ہلاتے ہوئے ، نیچے بالوں کو دیکھتے ہوئے ، نیچے: درمیانی کاغذ کیا ہے؟",
    hi: "प्रत्येक परीक्षण पर, जब आप क्रॉस हेयर को देखते हैं, तो तीन यादृच्छिक अक्षरों का एक ट्रिपल आपकी आंख के कोने में चमक जाएगा। बस एक झलक। कार्य को जानने के लिए, इसे पहले एक स्थिर प्रदर्शन के साथ आज़माएं। अपनी आँखों को हिलाने के बिना, नीचे, नीचे के बालों को देखते हुए: मध्य पत्र क्या है?",
  ...
  T_letterDemo: {
    ...
    pl: "Podczas każdej próby losowa litera błyszczy w rogu oka. Tylko błysk. Aby nauczyć się tego zadania, spróbujmy najpierw z wyświetlaczem statycznym. Patrząc na włosy krzyżowe, poniżej, bez poruszania oczami: jaki to litera?",
  ...
  T_typeOrClickRepeatedLetters: {
    ...
    ka: "ასოების ნაჩვენები სიაში დაჭერით, ან კლავიატურაზე/კლავიატურაზე დაჭერით.",
  ...
  T_readyPressSpaceOrClickCrosshairRepeatedLetters: {
    ...
    ka: "მზად ხართ ასოების იდენტიფიცირებისთვის? ჯვრის თმების ცენტრში პირდაპირ დათვალიერებისას, გთხოვთ, დააჭირეთ მას ან დააჭირეთ კოსმოსურ ზოლს.",
  ...
  T_sentenceGuessingGame: {
    ...
    fi: "Lauseen ymmärrettävyys vaihtelee helposti alas tai mahdotonta. Et voi saada paljon enemmän kuin kaksi kolmasosaa oikein, joten rentoudu. Ajattele sitä arvauspelinä ja hanki vain niin monta kuin pystyt. Kuulet piippauksen aina kun olet oikeassa.",
  ...
  T_thresholdBeginBlock: {
    ...
    ko: "t_thresholdbeginblock → t_thresholdmiddleletterbeginblock을 변경합니다",
  },
  T_thresholdMiddleLetterBeginBlock: {
    ...
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu beginnen. In jedem Versuch werden drei Buchstaben ein Triplett vorhanden, zum Beispiel: Z R N. Bitte melden Sie nur den mittleren Buchstaben.",

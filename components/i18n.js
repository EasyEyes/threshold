...
export const phrases = {
  ...
  RC_selectMicrophone: {
    ...
    ko: '라우드 스피커를 보정하기 위해 스마트 폰 (또는 USB 마이크)이 편리한 경우 아래 목록에 제조사 및 모델이 표시됩니까? 그렇다면 선택하십시오. 그렇지 않으면 "없음"을 선택하십시오. 그런 다음 진행을 클릭하십시오.\n',
    __EMPTY: "#VALUE!",
    __EMPTY_1: "#VALUE!",
  },
  RC_removeHeadphones: {
  ...
  RC_getUSBMicrophoneReady: {
    ...
    fi: "2. Aseta mikrofoni jalustaansa ja napsauta OK tai paina paluu.\n3. Ainakin ensimmäistä kertaa ilmestyy ponnahdusikkuna, jossa pyydetään lupaa mikrofonia. Kun annat luvan, kalibrointi alkaa.",
    ka: "2. დააყენეთ მიკროფონი თავის სამფეხა, და დააჭირეთ ღილაკს OK ან Hit Return.\n3. ყოველ შემთხვევაში, პირველად, გამოჩნდება pop -up ითხოვს მიკროფონის გამოყენების ნებართვას. როდესაც ნებართვას მიიღებთ, დაიწყება კალიბრაცია.",
  ...
  RC_soundCalibrationDone: {
    ...
    es: "Gracias. La calibración está lista y puede guardar el teléfono inteligente. IMPORTANTE: No toque el control de volumen hasta que se realice el experimento. Cambiar el volumen arruinará la calibración e invalidará todos los resultados.",

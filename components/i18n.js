...
export const phrases = {
  ...
  EE_compatibleBrowserOSDeviceCores: {
    ...
    ja: "その説明で述べたように、この研究では、少なくとも222 CPUコアを使用してOOO DDDで実行されるBBBブラウザが必要です",
  ...
  RC_distanceTrackingCloseL: {
    ...
    pl: "1. Zamknij lewe oko. (To jest lewa strona ekranu.)\n2. Użyj klucza strzałki, aby przesunąć migoczącą kropkę. (Lub po prostu przeciągnij go, jeśli nie reaguje na klawisz strzałki.) Patrząc na włosy krzyżowe, monitoruj migoczącą kropkę w rogu oka i przesuń go w lewo i w prawo, aż zniknie w twojej ślepej.\n3. Hit Return.\nUwaga: miej oko na włosy krzyżowe. Migocząca kropka nie zniknie, gdy podąża za nim oko.",
  ...
  RC_distanceTrackingCloseR: {
    ...
    "zh-CN":
      "1.闭上右眼。 （这是屏幕的右侧。）\n2.使用◀箭头键滑动闪烁的点。在看着十字头发的同时，监视眼角的闪烁点，然后向左和向右滑动，直到它消失在盲点中​​。\n3.命中返回。\n注意：请密切关注十字头发。当您的眼睛跟随它时，闪烁的点不会消失。",
    "zh-HK":
  ...
  RC_soundCalibrationNeedsIPhone: {
    ...
    kn: "ನಿಖರವಾದ ಧ್ವನಿಯನ್ನು ಉತ್ಪಾದಿಸಲು, ಪ್ರಯೋಗವು ಧ್ವನಿವರ್ಧಕಗಳನ್ನು ಮಾಪನಾಂಕ ನಿರ್ಣಯಿಸುವ ಅಗತ್ಯವಿದೆ. ಇದಕ್ಕೆ ಇಂಟರ್ನೆಟ್‌ಗೆ ಸಂಪರ್ಕ ಹೊಂದಿದ ಐಫೋನ್ ಅಥವಾ ಐಪ್ಯಾಡ್ ಅಗತ್ಯವಿದೆ. ನಿಮಗೆ ಒಂದು ಸೂಕ್ತವಿದೆಯೇ?\n",
  ...
  T_identifyPressItOrClickItRepeatedLetters: {
    ...
    ar: "حدد الحرفين الوسيطين عن طريق النقر أو الضغط عليها على لوحة المفاتيح.",
  ...
  T_middleLetterDemo: {
    ...
    ur: "ہر ٹیسٹ پر ، جب آپ کراس کے بالوں کو دیکھیں تو ، آپ کی آنکھ کے کونے میں تین بے ترتیب حرفوں کا ایک ٹرپل چمک اٹھے گا۔ صرف ایک جھلک کام کو جاننے کے لئے ، مستحکم کارکردگی کے ساتھ پہلے اسے آزمائیں۔ جب آپ کراس بالوں کو دیکھیں تو ، آنکھیں ہلاتے ہوئے ، درمیانی خط کی شناخت کرنے کی کوشش کریں۔",
  ...
  T_sentenceProcedure: {
    ...
    ur: "ہر آزمائش پر ، آپ کو ایک جملہ سنا جائے گا ، عام طور پر شور میں۔ تب آپ کو تمام ممکنہ جملوں کی ایک فہرست نظر آئے گی ، اور آپ جو کچھ سنا ہے ، یا آپ کا بہترین اندازہ لگائیں گے۔",

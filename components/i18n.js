...
export const phrases = {
  ...
  RC_screenSizeCredit: {
    ...
    ur: 'لی ایٹ ال کے ذریعہ کریڈٹ کارڈ تجویز کیا گیا ہے۔ (2020) "ورچوئل چنیسٹ" کاغذ۔',
  ...
  T_thresholdLetterBeginBlock: {
    ...
    ka: "თქვენ დაიწყებთ xxx ტესტების ბლოკს. წერილები გამოჩნდება თითოეულ სასამართლო პროცესზე. გთხოვთ, შეატყობინოთ,",

...
export const phrases = {
  ...
  RC_distanceTrackingCloseL: {
    ...
    ko: "1. 왼쪽 눈을 닫습니다. (이것은 화면의 왼쪽입니다.)\n2. ▶ 화살표 키를 사용하여 깜박 거리는 점을 밀어 넣습니다. (또는 화살표 키에 응답하지 않으면 드래그하십시오.) 십자 머리카락을 보면서 눈 모서리의 깜박 거리는 점을 모니터링하고 사각 지대로 사라질 때까지 왼쪽과 오른쪽으로 밀어 넣으십시오.\n3. 반환을 누르십시오.\n참고 : 크로스 털을 주시하십시오. 눈이 뒤 따르는 동안 깜박 거리는 점은 사라지지 않습니다.",
  },
  ...
  RC_gazeTrackingIntro: {
    ...
    te: '"సిలువను పట్టుకోండి!" కంటి స్థానాన్ని పర్యవేక్షించడానికి ఇప్పుడు మేము చూపుల ట్రాకింగ్‌ను ఏర్పాటు చేస్తాము. మీ ముఖాన్ని వీడియో ఫీడ్‌లో ఉంచండి (క్రింద చూడండి). క్రాస్ హెయిర్స్ మధ్యలో క్లిక్ చేయండి, అది ఎక్కడ ఉన్నా. మీరు క్లిక్ చేసినప్పుడు మీ కళ్ళు దానిపై ఉన్నాయని నిర్ధారించుకోండి. మీరు దీన్ని క్లిక్ చేసినప్పుడు, క్రాస్ హెయిర్స్ క్రొత్త ప్రదేశానికి వెళ్తాయి. క్రమాంకనం పూర్తయ్యే వరకు ప్రతి క్రొత్త ప్రదేశంలో క్లిక్ చేయండి. ఇది ఒక ఆట. సిలువను పట్టుకోండి!',
  ...
  RC_privacyCamera: {
    ...
    hi: "कैमरा गोपनीयता का आश्वासन। कोई फ़ोटो या वीडियो रिकॉर्ड नहीं किया गया है। प्रत्येक वेबकैम फ्रेम का उपयोग केवल इस कंप्यूटर के अंदर किया जाता है, पूरी तरह से आंख और टकटकी स्थिति का अनुमान लगाने के लिए, और फिर 10 सेकंड के भीतर मिटा दिया जाता है। केवल आंख और टकटकी की स्थिति बनाए रखी जाती है।",

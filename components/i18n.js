...
export const phrases = {
  ...
  T_identifyVernierPressItOrClickIt: {
    ...
    fi: "Mihin suuntaan ylälinja siirtyy? Napsauta kirjettä tai paina näppäintä vasemmalle tai oikealle.",
  ...
  T_readyTrackCrosshair: {
    ...
    fi: "Valmis? Seuraa kohdistimella ristikohdan keskipistettä, kunnes kohde ilmestyy.",

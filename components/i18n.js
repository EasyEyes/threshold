...
export const phrases = {
  ...
  RC_findModelAndroid: {
    ...
    pl: "Przejdź do menu Ustawienia lub opcji, przewiń do dołu listy i sprawdź „About Telefon”, „About Device” lub podobne. Skopiuj nazwę i numer modelu do odpowiednich pól poniżej.",
    ...
    he: "עבור לתפריט ההגדרות או האפשרויות, גלול לתחתית הרשימה ובדוק 'אודות טלפון', 'אודות מכשיר' או דומה. העתק את שם הדגם ומספר לשדות המתאימים למטה.",
  ...
  RC_findModelIOs: {
    ...
    pl: "Przejdź do Ustawienia> Ogólne> O. Po prawej stronie „Numer modelu” znajdziesz numer części. Aby znaleźć numer modelu („A”, a następnie numer), dotknij numeru części. Skopiuj nazwę i numer modelu do odpowiednich pól poniżej.",
    ...
    he: 'עבור אל הגדרות> כללי> אודות. מימין ל"מספר הדגם ", תמצא את מספר החלק. כדי למצוא את מספר הדגם (A "A" ואחריו מספר), הקש על מספר החלק. העתק את שם הדגם ומספר לשדות המתאימים למטה.',
  ...
  RC_privacyIphoneMicrophone: {
    ...
    he: "❌ RC_PRIVACYIPHONEMICYROPHONE מיושן. השתמש במקום זאת ב- RC_PRIVACYMICROPHONECALIBRATION.",
    ...
    te: "❌ RC_PRIVACYIPHONEMICHROPONE వాడుకలో లేదు. బదులుగా rc_privacymicrophonecalibration ఉపయోగించండి.",
    ...
    ko: "RC_PRIVACYIPHONEMICROPHONE은 쓸모가 없습니다. 대신 rc_privacymicrophonecalibration을 사용하십시오.",
  },
  ...
  RC_soundCalibrationNeedsIPhone: {
    ...
    pl: "❌ RC_SoundCalibationneedsiphone jest przestarzały. Zamiast tego użyj RC_SoundCalibationneedsmikrofon.",
    ...
    fi: "❌ RC_SOONDCALIBRATIONNEEDSIPHONE on vanhentunut. Käytä sen sijaan RC_SOONDCALIBRATIONNEDSMICROPHONE.",

...
export const phrases = {
  ...
  RC_FindModelAndroid: {
    ...
    he: "מכיוון שמדובר באנדרואיד, עבור לתפריט ההגדרות או האפשרויות, גלול לתחתית הרשימה ובדוק 'אודות טלפון', 'על מכשיר' או דומה. העתק את שם הדגם ומספר השדות המתאימים למטה.",
    ...
    "zh-HK":
      "由於這是一個Android，請轉到“設置或選項”菜單，滾動到列表的底部，然後檢查“關於電話”，“關於設備”或類似的“關於電話”。將模型名稱和數字複製到下面的相應字段。",
  ...
  RC_phoneMicrophoneInstructions: {
    ...
    ar: '1. إذا ظهر أحد المنبثقة ، فطلب إذنك لاستخدام الميكروفون ، انقر فوق "السماح".\n2. يجب أن تكون المنشفة المطوية على الطاولة بينك وبين جهاز الكمبيوتر الخاص بك. ضع هذا الهاتف على المنشفة ، ويمتد إلى ما وراء المنشفة ، مع حافة الميكروفون (السفلية) التي تواجه جهاز الكمبيوتر الخاص بك.\n3. اضغط على "متابعة".',
  ...
  RC_placeSmartphoneMicrophone: {
    ...
    ru: "Оставьте свой телефон на сложенную ткань, укажите на это кромке телефона на компьютер, немного протолкнув его по краю сложенной ткани. Пресса продолжается.",
    ...
    ar: "استراحة هاتفك على قطعة قماش مطوية ، قم بتوضيح حافة الهاتف هذه على جهاز الكمبيوتر الخاص بك ، ودفعه قليلاً بعد حافة القماش المطوي. اضغط على متابعة.",

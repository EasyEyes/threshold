...
export const phrases = {
  ...
  RC_citeSoundCompressionModel: {
    ...
    fr: 'Basé sur l\'équation. 4 de Giannoulis et al. (2012). <a href="http://eecs.qmul.ac.uk/~josh/documents/2012/giannoulismassbergreiss-dynamicrangecompression-jaes2012.pdf"> conception de compresseur de gamme dynamique numérique. </a> J. Audio Eng. Soc. 6 (6): 399-408.',
  ...
  RC_soundCalibrationDone: {
    ...
    fi: "Kiitos. Kaiutin on nyt kalibroitu, ja voit laittaa älypuhelimen (tai USB -mikrofonin) pois. Tärkeää: Älä kosketa äänenvoimakkuutta, ennen kuin koe on tehty. Volumejen muuttaminen pilaa kaiutinkalibroinnin ja mitätöimään kaikki tulokset.",
  ...
  "❌T_identifyPressItOrClickIt": {
    ...
    fi: "Muuta t_IdentifyPressitorClickit → T_IdentifyMiddlotEtterPressItorClickit",

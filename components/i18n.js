...
export const phrases = {
  ...
  T_thresholdLetterBeginBlock: {
    "en-US":
      "You are about to begin a block of xxx trials. A letter will appear in each trial. Please report it,",
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu beginnen. In jedem Versuch erscheint ein Brief. Bitte melden Sie es,",
    fr: "Vous êtes sur le point de commencer un bloc d'essais xxx. Une lettre apparaîtra dans chaque procès. Veuillez le signaler,",
    es: "Estás a punto de comenzar un bloque de pruebas xxx. Aparecerá una carta en cada juicio. Por favor denunciarlo,",
    pt: "Você está prestes a iniciar um bloco de ensaios xxx. Uma carta aparecerá em cada teste. Por favor, relate,",
    it: "Stai per iniziare un blocco di prove xxx. Una lettera apparirà in ogni prova. Si prega di segnalarlo,",
    ro: "Ești pe cale să începi un bloc de încercări xxx. O scrisoare va apărea în fiecare proces. Vă rugăm să îl raportați,",
    pl: "Niedługo rozpoczniecie blok prób xxx. W każdym procesie pojawi się list. Zgłoś to,",
    ru: "Вы собираетесь начать блок xxx испытаний. Письмо появится в каждом испытании. Пожалуйста, сообщите об этом,",
    hy: "Դուք պատրաստվում եք սկսել xxx փորձարկումների բլոկ: Յուրաքանչյուր փորձության մեջ նամակ կհայտնվի: Խնդրում ենք զեկուցել այն,",
    fi: "Olet aloittamassa xxx -kokeiden lohkon. Jokaisessa kokeessa ilmestyy kirje. Ilmoita siitä,",
    ka: "თქვენ დაიწყებთ xxx ტესტების ბლოკს. წერილი გამოჩნდება თითოეულ სასამართლო პროცესზე. გთხოვთ, შეატყობინოთ მას,",
    he: "אתה עומד להתחיל בלוק של ניסויים ב- xxx. מכתב יופיע בכל משפט. אנא דווח על כך,",
    ar: "أنت على وشك البدء في كتلة من تجارب xxx. ستظهر رسالة في كل تجربة. الرجاء الإبلاغ عنها ،",
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر آزمائش میں ایک خط نظر آئے گا۔ براہ کرم اس کی اطلاع دیں ،",
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण में एक पत्र दिखाई देगा। कृपया इसकी रिपोर्ट करें,",
    ta: "நீங்கள் xxx சோதனைகளின் ஒரு தொகுதியைத் தொடங்க உள்ளீர்கள். ஒவ்வொரு விசாரணையிலும் ஒரு கடிதம் தோன்றும். தயவுசெய்து அதைப் புகாரளிக்கவும்,",
    ml: "നിങ്ങൾ xxx പരീക്ഷണങ്ങളുടെ ഒരു ബ്ലോക്ക് ആരംഭിക്കാൻ പോകുന്നു. ഓരോ വിചാരണയിലും ഒരു കത്ത് ദൃശ്യമാകും. ദയവായി അത് റിപ്പോർട്ടുചെയ്യുക,",
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. ప్రతి విచారణలో ఒక లేఖ కనిపిస్తుంది. దయచేసి దాన్ని నివేదించండి,",
    kn: "ನೀವು xxx ಪ್ರಯೋಗಗಳ ಬ್ಲಾಕ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಲಿದ್ದೀರಿ. ಪ್ರತಿ ವಿಚಾರಣೆಯಲ್ಲಿ ಪತ್ರ ಕಾಣಿಸುತ್ತದೆ. ದಯವಿಟ್ಟು ಅದನ್ನು ವರದಿ ಮಾಡಿ,",
    ...
    "zh-CN": "您即将开始一个xxx试验。每个审判都会出现一封信。请报告，",
    "zh-HK": "您即將開始一個xxx試驗。每個審判都會出現一封信。請報告，",

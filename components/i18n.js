...
export const phrases = {
  ...
  EE_incompatibleReturnToProlific: {
    ...
    de: "Diese Studie ist mit Ihrem Computer oder Browser nicht kompatibel. Bitte geben Sie sie also an protrific.co zurück. Die Zahlungseintritt wird abgelehnt (was Ihren Ruf schadet). Bitte geben Sie sie zurück.",
  ...
  T_thresholdSoundCheck: {
    ...
    ur: "سلام بیپ بٹن پر کلک کریں ، براہ کرم یقینی بنائیں کہ اس کمپیوٹر کی آواز کام کر رہی ہے۔ ویسے ، جب بھی آپ کی ٹری درست تھی ، آپ کو ایسی قسم کا بیپ سنیں گے۔",

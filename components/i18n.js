...
export const phrases = {
  ...
  RC_panelIntro: {
    ...
    de: "❌ RC_panelIntro is obsolete.",
    fr: "❌ RC_panelIntro is obsolete.",
    es: "❌ RC_panelIntro is obsolete.",
    pt: "❌ RC_panelIntro is obsolete.",
    it: "❌ RC_panelIntro is obsolete.",
  ...
  T_thresholdVenierBeginBlock: {
    "en-US":
      "You are about to begin a block of xxx trials. Each trial will present a new pair of lines. Please report whether the upper line is shifted left or right,",
    de: "Sie sind kurz davor, einen Block von xxx -Versuchen zu beginnen. Jeder Versuch wird ein neues Paar Linien vorstellen. Bitte melden Sie, ob die obere Linie nach links oder rechts verschoben wird.",
    fr: "Vous êtes sur le point de commencer un bloc d'essais xxx. Chaque essai présentera une nouvelle paire de lignes. Veuillez signaler si la ligne supérieure est décalée à gauche ou à droite,",
    es: "Estás a punto de comenzar un bloque de pruebas xxx. Cada prueba presentará un nuevo par de líneas. Informe si la línea superior se desplaza hacia la izquierda o hacia la derecha,",
    pt: "Você está prestes a iniciar um bloco de ensaios xxx. Cada teste apresentará um novo par de linhas. Por favor, relate se a linha superior é deslocada para a esquerda ou para a direita,",
    it: "Stai per iniziare un blocco di prove xxx. Ogni prova presenterà una nuova coppia di linee. Si prega di segnalare se la linea superiore è spostata a sinistra oa destra,",
    ro: "Ești pe cale să începi un bloc de încercări xxx. Fiecare proces va prezenta o nouă pereche de linii. Vă rugăm să raportați dacă linia superioară este deplasată la stânga sau la dreapta,",
    pl: "Niedługo rozpoczniecie blok prób xxx. Każda próba przedstawi nową parę linii. Proszę zgłosić, czy górna linia jest przesunięta w lewo, czy w prawo,",
    ru: "Вы собираетесь начать блок xxx испытаний. Каждое испытание представит новую пару линий. Пожалуйста, сообщите, сдвинута ли верхняя линия влево или вправо,",
    hy: "Դուք պատրաստվում եք սկսել xxx փորձարկումների բլոկ: Յուրաքանչյուր փորձություն կներկայացնի նոր զույգ տող: Խնդրում ենք զեկուցել, թե արդյոք վերին գիծը տեղափոխվում է ձախ կամ աջ,",
    fi: "Olet aloittamassa xxx -kokeiden lohkon. Jokainen kokeilu esittelee uuden linjaparin. Ilmoita, siirretäänkö ylälinja vasemmalle tai oikealle,",
    ka: "თქვენ აპირებთ xxx კვლევების ბლოკს. თითოეული სასამართლო პროცესი წარმოგიდგენთ ახალ წყვილს. გთხოვთ, შეატყობინოთ თუ არა ზედა ხაზი მარცხნივ ან მარჯვნივ,",
    he: "אתה עומד להתחיל בלוק של ניסויים ב- xxx. כל ניסיון יציג זוג שורות חדש. אנא דווח אם הקו העליון מועבר שמאלה או ימינה,",
    ar: "أنت على وشك البدء في كتلة من تجارب xxx. ستقدم كل تجربة زوجًا جديدًا من الخطوط. الرجاء الإبلاغ عما إذا كان الخط العلوي قد تم تحويله إلى اليسار أو اليمين ،",
    ur: "آپ xxx ٹرائلز کا ایک بلاک شروع کرنے والے ہیں۔ ہر مقدمے کی سماعت لائنوں کی ایک نئی جوڑی پیش کرے گی۔ براہ کرم اطلاع دیں کہ آیا اوپری لائن کو بائیں یا دائیں منتقل کیا گیا ہے ،",
    hi: "आप xxx परीक्षणों का एक ब्लॉक शुरू करने वाले हैं। प्रत्येक परीक्षण लाइनों की एक नई जोड़ी पेश करेगा। कृपया रिपोर्ट करें कि ऊपरी रेखा को बाएं या दाएं स्थानांतरित किया गया है,",
    ta: "நீங்கள் xxx சோதனைகளின் ஒரு தொகுதியைத் தொடங்க உள்ளீர்கள். ஒவ்வொரு சோதனையும் ஒரு புதிய ஜோடி வரிகளை வழங்கும். மேல் வரி இடது அல்லது வலதுபுறமாக மாற்றப்பட்டதா என்பதைப் புகாரளிக்கவும்,",
    ...
    te: "మీరు xxx ట్రయల్స్ యొక్క బ్లాక్‌ను ప్రారంభించబోతున్నారు. ప్రతి ట్రయల్ కొత్త జత పంక్తులను ప్రదర్శిస్తుంది. దయచేసి ఎగువ రేఖ ఎడమ లేదా కుడి వైపుకు మార్చబడిందో లేదో నివేదించండి,",
    kn: "ನೀವು xxx ಪ್ರಯೋಗಗಳ ಬ್ಲಾಕ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಲಿದ್ದೀರಿ. ಪ್ರತಿ ಪ್ರಯೋಗವು ಹೊಸ ಜೋಡಿ ಸಾಲುಗಳನ್ನು ಪ್ರಸ್ತುತಪಡಿಸುತ್ತದೆ. ಮೇಲಿನ ರೇಖೆಯನ್ನು ಎಡ ಅಥವಾ ಬಲಕ್ಕೆ ಸ್ಥಳಾಂತರಿಸಲಾಗಿದೆಯೆ ಎಂದು ದಯವಿಟ್ಟು ವರದಿ ಮಾಡಿ,",
    bn: "আপনি xxx ট্রায়ালগুলির একটি ব্লক শুরু করতে চলেছেন। প্রতিটি ট্রায়াল লাইনগুলির একটি নতুন জুড়ি উপস্থাপন করবে। উপরের লাইনটি বাম বা ডানদিকে স্থানান্তরিত হয়েছে কিনা তা দয়া করে রিপোর্ট করুন,",
    id: "Anda akan memulai blok uji coba xxx. Setiap percobaan akan menyajikan sepasang garis baru. Harap laporkan apakah garis atas digeser ke kiri atau kanan,",
    "zh-CN":
      "您即将开始一个xxx试验。每个试验都会呈现一条新的线条。请报告上线是向左还是向右移动",
    "zh-HK":
      "您即將開始一個xxx試驗。每個試驗都會呈現一條新的線條。請報告上線是向左還是向右移動",
    ja: "xxxトライアルのブロックを開始しようとしています。各トライアルは、新しいラインのペアを提示します。上線が左または右にシフトされているかどうかを報告してください。",
    ko: "xxx 시험 블록을 시작하려고합니다. 각 시험에는 새로운 라인이 나타납니다. 상단 라인이 왼쪽인지 오른쪽으로 바뀌 었는지보고하십시오.",
  },

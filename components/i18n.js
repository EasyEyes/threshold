...
export const phrases = {
  ...
  EE_ID_noLocalStorage: {
    ...
    "zh-CN":
      "研究人员要求您从上一个会话中提供EasyEyes ID，请在此处输入，或在上次会话结束时上传下载的文件。",
    "zh-HK":
  ...
  RC_privacyCamera: {
    ...
    id: "Jaminan privasi kamera. Tidak ada foto atau video yang direkam. Setiap bingkai webcam hanya digunakan di dalam komputer ini, semata -mata untuk memperkirakan posisi mata dan pandangan, dan kemudian dihapus, dalam 10 detik. Hanya posisi mata dan pandangan yang dipertahankan.",
    "zh-CN":
  ...
  RC_privacyIphoneMicrophone: {
    ...
    fr: "Assurance de la confidentialité des microphones. EasyEyes utilise votre microphone iPhone / iPad, plutôt que le microphone intégré de votre bureau, car le microphone iPhone / iPad est calibré du fabricant. Le microphone enregistre uniquement tandis qu'un son bruyant joue dans le haut-parleur de l'ordinateur de bureau, et l'ordinateur de bureau affiche bien en vue \"silencieux s'il vous plaît! Maintenant l'enregistrement\". L'enregistrement est utilisé uniquement pour estimer les caractéristiques des haut-parleurs, puis effacée, dans les 30 secondes. Seules les caractéristiques du haut-parleur sont conservées.",
  ...
  T_middleLetterDemo: {
    ...
    ko: "각 시험에서 십자형 머리카락을 보면서 3 개의 임의의 문자가 눈의 모퉁이에 번쩍입니다. 단지 플래시. 작업을 배우려면 먼저 정적 디스플레이를 사용하여 시도해 봅시다. 눈을 움직이지 않고 아래의 십자 머리카락을 보는 동안 중간 문자를 식별하십시오.",
  },
  T_ok: {
    "en-US": "OK",
    de: "OK",
  ...
  T_rsvpReadingTask: {
    ...
    ta: "நீங்கள் xxx சோதனைகளின் ஒரு தொகுதியைத் தொடங்க உள்ளீர்கள். நீங்கள் ஒரு கதையை வாசிப்பீர்கள், ஒரு நேரத்தில் சில சொற்கள். ஒவ்வொரு சோதனையும் ஒரு வாக்கியம் மதிப்புள்ள சொற்களைப் பற்றி விரைவாக உங்களுக்குக் காண்பிக்கும், ஒன்றன் பின் ஒன்றாக, பின்னர் நீங்கள் என்ன சொற்களைப் படித்தீர்கள் என்பதை நினைவில் கொள்ளும்படி கேட்கும்.",

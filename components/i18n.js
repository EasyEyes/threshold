...
export const phrases = {
  ...
  T_middleLetterBrief: {
    ...
    he: "זה R. תצוגה זו סטטית, כך שיהיה קל להעביר את העיניים למכתב ולזהות אותו. אבל, במשפט אמיתי, המכתבים מבהיקים, כך שאין זמן להזיז את העיניים. חשוב להסתכל על שערות הצלב כשאתה יוזם את המשפט. האותיות יבהבו מייד. לא משנה לאן העיניים שלך הולכות אחרי ההבזק. גוש הבדיקה הראשון הוא רק כמה ניסויים של תרגול, לפני שנתחיל ברצינות.",
  ...
  T_letterBrief: {
    ...
    he: "זה R. תצוגה זו סטטית, כך שיהיה קל להעביר את העיניים למכתב ולזהות אותו. אבל, במשפט אמיתי, המכתב הבזיק, כך שאין זמן להזיז את העיניים. חשוב להסתכל על שערות הצלב כשאתה יוזם את המשפט. המכתב יבהב מייד. לא משנה לאן העיניים שלך הולכות אחרי ההבזק. גוש הבדיקה הראשון הוא רק כמה ניסויים של תרגול, לפני שנתחיל ברצינות.",

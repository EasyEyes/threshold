...
export const GLOSSARY: Glossary = {
  ...
  fontPadding: {
    ...
    default: "0.5",
    explanation:
      "⭑ fontPadding is a positive number (default 0.5; we've tried 0, 0.5, 1, and 3) specifying how much padding PIXI.js should add around each string to avoid clipping, at the cost of slower rendering and increased risk of crashing at large size (>100 pt). Setting fontPadding to zero produces the default PIXI.js behavior, which renders the Roboto Mono font perfectly, but slightly clips the left and bottom edges of strings in fonts with more flourish, i.e. Catalina, Burgues, and Arabic. Increasing fontPadding to 0.5 or higher eliminates clipping of these fonts. Setting fontPadding to a high value (e.g. 3) can cause timing problems: lateness and errors in duration. [Our typesetting code has improved greatly and we are now re-assessing how fontPadding affects lateness, duration, and probability of crashing.] Lateness and duration are measured by EasyEyes and reported in the CSV results file as targetMeasuredLatenessSec and targetMeasuredDurationSec. A new parameter _logFontBool should be very helpful in diagnosing font-related crashes online. On our 8-core M1 MacBook Pro, setting fontPadding to 0 or 0.5 gives good timing:  duration within 10 ms of the requested 150 ms targetDurationSec and SD about 20 ms, as I recall. Setting fontPadding to 3 results in terrible timing: Rendering is obviously very slow, and the requested 150 ms targetDurationSec yields 100 ms mean duration. The experiment testClippingOfCrowdingAndReading.xlsx was used to assess this.",
  },
  fontRenderMaxPx: {

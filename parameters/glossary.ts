...
export const GLOSSARY: Glossary = {
  ...
  fontSizeReferencePx: {
    ...
    default: "300",
    explanation:
      'fontSizeReferencePx (default 300) is the (moderate) font size used to compute a normalized bounding box around the stimulus, which is later scaled and shifted. Smaller is quicker, but worsens the effect of pixel-quantization. Pixel quantization has two effects: \n1. a fractional error of up to ±0.5/fontSizeReferencePx in each side of the bounding rect. We should avoid underestimating the bounding box by "growing" it by half a pixel outward on every side. \n2. a loss of thin less-than-one-pixel-thick tips.\nIn October 2024, Maria Pombo found no effect on timing of changing fontSizeReferencePx from 50 to 300 (the current default).',
  },
  fontSource: {
    name: "fontSource",
    availability: "now",

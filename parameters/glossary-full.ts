...
export const GLOSSARY: GlossaryFullItem[] = [
  ...
  },
  {
    ...
    example: "",
    explanation:
      "viewingDistanceNudgingBool is obsolete. In effect, it is always TRUE. Use viewingDistanceAllowedRatio to control nudging.",
    type: "obsolete",
    default: "",
    categories: "",
  },

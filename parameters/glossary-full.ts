...
export const GLOSSARY: GlossaryFullItem[] = [
  ...
  },
  {
    ...
    availability: "now",
    example: "_calibrateDistanceCameraToCardCm",
    explanation:
  ...
  },
  {
    ...
    availability: "now",
    example: "_calibrateTrackDistanceCardTopVideoFraction",
    explanation:
  ...
  },
  {
    ...
    availability: "now",
    example: "calibrateDistanceCheckLengthAllowedSD",
    explanation:
  ...
  },
  {
    ...
    example: "",
    explanation:
      '_needMemoryGB (default 8) requires that a participant computer running Windows or macOS have at least this many GB of memory, as reported by navigator.deviceMemory, but the requirement is halved for OSes other than macOS and Windows. In 2025, EasyEyes experienced memory-related issues only on Windows, so, if the browser, like Safari and Firefox, does not support navigator.deviceMemory, then _needMemoryGB reject the computer only if its OS is Windows. (When the Device Compatibility page rejects a Windows computer because the browser doesn\'t support navigator.deviceMemory, the participant is invited to switch to Chrome or Edge, which do support it and are easily downloaded.)\n\n⚠ CAUTION: Every browser that supports navigator.deviceMemory has a maximum value that it can return. Until recently that was 8 GB, but, since April 2026, new versions of desktop browsers have raised that limit to 32 GB. The _needMemoryGB value will accept only those computers that verify that they have the required amount of memory. A computer can be rejected for lacking memory, or lacking a browser that can report it. The navigator.deviceMemory limits are designed to preserve privacy. The value returned by navigator.deviceMemory is rounded to the nearest discrete level: smallestValue, ... , 2, 4, 8, ..., maxValue GB. Thus, for a MacBook Pro with 64 GB, Chrome 146 returned 8, and Chrome 147 (released April 2026) returns 32.\n\nnavigator.deviceMemory is supported by the browsers Chrome, Edge, Opera, and Samsung, and not by Safari and Firefox.\nhttps://developer.mozilla.org/en-US/docs/Web/API/Navigator/deviceMemory\n"Before Chrome 147, reported values were 0.25, 0.5, 1, 2, 4, and 8.\nFrom Chrome 147, reported values are 2, 4, 8, 16, and 32."\n\nIn 2025, ChatGPT estimated the mean amounts of memory under several OSes: \n        •        Windows 10: Average 8 GB, with a wide range due to diverse user requirements.\n        •        macOS: Average 16 GB, following Apple’s recent standardization.\n        •        ChromeOS: Average 4 to 8 GB, reflecting the lightweight nature of Chromebooks.\n        •        Linux: Average 4 GB, considering the prevalence of mid-range systems.\nBased on results from 7 Windows computers, requiring 8 GB may achieve quick rendering of large fonts for Windows. macOS computers have been sold with at least 8 GB for many years. It appears that ChromeOS and Linux use memory more efficiently, so we require just _needMemoryGB/2 under OSes other than macOS and Windows. ',
    type: "numerical",
    default: "8",
    categories: "",
  },
  ...
  },
  {
    ...
    availability: "now",
    example: "targetImageReplacementBool",
  ...
  },
  {
    ...
    default: "",
    categories:
      "letter, gabor, vernier, image, movie, sound, vocoderPhrase, reading, rsvpReading, repeatedLetters",
  },
  {
  ...
  },
  {
    ...
    default: "",
    categories:
      "targetEccentricityXDeg, spacingDeg, targetSizeDeg, targetN, targetOffsetDeg, targetDurationSec, targetContrast, targetSoundDBSPL, targetSoundNoiseDBSPL",
  },
  {
  ...
  },
  {
    ...
    availability: "now",
    example: "thresholdParameterScaleUp",
    explanation:
  ...
  },
  {
    ...
    availability: "now",
    example: "thresholdParameterScaleUpMore",
    explanation:
